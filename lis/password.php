                        ...
                        <form action="password_process.php?action=edit" name="frm" method="post" id="frm" onsubmit="password();" >
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <input name="uname" type="text" class="validate[required] new_textbox190" id="uname" size="45" value="<?php echo $res_edit["user_id"];?>"/></td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
                              <input name="mobile" type="text" class="validate[required] new_textbox190" id="mobile" size="45" value="<?php echo $res_edit["mobile"];?>"/></td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><input name="submit" id="submit" value="submit" type="image" src="../images/save_btn.png" /></td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
