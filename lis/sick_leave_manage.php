          ...
          <tr>
            <td height="450" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
				...
				?>
                  <tr>
                    <td height="25" colspan="9" align="center" valign="middle"><span class="nametext1"><?php echo constant("ADMIN_GROUP_MANAGE_NOREC");?></span></td>
                  </tr>
                  <?
					}
					?>
                  <tr>
                    <td height="25" colspan="9" align="left" valign="middle"  class="pedtext" ><?php echo constant("CD_SICK_LEAVE_MANAGE_OTHERS");?></td>
                  </tr>
                </table></td>
              </tr>
			  <tr>
                ...
                <thead>
                  <tr class="logintext">
                    ...
                    <th width="21%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_NEWS_MANAGE_TEACHER");?></th>
                    <th width="13%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("TEACHER_MANAGE_SICKLEAVE_FROMDT");?></th>
                    ...
                    <th width="14%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("TEACHER_MANAGE_SICKLEAVE_ATTACH");?></th>
                    <th width="14%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("TEACHER_MANAGE_SICKLEAVE_STATUS");?></th>
                  </tr>
                  </thead>
                  <?php				
					$i =1;
