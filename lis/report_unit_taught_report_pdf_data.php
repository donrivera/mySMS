...
<table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <?php
                    ...
                    <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                      ...
                      <td align="right" valign="middle" class="mycon"><?php echo $valenroll["course_fee"];?>&nbsp;</td>
                      ...
                      <td align="right" valign="middle" class="mycon"><?php echo $valenroll["course_fee"];?>&nbsp;</td>
                      <td align="right" valign="middle" class="mycon"><?php echo $en_amt;?>&nbsp;</td>
                      <td align="right" valign="middle" class="mycon"><?php echo $re_amt;?>&nbsp;</td>
                      <td align="right" valign="middle" class="mycon"><?php echo $bal_amt;?>&nbsp;</td>
                      <?php
                              $i = $i + 1;
                              if($color=="#ECECFF")
                              {
