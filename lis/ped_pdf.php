...
if($_SERVER['HTTP_HOST'] == "bletprojects.com" || $_SERVER['HTTP_HOST'] == "localhost"){
	$baseUrl="http://" . $_SERVER['HTTP_HOST'] ."/schedule/lis/"; 
}else if($_SERVER['HTTP_HOST'] == "berlitz-ksa.com" || $_SERVER['HTTP_HOST'] == "www.berlitz-ksa.com"){
	$baseUrl="http://" . $_SERVER['HTTP_HOST'] ."/mySMS/lis/"; 
}else{
	$baseUrl="http://" . $_SERVER['HTTP_HOST'] ."/lis/";
}

$filename = "ped.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."ped_pdf_data.php?cmbgroup=$_REQUEST[cmbgroup]";
