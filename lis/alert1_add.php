                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                        ...
                        <tr>                          
                         <td align="left" valign="middle" id="lblname">&nbsp;</td>
                          ...
                          <td>&nbsp;</td>
                           ...
                           <td height="28" align="left" valign="top" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_ALERT1_MANAGE_IMPORTANTINFO");?> </td>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                        </tr>                        
                        <tr>                          
                          <td align="left" valign="middle">&nbsp;</td>
                          ...
                          <td height="28" align="left" valign="top" class="leftmenu"> : <?php echo constant("ADMIN_ALERT1_MANAGE_INFORMATION");?></td>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="middle">&nbsp;</td>
                          <td>&nbsp;</td>
                          <td align="right" valign="middle"><input name="submit" type="submit" class="btn1" value="<?php echo constant("btn_save_btn");?>" align="left" border="0" /></td>
                          <td>&nbsp;</td>
