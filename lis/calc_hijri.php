...
<table width="420" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
  <tr>
    <td height="30" colspan="4" align="left" valign="middle" bgcolor="#CCCCCC" class="login_header">&nbsp;<?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_HIJRITOGREGORIAN");?></td>
  </tr>
  <tr>
    <td width="48">&nbsp;</td>
...
<table width="420" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
  <tr>
    <td height="30" colspan="4" align="right" valign="middle" bgcolor="#CCCCCC" class="headingtext">&nbsp;<?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_HIJRITOGREGORIAN");?></td>
  </tr>
  <tr>
    <td width="48">&nbsp;</td>
    <td width="59" height="20" align="left" valign="middle" class="bigerrortext">&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="left" valign="middle"><input type="submit" name="submit" id="submit" value="<?php echo constant("btn_english");?>" class="btn1" onclick="showdate();"/></td>
     <td align="left" valign="middle"><input name="datepicker14" type="text" class="textfield_amt" id="datepicker14" /></td>
    <td align="left" valign="middle" class="heading"> : <?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_HIJRI");?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="left" valign="middle" class="bigerrortext">&nbsp;</td>
