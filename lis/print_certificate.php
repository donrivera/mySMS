            ...
            <td align="left" valign="middle" ><table width="870" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="380" align="right" valign="top" ><table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <th height="28" align="right" valign="middle" class="cer2" scope="col"><span class="cer_my_head_bold" dir="rtl">في المستوى <?php echo $eng_course_name;?>  , وأكمل   <?php echo $dbf->enNo2ar($hr,'');?>   ساعة دراسية</span></th>
                    </tr>
                  <tr>
