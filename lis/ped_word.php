          ...
          <tr>
            ...
            <table width="1000" border="1" cellspacing="0" bordercolor="#000000" cellpadding="0" style="border-collapse:collapse;">
              <tr>
                ...
                <td width="37" align="center" valign="middle" class="pedtext"><?php echo constant("RECEPTION_ARF_MANAGE_LIS");?></td>
                <td width="31" align="center" valign="middle" class="pedtext"><?php echo constant("STUDENT_ADVISOR_PED_UNITS");?></td>
                <td width="100" align="center" valign="middle" class="pedtext"><?php echo constant("STUDENT_ADVISOR_PED_DATE");?></td>
              ...
              <tr bgcolor="#E9EFEF">
                ...
                ?>
                  <tr>
                    ...
                    <td width="42" align="center" valign="middle" bgcolor="#F7F3F8" class="pedtext_normal" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;"><?php echo $present["COUNT(id)"];?></td>
