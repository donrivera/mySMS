        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="50%" height="30" align="left" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS_NOT_ENROLLED");?></td>
                  <td width="7%"><span class="headingtext"><?php echo constant("ADMIN_REPORT_STUDENT_NOT_ENROLLED_STATUS");?></span> :</td>
          ...
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <tr class="logintext">
                  ...
                  <th width="11%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_STUDENTNAME");?></th>
                  <th width="8%" align="left" valign="middle" class="pedtext">&nbsp;</th>
                  <th width="14%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_NOT_ENROLLED_MOBILENUMBER");?></th>
                  <th width="13%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_GROUP_GRADE_EMAIL");?></th>
                  <th width="11%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_NOT_ENROLLED_DATEOFENQU");?></th>
                  <th width="13%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_NOT_ENROLLED_LASTCOMT");?></th>
                  <th width="13%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_NOT_ENROLLED_LEADINFO");?></th>
                  <th width="14%" colspan="2" align="center" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_NOT_ENROLLED_INTRESTEDIN");?></th>
                </tr>
				</thead>
                <?php
					if($_REQUEST[teacher]!=''){
                ...
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                  ...
                  <td align="left" valign="middle" class="contenttext" style="padding-left:5px;"><a href="single-home.php?student_id=<?php echo $val_student[id];?>" style="cursor:pointer;"><?php echo $dbf->printStudentName($val_student[id]);?></a></td>
                  <td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="50%" align="center" valign="middle"><a href="sms_single.php?student_id=<?php echo $val["id"];?>&TB_iframe=true&amp;height=330&amp;width=485&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox "><img src="../images/mobile.png" width="32" height="32" border="0"></a></td>
