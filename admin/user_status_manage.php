        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="30" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="logintext"><?php echo constant("ADMIN_USER_STATUS_MANAGE_MANAGE_USER_STATUS");?></td>
                <td width="22%">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left"><a href="user_status_add.php">
              ...
              <tr>
				...
				<thead>
                    <tr class="logintext">
                      ...
                      <th width="81%" align="left" valign="middle" bgcolor="#99CC99"><span class="pedtext"><?php echo constant("ADMIN_USER_STATUS_MANAGE_GROUPTYPE");?></span></th>
					...
					$i = 1;
					$color = "#ECECFF";
					$num=$dbf->countRows('common',"type='user status'");
					foreach($dbf->fetchOrder('common',"type='user status'","id DESC") as $val) {
					?>
                    <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='user_status_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                      ...
                      <td height="25" align="left" valign="middle" class="contenttext"><?php echo $val[name];?></td>
                      <td width="5%" align="center" valign="middle"><a href="user_status_edit.php?id=<?php echo $val[id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
                       <?php
					  $num_sg=$dbf->countRows('teacher',"teacher_status='$val[id]'");
					  if($num_sg > 0)
					  {
						  ?>
					  ...
					  {
					  ?>
                      <td width="5%" align="center" valign="middle"  style="background-color:<?php echo $color;?>"><a href="user_status_process.php?action=delete&amp;id=<?php echo $val[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>" /></a></td>
                      <?php
					  }
					  $i = $i + 1;
					   if($color=="#ECECFF")
