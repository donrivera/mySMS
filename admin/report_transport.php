   ...
   <tr>
        <td align="left" height="25" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>&nbsp;</td>
					<td width="30" align="center" valign="middle"><a href="report_transport_word.php?area_code=<?php echo $_REQUEST[area_code];?>&centre_id=<?php echo $_REQUEST['centre_id'];?>&mobile=<?php echo $_REQUEST['mobile'];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_WORD ?>"></a></td>
					<td width="30" align="center" valign="middle"><a href="report_transport_csv.php?area_code=<?php echo $_REQUEST[area_code];?>&centre_id=<?php echo $_REQUEST['centre_id'];?>&mobile=<?php echo $_REQUEST['mobile'];?>"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_XLS ?>"></a></td>
					<td width="30" align="center" valign="middle"><a href="report_transport_pdf.php?area_code=<?php echo $_REQUEST[area_code];?>&centre_id=<?php echo $_REQUEST['centre_id'];?>&mobile=<?php echo $_REQUEST['mobile'];?>"><img src="../images/pdf.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_PDF ?>"></a></td>
					<td width="30" align="center" valign="middle"><a href="report_transport_print.php?area_code=<?php echo $_REQUEST[area_code];?>&centre_id=<?php echo $_REQUEST['centre_id'];?>&mobile=<?php echo $_REQUEST['mobile'];?>" target="_blank"><img src="../images/print.png" width="16" height="16" border="0" title="<?php echo STUDENT_ADVISOR_SEARCH_MANAGE_PRINT ?>"></a></td>
				</tr>
			</table>
		</td>
  </tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="29%" height="30" align="left" class="logintext"> <?php echo constant("REPORT_STUDENT_TRANSPORT");?></td>
                <td width="2%" id="lblname">&nbsp;</td>
              ...
              <tr>
                <td height="36" colspan="5" align="left" valign="middle" bgcolor="#FFFFFF" ><table width="100%" height="36" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="71" height="36" align="right" valign="middle" bgcolor="#FFFFFF" class="leftmenu"><?php echo "Suburb";?> :</td>
                    <td width="102" height="36" align="left" valign="middle" bgcolor="#FFFFFF" >
						<select name="area_code" id="area_code"  style="border:solid 1px; border-color:#FFCC33; height:20px; width:110px;">
						<option value=""> Select </option>
						<?php
							foreach($dbf->fetchOrder('area',"","name") as $val1):
						?>
							<option value="<?php echo $val1['code'];?>" <?php if($_REQUEST['area_code']==$val1['code']) { ?> selected="selected" <?php } ?>><?php echo $val1['name'];?></option>
						<?php endforeach;?>
						</select>
					</td>
                    <td width="81" height="36" align="right" valign="middle" bgcolor="#FFFFFF" class="leftmenu"><?php echo "Centre";?> :</td>
                    <td width="102" height="36" align="left" valign="middle" bgcolor="#FFFFFF">
						<select name="centre_id" id="centre_id"  style="border:solid 1px; border-color:#FFCC33; height:20px; width:110px;">
						<option value=""> Select </option>
						<?php
							foreach($dbf->fetchOrder('centre',"","name") as $val2):
						?>
							<option value="<?php echo $val2['id'];?>" <?php if($_REQUEST['centre_id']==$val2['id']) { ?> selected="selected" <?php } ?>><?php echo $val2['name'];?></option>
						<?php endforeach;?>
						</select>
                    <td width="81" height="36" align="right" valign="middle" bgcolor="#FFFFFF" class="leftmenu"><?php echo "Show Mobile";?> :</td>
                    <td width="102" height="36" align="left" valign="middle" bgcolor="#FFFFFF" class="leftmenu">
						<input type="radio" name="mobile" value="Yes" <?php echo ($_REQUEST["mobile"] == 'Yes' ? 'checked' : '')?>>Yes
						<input type="radio" name="mobile" value="No"  <?php echo ($_REQUEST["mobile"] == 'No' ? 'checked' : '')?>>No
					</td>
                    <td width="58" height="36" align="right" valign="middle" bgcolor="#FFFFFF" class="leftmenu">&nbsp;</td>
                    <td width="100" height="36" align="left" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
			...
			<table width="100%" border="1" cellpadding="0" bordercolor="#000000" cellspacing="0" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
              <thead>
                <tr class="logintext">
                  ...
                  <?php endif;?>
				  <th width="18%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo "Address";?></th>
                  <th width="11%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext">Class Time</th>
                  <th colspan="4" align="center" valign="middle" bgcolor="#99CC99" class="pedtext">Schedule</th>
                </tr>
              </thead>
              <?php			  	
              ...
              <tr bgcolor="<?php echo $color;?>" ><!--onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php #echo $color;?>'" style="cursor:pointer;" onClick="javascript:window.location.href='report_student_cycle_dtls.php?student_id=<?php echo $val[id];?>'"-->
                ...
                <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo (empty($val['student_id'])?'':$val['student_id']);?></td>
				<?php if($_REQUEST['mobile']=='Yes'):?>
                <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val['student_mobile'];?></td>
                <?php endif;?>
				<td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val['address'];?></td>
                <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $dbf->printClassTimeFormat($val['group_start_time'],$val['group_end_time']);?></td>
				<td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val['start_date']."&nbsp;TO&nbsp;".$val['end_date'];?></td>
                <!--
				<td width="4%" align="center" valign="middle" ><?php echo "b";?></td>
            ...
            <tr>
              <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr>
                  ...
                  <td width="10%" align="left">&nbsp;</td>
                  <td width="41%" align="left">&nbsp;</td>
                  <td width="18%" align="right" class="logintext"><?php echo constant("REPORT_STUDENT_LIFE_CYCLE");?>&nbsp;</td>
                </tr>
                <tr>
                  <td height="36" colspan="5" align="left" valign="middle" bgcolor="#FFFFFF" ><table width="100%" height="36" border="0" cellpadding="0" cellspacing="0">
                    <tr>
            ...
            <tr>
			  ...
			  ?>
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;" onClick="javascript:window.location.href='report_student_cycle_dtls.php?student_id=<?php echo $val[id];?>'">
                  ...
                  <td align="right" valign="middle" class="mycon" style="padding-right:5px;"><?php echo $val[first_name];?><?php echo $Arabic->en2ar($dbf->StudentName($val["id"]));?></td>
                  <td align="center" valign="middle" class="mycon" ><?php echo $i;?></td>
