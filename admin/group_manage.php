        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="logintext"><?php echo constant("ADMIN_GROUP_MANAGE_MANAGE_GROUP");?> </td>
                <td width="22%">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left"><a href="group_add.php"><input name="button" type="button" class="btn1" value="<?php echo constant("btn_add_btn");?>" align="left" border="0" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="19%" align="left" valign="middle" bgcolor="#99CC99" ><span class="pedtext" ><?php echo constant("ADMIN_GROUP_MANAGE_GROUP");?></span></th>
                <th width="62%" align="left" valign="middle" bgcolor="#99CC99" ><span class="pedtext"><?php echo constant("ADMIN_GROUP_MANAGE_COURSE");?></span></th>
              ...
              <?php					
					...
					?>
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='group_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                ...
                <td align="left" valign="middle" class="contenttext" style="padding-left:5px;"><?php echo $strcourse;?></td>
                <td width="5%" align="center" valign="middle" >
                <a href="group_edit.php?id=<?php echo $val[id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
                 <?php
					  $num_sg=$dbf->countRows('group_size',"group_id='$val[id]'");
					  if($num_sg > 0)
					  {
						  ?>
                          <td width="5%" align="center" valign="middle">
                          <a href="" onClick="errorconfirm();"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>" /></a></td>
                          <?php
					  }
					  else
					  {
					  ?>
                      <td width="5%" align="center" valign="middle" >
                      <a href="group_process.php?action=delete&amp;id=<?php echo $val[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>" /></a></td>
                      <?php
					  }					  
