                        ...
                        <td align="center" valign="top">
                          ...
                          <table width="100%" border="1" cellpadding="0" bordercolor="#999999" cellspacing="0" style="border-collapse:collapse;">
                            ...
                            <tr>
                              ...
                              <td width="12%" align="center" valign="middle"><a href="course_fee.php?action=delete&course_id=<?php echo $_REQUEST["course_id"];?>&record_id=<?php echo $course_fee["id"];?>"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>"></a></td>
                            </tr>
                            <?php
							$k++;
							}
