...
$html = '<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
		  ...
		  $html.='<tr>
			...
			<td width="21%" align="left" valign="middle" style="padding-left:1px;"><span id="result_box" lang="ar" xml:lang="ar">'.$val["first_name"].'&nbsp;'.$Arabic->en2ar($dbf->StudentName($val["id"])).'</span></td>
