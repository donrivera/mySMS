                  ...
                  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablesorter" id="sort_table1" style="border-collapse:collapse;">
                    <thead>
                      <tr class="logintext">
                        ...
                        <th width="13%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo ADMIN_MENU_CENTRE ?></th>
                        <th width="14%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo ADMIN_USER_MANAGE_NAMEOFUSER ?></th>
                        <th width="11%" height="25" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo ADMIN_USER_MANAGE_USERID ?></th>
                        <th width="21%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo ADMIN_USER_MANAGE_EMAIL ?></th>
                        <th width="19%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo ADMIN_USER_MANAGE_MOBILENO ?></th>
                    ...
                    <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                      ...
                      <td width="3%" align="center" valign="middle"><a href="user_edit.php?id=<?php echo $val[id];?>"><img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
                      <?php
