...
$res = $dbf->strRecordID("grade","*","id='$_REQUEST[id]'");
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_GRADE_MANAGE_EDITGRADE");?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="grade_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                        <tr>
                          <td width="10%">&nbsp;</td>
                          <td width="18%" height="30">&nbsp;</td>
                          <td width="1%">&nbsp;</td>
                          <td width="36%" align="left" valign="middle" class="nametext1"><?php if($_REQUEST['msg'] == "rangeexist") { echo constant("RANGE_ALREADY_EXIST"); } ?></td>
                          <td width="1%">&nbsp;</td>
                          <td width="34%">&nbsp;</td>
                        </tr>
                        <tr>
						  ...
						  <input name="name" type="text" class="validate[required] new_textbox1" id="name" maxlength="100" value="<?php echo $res[name];?>" /></td>
                          <td>&nbsp;</td>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td align="left" valign="middle">
						  <input name="from" type="text" class="new_textbox40" id="from" size="45" maxlength="4" value="<?php echo $res[frm];?>" onKeyPress="return isNumberKey(event);"/></td>
                          <td>&nbsp;</td>
                          <td align="left" valign="middle">&nbsp;</td>
                        </tr>
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td align="left" valign="middle">
						  <input name="to" type="text" class="new_textbox40" id="to" size="45" maxlength="4" value="<?php echo $res[tto];?>" onKeyPress="return isNumberKey(event);"/></td>
                          <td>&nbsp;</td>
                          <td align="left" valign="middle">&nbsp;</td>
                        </tr>
                        <tr>
			...
			<table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_GRADE_MANAGE_EDITGRADE");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td align="right" valign="middle"><input name="name2" type="text" class="validate[required] new_textbox1" id="name2" maxlength="100" value="<?php echo $res[name];?>" /></td>
                          <td>&nbsp;</td>
                        ...
                        <tr>
						  ...
						  <input name="from" type="text" class="validate[required] new_textbox1" id="from" size="45" maxlength="4" value="<?php echo $res[frm];?>" onKeyPress="return isNumberKey(event);"/></td>
                          <td>&nbsp;</td>
                          <td align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_GRADE_MANAGE_FROMMARKS");?></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          <td>&nbsp;</td>
                          <td align="right" valign="middle">
						  <input name="to" type="text" class="validate[required] new_textbox1" id="to" size="45" maxlength="4" value="<?php echo $res[tto];?>" onKeyPress="return isNumberKey(event);"/></td>
                          <td>&nbsp;</td>
                          <td align="left" valign="middle" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_GRADE_MANAGE_TOMARKS");?></td>
                        </tr>
                        <tr>
                          <td height="30" colspan="6" align="left" valign="middle"></td>
                        </tr>
