        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="headingtext"><h1 class="logintext"><?php echo constant("ADMIN_MATERIAL_MANAGE_MANAGE_MATERIAL");?></h1></td>
                <td width="22%">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left"><a href="material_add.php"><input name="button" type="button" class="btn1" value="<?php echo constant("btn_add_btn");?>" align="left" border="0" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="82%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><span class="pedtext"><?php echo constant("ADMIN_MATERIAL_MANAGE_NAMEOFMATERIAL");?></span></th>
              ...
              <?php
					...
					$i = 1;
					$color = "#ECECFF";
					$num=$dbf->countRows('common',"type='material type'");
					foreach($dbf->fetchOrder('common',"type='material type'","id DESC") as $val) {
					?>
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='material_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                ...
                <td width="4%" align="center" valign="middle"><a href="material_edit.php?id=<?php echo $val[id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
                 <?php
					  ...
					  {
					  ?>
                      <td width="5%" align="center" valign="middle" style="background-color:<?php echo $color;?>"><a href="material_process.php?action=delete&amp;id=<?php echo $val[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>" /></a></td>
                      <?php
					  }
					  $i = $i + 1;
					  if($color=="#ECECFF")
