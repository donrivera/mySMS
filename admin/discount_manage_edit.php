...
$dbf = new User();
$res = $dbf->strRecordID("discount","*","id='$_REQUEST[id]'");
#echo var_dump($res);
            ...
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    <td width="54%" height="30" class="logintext"><?php echo "Edit Discount";?></td>
                    <td width="22%">&nbsp;</td>
                    <td width="8%" align="left">&nbsp;</td>
                    <td width="8%" align="left"></td>
                    <td width="8%" align="left"><a href="discount_manage.php"> <input type="button" value="<?php echo constant("btn_cancel_btn2");?>" class="btn1" border="0" align="left" /></a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        <td align="center" valign="top" bgcolor="#EBEBEB">
                         <?php
							$sql=$dbf->genericQuery("SELECT id,name FROM centre WHERE id='".$res[centre]."'");
						?>
                        <form action="discount_manage_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" >
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
							...
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="code" type="text" class="validate[required] new_textbox1" id="code" size="45" minlength="4" value="<?php echo $res['code'];?>"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="desc" type="text" class="validate[required] new_textbox1" id="desc" size="45" minlength="4" value="<?php echo $res['name'];?>"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="percent" type="text" class="validate[required] new_textbox1" id="percent" onKeyPress="return isNumberKey(event)" size="45" minlength="2" value="<?php echo $res['percent']* 100;?>"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
