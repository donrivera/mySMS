    ...
    <td height="104" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" height="25" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>&nbsp;</td>
              <td width="36" align="center" valign="middle"><a href="report_teacher_capacity_word.php"><img src="../images/word2007.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_WORD ?>"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_teacher_capacity_csv.php"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_XLS ?>"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_teacher_capacity_pdf.php"><img src="../images/pdf.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_PDF ?>"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_teacher_capacity_print.php" target="_blank"><img src="../images/print.png" alt="" width="16" height="16" border="0" title="<?php echo STUDENT_ADVISOR_SEARCH_MANAGE_PRINT ?>"></a></td>
            </tr>
        </table></td>
      </tr>
    </table></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr class="logintext">
                <td width="32%" height="30" class="logintext">
                <img src="../images/rightarrow.png" width="16" height="16">
				<?php echo ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS ?><img src="../images/rightarrow.png" width="16" height="16">
				<?php echo ADMIN_MENU_REPORTS_TEACHER_CAPACITY ?></td>
                <td width="5%" align="right" valign="middle" class="headingtext">&nbsp;</td>
                <td width="9%" align="left"></td>
                <td width="4%" align="right" class="headingtext">&nbsp;</td>
          ...
          <tr>
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#999" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
			<thead>
                <tr class="logintext">
                ...
                <?php			
					...
					$num=$dbf->countRows('user u,teacher c',"u.uid = c.id  And u.user_type='Teacher'");
					foreach($dbf->fetchOrder('user u,teacher c',"u.uid = c.id And u.user_type='Teacher'","","u.*") as $val) {
                ...
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                  ...
                  <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $res_teacher["name"];?></td>
                ...
                <tr>
                  <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                    <tr class="logintext">                      
                      ...
                      <td width="25%" height="30" align="right" class="headingtext"><img src="../images/arrow_small_right4.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS_TEACHER_CAPACITY");?>
