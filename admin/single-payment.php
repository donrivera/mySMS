                              ...
                              <td align="center" >
                                  ...
                                  if($vali["paid_amt"]=="0") {
									  ...
									  //if course not completed
								  		if($num_complete == 0) {
									  ?>
                                    <a href="single-payment.php?action=sch_del&amp;course_id=<?php echo $course_id;?>&amp;student_id=<?php echo $student_id;?>&amp;schid=<?php echo $vali["id"];?>"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>" /></a>
                                    <?php }} ?></td>
                            </tr>
                          <?php $j++; } ?>
                          </table></td>
