    ...
    <td align="left" valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td bgcolor="#b4b4b4" align="left" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="logintext"><?php echo constant("ADMIN_TEACHER_MANAGE_MANAGE_TEACHER_PREFERENCE");?></td>
                <td width="22%">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left"><a href="teacher_add.php"> <input type="button" value="<?php echo constant("btn_add_btn");?>" class="btn1" border="0" align="left" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td height="450" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
				...
				<thead>
                    <tr class="logintext">
                      ...
                      <th width="83%" align="left" valign="middle" bgcolor="#99CC99"><span class="pedtext"><?php echo constant("ADMIN_TEACHER_MANAGE_NAMEOFTEACHER");?></span></th>
					...
					$i = 1;
					$color = "#ECECFF";
					$num=$dbf->countRows('common',"type='teacher preference'");
					foreach($dbf->fetchOrder('common',"type='teacher preference'","id DESC") as $val) {
					?>
                    <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='teacher_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                      ...
                      <td width="4%" align="center" valign="middle"><a href="teacher_edit.php?id=<?php echo $val[id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
                      <?php
					  $num_sg=$dbf->countRows('teacher',"prefer_time='$val[id]'");
					  if($num_sg > 0)
					  {
						  ?>
			  ...
			  <?php
					...
					?>
                    <tr>
                      <td height="25" colspan="10" align="center" valign="middle" class="nametext1"><?php echo constant("ADMIN_TEACHER_MANAGE_NORECORD");?> </td>
                    </tr>
                    <?
					}
					?>
