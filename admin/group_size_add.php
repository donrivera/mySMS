        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="51%" height="30" class="logintext"><?php echo constant("ADD_GROUP_SIZE");?></td>
                <td width="21%">&nbsp;</td>
                <td width="7%" align="left">&nbsp;</td>
                <td width="6%" align="left"></td>
                <td width="8%" align="center"><a href="group_size_manage.php">
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADD_GROUP_SIZE");?></span></td>
                  ...
                  <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="group_size_process.php?action=insert" name="frm" method="post" id="frm">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <select name="group" id="group" class="validate[required]" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF; height:22px; width:192px;">
                                    <option value="">--Select--</option>
                                    <?php
                                    foreach($dbf->fetchOrder('common',"type='group group' And id not in (select group_id from group_size)","name") as $val) {	
                                  ?>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><span class="contenttext" style="padding-left:5px;">
                                <input name="size_from" type="text" class="validate[required] new_textbox40" id="size_from" value="" onKeyPress="return isNumberKey(event);" maxlength="3" />
                                <span class="contenttext" style="padding-left:5px;">
                                <input name="size_to" type="text" class="validate[required] new_textbox40" id="size_to" value=""  onkeypress="return isNumberKey(event);"  maxlength="3"/>
                                </span></span></td>
                              <td>&nbsp;</td>
                            ...
                            <tr style="display:none;">
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><span class="contenttext" style="padding-left:5px;">
                                <input name="week_id" type="text" class="new_textbox12" id="week_id" value="" readonly="readonly" />
                                </span>
                              </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><span class="contenttext" style="padding-left:5px;">
                                <input name="units" type="text" class="validate[required] new_textbox40" id="units" value="" onKeyPress="return isNumberKey(event);" maxlength="3" />
                              </span></td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
				 ...
				 <table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" valign="middle" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADD_GROUP_SIZE");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                        ...
                        <form action="group_size_process.php?action=insert" name="frm" method="post" id="frm">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td align="left" valign="middle"><span class="nametext1">*</span> : <?php echo constant("CD_EP_ADDING_STUDENT_GROUPADD");?></td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              <td>&nbsp;</td>
                              <td align="right" valign="middle"><span class="contenttext" style="padding-right:5px;">
                                <input name="size_from" type="text" class="validate[required] new_textbox40" id="size_from" value="" onKeyPress="return isNumberKey(event);" maxlength="3" />
                                <span class="contenttext" style="padding-right:5px;">
                                <input name="size_to" type="text" class="validate[required] new_textbox40" id="size_to" value=""  onkeypress="return isNumberKey(event);"  maxlength="3"/>
                                </span></span></td>
                              <td align="left" valign="middle"><span class="nametext1">*</span> : <?php echo constant("ADMIN_GROUP_SIZE_MANAGE_SIZEOFGROUP");?></td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr style="display:none;">
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
