                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bordercolor="#000000" class="tablesorter" id="sort_table">
                  <thead>
                    <tr class="logintext">
                      ...
                      <th width="21%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("SA_CD_CANCEL_STATUS");?></th>
                      <th width="17%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("SA_ADMIN_CANCEL_STATUS");?></th>
