    ...
    <td align="left" valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="30" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;"><?php echo constant("ADMIN_WEEK_MANAGE_MANAGE_WEEK");?></td>
          </tr>
          <tr>
			...
			<thead>
              <tr>
                ...
                <th width="63%" align="left" valign="middle" bgcolor="#99CC99"><span class="pedtext"><?php echo constant("ADMIN_WEEK_MANAGE_NAMEOFDAYS");?></span></th>
                <th width="24%" align="left" valign="middle" bgcolor="#99CC99"><span class="pedtext"><?php echo constant("ADMIN_WEEK_MANAGE_TYPEOFDAYS");?></span></th>
              ...
              <?php
					$i = 1;
					$color = "#ECECFF";
					$num=$dbf->countRows('working_day',"");
					foreach($dbf->fetchOrder('working_day',"","id") as $val) {
					...
					?>
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='week_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                ...
                <td align="left" valign="middle" class="contenttext" style="padding-left:5px;"><?php echo $status;?></td>
                <td width="4%" align="center" valign="middle" >
                <a href="week_edit.php?id=<?php echo $val[id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
                <td width="5%" align="center" valign="middle">
                <a href="week_status.php?page=week_status.php&id=<?php echo $val[id];?>&amp;TB_iframe=true&amp;height=190&amp;width=465&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox ">
                    <img src="../images/holiday.png" width="16" height="16" border="0" title="Set Holiday" /></a>
