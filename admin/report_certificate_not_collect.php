        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="30%" height="30" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS_COLLECT");?></td>
                  ...
                  <td width="4%" align="center"><span class="logintext"><?php echo constant("ADMIN_REPORT_GROUP_TO_FINISH_TO");?></span> :&nbsp; </td>
              ...
              <tr style="display:none;" id="<?php echo $val[id];?>">
                ...
                <table width="99%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                  <tr class="pedtext">
                    ...
                    <td width="25%" align="left" valign="middle" style="background-color:#DDDDDD;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_SEARCH_GROUPNM");?></td>
                    <td width="17%" align="left" valign="middle" style="background-color:#DDDDDD;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_COURSE");?></td>
                    <td width="14%" align="left" valign="middle" style="background-color:#DDDDDD;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_TEACHER");?></td>
                    <td width="13%" align="center" valign="middle" style="background-color:#DDDDDD;"><?php echo constant("CD_SEARCH_PRINT_INVOICE_INVOICENO");?></td>
                    <td align="center" valign="middle" style="background-color:#DDDDDD;">&nbsp;<?php echo constant("CD_SEARCH_PRINT_INVOICE_BALANCE");?>&nbsp;</td>
                    <td width="12%" align="left" valign="middle" style="background-color:#DDDDDD;"><?php echo constant("TEACHER_MY_GROUPS_STATUS");?></td>
                  </tr>
                  <?php
					$color1="#ECECFF";
					$j=1;				  
                  ...
                  <tr bgcolor="<?php echo $color1;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color1;?>'">
                    ...
                    <td width="13%" align="center" valign="middle"><?php echo $bal_amt.'&nbsp;'.$res_currency[symbol];?></td>
              ...
              <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <table width="100%" border="0" cellspacing="0">
                        <tr class="logintext">
                          ...
                          <td width="25%" height="30" align="right" class="headingtext"><img src="../images/arrow_small_right4.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS_COLLECT");?> <img src="../images/arrow_small_right2.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS");?></td>
                          </tr>
                        </table>                        
                  </td>
                  </tr>
                <tr>
                  <td align="left" valign="top">                    
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablesorter" id="sort_table1" style="border-collapse:collapse;">
                      <thead>
                        <tr class="logintext">
                          ...
                          <th width="5%" height="25" align="center" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("STUDENT_ADVISOR_SEARCH_MANAGE_SL");?>
                          </th>
                          <th width="3%" height="25" align="center" valign="middle" bgcolor="#99CC99" >&nbsp;</th>
                          </tr>
                        </thead>
					...
					//Get number of rows
					$num=$dbf->countRows('student_enroll',"certificate_collect='0'","");
					...
					?>
                      <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                        ...
                        <td width="7%" align="center" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[age];?></td>
                        <td width="18%" align="right" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[first_name];?> <?php echo $Arabic->en2ar($dbf->StudentName($val["id"]));?></td>
                        <td width="5%" align="center" valign="middle" class="mycon"><?php echo $k; ?></td>
                        <td width="3%" align="center" valign="middle" class="contenttext"><a href="javascript:void(0);" onClick="show_details('<?php echo $val[id];?>');">
                          <span id="plusArrow<?php echo $val[id];?>"><img src="../images/plus.gif" border="0" ></span>
                          </a></td>
