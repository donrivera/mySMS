...
$dbf = new User();
$res = $dbf->strRecordID("area","*","id='$_REQUEST[id]'");
#echo var_dump($res);
            ...
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    <td width="54%" height="30" class="logintext"><?php echo "Edit Area Account";?></td>
                    <td width="22%">&nbsp;</td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="area_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" >
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
							...
							<tr>
                              ...
                              <td align="left" valign="middle">
									<input name="area_code" type="text" class="validate[required] new_textbox1" id="area_code" size="45" minlength="4" value="<?php echo $res['code'];?>"/>
							  </td>
                              <td>&nbsp;</td>
							...
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="area_name" type="text" class="validate[required] new_textbox1" id="area_name" size="45" minlength="4" value="<?php echo $res['name'];?>"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
