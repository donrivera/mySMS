              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                  <tr>
                    ...
                    <form action="user_process.php?action=edituser&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" enctype="multipart/form-data">
                          ...
                          <div id="showcenter" style="display:<?php  if($res_usr[user_type]=="Student" || $res_usr[user_type]=="Teacher"){ echo none;}else { echo '';} ?>">
                            <table width="350" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="241" align="left" valign="middle"><select name="center_id" id="center_id" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF; height:25px; width:192px;">
                                  <option value="">--Select--</option>
                                  <?php
                          ...
                          <div id="showdiv" style="display:<?php if($res_usr[user_type]=="Student" ){ echo none;}else { echo '';} ?>">
                            <table width="350" border="0" cellspacing="0" cellpadding="0">
                              <tr>
								...
								<td width="10">&nbsp;</td>
								<td width="138" align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_USER_MANAGE_USERSTATUS");?></td>
                              </tr>
                            </table>
                          </div></td>
                           <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          ...
                          <div id="showcenter" style="display:<?php  if($res_usr[user_type]=="Student" || $res_usr[user_type]=="Teacher"){ echo none;}else { echo '';} ?>">
                            <table width="350" border="0" cellspacing="0" cellpadding="0">
                              <tr>                                
                                ...
                                <!--id NOT IN(select center_id from user)-->
                                <td width="192" align="right" valign="middle"><select name="center_id" id="center_id" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF; height:25px; width:192px;">
                                  <option value="">--Select--</option>
                                  <?php
                                    foreach($dbf->fetchOrder('centre',"","name") as $valc) {	
                                  ?>
								...
								<td width="10">&nbsp;</td>
								<td width="138" align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_USER_MANAGE_CENTRENAME");?></td>
                              </tr>
                            </table>
                          </div></td>
                           <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
