      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <input name="testinput" type="text" class="searchtext" id="testinput" autocomplete="off" style="text-align:right;" />              
            </div>
            </td>
          </tr>
        </table></td>
    ...
    <div id="glowmenu" class="glowingtabs">
	  ...
	  ?>
        ...
        <li><a <?php echo $mystyle;?> href="javascript:void(0);" title="<?php echo constant("ADMIN_MENU_STUDENT");?>" rel="mnu_enroll"><span <?php echo $mystyle;?>><?php echo constant("ADMIN_MENU_STUDENT");?></span></a></li>
         ...
         <?php
		$mystyle = '';
		  if($page_name == "report_teacher_board.php" || $page_name=="report_teacher_schedule.php" || $page_name=="report_student_awaiting.php" || $page_name == "report_group_to_finish.php" || $page_name == "report_certificate_not_collect.php" || $page_name=="report_absent_report.php" || $page_name=="report_teacher_leave_report.php" || $page_name == "report_student_group_grade_dtls.php" || $page_name == "report_teacher_overtime_report.php" || $page_name == "report_teacher_capacity.php" || $page_name=="report_certificate_report.php" || $page_name=="report_freq_customer_report.php" || $page_name == "report_student_group_grade.php" || $page_name == "report_student_not_enrolled.php" || $page_name == "report_student_on_hold.php" || $page_name == "report_statistic.php" || $page_name == "report_student_cycle.php" || $page_name == "report_student_cycle_dtls.php" || $page_name == "report_management.php") {
			  $mystyle = 'style="background-color:#003399; background-image:none;"';
		  }
		  ?>
        ...
        <a href="email_manage.php"><?php echo constant("ADMIN_MENU_SMS_TEMP");?></a> 
