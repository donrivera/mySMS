                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_ALERT1_MANAGE_ALERTTYPE");?></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          ...
                          <td>&nbsp;</td>
                          <td align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_ALERT1_MANAGE_IMPORTANT");?></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          ...
                          <td>&nbsp;</td>
                          <td align="left" valign="top" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_ALERT1_MANAGE_IMPORTANTINFO");?></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          ...
                          <td>&nbsp;</td>
                          <td align="left" valign="top" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_ALERT1_MANAGE_INFORMATION");?></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          ...
                          <td>&nbsp;</td>
                          <td align="left" valign="middle" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_ALERT1_MANAGE_DATE");?></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                          ...
                          <td>&nbsp;</td>
                          <td align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_ALERT1_MANAGE_AUDIENCE");?></td>
                        </tr>
                        <tr>
                          <td height="10" colspan="6" align="left" valign="middle"></td>
                        </tr>
