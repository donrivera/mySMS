            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 1px; border-color:#CCC;">
              ...
              <tr>
                ...
                <table width="70%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" bordercolor="#CCCCCC">
                  <tr>
                    <td width="32%" align="left" valign="middle" class="pedtext"><?php echo constant('ADMIN_VIEW_COMMENTS_MANAGE_STUDENT');?> :</td>
                    <td width="68%" align="left" valign="middle" class="mycon"><?php echo $dbf->getDataFromTable("student", "first_name", "id='$student_id'");?> <?php echo $Arabic->en2ar($dbf->StudentName($student_id));?></td>
                  </tr>
                </table>
                </td>
              </tr>
