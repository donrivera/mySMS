        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="34%" height="30" align="left" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"> <?php echo constant("ADMIN_REPORT_STUDENT_GROUP_GRADE_STUDENTGG");?></td>
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
			 ...
			 ?>
                ...
                <table width="90%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" bordercolor="#CCCCCC">
                  <tr>
                    <td height="25" colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><span class="pedtext">
                      <?php echo constant("ADMIN_REPORT_STUDENT_GROUP_GRADE_STUDENTDETAILS");?></span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="22" align="right" valign="middle" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_GROUP_GRADE_EMAIL");?> :&nbsp;</td>
                    <td align="left" valign="middle"><span class="lable1"><?php echo $res[email]; ?></span></td>
                  </tr>
                  </table></td>
                <td align="center" valign="middle" class="logintext"></td>
                <td width="554" rowspan="4" align="left" valign="top">
				<?php
              ...
              <tr>
                ...
                <table width="90%" border="1" bordercolor="#999" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                  <tr>
                    <td width="8%" height="25" align="center" valign="middle" bgcolor="#CCCCCC">&nbsp;</td>
                    <td width="31%" align="left" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_GROUP_GRADE_COURSENAME");?></td>
                    <td width="27%" align="center" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_GROUP_GRADE_PERCENTAGE");?></td>
                    <td width="34%" align="center" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_GROUP_GRADE_GRADE");?></td>
                  </tr>
                  <?php					
					$i = 1;
				...
				?>
                        ...
                        <td align="left" valign="top" style="padding-top:40px;">
                          ...
                          <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" bordercolor="#CCCCCC">
                            <tr>
                              <td height="25" colspan="2" align="center" valign="middle" bgcolor="#CCCCCC"><span class="logintext"><?php echo constant("ADMIN_REPORT_STUDENT_GROUP_GRADE_STUDENTDETAILS");?></span></td>
                            </tr>
                            <tr>
                              <td width="47%" align="right" valign="middle"><span class="lable1"><?php echo $res[first_name]; ?><?php echo $Arabic->en2ar($dbf->StudentName($res["id"]));?></span></td>
                              <td width="47%" align="left" valign="middle" class="pedtext"> : <?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_STUDENTNAME");?></td>
                              </tr>
                            <tr>
                        ...
                        <td align="left" valign="top">
                          <table width="100%" border="1" bordercolor="#999" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                            ...
                            <td align="center" valign="middle" bgcolor="#F8F9FB" class="mycon" style="padding-left:5px;"><?php echo $grade_name;?></td>                             
                              ...
                              <td height="25" align="right" valign="middle" bgcolor="#F8F9FB" class="mycon" style="padding-left:5px;"><?php echo $res_course[name];?></td>
                              <td height="25" align="center" valign="middle" bgcolor="#F8F9FB" class="contenttext">&nbsp;</td>
                              <?php
								}
								  $i = $i + 1;
