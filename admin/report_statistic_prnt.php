  ...
  <tr>
    ...
    <td class="leftmenu"><table width="90%" border="1" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#AAAAAA;" bordercolor="#AAAAAA" >
      ...
      <tr class="pedtext">
        ...
        <td align="left" valign="middle" bgcolor="#CDCDCD" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#6a6868;font-weight:bold;"> <?php echo constant("STUDENT_ADVISOR_PED_STARTDT");?></td>
