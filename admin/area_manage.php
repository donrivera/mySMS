          ...
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                ...
                <td width="8%" align="left"></td>
                <td width="8%" align="left"><a href="area_manage_add.php"><input name="button" type="button" class="btn1" value="<?php echo constant("btn_add_btn");?>" align="left" border="0" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
			...
			<thead>
              <tr class="logintext">
				...
				<th width="10%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo "Name";?></th>
				<th width="20%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo "Description";?></th>
              ...
              <?php
					...
					$i = 1;
					$color = "#ECECFF";
					$sql=$dbf->genericQuery("SELECT * FROM area");
					$num=count($sql);
              ...
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;"><!--onClick="javascript:window.location.href='type_edit.php?id=<?php #echo $val[id];?>'"-->
                ...
                <td width="4%" align="center" valign="middle"><a href="area_manage_edit.php?id=<?php echo $val[id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
                 <?php
					  ...
					  {
					  ?>
                      <td width="5%" align="center" valign="middle" style="background-color:<?php echo $color;?>"><a href="area_process.php?action=delete&amp;id=<?php echo $val[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>" /></a></td>
                      <?php
					  }
					  $i = $i + 1;
					  if($color=="#ECECFF")
