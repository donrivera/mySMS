...
$res = $dbf->strRecordID("centre_vacation","*","id='$_REQUEST[id]'");
?>
            ...
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    <td width="54%" height="30" align="left" class="logintext"><?php echo constant("VOCATION_CENTER");?> </td>
                    <td width="22%" height="30">&nbsp;</td>
                    <td width="8%" height="30" align="left">&nbsp;</td>
                    <td width="8%" height="30" align="left">&nbsp;</td>
                    <td width="8%" height="30" align="left"><a href="vacation_center_manage.php"> <input type="button" value="<?php echo constant("btn_cancel_btn2");?>" class="btn1" border="0" align="left" /></a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                      ...
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                        <tr>
                          <td align="center" valign="top" bgcolor="#EBEBEB">
                            ...
                            <form action="vacation_center_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" onsubmit="return validate();">
                              <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                  <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                  <td height="28" align="right" valign="top" class="leftmenu"> <?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_STARTDATE");?> : <span class="nametext1">*</span></td>
                                  <td>&nbsp;</td>
                            ...
                            <form action="vacation_center_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" onsubmit="return validate();">
                              <table width="100%" border="0" cellpadding="0" cellspacing="0" >
								 ...
								 <td align="left" valign="middle" id="lblerror">&nbsp;</td>
                                  ...
                                  <td align="left" valign="middle">
									...
									foreach($dbf->fetchOrder('centre',"","") as $resc) {
									 ...
									 <td>&nbsp;</td>
                                  <td valign="middle" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_CENTRE_MANAGE_CENTRENAME");?></td>
								...
								<td rowspan="2" align="left" valign="top" >
                                  ...
                                  <input name="startdate" type="text" class="datepick new_textbox1" readonly="" id="startdate" size="45" value="<?php echo $res["frm"];?>"/></td>
								  <td>&nbsp;</td>
                                  <td valign="top" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_STARTDATE");?></td>
                                   <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                  ...
                                  <td valign="top" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("CD_REPORT_GROUP_TO_FINIFH_PDF_DATA_ENDDATE");?></td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr>
								  <td align="left" valign="top" id="showsch">&nbsp;</td>
                                  ...
                                  <td align="right" valign="top">
								   ...
								   <td>&nbsp;</td>
                                  <td align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_VACATIONTYPE");?></td>                                   
                                </tr>
                                <tr>
                                  <td height="10" colspan="6" align="left" valign="middle"></td>
                                  </tr>
