...
if($teacher_id == "")
{
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FFCCFF;">
          <tr>
            <td height="25" align="center" valign="middle" bgcolor="#FFFF99" class="nametext1"><?php echo constant("ADMIN_VACATION_TEACHER_AJAX_SELECTTEACHER");?></td>
          </tr>
        </table>
        </td>
        </tr>
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FFCCFF;">
  <tr>
    <td height="25" align="center" valign="middle" bgcolor="#FFFF99" class="nametext1"><?php echo constant("ADMIN_VACATION_TEACHER_AJAX_SELECTSTARTEND");?></td>
  </tr>
</table>
</td>
</tr>
