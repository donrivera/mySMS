...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" height="30"  bgcolor="#FFA938" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;">
  ...
  <tr>
	...
	?>
      <tr>
        ...
        <td height="30" align="left" valign="middle" style="border-right:solid 2px; border-color:#CCC;" class="<?php echo $class;?>"><a style="text-decoration:none;" href="<?php echo $val_quick[links];?>"><?php echo constant($linkname);?></a></td>
      </tr>
      <tr>
