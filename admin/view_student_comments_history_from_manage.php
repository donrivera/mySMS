        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <?php
			  $res_student = $dbf->strRecordID("student","*","id='$_REQUEST[ids]'");
			  ?>
              <tr>
                        ...
                        <!-- Gray -->
                          <table width="98%" border="0" align="right" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td align="left" valign="top" background="../images/bot_mid_grey.png"></td>
                  ...
                  <tr>
                    ...
                    <table width="630" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <input type="text" maxlength="75" name="msg" id="msg" style="width:580px; height:35px; border:solid 1px; border-color:#699;background-color:#E6F7FF;" onkeypress="onEnter(event);"></td>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td bgcolor="#b4b4b4"  style="background:url(../images/footer_repeat.png) repeat-x;">
              ...
              <table width="100%" border="0" cellspacing="0">
                <tr>
                  <td width="26%" align="left"><a href="view_student_comments_history.php"><input type="button" value="<?php echo constant("btn_back_btn");?>" class="btn2" border="0" align="left" /></a></td>
                  <td width="12%" align="left" valign="middle" class="logintext">&nbsp;</td>
