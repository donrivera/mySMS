              ...
              <tr>
                ...
                <td colspan="4" align="center" valign="top"><table width="99%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td width="5%" align="center" valign="middle" class="mytext"><a href="single-arf.php?student_id=<?php echo $arf["student_id"];?>&id=<?php echo $arf[id];?>"><img src="images/search.png" width="20" height="20" border="0" title="<?php echo ICON_VIEW ?>" /></a></td>
                    <td width="5%" align="center" valign="middle" class="mytext"><a href="arf_print.php?id=<?php echo $arf[id];?>" target="_blank">
                    <img src="../images/print.png" width="16" height="16" border="0" title="<?php echo STUDENT_ADVISOR_SEARCH_MANAGE_PRINT ?>"/></a></td>
                  </tr>
                  <?php $k++; } ?>
                </table></td>
              </tr>
            ...
            <table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <td colspan="4" align="center" valign="top"><table width="99%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
				  ...
				  ?>
                  <tr>
                    <td width="5%" align="center" valign="middle" class="mytext">
                    <a href="single-arf.php?student_id=<?php echo $arf["student_id"];?>&id=<?php echo $arf["id"];?>">
