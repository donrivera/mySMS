...
$html = '<table width="1000" border="1" cellpadding="0" cellspacing="0"  bordercolor="#AAAAAA" style="border-collapse:collapse;">
                <tr>
                  ...
                  <th width="10%" align="left" valign="middle" bgcolor="#CDCDCD"><span id="result_box" lang="ar" xml:lang="ar">Cancellation Date Approved</span></th>
                  <th width="12%" align="left" valign="middle" bgcolor="#CDCDCD"><span id="result_box" lang="ar" xml:lang="ar">SA Comments</span></th>
                  <th width="7%" align="center" valign="middle" bgcolor="#CDCDCD" ><span id="result_box" lang="ar" xml:lang="ar">CD Comments</span></th>
                  <th width="13%" align="left" valign="middle" bgcolor="#CDCDCD"><span id="result_box" lang="ar" xml:lang="ar">Admin Comments</span></th>
                </tr>';
					$i = 1;
					$color="#ECECFF";
                ...
                $html.='<tr>
                  ...
                  <td align="left" valign="middle" bgcolor="#F8F9FB">'.$sc[admin_dated].'</td>
                  <td align="left" valign="middle" bgcolor="#F8F9FB">'.$sc[comment].'</td>
                  <td align="center" valign="middle" bgcolor="#F8F9FB" >'.$sc[cd_comment].'</td>
                  <td align="left" valign="middle" bgcolor="#F8F9FB" >'.$sc[admin_comment].'</td>';
					  $i = $i + 1;
					  }
                $html.='</tr>
            </table>';
	...
	$mpdf->WriteHTML($html);
	$mpdf->Output("report_student_cancelled.pdf", 'D');
	exit;
?>	
