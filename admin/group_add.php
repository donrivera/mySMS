                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_GROUP_MANAGE_NEWGROUP");?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="group_process.php?action=insert" name="frm" method="post" id="frm" onsubmit="return validate();">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><input name="name" type="text" class="validate[required] new_textbox1" id="name" size="45" minlength="4"/></td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
							  ...
							  ?>
                                <tr>
                                  <td width="11%" height="20" align="left" valign="middle">
                                    <input type="checkbox" value="<?php echo $val["id"];?>" name="code<?php echo $i;?>" id="code<?php echo $i;?>" /></td>
                                  <td width="89%" align="left" valign="middle"><?php echo $val["name"]." [".$val["code"]."]";?></td>
                                </tr>
                                <?php
								$i++;
								}
				...
				<table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_GROUP_MANAGE_NEWGROUP");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                        ...
                        <form action="group_process.php?action=insert" name="frm" method="post" id="frm" onsubmit="return validate();">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><input name="name" type="text" class="validate[required] new_textbox1" id="name" size="45" minlength="4"/></td>
                              <td align="right" valign="middle"><span class="nametext1">*</span> : <?php echo constant("ADMIN_GROUP_MANAGE_GROUPNAME");?></td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            ...
                            <tr>
							  ...
							  ?>
                                <tr>
                                  <td width="89%" align="right" valign="middle"><?php echo $Arabic->en2ar($val["name"])." [".$Arabic->en2ar($val["code"])."]";?></td>
								   <td width="11%" height="20" align="left" valign="middle">
                                    <input type="checkbox" value="<?php echo $val["id"];?>" name="code<?php echo $i;?>" id="code<?php echo $i;?>" /></td>
                                </tr>
                                <?php
