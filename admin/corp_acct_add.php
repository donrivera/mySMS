            ...
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    <td width="54%" height="30" class="headingtext"><h1 class="logintext"><?php echo "Manage Corporate Account";?></h1></td>
                    <td width="22%">&nbsp;</td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo "Add Account";?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <?php
							$sql=$dbf->genericQuery("SELECT id,name FROM centre");
						?>
                        <form action="corp_acct_process.php?action=insert" name="frm" method="post" id="frm" >
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
							...
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="corporate_code" type="text" class="validate[required] new_textbox1" id="corporate_code" size="45" minlength="4"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="corporate_name" type="text" class="validate[required] new_textbox1" id="corporate_name" size="45" minlength="4"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="corporate_address" type="text" class="validate[required] new_textbox1" id="corporate_address" size="45" minlength="4"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="corporate_contact" type="text" class="validate[required] new_textbox1" id="corporate_contact" size="45" minlength="4"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="corporate_details" type="text" class="validate[required] new_textbox1" id="corporate_details" size="45" minlength="4"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="corporate_num_of_students" type="text" class="validate[required] new_textbox1" id="corporate_num_of_studnets" size="45" minlength="4" onKeyPress="return isNumberKey(event);"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="corporate_num_of_class" type="text" class="validate[required] new_textbox1" id="corporate_num_of_class" size="45" minlength="4" onKeyPress="return isNumberKey(event);"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="corporate_remarks" type="text" class="validate[required] new_textbox1" id="corporate_remarks" size="45" minlength="4"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							...
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><input name="material_name" type="text" class="validate[required] new_textbox1" id="material_name" size="45" minlength="4"/></td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							-->
				...
				<table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("MANAGE_ADD_TYPE");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="type_process.php?action=insert" name="frm" method="post" id="frm" >
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="right" valign="middle"><input name="material_name" type="text" class="validate[required] new_textbox1" id="material_name" size="45" minlength="4"/></td>
                              <td>&nbsp;</td>
