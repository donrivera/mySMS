            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 1px; border-color:#CCC;">
              ...
              <tr>
                ...
                <td align="left" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="17%" align="right" valign="middle" bgcolor="#E9E9E9" class="mytext" style="border-left:solid 1px; border-top:solid 1px; border-bottom:solid 1px; border-color:#999;"><?php echo constant("CD_STUDENT_CENTER_TO");?>:</td>
                    <td width="33%" align="center" valign="middle" bgcolor="#E9E9E9" class="hometest_name" style="border-left:solid 1px; border-top:solid 1px; border-bottom:solid 1px; border-color:#999;" id="lbl_centre_to">
                    ...
                    <td width="16%" align="right" valign="middle" bgcolor="#E9E9E9" class="mytext" style="border-left:solid 1px; border-top:solid 1px; border-bottom:solid 1px; border-color:#999;"><?php echo constant("CD_STUDENT_CENTER_TOGROUP");?>:&nbsp;</td>
