...
if($_REQUEST['action']=='update')
{
	...
	$to_name = $dbf->getDataFromTable("user","user_name","user_type='Center Director' AND center_id='$centre_id'");
	...
	if($no_unit_finined > 0)
	{
		...
		$string_enroll="status_id='7'";
		$dbf->updateTable("student_enroll",$string_enroll,"student_id='$student_id' And course_id='$course_id'");
		$string_fees="type='cancelled student'";
		$dbf->updateTable("student_fees",$string_fees,"student_id='$student_id' And course_id='$course_id'");
		//$string_st="status_id='7'"; //Hold Status
