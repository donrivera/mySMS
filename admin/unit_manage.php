        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="logintext"><?php echo constant("ADMIN_UNIT_MANAGE_MANAGE_UNIT");?></td>
                <td width="22%">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left"><a href="unit_add.php"> <input type="button" value="<?php echo constant("btn_add_btn");?>" class="btn1" border="0" align="left" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
              ...
              <tr>
				...
				<thead>
                    <tr class="logintext">
                      ...
                      <th width="85%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_UNIT_MANAGE_UNITNUMBER");?></th>
					...
					$i = 1;
					$color = "#ECECFF";
					$num=$dbf->countRows('common',"type='Unit No'");
					foreach($dbf->fetchOrder('common',"type='Unit No'","id") as $val) {
					?>
                    <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='unit_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                      ...
                      <?php
					  $num_sg=$dbf->countRows('student_group',"units='$val[id]'");
					  if($num_sg > 0)
					  {
						  ?>
                          <td width="4%" align="center" valign="middle"><a href="" onClick="errorconfirm_edit();"><img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
                          <?php
					  }
					  else
					  {
                      ...
                      <a href="unit_edit.php?id=<?php echo $val[id];?>"><img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
                      <?php
					  }
					  ...
					  {
					  ?>
                      <td width="4%" align="center" valign="middle"><a href="unit_process.php?action=delete&amp;id=<?php echo $val[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>" /></a></td>
                      <?php
					  }
