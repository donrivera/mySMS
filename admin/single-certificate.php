                  ...
                  <tr>
                    ...
                    <td height="30" colspan="2" align="left" valign="middle" class="mytext"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						if($bal_amt <= 0){
						?>
						<a href="print_certificate.php?course_id=<?php echo $_REQUEST[course_id];?>&student_id=<?php echo $_REQUEST[student_id];?>" target="_blank"><?php if($_REQUEST[student_id]!="" && $_REQUEST[course_id]!=''){ ?><img src="../images/print.png" width="16" height="16" border="0" title="<?php echo STUDENT_ADVISOR_SEARCH_MANAGE_PRINT ?>"/><?php } ?></a>
						<?php } ?>
                        </td>
                        </tr>
                      </table></td>
