...
$res_help = $dbf->strRecordID("help","*","id='$_REQUEST[id]'");
?>
    ...
    <td align="left" valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="logintext"><?php echo constant("RE_MENU_HELP");?></td>
                <td width="22%">&nbsp;</td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_HELP_MANAGE_EDITHELP");?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="help_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm">
                          <table width="90%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td height="35" align="left" valign="middle"><input name="title" type="text" class="validate[required] new_textbox1" id="title" size="45" minlength="4" value="<?php echo $res_help[title];?>"/></td>
                            </tr>
                            <tr>
                              ...
                              <td height="30" align="left" valign="middle"><textarea name="content" cols="25" rows="5" class="validate[required]" id="content"><?php echo $res_help[descr];?></textarea>
				...
				<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_HELP_MANAGE_EDITHELP");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                      ...
                      <tr>
                        ...
                        <form action="help_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm">
                          <table width="90%" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td height="35" align="right" valign="middle"><input name="title" type="text" class="validate[required] new_textbox1" id="title" size="45" minlength="4" value="<?php echo $res_help[title];?>"/></td>
                            ...
                            <tr>                              
                              <td height="30" align="right" valign="middle"><textarea name="content" cols="25" rows="5" class="validate[required]" id="content"><?php echo $res_help[descr];?></textarea>
                                <script type="text/javascript">
							//<![CDATA[
        ...
        ['Undo','Redo'],['Format'],['Styles'],['Font'],['FontSize'],['TextColor']]
                            ...
                            <tr>
                              <td height="25" align="center" valign="middle" class="leftmenu"><input type="submit" name="submit" id="submit" value="<?php echo constant("btn_save_btn");?>" class="btn1" border="0" align="left" /></td>
