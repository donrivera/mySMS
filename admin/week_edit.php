        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0" >
              <tr>
                <td width="36%" height="30" class="headingtext"><h1 class="logintext"><?php echo constant("WEEK");?></h1></td>
                <td width="36%">&nbsp;</td>
                <td width="7%" align="left">&nbsp;</td>
                <td width="7%" align="left">&nbsp;</td>
                <td width="14%" align="left"><a href="week_manage.php">
              ...
              <tr>
                <td align="center" valign="top" bgcolor="#FFFFFF"><table width="300" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#66CC66;">
                    <tr>
                      ...
                      <td width="253" align="left" valign="middle" bgcolor="#EAFDEB" class="nametext1"><?php echo constant("ADMIN_WEEK_MANAGE_EXIT");?></td>
                    </tr>
                </table></td>
              </tr>
              <?php } ?>
              <tr>
                <td height="200" align="center" valign="top" bgcolor="#FFFFFF" style="padding-top:20px;">
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_WEEK_MANAGE_EDITWEEKDAY");?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="week_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm">
						  <?php
                          $res = $dbf->strRecordID("working_day","*","id='$_REQUEST[id]'");
                          ?>
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("ADMIN_WEEK_MANAGE_DAYNAME");?>  : <span class="nametext1">*</span> </td>
                              <td>&nbsp;</td>
				...
				<table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td  align="right" valign="middle" width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_WEEK_MANAGE_EDITWEEKDAY");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                        ...
                        <form action="week_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm">
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <input name="name" type="text" class="validate[required] new_textbox1" id="name" value="<?php echo $res[name];?>" size="45" minlength="4"/></td>
                               <td align="left" valign="middle">&nbsp;</td>
                              <td align="left" valign="middle" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_WEEK_MANAGE_DAYNAME");?></td>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            </tr>
                            <tr>
                              <td height="30" colspan="6" align="left" valign="middle"></td>
