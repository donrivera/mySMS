...
//alert(tno)
	ajaxRequest.open("GET", "center_check.php" + "?tno=" + tno, true);
...
var ajaxRequest;  // The variable that makes Ajax possible!
	...
	ajaxRequest.open("GET", "center_class.php" + "?tno=" + tno, true);
	ajaxRequest.send(null); 
}
</script>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4"  style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr class="logintext">
                <td width="54%" height="30" class="headingtext">&nbsp; <?php echo constant("CENTER");?></td>
                <td width="22%" height="30">&nbsp;</td>
                <td width="8%" height="30" align="left">&nbsp;</td>
                <td width="8%" height="30" align="left">&nbsp;</td>
                <td width="8%" height="30" align="left"><a href="center_manage.php"> <input type="button" value="<?php echo constant("btn_cancel_btn2");?>" class="btn1" border="0" align="left" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <table width="300" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF9900;">
                <tr>
                  <td width="37" height="30" align="center" valign="middle" bgcolor="#FCF3CF"><img src="../images/errror.png" width="32" height="32" /></td>
                  <td width="10" bgcolor="#FCF3CF">&nbsp;</td>
                  <td width="253" align="left" valign="middle" bgcolor="#FCF3CF" class="red_smalltext"><?php echo constant("CD_CENTRE_EXISTS");?></td>
                </tr>
            </table></td>
          </tr>
          <?php } ?>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_CENTRE_MANAGE_NEWCENTRE");?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="center_process.php?action=insert" name="frm" method="post" id="frm" >
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                              ...
                              <tr>
                                ...
                                <input name="name" type="text" value="<?php echo $_SESSION['c_name'];?>" class="validate[required] new_textbox190" id="name" onKeyUp="ajaxshowcenter(this.value)" />&nbsp;&nbsp;
                                <label id="showcenter"></label></td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td align="left" valign="middle">
                                <input name="no" type="text" class="validate[required] new_textbox190" id="no" value="<?php echo $_SESSION['c_no'];?>" size="45" minlength="4" onKeyPress="return isNumberKey(event);"/></td>
                                <td>&nbsp;</td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td align="left" valign="middle"><input name="tel_no" type="text" value="<?php echo $_SESSION['c_tel_no'];?>" class="validate[required] new_textbox190" id="tel_no" size="45" minlength="4" onKeyPress="return PhoneNo(event);"/></td>
                                <td>&nbsp;</td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td align="left" valign="middle"><input name="email_add" type="text" value="<?php echo $_SESSION['c_email_add'];?>" class="validate[required,custom[email]] new_textbox190" id="email_add" size="45"/></td>
                                <td>&nbsp;</td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td align="left" valign="middle"><input name="dir_name" type="text" value="<?php echo $_SESSION['c_dir_name'];?>" class="validate[required] new_textbox190" id="dir_name" size="45" minlength="4"/></td>
                                <td>&nbsp;</td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td align="left" valign="middle"><input name="invoice_from" type="text" value="<?php echo $_SESSION['c_invoice_from'];?>" class="validate[required] new_textbox40" id="invoice_from"  maxlength="2" onKeyPress="return isNumberKey(event);"/></td>
                                <td>&nbsp;</td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                <td height="28" align="right" valign="top" class="leftmenu" style="padding-top:7px;"><?php echo constant("ADMIN_CENTRE_MANAGE_CENTREADDRESS");?></td>
                                <td>&nbsp;</td>
                                <td align="left" valign="middle"><table width="280">
                                    <tr>
                                      <td width="105" class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_STREET");?></td>
                                      <td width="159"><input type="text" name="street" value="<?php echo $_SESSION['c_street'];?>" id="street" class="new_textbox190" /></td>
                                    </tr>
                                    <tr>
                                      <td class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_AREA");?></td>
                                      <td><input type="text" name="area" id="area" value="<?php echo $_SESSION['c_area'];?>" class="new_textbox190" /></td>
                                    </tr>
                                    <tr>
                                      <td class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_PROVINCE");?></td>
                                      <td><input type="text" name="province" id="province" value="<?php echo $_SESSION['c_province'];?>" class="new_textbox190" /></td>
                                    </tr>
                                    <tr>
                                      <td class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_COUNTRY");?></td>
                                      <td><select name="country" id="country" class="combo190">
                                          <?php
											foreach($dbf->fetchOrder('countries',"","") as $resc) {
											  ?>
                                          <option value="<?php echo $resc['id']?>"<?php if($resc["id"]==189) { echo "Selected"; }?>>
										  <?php echo $resc['value'] ?></option>
                                          <?php }?>
                                      </select></td>
                                    </tr>
                                </table></td>
                              ...
                              <tr>
                                ...
                                <td align="left" valign="middle"><table width="318">
                                    <tr>
                                      <td width="145" class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_NOUNITS");?></td>
                                      <td width="80">
                                      <select name="unit" id="unit" class="combo80">
                                          ...
                                          <?php
											for($i=1;$i<37;$i++) {
											  ?>
                                          <option value="<?php echo $i;?>" <?php if($i==$_SESSION['c_unit']) { echo "Selected"; }?>><?php echo $i;?></option>
                                          <?php }?>
                                        </select>
                                        </td>
                                    </tr>
                                    <tr>
                                      <?php
                                       $ctime = explode(":",$_SESSION['c_ctime']);
                                       $ctime = $ctime[0];
                                       ?>
                                      <td class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_STARTTIME");?></td>
                                      <td align="left"><select name="start_time" id="start_time" class="combo80">
                                        <option value="0" >select</option>
                                        <?php
                                            for($i=1;$i<=23;$i++)
                                            {
                                    ...
                                    <tr>
                                      <?php
                                       $ctime = explode(":",$_SESSION['c_etime']);
                                       $ctime = $ctime[0];
                                       ?>
                                      <td class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_ENDTIME");?></td>
                                      <td align="left"><select name="end_time" id="end_time"  class="combo80">
                                          <option value="" >select</option>
                                          <?php
                                            for($i=1;$i<=23;$i++)
                                            {
                                    ...
                                    <tr>
                                      <td class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_CLASSSTART");?> : <span class="nametext1">*</span></td>
                                      <?php
                                       $ctime = explode(":",$_SESSION['c_sstime']);
                                       $ctime = $ctime[0];
                                       ?>
                                      <td align="left"><select name="s_starttime" id="s_starttime"  class="validate[required] combo80">
                                          <option value="" >select</option>
                                          <?php
                                            for($i=1;$i<=23;$i++)
                                            {
                                    ...
                                    <tr>
                                      <?php
                                       $ctime = explode(":",$_SESSION['c_setime']);
                                       $ctime = $ctime[0];
                                       ?>
                                      <td class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_CLASSEND");?> : <span class="nametext1">*</span></td>
                                      <td align="left"><select name="s_endtime" id="s_endtime"  class="validate[required] combo80">
                                          <option value="" >select</option>
                                          <?php
                                            for($i=1;$i<=23;$i++)
                                            {
                              ...
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td align="left" valign="middle">
                                <input name="class" type="text" class="validate[required] new_textbox40" id="class" onKeyPress="return isNumberKey(event);" onKeyUp="showclassroom();"/></td>
                                <td>&nbsp;</td>
                                <td align="left" valign="middle">&nbsp;</td>
                              </tr>
                              <tr>
                                ...
                                <td align="left" valign="middle" id="showclass"><table width="333" cellpadding="2" cellspacing="0">
                                    ...
                                    <tr>
                                      ...
                                      <input name="c<?php echo $i;?>" type="text" class="new_textbox190 required" id="c<?php echo $i;?>" size="45" minlength="4" /></th>
                                      <th scope="col">&nbsp;</th>
                                      <th align="center" valign="middle" scope="col">
                                      <input name="r<?php echo $i;?>" type="text" class="new_textbox190" id="r<?php echo $i;?>" size="45" minlength="4"/></th>
                                    </tr>
                                    <?php $i++; } ?>
                                    <tr>
			...
			<table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_CENTRE_MANAGE_NEWCENTRE");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                        ...
                        <form action="center_process.php?action=insert" name="frm" method="post" id="frm" >
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                              ...
                              <tr>
                                ...
                                <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                <td>&nbsp;</td>
                                <td align="right" valign="middle"><input name="tel_no" type="text" value="<?php echo $_SESSION['c_tel_no'];?>" class="validate[required] new_textbox190" id="tel_no" size="45" minlength="4" onKeyPress="return PhoneNo(event);"/></td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                <td>&nbsp;</td>
                                <td align="right" valign="middle"><input name="email_add" type="text" value="<?php echo $_SESSION['c_email_add'];?>" class="validate[required,custom[email]] new_textbox190" id="email_add" size="45"/></td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                <td>&nbsp;</td>
                                <td align="right" valign="middle"><input name="dir_name" type="text" value="<?php echo $_SESSION['c_dir_name'];?>" class="validate[required] new_textbox190" id="dir_name" size="45" minlength="4"/></td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                <td>&nbsp;</td>
                                <td align="right" valign="middle"><input name="invoice_from" type="text" value="<?php echo $_SESSION['c_invoice_from'];?>" class="validate[required] new_textbox40" id="invoice_from"  maxlength="2" onKeyPress="return isNumberKey(event);"/></td>
                                <td>&nbsp;</td>
                                ...
                                <td align="left" valign="middle"><table width="318">
                                    ...
                                    <tr>
                                      ...
                                      <select name="s_starttime2" id="s_starttime2"  class="combo80">
									   ...
									   <td class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_CLASSSTART");?></td>
                                    </tr>
                                    <tr>
                                      <?php
                                       $ctime = explode(":",$_SESSION['c_setime']);
									  ...
									  <td class="lable1"><?php echo constant("ADMIN_CENTRE_MANAGE_CLASSEND");?></td>
                                    </tr>
                                </table></td>
                                <td>&nbsp;</td>
                                <td align="left" valign="top" class="leftmenu"> : <?php echo constant("ADMIN_CENTRE_MANAGE_CENTREOPENING");?> </td>
                                <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                ...
                                <td>&nbsp;</td>
                                <td align="right" valign="middle">
                                <input type="submit" name="submit" id="submit" value="<?php echo constant("btn_save_btn");?>" class="btn2" border="0" align="left" /></td>
                                <td>&nbsp;</td>
                                <td align="left" valign="middle">&nbsp;</td>
                                <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              </tr>
