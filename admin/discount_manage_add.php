                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <?php
							$sql=$dbf->genericQuery("SELECT id,name FROM centre WHERE id !='5'");
						?>
                        <form action="discount_manage_process.php?action=insert" name="frm" method="post" id="frm" >
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
							...
							<tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="code" type="text" class="validate[required] new_textbox1" id="code" size="45" minlength="4"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              <td height="28" align="right" valign="middle" class="leftmenu"><?php echo "Description";?> : <span class="nametext1">*</span> </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="desc" type="text" class="validate[required] new_textbox1" id="desc" size="45" minlength="4"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
							<tr>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              <td height="28" align="right" valign="middle" class="leftmenu"><?php echo "Percent";?> : <span class="nametext1">*</span> </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">
									<input name="percent" type="text" class="validate[required] new_textbox1" id="percent" size="45" minlength="2" onKeyPress="return isNumberKey(event)"/>
							  </td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
