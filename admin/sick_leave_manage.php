              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="7%" height="30" align="left" valign="middle" class="red_smalltext"><?php echo constant("ADMIN_VIEW_GROUP_SIZE_CENTRE");?> :</td>
                ...
                <thead>
				  ...
				  $color="#ECECFF";			
					$i =1;
					$num=$dbf->countRows('sick_leave m,sick_leave_centre d',"m.id=d.parent_id And d.centre_id='$_REQUEST[centre_id]' And m.sick_status='0'");
					$color = "#ECECFF";
					foreach($dbf->fetchOrder('sick_leave m,sick_leave_centre d',"m.id=d.parent_id And d.centre_id='$_REQUEST[centre_id]' And m.sick_status='0'","m.id DESC") as $val) {					
				...
				?>
                  <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'">
                    ...
                    <a href="sick_leave_add.php?page=sick_leave_add.php&id=<?php echo $val[id];?>&amp;TB_iframe=true&amp;height=400&amp;width=500&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox ">
				...
				?>
                  ...
                  <?
					...
					?>
                  <tr>
                    <td height="25" colspan="10" align="left" valign="middle" bgcolor="#F8F9FB" class="pedtext" ><?php echo constant("CD_SICK_LEAVE_MANAGE_OTHERS");?></td>
                  </tr>
                </table></td>
              </tr>
			  <tr>
