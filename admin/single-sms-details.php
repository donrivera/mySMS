...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f8faed" style="border:solid 1px #a8b56c;">
    <tr>
      <td height="20" colspan="2" align="right" valign="middle" style="padding-right:5px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="123" height="35" align="left" valign="middle"><span class="leftmenu"><img src="../logo/logo.png" alt="logo" width="100" height="30" /></span></td>
          <td width="481" align="right" valign="middle"><a href="single-sms-details-print.php?student_id=<?php echo $_REQUEST["student_id"];?>" target="_blank"><img src="../images/print.png" width="16" height="16" border="0" /></a></td>
          <td width="41" align="center" valign="middle"><img src="../images/close-btn.png" width="25" height="25" onclick="javascript:self.parent.tb_remove();"/></td>
        </tr>
      </table></td>
    </tr>
    <tr>
