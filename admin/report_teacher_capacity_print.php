...
<thead>
    ...
    <?php			
        $i = 1;
        $color="#ECECFF";
        $num=$dbf->countRows('user u,teacher_centre c',"u.uid = c.teacher_id And u.user_type='Teacher'");
        foreach($dbf->fetchOrder('user u,teacher_centre c',"u.uid = c.teacher_id And u.user_type='Teacher'","","u.*") as $val) {
