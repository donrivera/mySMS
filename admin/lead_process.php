...
if($_REQUEST['action']=='insert')
{
	...
	//Check duplicate
	$num=$dbf->countRows('common',"type='lead type' AND name='$_POST[name]'");
	if($num==0)
	{
		$cr_date = date('Y-m-d H:i:s A');
		
		$string="type='lead type',name='$_POST[name]',created_datetime='$cr_date',created_by='$_SESSION[id]'";
	...
	{
		header("Location:lead_add.php?msg=exist");		
	}
}
