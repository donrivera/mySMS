...
$dbf->updateTable("student_enroll","certificate_collect='1'","student_id='$_REQUEST[student_id]' And course_id='$_REQUEST[course_id]'");

# Certificate audit trail table
$cr_date = date('Y-m-d H:i:s A');
$dt = date('Y-m-d');

$is_exist = $dbf->countRows("student_certificate", "user_id='$_SESSION[id]' And student_id='$_REQUEST[student_id]' And course_id='$_REQUEST[course_id]' And print_date='$dt'");

if($is_exist == 0){
	$string="student_id='$_REQUEST[student_id]',course_id='$_REQUEST[course_id]',date_time='$cr_date',user_id='$_SESSION[id]',print_date='$dt'";
	$dbf->insertSet("student_certificate",$string);
}
?>
<style>	
.cer1
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="943"  height="30" align="right" valign="middle"><a href="certificate.php"></td></td>
            ...
            <td align="left" valign="middle" ><table width="870" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="447" align="left" valign="top"><table width="92%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <th height="28" align="left" valign="middle" class="cer1" scope="col"><span class="cer_my_head"><?php echo $gender;?></span>&nbsp;<span class="cer_my_head_bold"><?php echo $res['first_name']."&nbsp;".$res['father_name']."&nbsp;".$res['family_name'];?></span></th>
                  </tr>
                  <tr>
                  ...
                  <?php
				  $res_per = $dbf->strRecordID("teacher_progress_certificate","*","course_id='$_REQUEST[course_id]' And student_id='$_REQUEST[student_id]'");
                ...
                <td width="380" align="right" valign="top" ><table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <th height="28" align="right" valign="middle" class="cer2" scope="col"><span class="cer_my_head_bold" dir="rtl">بأن المتدرب: <?php echo $res['first_name1']."&nbsp;".$res['father_name1']."&nbsp;".$res['grandfather_name1']."&nbsp;".$res['family_name1'];#echo $Arabic->en2ar($res[first_name]);?></span>&nbsp; </th>
                    </tr>
                  <tr>
                    <th height="28" align="right" valign="middle" class="cer2" scope="col">&nbsp;<span class="cer_my_head_bold"><span dir="rtl">الجنسية: <?php echo $resc["arabic"];?></span> </span></th>
                    </tr>
                  <tr>
