...
$dbf = new User();
$res = $dbf->strRecordID("sms_templete","*","id='$_REQUEST[id]'");
              ...
              <tr>
                <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    ...
                    <a href="sms_template_manage.php"><input type="submit" name="submit" id="submit" value="<?php echo constant("btn_cancel_btn2");?>" class="btn1"/></a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_SMS_TEMPLATE_MANAGE_EDITSMS");?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="sms_template_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" >
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <input name="name" type="text" class="validate[required] new_textbox1" id="name" size="45" value="<?php echo $res[name];?>" /></td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><textarea name="textarea" id="textarea" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF;" rows="5" cols="29" onfocus="if(this.value=='SMS Message-160 char')this.value='';" onclick="if(this.value=='SMS Message-160 char')this.value='';" onkeydown="CountLeft();" onkeyup="CountLeft();" onblur="if(this.value=='') this.value='SMS Message-160 char';" ><?php echo $res[contents];?></textarea></td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <?php $txt = 160-strlen($res[contents]);?>
                              <td align="left" valign="middle">                              
                              <input name="count" type="text" id="count" readonly="readonly" value="<?php echo $txt;?>" style="width:50px; border:solid 1px; border-color:#FFCC00; text-align:center; font-weight:bold; background-color:#FFFF99;" /></td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
				...
				<table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_SMS_TEMPLATE_MANAGE_EDITSMS");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                        ...
                        <form action="sms_template_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" >
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td height="28" align="left" valign="top" class="leftmenu">&nbsp;</td>
                              <td>&nbsp;</td>
                              <td align="right" valign="middle"><textarea name="textarea" id="textarea" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF;" rows="5" cols="29" onfocus="if(this.value=='SMS Message-70 char')this.value='';" onclick="if(this.value=='SMS Message-70 char')this.value='';" onkeydown="CountLeft_AR();" onkeyup="CountLeft_AR();" onblur="if(this.value=='') this.value='SMS Message-70 char';" ><?php echo $res[contents];?></textarea></td>
                              <td>&nbsp;</td>
