        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="headingtext"><h1><?php echo "Preferences";?></h1></td>
                <td width="22%">&nbsp;</td>
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bordercolor="#000000" class="tablesorter" id="sort_table">
                  <thead>
                    <tr class="logintext">
                      ...
                      <th width="15%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo "Email";?></th>
					  <th width="15%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo "Mobile";?></th>
                      <th colspan="1" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("COMMON_ACTION");?></th>
                    </tr>
                  </thead>
                  <?php
					$i = 1;
					...
					$sql=$dbf->genericQuery("SELECT * FROM user WHERE id='$_SESSION[id]'");
					$num=count($sql);
					foreach($sql as $val) 
					{	
						
				  ?>
                  <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'"  style="cursor:pointer;"><!--onClick="javascript:window.location.href='arf_edit.php?id=<?php echo $val[id];?>'"-->
                    ...
                    <td width="5%" align="center" valign="middle"><a href="preferences_edit.php?id=<?php echo $val[id];?>"><img src="../images/edit.gif" border="0" title="Edit" /></a></td>
                    <?php
					  $i = $i + 1;
					  if($color=="#ECECFF")
					  {
