...
function setsubmit(){
	...
	document.location.href='daily_ped.php?cmbgroup='+cmbgroup+'&mystatus='+mystatus;
}
...
<table <?php if($_SESSION["lang"] == "AR"){?> style="margin-top:-15px;" <?php } ?> width="100%" border="0" align="center" cellpadding="0" cellspacing="0" onclick="countdown_init(<?=$count;?>);">
  ...
  <tr>
    ...
    <form action="daily_ped_process.php?action=insert" name="frm1" method="post" id="frm1">
              ...
              <td colspan="3" align="left" valign="top">
                ...
                <table width="1000" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bgcolor="#FFFFFF">
                  ...
                  <tr>
                    ...
                    <table width="1000" border="1" cellspacing="0" bordercolor="#000000" cellpadding="0" style="border-collapse:collapse;">
                      <tr>
                        ...
                        <td width="45" align="center" valign="middle"><img src="../images/ped-units.jpg" width="32" height="41"></td>
                      ...
                      <tr bgcolor="#E9EFEF">
                        <td width="230" align="left" valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td align="center" valign="middle">&nbsp;</td>
									<?php if($res_ped["date1"] != '0000-00-00') {$date1 = $res_ped["date1"];}?>
								...
								<tr>
									<td align="center" valign="middle">&nbsp;</td>
									<?php if($res_ped["dby1_date1"] != '0000-00-00') {$dby1_date1 = $res_ped["dby1_date1"];}?>
								...
								<tr>
									<td align="center" valign="middle">&nbsp;</td>
									<?php if($res_ped["cby1_date1"] != '0000-00-00') {$cby1_date1 = $res_ped["cby1_date1"];}?>
								...
								<tr>
									<td align="center" valign="middle">&nbsp;</td>
									<?php if($res_ped["inst2_date2"] != '0000-00-00') {$inst2_date2 = $res_ped["inst2_date2"];}?>
								...
								<tr>
									...
									<?php $ch1 = in_array("Confirm that students are satisfied with the materials",$chk_coun);?>
								<tr>
								...
								<tr>
									<td align="center" valign="middle">&nbsp;</td>
									<?php if($res_ped["inst3_date3"] != '0000-00-00') {$inst3_date3 = $res_ped["inst3_date3"];}?>
								...
								<tr>
									<td align="center" valign="middle">&nbsp;</td>
									<?php if($res_ped["inst4_date4"] != '0000-00-00') {$inst4_date4 = $res_ped["inst4_date4"];}?>
								...
								<tr>
									<td align="center" valign="middle">&nbsp;</td>
									<?php if($res_ped["distrbute_date"] != '0000-00-00') {$distrbute_date =$res_ped["distrbute_date"];}?>
								...
								<tr>
									<td align="center" valign="middle">&nbsp;</td>
									<?php if($res_ped["collect_date"] != '0000-00-00') {$collect_date = $res_ped["collect_date"];}?>
                        ...
                        <td colspan="6" align="left" valign="top" bgcolor="#F7F3F8">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<?php
									for($i = 1; $i<=$res_teacher_group[unit_per_day]; $i++) 
									{ 
								...
								?>
								<tr>
									<td width="32" height="30" align="center" valign="middle" bgcolor="<?php echo $row_bg_color;?>" class="pedtext_normal" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;">
										<select name="atendance_per_unit[]">
											<?php
												for($a=1;$a<=$res_teacher_group[units];$a++):
											?>
									...
									<td width="100" align="center" valign="middle" bgcolor="<?php echo $row_bg_color;?>" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;"><input name="u_dated<?=$i?>" type="text" class="attendance_datepick datefield new_textbox80" id="u_dated<?=$i?>" value="<?php #echo $res_unit["dated"];?>"></td>
									...
									<td width="131" align="center" valign="middle" bgcolor="<?php echo $row_bg_color;?>" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px; "><?php echo $res_teacher[name];?></td>
									<td width="230" align="middle" valign="middle" bgcolor="<?php echo $row_bg_color;?>" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;">
										<input name="material_covered[]" type="text" id="material_covered[]" value="<?php #echo $res_unit["material_overed"];?>" class="new_textbox140"></td>
									<td  align="left" valign="middle" bgcolor="<?php echo $row_bg_color;?>" style="border-bottom:solid 1px; border-color:#000000;">&nbsp;
										<input name="homework[]" type="text" id="homework[]" class="new_textbox140" value="<?php #echo $res_unit["homework"];?>"></td>
								</tr>
								<?php 
									} 
								?>
								<!--<input type="hidden" name="ucount" id="ucount" value="<?php echo $i-1;?>">-->
								<input type="hidden" name="unit_per_day" id="unit_per_day" value="<?php echo $res_teacher_group[unit_per_day]-1;?>">
							</table>
						</td>
                       </tr>
					</table>
                  ...
                  <tr>
					...
					<table  cellspacing="0" cellpadding="0" align="center" style="width:660px;margin-right:0px;float:right;" >
						 <tr>
							...
							<td id="rowHeaders" width="70%">
								<div id="colScroll" style="overflow-x:hidden;">
									<table cellspacing="0" cellpadding="1" style="width: 145px;">
										<tr>
											<?php
												$unit_per_day=$val_course['unit_per_day'];
												$no_cols = $unit_per_day/ $unit_per_day;#$unit / $unit_per_day;
											...
											<th align="center" bgcolor="#4D7373" colspan="3">
												...
												<input type="text" readonly="" class="attendance_datepick" style="width:60px; height:12px; font-size:10px;" name="attend_date[]" id="attend_date[]"  value="<?php #echo $attend_dt;?>">
											</th>
											<?php
													$j++;							 
													$z = $z + $perday;
							...
							<td id="colHeaders">
								<div id="rowScroll" style="overflow-y:hidden">
									<table cellspacing="0" cellpadding="0" border="1">
										...
										?>
										<tr>
											<td height="32" bgcolor="#E9EFEF" class="pedtext" style="max-width:200px;overflow:hidden;text-overflow:ellipsis;">
												...
												<input type="hidden" name="student_id[]" id="student_id[]" value="<?php echo $r["id"];?>">
											</td>
										</tr>
										<?php
											$s_count++;
								 ...
								 <div id="contentScroll" style="overflow:auto">
									...
									<table cellspacing="0" cellpadding="0" style="width: 100px;" border="0">
										...
										?>
												...
												-->
												<select  name="shift[<?php echo $r["id"];?>][]" id="shift[<?php echo $r["id"];?>][]">
													<option value=""></option>
