...
<table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#AAAAAA" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <tr class="logintext">
                  ...
                  <th width="14%" align="left" valign="middle" bgcolor="#CDCDCD" class="menutext" style="font-family:Arial, Helvetica, sans-serif;font-size:12px;color:#6a6868;font-weight:bold;"><?php echo constant("ADMIN_REPORT_STATISTIC_ENDDAT");?> </th>
                  <th width="23%" align="left" valign="middle" bgcolor="#CDCDCD" class="menutext" style="font-family:Arial, Helvetica, sans-serif;font-size:12px;color:#6a6868;font-weight:bold;"><?php echo constant("ADMIN_REPORT_STUDENT_AWAITING_LEVEL");?></th>
                  </tr>
				  </thead>
                <?php
					$i = 1;
