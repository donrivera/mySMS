...
<table <?php if($_SESSION["lang"] == "AR"){?> style="margin-top:-15px;" <?php } ?> width="100%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="countdown_init(<?=$count;?>);">
  ...
  <tr>
    ...
    <form name="frm" method="post" id="frm" autocomplete="off">
          <table width="1100" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#009;">
            ...
            <tr>
              <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="16%" align="left" valign="middle" class="nametext">&nbsp;</td>
                  <td width="25%">&nbsp;</td>
                  <td width="0%">&nbsp;</td>
                  <td width="29%">&nbsp;</td>
                  <td width="30%">&nbsp;</td>
                ...
                <tr>
                  ...
                  <table width="350" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
                    ...
                    <tr>
                      <td width="23%" height="25" align="right" bgcolor="#FFCB7D" class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_GROUP");?> : &nbsp;</td>
                      <td width="77%" align="left" valign="middle" bgcolor="#FFCB7D" class="heading" id="statusresult">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="50%" height="20" align="left" valign="middle" class="nametext"><?php echo constant("TEACHER_REPORT_TEACHER_TXT5");?> : </td>
                        <td width="50%" align="center" valign="middle" class="nametext" style="border-bottom:dotted 1px #000000;"><?php echo $res_size[units];?></td>
                      </tr>
                  </table></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="50%" height="20" align="left" valign="middle" class="nametext"><?php echo constant("TEACHER_REPORT_TEACHER_GROUPSTDT");?>: </td>
                        <td width="50%" align="center" valign="middle" class="nametext" style="border-bottom:dotted 1px #000000;"><?php echo $sdt;?></td>
                      </tr>
                  </table></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="50%" height="20" align="left" valign="middle" class="nametext"><?php echo constant("TEACHER_REPORT_TEACHER_GROUPENDDT");?>: </td>
                        <td width="50%" align="center" valign="middle" class="nametext" style="border-bottom:dotted 1px #000000;"><?php echo $edt;?></td>
                      </tr>
                  </table></td>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="50%" height="20" align="left" valign="middle" class="nametext"><?php echo constant("TEACHER_REPORT_TEACHER_PROGRESSREPORT");?>  : </td>
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="50%" height="20" align="left" valign="middle" class="nametext"><?php echo constant("TEACHER_REPORT_TEACHER_BY");?> : </td>
                        <td width="50%" align="left" valign="middle" style="border-bottom:dotted 1px #000000;"><?php echo $pro["report_print_by"];?>
                        </td>
                      </tr>
                  </table></td>
                  <td>&nbsp;</td>
            ...
            <tr>
              ...
              <table width="1100" border="1" cellspacing="0" cellpadding="0" style="border:solid 1px; border-collapse:collapse;">
                <tr>
                  ...
                  <td height="20" align="left" bgcolor="#E8E8E8" class="pedtext"><?php echo constant("ADMIN_TEACHER1_MANAGE_NATIONALITY");?></td>
                  <td height="20" align="center" bgcolor="#E8E8E8" class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_STDIDNO");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_FLUEN15");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_PRONUN15");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_GARMMER15");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_VOCABUL15");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_TXT");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_TEACHER_TEXT");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_DESRESUlT");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_NUMERESULT");?></td>
                  <td align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_BENIFTGRD");?></td>
                  <td align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_TEACHER_ATTEND");?></td>
                  <td align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_TEACHER_TXT8");?></td>
                  <td align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_ATTENDCALC");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_FINALGRD");?></td>
                  <td height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_TEXT");?></td>
                </tr>
				 <?php
  ...
  <tr>
    ...
    <form name="frm" method="post" id="frm" autocomplete="off">
          <table width="1100" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#009;">
			...
			<?php }	?>
            <tr>
              <td width="22%" align="center" valign="middle"><?php if($_REQUEST[group_id] !='') { ?><a href="report_center_director_print.php?group_id=<?php echo $_REQUEST[group_id];?>" target="_blank"><img src="../images/print.png" width="16" height="16" /></a><?php } ?></td>
              <td width="43%">&nbsp;</td>
              <td width="32%" height="30" align="right" valign="middle"></td>
            </tr>
            <tr>
              <td align="center" valign="top"><img src="../images/logo.png" width="105" height="30" /></td>
              <td align="center" valign="middle" class="heading1"><?php echo constant("TEACHER_REPORT_CENTERDI_HEADTEXT");?></td>
              ...
              <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <table width="350" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
                    ...
                    <tr>
                      <td height="25" align="right" bgcolor="#FFCB7D" class="pedtext">
                      <select name="mystatus" id="mystatus" style="width:150px; border:solid 1px; border-color:#999999;">
                        <option value="">All</option>
                    ...
                    <tr>
                      <td width="73%" height="25" align="right" bgcolor="#FFCB7D" class="pedtext" id="statusresult"><select name="group_id" id="group_id" style="width:150px; border:solid 1px; border-color:#999999;" onChange="setsubmit();">
                            <option value="">Select Group</option>
                            <?php
							  if($_REQUEST["mystatus"] == ''){
								  $status = 'Continue';
                      ...
                      <td width="27%" align="left" valign="middle" bgcolor="#FFCB7D" class="pedtext" >: <?php echo constant("TEACHER_REPORT_TEACHER_GROUP");?></td>
                    </tr>
                    <?php
					  $res_g = $dbf->strRecordID("student_group","*","id='$_REQUEST[group_id]'");
					  $res_course = $dbf->strRecordID("course","*","id='$res_g[course_id]'");
            ...
            <tr>
              ...
              <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border:solid 1px; border-collapse:collapse;">
                <tr>
                  ...
                  <td width="6%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_TEXT");?></td>
                  <td width="4%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_FINALGRD");?></td>
                  <td width="6%" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_ATTENDCALC");?></td>
                  <td width="5%" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_TEACHER_TXT8");?></td>
                  <td width="6%" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_TEACHER_ATTEND");?></td>
                  <td width="6%" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_BENIFTGRD");?></td>
                  <td width="6%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_NUMERESULT");?></td>
                  <td width="6%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_DESRESUlT");?></td>
                  <td width="5%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_TEACHER_TEXT");?></td>
                  <td width="8%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_TXT");?></td>
                  <td width="6%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_VOCABUL15");?></td>
                  <td width="5%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_GARMMER15");?></td>
                  <td width="5%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_PRONUN15");?></td>
                  <td width="5%" height="20" align="center" class="rotate_text"><?php echo constant("TEACHER_REPORT_CENTERDI_FLUEN15");?></td>
