                  ...
                  <tr>
                    ...
                    <table width="1000" border="1" cellspacing="0" bordercolor="#000000" cellpadding="0" style="border-collapse:collapse;">
                      ...
                      <tr bgcolor="#E9EFEF">
						...
						$present = $dbf->strRecordID("ped_attendance","COUNT(id) as total","attend_date='$res_unit[dated]' And teacher_id='$_SESSION[uid]' And group_id='$_REQUEST[cmbgroup]' And (shift1='X' OR shift2='X' OR shift3='X' OR shift4='X' OR shift5='X' OR shift6='X' OR shift7='X' OR shift8='X' OR shift9='X' OR shift1='L' OR shift2='L' OR shift3='L' OR shift4='L' OR shift5='L' OR shift6='L' OR shift7='L' OR shift8='L' OR shift9='L')");
