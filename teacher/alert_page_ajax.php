...
include_once '../includes/language.php';
			...
			ob_clean();
			$VALUE=$_POST['val']; 							
				$totalcount=$dbf->countRows("alerts","teacher='1' AND status='0' And imp='1' And imp='1' And id not in (select alert_id from alerts_read where user_id='$_SESSION[id]')");//mysql_result(mysql_query($total),0);
				$perpage=1;
