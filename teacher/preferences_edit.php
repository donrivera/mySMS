        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="30" bgcolor="#FFA938" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="30%" class="footertext">&nbsp;<?php echo "Edit Preferences";?></td>
                          ...
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="100%" class="logintext" style="background:url(../images/left_mid_bg.png) repeat-x;"><?php echo "Details";?></td>
                          ...
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                              <tr>
                                ...
                                <form action="preferences_process.php?action=edit" name="frm" method="post" id="frm">
									<?php
										$user = $dbf->strRecordID("user","email,mobile,id","id='$_SESSION[id]'");
									?>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-color:#CCCCCC;">
									<tr>
										<td width="63">&nbsp;</td>
										<td width="115" height="30" align="left" valign="middle" class="leftmenu">&nbsp;</td>
									...
									<tr>
										<td width="63">&nbsp;</td>
										<td width="115" height="30" align="left" valign="middle" class="leftmenu"><?php echo "Email";?> : <span class="nametext1">*</span></td>
										<td width="202" class="leftmenu">
									...
									<tr>
										<td width="63">&nbsp;</td>
										<td width="115" height="30" align="left" valign="middle" class="leftmenu"><?php echo "Mobile";?> : <span class="nametext1">*</span></td>
										<td width="202" class="leftmenu">
								...
								<input type="hidden" name="record_id" value="<?php echo $user["id"];?>">
                                </form></td>
                          </tr>
                        </table></td>
                      </tr>
