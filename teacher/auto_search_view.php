            ...
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="middle" bgcolor="#000000" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    <td width="54%" height="36" class="headingtext"><h1><span class="logintext"><?php echo constant("STUDENT_INFORMATON");?></span></h1></td>
                    <td width="22%">&nbsp;</td>
              ...
              <tr>
				...
				<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #CCCCCC; border-right:solid 1px #CCCCCC;  ">
                      <tr>
					...
					<form action="s_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" enctype="multipart/form-data">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#CCCCCC;">
                            <tr>
                              <td width="9%">&nbsp;</td>
                              <td width="33%">&nbsp;</td>
                              <td width="0%">&nbsp;</td>
                            ...
                            <tr>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              <td height="28" align="right" valign="top" class="leftmenu"><label class="description" for="element_7"><?php echo constant("STUDENT_ADVISOR_HOME_S_CLASSIC_COMMENTS");?></label>:</td>
                              <td>&nbsp;</td>
					...
					<form action="s_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" enctype="multipart/form-data">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#CCCCCC;">
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td height="29" align="left" valign="middle" class="leftmenu"> : <?php echo constant("STUDENT_ADVISOR_HOME_S_CLASSIC_L5");?></td>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td height="28" align="left" valign="top" class="leftmenu"><label class="description" for="element_7"> : <?php echo constant("STUDENT_ADVISOR_HOME_S_CLASSIC_COMMENTS");?></label></td>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
