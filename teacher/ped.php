...
<?php
	$atd_sdate=explode("-",$dbf->getDataFromTable("student_group", "start_date", "id='$_REQUEST[cmbgroup]'"));
	$atd_edate=explode("-",$dbf->getDataFromTable("student_group", "end_date", "id='$_REQUEST[cmbgroup]'"));
?>
<script>
$(function() 
{
	...
	$( ".attendance_datepick" ).datepicker(
	{
		changeMonth: true,
		changeYear: true,
                    ...
                    <tr>
                      ...
                      <td width="72%" align="left" valign="middle" bgcolor="#FFCB7D" class="heading" id="statusresult">
                        <select name="cmbgroup" id="cmbgroup" style="width:150px; border:solid 1px; border-color:#999999;" onChange="setsubmit();">
                          ...
                          <?php
						  foreach($dbf->fetchOrder('student_group',"teacher_id='$teacher_id'","group_name","") as $res_group) {
							  ?>
            ...
            <tr>
              <td colspan="3" align="left" valign="top">
                ...
                <table width="1000" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bgcolor="#FFFFFF">
                  ...
                  foreach($dbf->fetchOrder('student_group',"id='$_REQUEST[cmbgroup]'","group_name","") as $res_group){
                  ...
                  <tr>
                    ...
                    <table width="1000" border="1" cellspacing="0" bordercolor="#000000" cellpadding="0" style="border-collapse:collapse;">
                      <tr>
                        ...
                        <td width="29" align="center" valign="middle"><img src="../images/ped-units.jpg" width="32" height="41"></td>
                        ...
                        <td width="131" align="center" valign="middle" class="pedtext2"><?php echo constant("STUDENT_ADVISOR_PED_INSTRUCTOR");?></td>
                      ...
                      <tr bgcolor="#E9EFEF">
						...
						elseif(($i==$unit-10) || ($i==$unit-11)){$row_bg_color="#CCCCCC";}
						else{$row_bg_color="#F7F3F8";}
						...
						?>
                          ...
                          <tr>
                            ...
                            <td width="100" align="center" valign="middle" bgcolor="<?php echo $row_bg_color;?>" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;">
								<input name="ped_unit[<?=$i?>][date]" type="text" class="attendance_datepick datefield new_textbox80" id="ped_unit[<?=$i?>][date]" readonly=""  value="<?php echo ($res_unit["dated"]=='0000-00-00'?'':$res_unit["dated"]);?>">
							</td>
                            <td width="32" align="center" valign="middle" bgcolor="<?php echo $row_bg_color;?>" class="pedtext_normal" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;"><?php echo ($res_unit["dated"]=='0000-00-00'?0:$present["total"]);?></td>
							...
							<?php echo $dbf->getDataFromTable("teacher","name","id='$res_unit[teacher_id]'");?></td>
                            <td width="230" align="middle" valign="middle" bgcolor="<?php echo $row_bg_color;?>" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;">
								<input name="ped_unit[<?=$i?>][material_covered]" type="text" id="ped_unit[<?=$i?>][material_covered]" value="<?php echo $res_unit["material_overed"];?>" class="new_textbox140">
							</td>
                            <td  align="left" valign="middle" bgcolor="<?php echo $row_bg_color;?>" style="border-bottom:solid 1px; border-color:#000000;">&nbsp;
                              <input name="ped_unit[<?=$i?>][homework]" type="text" id="ped_unit[<?=$i?>][homework]" class="new_textbox140" value="<?php echo $res_unit["homework"];?>">
							</td>
                            </tr>
                          <?php } ?>
                  ...
                  <tr>
                    ...
                    foreach($dbf->fetchOrder('student_group',"id='$_REQUEST[cmbgroup]'","","") as $val_course)
					{
							...
							{	
								case 2:	{
											$td_height="38";
											$stu_table_height=$dbf->getDataFromTable('student_group_dtls','COUNT(id)',"parent_id='$_REQUEST[cmbgroup]'");
											switch($stu_table_height)
											{
												case 1:		{$table_height="90px";}break;
												case 2:		{$table_height="130px";}break;
												case 3:		{$table_height="170px";}break;
												case 4:		{$table_height="210px";}break;
												case 5:		{$table_height="250px";}break;
												case 6:		{$table_height="290px";}break;
												case 7:		{$table_height="330px";}break;
												case 8:		{$table_height="370px";}break;
												case 9:		{$table_height="410px";}break;
												case 10:	{$table_height="450px";}break;
												case 11:	{$table_height="490px";}break;
												case 12:	{$table_height="530px";}break;
												case 13:	{$table_height="570px";}break;
												case 14:	{$table_height="610px";}break;
												case 15:	{$table_height="750px";}break;
												case 16:	{$table_height="790px";}break;
												default:	{$table_height="90px";}break;
											}
										}break;
								case 3:	{
											$td_height="57";
											...
											switch($stu_table_height)
											{
												case 1:		{$table_height="110px";}break;
												case 2:		{$table_height="170px";}break;
												case 3:		{$table_height="230px";}break;
												case 4:		{$table_height="290px";}break;
												case 5:		{$table_height="350px";}break;
												case 6:		{$table_height="410px";}break;
												case 7:		{$table_height="470px";}break;
												case 8:		{$table_height="530px";}break;
												case 9:		{$table_height="590px";}break;
												case 10:	{$table_height="640px";}break;
												case 11:	{$table_height="700px";}break;
												case 12:	{$table_height="760px";}break;
												case 13:	{$table_height="820px";}break;
												case 14:	{$table_height="880px";}break;
												case 15:	{$table_height="940px";}break;
												case 16:	{$table_height="1000px";}break;
												default:	{$table_height="110px";}break;
											}
										}break;
					...
					<style>
						...
						#contentScroll { height: <?=$table_height?>; width: 790px; }/*Student Attendance*/
						#colScroll { width: 630px; } /* date */
					</style>
									...
									<table cellspacing="0" cellpadding="0" border="1" width="100%">
										...
										<tr>
											...
											<th align="center" bgcolor="#4D7373" colspan="3">
												...
												<input type="text" readonly="" class="attendance_datepick" style="width:53px; height:12px; font-size:10px;" name="ped_attendance[<?=$i+1?>][date]" id="ped_attendance[<?=$i?>][date]"  value="<?php echo $attend_dt;?>">
												<input type="hidden" name="ped_attendance[<?=$i+1?>][unit]" id="ped_attendance[<?=$i?>][unit]"  value="<?php echo $i+1;?>">
											</th>
											<?php
													$j++;							 
													$z = $z + $perday;
