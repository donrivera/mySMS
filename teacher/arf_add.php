                            ...
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                              <tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-color:#CCCCCC;">
                                  ...
                                  <tr>
                                    ...
                                    <td width="202" class="leftmenu" id="lblstudent">
                                      <select name="student" id="student"  style="border:1px solid #999;font-size:14px;color:#000;background:#ECF1FF;padding:2px; width:192px;"><!--class="validate[required]"-->
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" valign="middle"><input name="nr" type="text" class="validate[required] new_textbox190" id="nr" value="<?php $arf_id= $dbf->strRecordID("arf","MAX(id) as idtop","");echo $arf_id['idtop'] + 1;?>" readonly="readonly" /></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                  ...
                                  <tr>
									...
									<td height="25" align="left" valign="middle" class="leftmenu">
										<input type="radio" name="function" value="customer" <?php echo ($_SESSION[user_type] == 'Customer' ? 'checked' : '')?>>
									</td>
									<td align="left" valign="middle" class="leftmenu">&nbsp;</td>
									<td width="74" align="right" class="leftmenu"><?php echo constant("TEACHER_ARF_MANAGE_RECEPTION");?> : </td>
									<td height="25" align="left" valign="middle">
										<span class="leftmenu">
											<input type="radio" name="function1" value="reception">
										</span>
									</td>
								</tr>
								<tr>
									...
									<td height="25" align="left" valign="middle" class="leftmenu">
										<input type="radio" name="function" value="teacher" <?php echo ($_SESSION[user_type] == 'Teacher' ? 'checked' : '')?>>
									</td>
									<td align="left" valign="middle" class="leftmenu">&nbsp;</td>
									<td align="right" class="leftmenu"><?php echo constant("TEACHER_ARF_MANAGE_LCD");?> : </td>
									<td height="25" align="left" valign="middle">
										<span class="leftmenu">
											<input type="radio" name="function1" value="lcd">
										</span> 
									</td>
								</tr>
								<tr>
									...
									<td height="25" align="left" valign="middle" class="leftmenu">
										<input type="radio" name="function" value="reception" <?php echo ($_SESSION[user_type] == 'Reception' ? 'checked' : '')?>>
									</td>
									<td align="left" valign="middle" class="leftmenu">&nbsp;</td>
									<td align="right" class="leftmenu"><?php echo constant("TEACHER_ARF_MANAGE_LIS");?> : </td>
									<td height="25" align="left" valign="middle">
										<span class="leftmenu">
											<input type="radio" name="function1" value="lis">
										</span>
									</td>
								</tr>
								<tr>
									...
									<td height="25" align="left" valign="middle" class="leftmenu">
										<input type="radio" name="function" value="customer service" <?php echo ($_SESSION[user_type] == 'Customer Service' ? 'checked' : '')?>>
									</td>
									<td align="left" valign="middle" class="leftmenu">&nbsp;</td>
									<td align="right" class="leftmenu"><?php echo constant("TEACHER_ARF_MANAGE_CS");?> : </td>
									<td height="25" align="left" valign="middle">
										<span class="leftmenu">
											<input type="radio" name="function1" value="customer service">
										</span>
									</td>
								</tr>
								<tr>
									...
									<td height="25" align="left" valign="middle" class="leftmenu">
										<input type="radio" name="function" value="other" <?php echo ($_SESSION[user_type] == 'Other' ? 'checked' : '')?>>
											<input name="other1" type="text" id="other1" value="" class="new_textbox100"/>
									</td>
									<td align="left" valign="middle" class="leftmenu">&nbsp;</td>
									<td align="right" class="leftmenu"><?php echo constant("TEACHER_ARF_MANAGE_OTHER");?> :</td>
									<td height="25" align="left" valign="middle">&nbsp;&nbsp;
										<input type="radio" name="function1" value="other">
											<input name="other2" type="text" id="other2" value="" class="new_textbox100"/>
									</td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								...
								<tr>
									...
									<td height="25" align="left" valign="middle" class="leftmenu">
										<input type="radio" name="subject" value="program">
									</td>
									<td align="left" valign="middle" class="leftmenu">&nbsp;</td>
									<td align="left" valign="middle" class="leftmenu">&nbsp;</td>
									<td align="left" valign="middle">&nbsp;</td>
								...
								<table>
									<tr>
										...
										<td><textarea name="action_report" cols="50" rows="10"></textarea></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
									...
									<tr>
										...
										<td><textarea name="action_taken" cols="50" rows="10"></textarea></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td align="left" valign="middle" class="leftmenu"><?php echo constant("TEACHER_ARF_MANAGE_DATE");?> : 
									...
									<tr>
										...
										<td><textarea name="result_check" cols="50" rows="10"></textarea></td>
									</tr>
									<tr>
										<td>&nbsp;</td>
										<td align="left" valign="middle" class="leftmenu"><?php echo constant("TEACHER_ARF_MANAGE_DATE");?> : 
