...
function secondPass(){
	...
	if(f)
		for(key in google_language_code)
			...
			document.getElementById("mytxt_src").value = t1;
			document.getElementById("mytxt_src1").value = t2;
			document.getElementById("mytxt_src2").value = t3;
			document.getElementById("mytxt_src3").value = t4;
