            ...
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="middle" bgcolor="#000000" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    <td width="54%" height="30" align="left" class="footertext"><?php echo constant("TEACHER_PASSWORD_CHANGE_PASSWORD");?> </td>
                    <td width="22%">&nbsp;</td>
              ...
              <tr>
                <td align="center" valign="top" bgcolor="#FFFFFF"><table width="300" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#66CC66;">
                    <tr>
                      ...
                      <td width="253" align="left" valign="middle" bgcolor="#FFF2FD" class="nametext"><?php echo constant("TEACHER_PASSWORD_INVALIDPWD");?></td>
                    </tr>
                </table></td>
              </tr>
              <?php } ?>
              ...
              <tr>
                <td align="center" valign="top" bgcolor="#FFFFFF"><table width="314" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#66CC66;">
                    <tr>
                      <td width="37" height="30" align="center" valign="middle" bgcolor="#FFF2FD"><img src="../images/close-btn.png" width="25" height="25" /></td>
                      <td width="253" align="left" valign="middle" bgcolor="#FFF2FD" class="nametext"><?php echo constant("TEACHER_PASSWORD_SUCMSG");?></td>
                    </tr>
                </table></td>
              </tr>
              <?php } ?>
  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="footertext"><?php echo constant("NEW_PASSWORD");?></span></td>
					...
					<form action="password_process.php?action=edit" name="frm" method="post" id="frm" onsubmit="password();" >
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-color:#CCCCCC;">
                            ...
                            <tr>
                              ...
                              <td height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("TEACHER_PASSWORD_OLDPASSWORD");?> : <span class="nametext1">*</span> </td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              <td height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("TEACHER_PASSWORD_NEWPASSWORD");?> : <span class="nametext1">*</span></td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              <td height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("TEACHER_PASSWORD_CONFIRMPASSWORD");?> : <span class="nametext1">*</span></td>
                              <td>&nbsp;</td>
          ...
          <tr>
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="middle" bgcolor="#000000" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    <td width="54%" height="30" align="left" class="footertext"><a href="home.php"> 
                      <input type="button" value="<?php echo constant("btn_cancel_btn2");?>" class="btn2" border="0" align="left" /></a> </td>
                    <td width="22%">&nbsp;</td>
                    <td width="8%" align="right"><?php echo constant("TEACHER_PASSWORD_CHANGE_PASSWORD");?></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
				...
				<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="footertext"><?php echo constant("NEW_PASSWORD");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                      ...
                      <tr>
                        ...
                        <form action="password_process.php?action=edit" name="frm" method="post" id="frm" onsubmit="password();" >
                              <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-color:#CCCCCC;">
                                ...
                                <tr>
                                  <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                  <td height="28" align="right" valign="middle"><input name="oldpassword" type="password" class="validate[required] new_textbox190_ar" id="oldpassword" size="45" minlength="4"/></td>
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle" class="leftmenu">: <span class="nametext1">*</span><?php echo constant("TEACHER_PASSWORD_OLDPASSWORD");?></td>
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                  <td height="28" align="right" valign="middle"><input name="newpassword" type="password" class="validate[required] new_textbox190_ar" id="newpassword" size="45" minlength="4"/></td>
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle" class="leftmenu">: <span class="nametext1">*</span><?php echo constant("TEACHER_PASSWORD_NEWPASSWORD");?></td>
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                  <td height="28" align="right" valign="middle"><input name="confirmpassword" type="password" class="validate[required] new_textbox190_ar" id="confirmpassword" size="45" minlength="4"/></td>
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle" class="leftmenu">:<span class="nametext1">*</span><?php echo constant("TEACHER_PASSWORD_CONFIRMPASSWORD");?></td>
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle">&nbsp;</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                  <td height="25" align="center" valign="middle" class="leftmenu"><input type="submit" name="submit" id="submit" value="<?php echo constant("btn_save_btn");?>" class="btn2"/>&nbsp;</td>
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle"></td>
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle">&nbsp;</td>
