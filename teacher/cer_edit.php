                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-color:#CCCCCC;">
                                  ...
                                  <tr>
                                    ...
                                    <td class="leftmenu" align="left" id="lblgroup">
                                      <select name="group_id" id="group_id"  style="border:1px solid #999;font-size:14px;color:#000;background:#ECF1FF;padding:2px; width:192px;"><!--onChange="show_student();"-->
								  ...
								  <tr>
                                    ...
                                    <td width="202" class="leftmenu">
                                      <input type="text" name="units" id="units" onKeyPress="return isNumberKey(event);" value="<?php echo $res_cer['units'];?>"/>
                                    </td>
                                    <td width="16">&nbsp;</td>
                                    <td width="74">&nbsp;</td>
                                    <td width="196">&nbsp;</td>
								  ...
								  <tr>
                                    ...
                                    <td width="202" class="leftmenu">
                                      <textarea name="remarks" cols="40" rows="10" ><?php echo $res_cer['remarks'];?></textarea>
                                    </td>
                                    <td width="16">&nbsp;</td>
                                    <td width="74">&nbsp;</td>
                                    <td width="196">&nbsp;</td>
