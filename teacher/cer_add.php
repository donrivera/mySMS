                          ...
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                              <tr>
                                ...
                                <form action="cer_process.php?action=insert" name="frm" method="post" id="frm">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-color:#CCCCCC;">
								  ...
								  <tr>
                                    ...
                                    <td width="202" class="leftmenu">
                                      <input type="text" name="units" id="units" onKeyPress="return isNumberKey(event);"/>
                                    </td>
                                    <td width="16">&nbsp;</td>
                                    <td width="74">&nbsp;</td>
                                    <td width="196">&nbsp;</td>
								  ...
								  <tr>
                                    ...
                                    <td width="202" class="leftmenu">
                                      <textarea name="remarks" cols="40" rows="10"></textarea>
                                    </td>
                                    <td width="16">&nbsp;</td>
                                    <td width="74">&nbsp;</td>
                                    <td width="196">&nbsp;</td>
