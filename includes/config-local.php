...
define('DB_PASSWORD', '');
define('DB_DATABASE', 'schedule_040513');

/*define('DB_SERVER', 'localhost');
define('DB_USERNAME', 'bletproj_berlz');
define('DB_PASSWORD', 'blet1234');
define('DB_DATABASE', 'bletproj_schedule');*/


/*define('DB_SERVER', 'localhost');
define('DB_USERNAME', 'berlitzk_SMTest');
