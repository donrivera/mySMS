            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <thead>
				  ...
				  $color="#ECECFF";			
					$i =1;
					$num=$dbf->countRows('sick_leave',"centre_id='$_REQUEST[centre_id]' And sick_status='0' And teacher_id > '0'");
					$color = "#ECECFF";
					foreach($dbf->fetchOrder('sick_leave',"centre_id='$_REQUEST[centre_id]' And sick_status='0' And teacher_id > '0'","id DESC") as $val) {
