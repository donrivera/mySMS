          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="6%" height="30" align="left" valign="middle" class="red_smalltext"><?php echo constant("ADMIN_VIEW_GROUP_SIZE_CENTRE");?> :</td>
                <td width="88%" align="left" valign="middle">
                <select name="centre_id" id="centre_id" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF; height:25px; width:192px;" onchange="javascript:document.frm.action='vacation_teacher_manage.php',document.frm.submit();">
