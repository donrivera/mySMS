            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bordercolor="#DFF2DB" class="tablesorter" id="tablesorter-demo">
             <thead>
              ...
              <?php					
					$color = "#ECECFF";
					$i = 1;
					$num=$dbf->countRows('student',"family_name LIKE '$_REQUEST[testinput]%' OR family_name1 LIKE '$_REQUEST[testinput]%' OR first_name LIKE '%$_REQUEST[testinput]%' OR student_first_name LIKE '%$_REQUEST[testinput]%' OR first_name1 LIKE '%$_REQUEST[testinput]%'");
				foreach($dbf->fetchOrder('student',"family_name LIKE '$_REQUEST[testinput]%' OR family_name1 LIKE '$_REQUEST[testinput]%' OR first_name LIKE '%$_REQUEST[testinput]%' OR student_first_name LIKE '%$_REQUEST[testinput]%' OR first_name1 LIKE '%$_REQUEST[testinput]%'","id DESC ") as $val){					
					?>
