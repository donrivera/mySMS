                  ...
                  <tr>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="59%" align="left" valign="middle" class="pedtext_normal" ><?php echo $res_g[group_name]."&nbsp;".$dbf->printClassTimeFormat($res_g["group_start_time"],$res_g["group_end_time"]);?></td>
                      </tr>
                    </table></td>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#CCC;">
				  ...
				  ?>
                  <tr>
                    <td height="20" align="right" valign="middle" class="pedtext_normal"><?php echo $dbf->printStudentName($res_student["id"]);?></td>
