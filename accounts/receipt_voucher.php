          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                ...
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left"><a href="view_receipt_voucher.php"> <input type="button" value="<?php echo constant("btn_cancel_btn2");?>" class="btn1" border="0" align="left" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext">Receipt Voucher</span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="voucher_process.php?action=receipt" name="frm" method="post" id="frm">
								...
								<tr>
									...
									<td>
										<?php
											...
											$pay_voucher=$dbf->getDataFromTable("acct_financial_transactions","COUNT(id)","id !='' AND transaction_type_code='RC'");
											$pay_voucher +=1;
								...
								<tr>
									...
									<td colspan="2">
										<select width="50" >
											...
											<?php
												$parties=$dbf->genericQuery("SELECT id,party_type_desc FROM acct_party_types WHERE id IN('1','2')");
												foreach($parties as $party):
											?>
											<option value="<?=$party['id']?>"><?=$party['party_type_desc']?></option>
											<?php endforeach;?>
										</select>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="2">
										<select width="50" name="party_code">
												<option>Select From List/s&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
											<?php
												$corp=$dbf->genericQuery("SELECT id,name,code FROM corporate ORDER BY id");
												foreach($corp as $c):
													$corp_name=explode('-',$c['name']);
											?>
												<option value="<?=$c['id']?>"><?=$corp_name[0]."&nbsp;".$c['code']?></option>
										<?php endforeach;?>
										</select>
									</td>
								</tr>
								...
								<tr>
									...
									<td colspan="2">
										<?php
											...
											$rd_bank=$dbf->getDataFromTable("acct_chart_accounts","account_number","account_name='Other Debit Accounts' && account_group_name='Other Debit Accounts'");
										?>
									...
									<td colspan="3">
											...
											<table border="1">
												...
												<tr>
													...
													<td><?=$dbf->selectAcctChart("acc_dir_no[]","D")?></td>
													<td>
												...
												<tr>
													<td><input type="text" name="acc_dir_value[]"/></td>
													<td><input type="text" name="acc_dir_desc[]"/></td>
													<td><?=$dbf->selectAcctChart("acc_dir_no[]","C")?></td>
													<td>
														<select  name="acc_dir_cost_ctr[]">
															<option>Cost Center</option>
															<?php
