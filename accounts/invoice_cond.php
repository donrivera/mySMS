...
$res = $dbf->strRecordID("conditions","*","type='Invoice'");
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_INVOICE_COND_TERMS_AND_CONDITION_FOR_INVOICE");?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="challan_cond_process.php?type=invoice" name="frm" method="post" id="frm">
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td height="28" align="right" valign="top" class="leftmenu"><?php echo constant("ADMIN_INVOICE_COND_NARRATION");?> : <span class="nametext1">*</span> </td>
                          <td>&nbsp;</td>
