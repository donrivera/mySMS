...
$val = $dbf->strRecordID("acct_financial_transactions","*","id='$trans_id'");
$trans_type_code=$val["transaction_type_code"];
$voucher_type=$dbf->getDataFromTable("acct_transaction_types","transaction_type_desc","transaction_type_code='$trans_type_code'");
  ...
  <tr>
    ...
    <table width="670" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
      <tr>
        ...
        <td width="123" align="center" valign="middle"><img src="../logo/DUK7.png" width="105" height="30" /></td>
      ...
      <tr>
        <td height="30" align="center" valign="middle" class="chtext">&nbsp;</td>
        <td colspan="3" align="center" valign="top" class="login_header"><?=$voucher_type?></td>
        <td align="center" valign="middle">&nbsp;</td>
      </tr>
      <tr>
        <td height="30" colspan="5" align="center" valign="middle" style="border-top:solid 1px; border-bottom:solid 1px; border-color:#999;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="24%" class="suc_msg"><?php echo $val["id"];?></td>
            ...
            <?php echo date('d/m/Y',strtotime($val["transaction_date"]));?>
            </td>
        ...
        <?php
		$amt = round($val["transaction_amount"]);
            ...
            <td width="375"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr>
				<td align="right" valign="middle" class="suc_msg">
					<?php
						switch($trans_type_code)
						{
							case 'PM':	{
											$getName=$dbf->getDataFromTable("acct_parties_in_transaction","party_id","transaction_id='$trans_id'");
											$printName=$dbf->getDataFromTable("acct_parties","party_name","id='$getName'");
										}break;
										
							case 'RC':	{
											
											$getType=$dbf->getDataFromTable("acct_parties_in_transaction","party_code","transaction_id='$trans_id'");
											switch($getType)
											{
												case 'ST':	{
																$studentId=$dbf->getDataFromTable("acct_parties_in_transaction","party_id","transaction_id='$trans_id'");
																$printName=$dbf->printStudentName($studentId);
															}break;
												case 'CP':	{
																$nameType=$dbf->getDataFromTable("acct_parties_in_transaction","party_id","transaction_id='$trans_id'");
																//$getName=explode('-',$dbf->getDataFromTable("corporate","name","id='$nameType'"));
																$getName=$dbf->getDataFromTable("corporate","name","id='$nameType'");
																$printName=$getName;
															}break;
												default:	{$printName="Select Transaction Type...";}break;
											}
										}break;
							default:	{$printName="Select Transaction Type...";}break;
						}
              ...
              <tr>
                <td align="right" valign="middle" class="suc_msg"><?php echo $dbf->getDataFromTable("acct_chart_accounts","account_name","account_number='$val[transaction_pay_type]'"); ?></td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td align="right" valign="middle" class="suc_msg"><?php echo $val["transaction_description"];?></td>
                <td>&nbsp;</td>
