...
function showno()
{
	...
	//alert(search1);
	ajaxRequest.open("GET", "sms_show_no.php" + "?number1=" + number1, true);
...
<table width="470" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 2px; border-color:#FF9900;">
    ...
    <tr>
      ...
      <table width="460" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="119" align="right" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:11px; font-weight:bold; color:#006;"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_STUDENT");?> <span class="nametext1"></span> :&nbsp;</td>
          <td width="341" height="30" id="lbl_error" class="red_smalltext"><input name="number" type="text" class="validate[required]" style="border:solid 1px; background-color:#ECF1FF; width:200px; border-color:#999999;" id="number" onkeyup="showno();"/></td>
        </tr>
        <tr>
          <td height="30" colspan="2" align="left" valign="middle" id="show">&nbsp;</td>
        </tr>
        <tr>
