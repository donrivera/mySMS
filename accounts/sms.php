                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            <tr>
                              ...
                              <tr>
                                  <td height="35" colspan="4" align="center" valign="top" class="leftmenu">
								      <table width="500" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF0000;">
                                        <tr>
                                          <td width="459" height="30" align="right" valign="middle" bgcolor="#FFFF00"  class="nametext1"><?php echo $_REQUEST[msg];?>                                          </td>
                            ...
                            <tr>
                              ...
                              <td align="right" valign="top" class="leftmenu"><table>
                                  ...
                                  <tr>
                                    <td align="center"><a href="sms_search_student.php?page=sms_search_student.php&amp;TB_iframe=true&amp;height=200&amp;width=365&amp;inlineId=hiddenModalContent&amp;modal=true"  class="top_menu_link thickbox "><?php echo constant("RECEPTION_SMS_SEARCHFORSTUDENT");?></a></td>
                                  </tr>
                              </table></td>
                            </tr>
                            <tr>
