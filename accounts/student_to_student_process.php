...
if($_REQUEST['action']=='update'){
	...
	if($_REQUEST["status"] == 'Approved'){
		...
		foreach($dbf->fetchOrder('transfer_student_to_student_dtls',"parent_id='$tran_id'") as $transfer){
		...
		if($num_student == 0){
		  ...
		  <tr>
			<td align="center" valign="top">&nbsp;</td>
					...
					$string="dated='$dttm',user_id='$_SESSION[id]',msg='$subject',send_to='Teacher',email='$to_user',centre_id='$_SESSION[centre_id]',send_date='$dt',msg_from='$subject',automatic='Yes',page_full_path='$_SERVER[REQUEST_URI]'";
