          ...
          <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                <td>&nbsp;</td>
                <td colspan="4" align="left" valign="top">
                <table width="70%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" bordercolor="#999999">
                  <tr>
                    <td width="9%" height="22" align="center" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("ADMIN_SMS_PARAMETER_TEMPLETE_SL_NO");?></td>
                    <td width="33%" align="left" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_AWAITING_COURSE");?></td>
                    <td width="36%" align="left" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("CERTIFICATE_PRINTED_ON");?></td>
                    <td width="22%" align="left" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("CERTIFICATE_PRINTED_BY");?></td>
                  </tr>
                  <?php
				  $sl = 1;
				  $num = $dbf->countRows('student_certificate',"student_id='$student_id'");
				  foreach($dbf->fetchOrder('student_certificate',"student_id='$student_id'","","") as $all){
					  $user = $dbf->getDataFromTable("user", "user_name", "id='$all[user_id]'");
					  $course = $dbf->getDataFromTable("course", "name", "id='$all[course_id]'");
				  ?>
                  <tr>
                    <td height="21" align="center" valign="middle" class="mytext"><?php echo $sl;?></td>
                    <td align="left" valign="middle" class="mytext">&nbsp;<?php echo $course;?></td>
                    <td align="left" valign="middle" class="mytext">&nbsp;<?php echo date('D,d M Y , h:i A',strtotime($all["date_time"]));?></td>
                    <td align="left" valign="middle" class="mytext">&nbsp;<?php echo $user;?></td>
                  </tr>
                  <?php
					$sl++;
					}
                    ...
                    <?php if($num == 0){?>
                    <tr>
                    <td height="21" colspan="4" align="center" valign="middle" class="red_smalltext"><?php echo constant("CERTIFICATE_NOT_PRINTED");?></td>
                    </tr>
                    <?php } ?>
                </table>
                </td>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <td colspan="4" align="left" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="1%">&nbsp;</td>
                      <td height="30" colspan="2" align="left" valign="middle"><?php echo $dbf->VVIP_Big_Icon($student_id);?></td>
              ...
              <tr>
                ...
                <table width="70%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" bordercolor="#999999">
                  <tr>
                    <td width="33%" align="right" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_AWAITING_COURSE");?></td>
                    <td width="36%" align="right" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("CERTIFICATE_PRINTED_ON");?></td>
                    <td width="22%" align="right" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("CERTIFICATE_PRINTED_BY");?></td>
                    <td width="9%" height="22" align="center" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("ADMIN_SMS_PARAMETER_TEMPLETE_SL_NO");?></td>
                  </tr>
                  <?php
				  $sl = 1;
				  ...
				  ?>
                  <tr>
                    <td align="right" valign="middle" class="mytext">&nbsp;<?php echo $course;?></td>
                    <td align="right" valign="middle" class="mytext">&nbsp;<?php echo date('D,d M Y , h:i A',strtotime($all["date_time"]));?></td>
                    <td align="right" valign="middle" class="mytext">&nbsp;<?php echo $user;?></td>
                    <td height="21" align="center" valign="middle" class="mytext"><?php echo $sl;?></td>
                  </tr>
                  <?php
					$sl++;
