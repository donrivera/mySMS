...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="37" align="right" valign="middle" style="padding-right:7px;"><img src="../images/close-btn.png" width="25" height="25" onclick="javascript:self.parent.tb_remove();"/></td>
  </tr>
  <tr>
    ...
    <table width="670" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="100%" border="1" bordercolor="#6666FF" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
          ...
          <tr class="suc_msg">
			...
			$first_pay = $dbf->getDataFromTable("student_fees", "fee_date", "fee_date > '$cur_date' And student_id='$student_id' And course_id='$course_id' LIMIT 0,1");
			?>            
              <br />
              <?php echo $first_pay = $dbf->getDataFromTable("student_fees", "fee_date", "fee_date > '$cur_date' And student_id='$student_id' And course_id='$course_id' LIMIT 1,1"); } ?></td>
          </tr>
        </table>
        </td>
        </tr>
      ...
      <tr>
        ...
        <table width="100%" border="2" align="center" cellpadding="0" cellspacing="0" bordercolor="#6666FF" style="border-collapse:collapse;">
          ...
          <?php
			...
			?>
          <tr>
            <td height="25" align="right" valign="middle" class="text_structure"><?php if($vali["paid_amt"]!="0") { echo $vali["paid_amt"];}?>&nbsp;</td>
            <td class="text_structure" align="center"><?php echo $ptype[name]; ?></td>
            <td align="center" class="text_structure">&nbsp;</td>
          ...
          <tr>
            <td height="100" align="right" valign="middle" class="text_structure"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="30" align="center" valign="middle" class="smalltext"><?php echo $feeamt;?></td>
              </tr>
              <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td align="left" valign="middle" class="menutext"><?php echo $camt;?></td>
              ...
              <tr>
                ...
                <td align="left" valign="middle" class="menutext"><?php echo $feeamt;?></td>
              ...
              <tr>
                ...
                <td align="left" valign="middle" class="menutext"><?php echo $bal_amt;?></td>
	  ...
	  if($_REQUEST[fee_id] == '0'){
			$amt = $res_enroll["ob_amt"];
			$comm = $res_enroll["othertext"];
		}else{
		...
		?>
      <tr>
        <td height="30" colspan="5" align="right" valign="middle" class="chtext"><?php //echo "hu";?> : Note &nbsp;</td>
      </tr>      
      <tr>
