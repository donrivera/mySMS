...
if($_REQUEST['action']=='search'){
	...
	$string="other_amt='$_POST[otheramt]',ob_amt='$_POST[payment]',othertext='$_POST[othertext]',payment_type='$_POST[ptype]',web='$_POST[web]',discount='$_POST[discount]',payment_date='$dt',course_fee='$_POST[course_fee]'";
	...
	if($res_en[ob_amt] != $_POST[payment]){
		
		$string2="fld_name='Initial Payment',chg_from='$res_en[ob_amt]',chg_to='$_POST[payment]',by_user='$_SESSION[id]',date_time='$dt',student_id='$student_id',centre_id='$_SESSION[centre_id]',create_date='$c_date'";
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td colspan="2" rowspan="4" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td height="28" align="left" valign="middle" class="mytext"><input name="payment" type="text" class="new_textbox100" id="payment" value="<?php echo $res_enroll["ob_amt"];?>"  maxlength="20" onKeyPress="return isNumberKey(event);"/></td>
                      ...
                      <?php
						...
						if($res_enroll["ob_amt"]> 0 || $num_structure > 0){
						?>
                      <tr>
                        <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <table width="98%" border="2" bordercolor="#AAAAAA" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                          ...
                          <tr class="mytext">
                            ...
                            <td align="left" valign="middle" class="text_structure">&nbsp;&nbsp;<?php echo $res_enroll["payment_date"];?></td>
                            <td align="right" valign="middle" class="text_structure"><?php echo $res_enroll["ob_amt"];?>&nbsp;<?php echo $res_currency[symbol];?>&nbsp;&nbsp;</td>
                            <?php $ptype = $dbf->strRecordID("common","*","id='$res_enroll[payment_type]'"); ?>
                            <td class="text_structure" align="center"><?php echo $ptype[name]; ?></td>
                            <?php if($res_enroll["payment_date"]!="0000-00-00") { $dt = $res_enroll["payment_date"]; } ?>
                            <td align="center" class="text_structure"><?php echo $dt;?>&nbsp;&nbsp;</td>
                            <td align="right" class="text_structure"><?php echo $res_enroll["ob_amt"];?>&nbsp;<?php echo $res_currency[symbol];?>&nbsp;&nbsp;</td>
                            <td align="center" ><a href="search_print_challan_admission.php?course_id=<?php echo $_REQUEST[course_id];?>&amp;fee_id=0&amp;student_id=<?php echo $val_student["id"];?>&amp;page=search_print_challan_admission.php&amp;TB_iframe=true&amp;height=440&amp;width=675&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox "> <img src="../images/print.png" width="16" height="16" border="0" title="Print" /></a></td>
                            <td align="center" ><?php echo constant("RECENT_INITIAL_PAYMENT");?></td>
                          ...
                          <tr class="mytext">
                            ...
                            <td align="center" ><?php if($vali["paid_amt"]>0) { ?>
                              <a href="search_print_challan_admission.php?course_id=<?php echo $_REQUEST[course_id];?>&amp;fee_id=<?php echo $vali["id"];?>&amp;student_id=<?php echo $val_student["id"];?>&amp;page=search_print_challan_admission.php&amp;TB_iframe=true&amp;height=440&amp;width=675&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox"><img src="../images/print.png" width="16" height="16" border="0" title="Print" /></a>
                              <?php } ?></td>
                              <td align="center" >
								  <?php
                                      //Check fees amount = paid amt
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <table width="98%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="2%">&nbsp;</td>
                    <td width="18%" height="30" align="left" valign="middle"><?php echo $dbf->VVIP_Big_Icon($student_id);?></td>
                    <td width="37%">&nbsp;</td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td colspan="2" rowspan="4" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td height="28" align="left" valign="middle" class="mytext"><input name="payment" type="text" class="new_textbox100_ar" id="payment" value="<?php echo $res_enroll["ob_amt"];?>"  maxlength="20" onKeyPress="return isNumberKey(event);"/></td>
                            <td align="center" valign="middle">
                              <?php
							  $valno = $dbf->strRecordID("student_fees","MAX(id)","id <> (SELECT MAX(id) FROM student_fees WHERE student_id='$student_id') AND student_id='$student_id'");
							  $maxid = $valno["MAX(id)"];							  
                      ...
                      <tr>
                        ...
                        <td height="18" colspan="4" align="left" valign="top" class="leftmenu"><table width="98%" border="2" bordercolor="#AAAAAA" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                          ...
                          <tr class="mytext">
                            ...
                            <td align="center" class="text_structure"><?php echo $dt;?>&nbsp;&nbsp;</td>
                            <td align="right" class="text_structure"><?php echo $res_enroll["ob_amt"];?>&nbsp;<?php echo $res_currency[symbol];?>&nbsp;&nbsp;</td>
                            <td align="right" valign="middle" class="text_structure">&nbsp;&nbsp;<?php echo $res_enroll["payment_date"];?></td>
