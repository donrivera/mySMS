...
$res = $dbf->strRecordID("course","*","id='$_REQUEST[id]'");
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_COURSE_MANAGE_EDITCOURSE");?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="course_process.php?action=edit&amp;id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" onSubmit="return validate();">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><input name="code" type="text" readonly="" class="new_textbox190" id="code" value="<?php echo $res[code];?>" /></td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><textarea id="descr" name="descr" style="border:solid 1px; background-color:#ECF1FF; border-color:#999999; width:190px; height:100px;"><?php echo $res[descr];?></textarea></td>
                              <td>&nbsp;</td>
                              <td align="left" valign="middle">&nbsp;</td>
                            </tr>
                            <tr>
