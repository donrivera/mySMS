          ...
          <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <td colspan="2" align="left" valign="top"><table width="95%" border="1" cellspacing="0" cellpadding="0" bordercolor="#999" style="border-collapse:collapse;">
                  <tr>
              ...
              <tr>
                ...
                <td colspan="4" align="left" valign="top"><table width="97%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="27%" align="right" valign="middle" class="leftmenu"><?php echo $res_std[first_name]; ?><?php echo $Arabic->en2ar($dbf->StudentName($res_std["id"]));?></td>
