          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="12%" align="left" valign="middle" bgcolor="#DDDDDD" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_DATE");?></th>
                <th width="11%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_FROM");?></th>
                <th width="10%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_TO");?></th>
                <th width="9%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_NO");?></th>
                <th width="42%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
              ...
              <?php					
					...
					$group_from = $dbf->getDataFromTable("student_group","group_name","id='$transfer[from_id]'");
					
					$to_id = $dbf->getDataFromTable("student_group","group_name","id='$transfer[to_id]'");
					$group_to = $dbf->getDataFromTable("student_group","group_name","id='$transfer[to_id]'");
					?>
              <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                ...
                <td align="left" valign="middle" class="mycon" style="padding-left:2px;"><?php if($from_id != ''){?><?php echo $from_id;?> <?php echo $group_from["group_time"];?>-<?php echo $dbf->GetGroupTime($group_from["id"]);?><?php } ?></td>
                <td align="left" valign="middle" class="mycon" style="padding-left:2px;"><?php if($to_id != ''){?><?php echo $to_id;?> <?php echo $group_to["group_time"];?>-<?php echo $dbf->GetGroupTime($group_to["id"]);?><?php }?></td>
