...
<table width="675" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <img src="../images/close-btn.png" width="25" height="25" onclick="javascript:self.parent.tb_remove();"/></td>
  </tr>
  <tr>
    ...
    <table width="670" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
      <tr>
        ...
        <td width="206" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="center" valign="middle" class="hometest_name">Al Ahsa - Soudi Arabia</td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="30" colspan="5" align="center" valign="middle" class="chtext"><table width="650" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="375" align="left" valign="top"><table width="80%" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                <td height="30">&nbsp;</td>
                <td class="suc_msg"><?php echo $amt;?> /-</td>
              </tr>
              <tr>
                <td height="30">&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <td width="375"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="167" align="right" valign="middle" class="suc_msg"><?php echo $val["first_name"];?>&nbsp;/&nbsp;<?php echo $Arabic->en2ar($val["first_name"]);?><br />
              ...
              <tr>
                <td align="right" valign="middle" class="suc_msg"><?php echo $amt;?> /-</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td width="156" height="30" align="right" valign="middle" class="smalltext">Details / <?php echo $Arabic->en2ar('Details');?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
