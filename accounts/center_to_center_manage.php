          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="12%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_TO");?></th>
                <th width="13%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_TOGROUP");?></th>
                <th width="7%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_NO");?></th>
                <th width="20%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
              ...
              <?php					
					$i = 1;
					$color = "#ECECFF";
                    $num=$dbf->countRows('transfer_centre_to_centre',"","");
					
					foreach($dbf->fetchOrder('transfer_centre_to_centre',"","id DESC ","*") as $transfer){
					
					//No. of students has been transfer
					$dtls = $dbf->strRecordID("transfer_centre_to_centre_dtls","COUNT(id)","parent_id='$transfer[id]'");					
              ...
              <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                ...
                <td align="left" valign="middle" class="mycon" style="padding-left:2px;"><?php echo $from_id;?> <?php echo $from_group["group_time"];?>-<?php echo $dbf->GetGroupTime($from_group["id"]);?></td>
                <td align="left" valign="middle" class="mycon" style="padding-left:2px;"><?php echo $centre_to;?></td>
                <td align="left" valign="middle" class="mycon" style="padding-left:2px;"><?php echo $to_id;?> <?php echo $to_group["group_time"];?>-<?php echo $dbf->GetGroupTime($to_group["id"]);?></td>
