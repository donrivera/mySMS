              ...
              <tr>
                ...
                <td colspan="4" align="center" valign="top"><table width="99%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle" class="shop2"><?php echo $dbf->printStudentName($res_student["id"]);?></td>
              ...
              <tr>
                ...
                <td colspan="4" align="center" valign="top"><table width="99%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td align="right" valign="middle" class="shop2"><?php echo $dbf->printStudentName($res_student["id"]);?></td>
