        ...
        <td colspan="4" align="center" valign="middle"><table width="440" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="30" colspan="2" align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="71%" align="right" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:bold; font-size:12px;"> <?php echo $student["first_name"];?> <?php echo $dbf->printStudentName($student["id"]);?></td>
                <td width="1%">&nbsp;</td>
