              ...
              <tr>
                ...
                <table width="99%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  <tr class="pedtext">
                    ...
                    <td width="48%" align="left" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_GROUP");?></td>
                    <td width="17%" align="left" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_COURSE");?></td>
                    <td width="15%" align="left" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("ADMIN_REPORT_TEACHER_BOARD_TEACHERNAME");?></td>
                    <td width="10%" align="center" valign="middle" bgcolor="#CCCCCC"><?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?></td>
                    <td width="6%" align="center" valign="middle" bgcolor="#CCCCCC"><?php echo constant("RESULTS");?></td>
                  </tr>
                  <?php
				  $k = 1;
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                <td>&nbsp;</td>
                <td colspan="4" align="left" valign="top"><table width="99%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  <tr class="pedtext">
                    <td width="7%" align="center" valign="middle" bgcolor="#CCCCCC"><?php echo constant("RESULTS");?></td>
                    <td width="10%" align="center" valign="middle" bgcolor="#CCCCCC"><?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?></td>
                    <td width="13%" align="right" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("ADMIN_REPORT_TEACHER_BOARD_TEACHERNAME");?></td>
                    <td width="16%" align="right" valign="middle" bgcolor="#CCCCCC"><?php echo $Arabic->en2ar('Timing');?></td>
                    <td width="14%" align="right" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("ADMIN_REPORT_TEACHER_BOARD_GROUPSTARTDATE");?> / <?php echo constant("ADMIN_REPORT_TEACHER_BOARD_GROUPENDDATE");?></td>
                    <td width="15%" align="right" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("CENTER");?></td>
                    <td width="16%" align="right" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_GROUP");?> / <?php echo constant("STUDENT_ADVISOR_GROUP_COURSE");?></td>
                    <td width="9%" align="center" valign="middle" bgcolor="#CCCCCC"><?php echo constant("STUDENT_MYACCOUNT_SL");?></td>
                  </tr>
                  <?php
				  $k = 1;
				  foreach($dbf->fetchOrder('student_group_dtls',"student_id='$student_id'","","") as $dtls){
                  ...
                  <tr>
                    ...
                    <td align="center" valign="middle" class="shop2"><?php echo $group[group_time];?>-<?php echo $dbf->GetGroupTime($group["id"]);?></td>
                    <td align="center" valign="middle" class="shop2"><?php echo $group["start_date"]. ' / '. $group["end_date"];?></td>
                    <td align="right" valign="middle" class="shop2"><?php echo $dbf->getDataFromTable("centre","name","id='$group[centre_id]'");?></td>
                    <td align="right" valign="middle" class="shop2"><?php echo $group["group_name"].'  [ '.$dbf->getDataFromTable("course","name","id='$group[course_id]'").' ]';?></td>
