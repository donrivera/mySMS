...
include_once '../includes/language.php';
		if($_REQUEST['choice']=="alert_respose"){
			...
			$VALUE=$_POST['val']; 
				$_POST['pagenumber']=0; 				
				$totalcount=$dbf->countRows("alerts","ac='1' AND status='0' And imp='1' And id not in (select alert_id from alerts_read where user_id='$_SESSION[id]')");
				$perpage=1;
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			...
			<tr>
			  ...
			  <td align="center" valign="top">
			   <?php
				foreach($dbf->fetchOrder('alerts',"ac='1' AND status='0' And imp='1' And id not in (select alert_id from alerts_read where user_id='$_SESSION[id]')","dt DESC LIMIT $limitstart,$limitend") as $valalert) {
