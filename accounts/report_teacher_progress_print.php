...
?>	
<link href="../css/stylesheet_converter.css" rel="stylesheet" type="text/css" />
<body>
    ...
    <table width="1000" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#000000;">
          ...
          <tr>
            <td height="20" colspan="5" align="left" valign="middle" class="forgottext">&nbsp;<?php echo constant("CD_GROUP_PROGRESS_LONGTEXT");?></td>
            </tr>
          <tr>
          ...
          <tr>
            <td height="20" colspan="5" align="left" valign="middle" class="leftmenu"><table width="985" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="116" height="30" align="left" valign="top" class="smalltext">&nbsp;&nbsp;<u class="leftmenu"><?php echo constant("CD_GROUP_PROGRESS_SCORE");?></u></td>
                <td width="84" class="smalltext">&nbsp;</td>
                <td width="371" class="smalltext">&nbsp;</td>
                <td width="414">&nbsp;</td>
              </tr>
              <tr>
                <td height="35" align="left" valign="top" class="smalltext">&nbsp;<?php echo constant("CD_GROUP_PROGRESS_ATTENDACE");?></td>
                <?php
                ...
                <td align="left" valign="top" class="smalltext" style="text-align:justify;">
              ...
              <tr valign="top">
                <td height="35" align="left" class="smalltext">&nbsp;<?php echo constant("STUDENT_PROGRESS_REPORT_PARTICIPATION");?></td>
                <td align="center" class="smalltext"><?php echo $res_progress["course_partication"];?></td>
                <?php $res_comment = $dbf->strRecordID("comment","*","id='$res_progress[course_partication]' And type='Participation'"); ?>
                <td align="left" class="smalltext" style="text-align:justify;"><?php echo $res_comment[comment];?></td>
                </tr>
              <tr valign="top">
                <td height="35" align="left" class="smalltext">&nbsp;<?php echo constant("STUDENT_PROGRESS_REPORT_HOMEWORK");?></td>
                <td align="center" class="smalltext"><?php echo $res_progress["course_homework"];?></td>
                <?php $res_comment = $dbf->strRecordID("comment","*","id='$res_progress[course_homework]' And type='Homework'"); ?>
                <td align="left" class="smalltext" style="text-align:justify;"><?php echo $res_comment[comment];?></td>
                </tr>
              <tr valign="top">
                <td height="35" align="left" class="smalltext">&nbsp;<?php echo constant("STUDENT_PROGRESS_REPORT_FLUENCY");?></td>
                <td align="center" class="smalltext"><?php echo $res_progress["course_fluency"];?></td>
                <?php $res_comment = $dbf->strRecordID("comment","*","id='$res_progress[course_fluency]' And type='Fluency'"); ?>
                <td align="left" class="smalltext" style="text-align:justify;"><?php echo $res_comment[comment];?></td>
                </tr>
              <tr valign="top">
                <td height="35" align="left" class="smalltext">&nbsp;<?php echo constant("STUDENT_PROGRESS_REPORT_PRONUNCI");?></td>
                <td align="center" class="smalltext"><?php echo $res_progress["course_pro"];?></td>
                <?php $res_comment = $dbf->strRecordID("comment","*","id='$res_progress[course_pro]' And type='Pronunciation'"); ?>
                <td align="left" class="smalltext" style="text-align:justify;"><?php echo $res_comment[comment];?></td>
                </tr>
              <tr valign="top">
                <td height="35" align="left" class="smalltext">&nbsp;<?php echo constant("STUDENT_PROGRESS_REPORT_GRAMMAR");?></td>
                <td align="center" class="smalltext"><?php echo $res_progress["course_grammer"];?></td>
                <?php $res_comment = $dbf->strRecordID("comment","*","id='$res_progress[course_grammer]' And type='Grammer'"); ?>
                <td align="left" class="smalltext" style="text-align:justify;"><?php echo $res_comment[comment];?></td>
                </tr>
              <tr valign="top">
                <td height="35" align="left" class="smalltext">&nbsp;<?php echo constant("STUDENT_PROGRESS_REPORT_VOCABUL");?></td>
                <td align="center" class="smalltext"><?php echo $res_progress["course_voca"];?></td>
                <?php $res_comment = $dbf->strRecordID("comment","*","id='$res_progress[course_voca]' And type='Vocabulary'"); ?>
                <td align="left" class="smalltext" style="text-align:justify;"><?php echo $res_comment[comment];?></td>
                </tr>
              <tr valign="top">
                <td height="35" align="left" class="smalltext">&nbsp;<?php echo constant("CD_GROUP_PROGRESS_COMPREHENSION");?></td>
                <td align="center" class="smalltext"><?php echo $res_progress["course_listen"];?></td>
              ...
              <tr>
                <td height="25" align="left" valign="middle" class="smalltext">&nbsp;<?php echo constant("CD_GROUP_PROGRESS_OVERALL");?></td>
                <td align="center" valign="middle" class="smalltext"><?php echo $avg;?></td>
                <td align="left" valign="middle">&nbsp;</td>
                </tr>
              <tr>
          ...
          <tr>
            <td height="20" colspan="2" align="left" valign="middle" class="leftmenu"><table width="99%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="33%" align="left" valign="middle" class="smalltext"><?php echo constant("CD_GROUP_PROGRESS_VERYGOOD");?></td>
                <td width="57%" align="left" valign="middle" class="smalltext"><?php echo constant("CD_GROUP_PROGRESS_FAIR");?></td>
                <td width="10%">&nbsp;</td>
                </tr>
              <tr>
                <td align="left" valign="middle" class="smalltext"><?php echo constant("CD_GROUP_PROGRESS_GOOD");?></td>
                <td align="left" valign="middle" class="smalltext"><?php echo constant("CD_GROUP_PROGRESS_INSUFFICIENT");?></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td align="left" valign="middle" class="smalltext"><?php echo constant("CD_GROUP_PROGRESS_SATISFACTORY");?></td>
          ...
          <tr>
            <td height="20" colspan="5" align="left" valign="middle" class="smalltext">&nbsp;<?php echo constant("CD_REPORT_TEACHER_PROGRESS_LONGTEXT1");?></td>
            </tr>
          <tr>
            <td height="40" align="left" valign="middle" class="leftmenu">&nbsp;</td>
            <td class="pedtext">&nbsp;</td>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td align="right" valign="middle" class="smalltext"><?php echo date('m/d/Y');?></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td height="20" align="left" valign="middle" class="leftmenu">&nbsp;</td>
