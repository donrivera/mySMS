...
$html = '<table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999" style="border-collapse:collapse;">
		<tr>
		  ...
		  <th width="10%" align="left" valign="middle" ><span id="result_box" lang="ar" xml:lang="ar">'.ACCOUNTANT_NEW_EN.'</span></th>
		  ...
		  <th width="10%" align="center" bgcolor="#CCCCCC"><span id="result_box" lang="ar" xml:lang="ar">'.ACCOUNTANT_FROM_STUDENT.'</span></th>
		...
		$html.='<tr>
		  ...
		  <td align="right" valign="middle"><span id="result_box" lang="ar" xml:lang="ar">'.$dbf->getDiscountPercent($course_fees, $discount).'&nbsp;'.$res_currency["symbol"].'</span></td>
		  ...
		  <td align="left" valign="middle">'.$from_id.' '.$from_group["group_time"].'-'.$dbf->GetGroupTime($from_group["id"]).'</td>
		  <td align="left" valign="middle">'.$to_id.' '.$to_group["group_time"].'-'.$dbf->GetGroupTime($to_group["id"]).'</td>';
			  $i = $i + 1;			  
		  }
		$html.='</tr>               
	</table>';
