                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("RECEPTION_QUICKLINK_MANAGE_ADDTO_QUICKLINK");?></span></td>
                                  ...
                                  <tr>
                                    ...
                                    <td height="28" colspan="2" align="left" valign="middle" class="leftmenu">
                                      ...
                                      <table width="99%" border="0" cellspacing="0" bordercolor="#cccccc" cellpadding="0" style="border-collapse:collapse;">
                                        ...
                                        <?php
										$k = 0;
										foreach($dbf->fetchOrder('quick_menu',"module_name='Accountant'","id") as $qpage) {
									$num=$dbf->countRows('quick_links',"link_name='$qpage[link_name]' And module_name='Accountant' And user_id='$_SESSION[id]'");
										?>
