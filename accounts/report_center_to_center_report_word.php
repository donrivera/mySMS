...
header("Content-Disposition: attachment; Filename=report_center_to_center_report.doc");
...
<table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#999999" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
    ...
    <tr class="logintext">
      ...
      <th width="10%" align="center" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("ACCOUNTANT_FROM_CENTER");?></th>
      <th width="9%" align="center" valign="middle" bgcolor="#CCCCCC" class="pedtext"><?php echo constant("ACCOUNTANT_TO_CENTER");?></th>
      </tr>
    </thead>
    <?php
        $i = 1;
    ...
    <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
      ...
      <td align="right" valign="middle" class="mycon"><?php echo $dbf->getDiscountPercent($course_fees, $student_enroll["discount"]);?>&nbsp;<?php echo $res_currency[symbol];?></td>
