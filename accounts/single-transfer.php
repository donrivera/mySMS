          ...
          <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <thead>
                  <tr>
                    ...
                    <th width="15%" align="left" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_STUDENT");?></th>
              ...
              <?php					
					$i = 1;
					$color = "#ECECFF";					
					foreach($dbf->fetchOrder('transfer_student_to_student m,transfer_student_to_student_dtls d',"m.id=d.parent_id And d.student_id And d.student_id='$student_id'","m.id DESC ","m.*") as $transfer){
                  ...
                  <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                    ...
                    <a href="single-transfer.php?action=delete1&student_id=<?php echo $student_id;?>&del_id=<?php echo $transfer[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="Delete" /></a>
                    <?php } ?>
                    </td>
                    <?php
              ...
              <tr>
                ...
                <thead>
                  <tr>
                    ...
                    <th width="14%" align="left" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_STUDENT");?></th>
                  ...
                  <?php					
                        $i = 1;
                        $color = "#ECECFF";                        
                        foreach($dbf->fetchOrder('transfer_different_centre m,transfer_different_centre_dtls d',"m.id=d.parent_id And d.student_id='$student_id'","m.id DESC ","*") as $transfer){
                  ...
                  <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                    ...
                    <td align="center" valign="middle" >
                    <?php if($transfer["status"] == 'Pending'){?>
                    <a href="single-transfer.php?action=delete2&student_id=<?php echo $student_id;?>&del_id=<?php echo $transfer[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="Delete" /></a>
                    <?php } ?>
                    </td>
                    <?php
                        $i = $i + 1;
              ...
              <tr>
                ...
                <thead>
                  ...
                  <?php					
                        $i = 1;
                        $color = "#ECECFF";                        
                        foreach($dbf->fetchOrder('transfer_centre_to_centre m,transfer_centre_to_centre_dtls d',"m.id=d.parent_id And d.student_id='$student_id'","m.id DESC ","m.*") as $transfer){
                  ...
                  <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                    ...
                    <td align="center" valign="middle" >
                    <?php if($transfer["status"] == 'Pending'){?>
                    <a href="single-transfer.php?action=delete3&student_id=<?php echo $student_id;?>&del_id=<?php echo $transfer[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="Delete" /></a>
                    <?php } ?>
                    </td>
                    <?php
                        $i = $i + 1;
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <table width="95%" border="1" cellspacing="0" cellpadding="0" bordercolor="#999" style="border-collapse:collapse;">
                    ...
                    <tr>
                      <td width="63%" height="22" align="right" valign="middle" class="mytext"><?php echo $dbf->printStudentName($student["id"]);?></td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="left" valign="middle"><a href="single-student_to_student_add.php?student_id=<?php echo $student_id;?>">
                <input type="button" value="<?php echo constant("btn_add_btn");?>" class="btn2" border="0" align="left" />
                </a></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="left" class="pedtext" ><?php echo $Arabic->en2ar('Student - To-  Student Transfer');?></td>
              ...
              <tr>
                ...
                <thead>
                  <tr>
                    <th width="4%" align="center" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("COMMON_ACTION");?></th>
                    <th width="9%" align="center" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?></th>
                    <th width="26%" align="right" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
                    <th width="15%" align="right" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_STUDENT");?></th>
                    <th width="6%" align="center" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_NO");?></th>
                    <th width="15%" align="right" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_TOGROUP");?></th>
                    <th width="12%" align="right" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_FROMGROUP");?></th>
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="left" valign="middle"><a href="single-center_to_center_add.php?student_id=<?php echo $student_id;?>">
                <input type="button" value="<?php echo constant("btn_add_btn");?>" class="btn2" border="0" align="left" />
                </a></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="left" valign="middle" height="30" class="pedtext"><?php echo $Arabic->en2ar('Center - To - Center Transfer');?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td colspan="4" align="left" valign="top">
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="left" valign="middle"><a href="center_to_center_add.php?student_id=<?php echo $student_id;?>">
                <input type="button" value="<?php echo constant("btn_add_btn");?>" class="btn2" border="0" align="left" />
                </a></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
