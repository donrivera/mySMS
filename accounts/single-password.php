              ...
              <tr>
                ...
                <table width="70%" border="0" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#CCC;">
                  ...
                  <tr>
                    ...
                    <td height="28" align="left" valign="middle" class="leftmenu"><?php echo constant("ADMIN_PASSWORD_OLDPASSWORD");?> : <span class="nametext1">*</span></td>
                    <td>&nbsp;</td>
                    <td align="left" valign="middle"><input name="oldpassword" type="password" class="new_textbox190" id="oldpassword" size="45" minlength="4"/></td>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <table width="70%" border="0" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#CCC;">
                  <tr>
                    <td>&nbsp;</td>
                    <td width="23%" height="30" align="left" valign="middle"><?php if($_REQUEST['msg']=="added"){ ?>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td class="mymenutext"><?php echo constant("ADMIN_USER_MANAGE_PWDMSG");?></td>
                          </tr>
                  ...
                  <tr>
                    <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                    <td height="28" align="left" valign="middle"><input name="oldpassword" type="password" class="new_textbox190_ar" id="oldpassword" size="45" minlength="4"/></td>
                    <td>&nbsp;</td>
                    <td align="left" valign="middle" class="leftmenu">&nbsp;<span class="nametext1">*</span> : <?php echo constant("ADMIN_PASSWORD_OLDPASSWORD");?>&nbsp;</td>
                    <td align="left" valign="middle" class="red_smalltext" id="lbl1">&nbsp;</td>
                    </tr>
                  <tr>
                    <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
