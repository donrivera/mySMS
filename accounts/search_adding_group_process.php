...
if($num_student == 0){
	...
	$string="student_id='$student_id',fee_id='$course_fee_id',centre_id='$centre_id',group_id='$group',course_id='$course_id',status_id='4',created_by='$_SESSION[id]',enroll_date='$current_date',page_full_path='$_SERVER[REQUEST_URI]'";				
	...
	if($no_unit_finined > 0){
		...
		//Insert / Update the Advance amount as Opening amount in ENROLLED Table
		$string="student_id='$student_id',fee_id='$course_fee_id',centre_id='$centre_id',group_id='$group',course_id='$course_id',status_id='5',created_by='$_SESSION[id]',enroll_date='$current_date',page_full_path='$_SERVER[REQUEST_URI]'";				
		$dbf->insertSet("student_enroll",$string);
...
<script type="text/javascript">
	self.parent.location.href='single-group.php?student_id=<?php echo $student_id;?>';
