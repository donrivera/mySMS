                          ...
                          <tr>
                            ...
                            <table width="715" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                <td align="left" valign="middle">&nbsp;</td>
                                <td height="28" align="left" valign="middle">
                                  <input name="t1" type="text" class="new_textbox140_ar" id="t1" value="<?php echo $res_edit_student["family_name"];?>" onBlur="checkTab('t1');"/></td>
                                <td align="left" valign="middle">
                                  <input name="t2" type="text" class="new_textbox140_ar" id="t2" value="<?php echo $res_edit_student["grandfather_name"];?>" onBlur="checkTab('t2');"/></td>
                                <td align="left" valign="middle">
                                  <input name="t3" type="text" class="new_textbox140_ar" id="t3" value="<?php echo $res_edit_student["father_name"];?>" onBlur="checkTab('t3');"/></td>
                                <td align="left" valign="middle">
