        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="15%" height="30" align="left" class="logintext"><?php echo "Journals";?></td>
                <td width="20%">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="30%" align="right" valign="middle" class="logintext">Center : &nbsp;</td>
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablesorter" id="sort_table1" style="border-collapse:collapse;">
              <thead>
                <tr class="logintext">
                  ...
                  <th width="11%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo "Notes";?></th>
			     ...
			     $k=1;
					...
					<tr style="display:none;" id="<?php echo $val[id];?>">
						...
						//Get currency
							$color1="#ECECFF";
							$j=1;	
							$sql1=$dbf->genericQuery("SELECT * FROM acct_in_transactions WHERE transaction_id='$val[id]' ORDER BY id");
									...
									<tr bgcolor="<?php echo $color1;?>" onmouseover="this.bgColor='#FDE6D0'" onmouseout="this.bgColor='<?php echo $color1;?>'" style="cursor:pointer;">
										...
										<td height="25" align="center" valign="middle">
											<?php 
												...
												//$credit=$dbf->getDataFromTable("acct_chart_accounts","account_sign","account_number='".$valinv['account_number']."'");
												//echo ($credit=='C'?$valinv['amount']:"-");
												echo ($valinv['amount']<0?number_format(abs($valinv['amount']),2):"");
											?>
										</td>
										<td align="center" valign="middle">
											<?php 
												//$debit=$dbf->getDataFromTable("acct_chart_accounts","account_sign","account_number='".$valinv['account_number']."'");
												//echo ($debit=='D'?$valinv['amount']:"-");
												echo ($valinv['amount']>=0?$valinv['amount']:"");
											?>
										</td>
									</tr>
									<?php
                ...
                <tr>
				  ...
				  ?>
					...
					foreach($dbf->fetchOrder('student_group_dtls',"parent_id='$val[id]'","id") as $valinv){
						...
						if($is_student > 0){?>
                          <tr bgcolor="<?php echo $color1;?>" onmouseover="this.bgColor='#FDE6D0'" onmouseout="this.bgColor='<?php echo $color1;?>'" style="cursor:pointer;">
                            <td align="center" valign="middle"><?php echo $dbf->VVIP_Icon($valinv["id"]);?></td>
                            <td align="center" valign="middle">
