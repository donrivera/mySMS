...
//AUTO FORMAT TEXTBOX FOR TELEPHONE NUMBER
...
//Filter a file input field with limited allowed extension*******************************************************
function check(file,type){ 
if(!new RegExp('[^/].(?:'+type+')','i').test(file.value)){
var input = document.createElement('input');
input.type = file.type;
input.name = file.name;
input.onchange = new Function("check(this,'"+type+"')");
file.parentNode.replaceChild(input,file);
alert("Incorrect file type. Please use a "+type.replace(/\|/g,' or a ')+" file.");
return false;
}
}
//*****************************************************************************
