                      ...
                      <tr>
					   ...
					   ?>
						...
						?>
                            ...
                            <tr>
                              <td width="63%" height="25" align="left" valign="middle" class="pedtext"><?php echo constant("PAYMENT_DATE");?> :</td>
                              <td width="37%" align="left" valign="middle" class="mytext"><?php echo $res_std[payment_date]?></td>
                            </tr>
                            <tr>
                              <td height="25" align="left" valign="middle" class="pedtext"><?php echo constant("LAST_PAYMENT");?> :</td>
                              <td align="left" valign="middle" class="mytext"><?php echo $res_std[payment_date];?></td>
                            </tr>
                            <tr>
                              <td height="25" align="left" valign="middle" class="pedtext"><?php echo constant("CD_SEARCH_INVOICE_PAIDAMOUNT");?> :</td>
                              <td align="left" valign="middle" class="mytext"><?php echo $res_std[ob_amt];?>&nbsp;<?php echo $res_currency[symbol];?></td>
                            </tr>
                            <tr>
                              <td height="25" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_ENTRY_BY");?> :</td>
                              <td align="left" valign="middle" class="mytext"><?php
                      ...
                      <tr>
					   ...
					   ?>
						...
						?>
                          ...
                          <tr>
                            <td height="25" align="left" valign="middle" class="mytext"><?php echo $res_std[ob_amt];?>&nbsp;<?php echo $res_currency[symbol];?></td>
                            <td align="left" valign="middle" class="pedtext">&nbsp; : <?php echo constant("CD_SEARCH_INVOICE_PAIDAMOUNT");?></td>
                          </tr>
                          <tr>
