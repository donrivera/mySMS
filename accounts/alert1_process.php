...
if($_REQUEST['action']=='insert')
{
	...
	{
		$string="alert_id='$_POST[alert_id]',imp='$important',imp_info='$_POST[imp_info]',infor='$_POST[info]',dt='$_POST[date]',tm='$tm',created_datetime='$cr_date',created_by='$_SESSION[id]',centre_id='$_POST[centre_id]'";	
	}
