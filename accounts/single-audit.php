              ...
              <tr>
                ...
                <table width="90%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle" class="shop2"><?php echo $group["group_name"];?> <?php echo $group["group_time"];?>-<?php echo $dbf->GetGroupTime($group["id"]);?></td>
              ...
              <tr>
                ...
                <td colspan="4" align="left" valign="top"><table width="90%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td align="right" valign="middle" class="shop2"><?php echo $group["group_name"];?> <?php echo $group["group_time"];?>-<?php echo $dbf->GetGroupTime($group["id"]);?></td>
