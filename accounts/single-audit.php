            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <td height="60" align="left" valign="middle"><table width="90%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  ...
                  <?php
				  foreach($dbf->fetchOrder('student_moving',"student_id='$student_id'","id","") as $dtls){
              ...
              <tr>
                ...
                <table width="90%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  <tr class="pedtext">
                    ...
                    <td width="29%" align="left" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("STUDENT_ADVISOR_PED_GROUP");?></td>
                    <td width="17%" align="left" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("STATUS_CHANGED_BY");?></td>
                    <td width="8%" align="center" valign="middle" bgcolor="#CCCCCC"><?php echo constant("TEACHER_MY_GROUPS_STATUS");?></td>
                    </tr>
                  <?php
				  $k = 1;
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle" class="shop2"><?php echo $group["group_name"];?> <?php echo $group["group_start_time"]."-".$group["group_end_time"];?></td>
				  ...
				  ?>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      <tr>
                        ...
                        <td height="15" align="center" valign="middle" class="mytext">&nbsp;<?php echo $dbf->getDataFromTable("student_status","name","id='$dtls[id]'");?></td>
                      </tr>
                    </table>
                    </td>
					<?php } ?>
          ...
          <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="center"><table width="70%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  <tr class="pedtext">
                    <td width="6%" height="25" align="center" valign="middle" bgcolor="#CCCCCC"><?php echo constant("CURRENT_STATUS");?></td>
                  </tr>
                  <?php
				  ...
				  ?>
                  <tr>
                    <td height="22" align="center" valign="middle" class="mytext"><table width="80%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse; cursor:pointer;">
                        <tr>
                          <td width="75%" align="left" valign="middle">&nbsp;<?php echo $dbf->getDataFromTable("course","name","id='$dtls[course_id]'");?></td>
                          <td width="25%" align="center" valign="middle" bgcolor="<?php echo $color;?>">&nbsp;</td>
                        </tr>
                    </table></td>
                  </tr>
                  <?php } ?>
              ...
              <tr>
                ...
                <td colspan="4" align="left" valign="top"><table width="90%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td align="right" valign="middle" class="shop2"><?php echo $group["group_name"];?> <?php echo $group["group_start_time"]."-".$group["group_end_time"];?></td>
