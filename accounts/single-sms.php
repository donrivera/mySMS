...
if($_REQUEST["action"] == "sms_sent"){
	...
	if($dbf->countRows("sms_gateway","status='Enable'") > 0){
		...
		$string1="parent_id='$ids',student_id='$_REQUEST[student]'";
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                ?>
                  ...
                  <?php }?>
                  <tr>
                    <td height="30" align="center" valign="middle" class="pedtext"><a href="single-sms-details.php?student_id=<?php echo $_REQUEST["student_id"];?>&amp;TB_iframe=true&amp;height=480&amp;width=675&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox">View All SMS</a> which is sent to <span class="red_smalltext"><?php echo $dbf->printStudentName($student["id"]);?></span></td>
                  </tr> 
                  <?php if($is_disable == 0) {?>               
                  <tr>
                    <td align="center" valign="middle">
                  ...
                  <tr>
                    <td align="center" valign="middle">
                    <br>
                    <span class="pedtext"><a href="single-email-details.php?student_id=<?php echo $_REQUEST["student_id"];?>&amp;TB_iframe=true&amp;height=480&amp;width=675&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox"><!--View All Email--></a><!-- which is sent to--></span> <span class="red_smalltext"><?php echo $dbf->printStudentName($student["id"]);?></span>
                    <br>
                    <br>
                    ...
                    <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#ccc;">
                      <tr>
                        <td width="89" height="30" align="left" valign="middle" bgcolor="#FFFFFF" class="pedtext"><?php echo constant("MESSAGE_TO");?> :</td>
                        ...
                        <td width="72" align="left" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                      </tr>
                      <tr>
...
height:250,toolbar:[
        ...
        ['Undo','Redo'],['Font'],['FontSize'],['TextColor']]									
                      ...
                      <tr>
                        ...
                        <td width="346" bgcolor="#FFFFFF">&nbsp;</td>
              ...
              <tr>
                ...
                ?>
                  ...
                  <tr>
                    <td align="center" valign="middle">
                    <br>
                    <form action="single-sms.php?action=email_sent" name="frm2" method="post" id="frm2"  onSubmit="return validateemail();">
                    <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#ccc;">
                      <tr>
                        <td width="89" height="30" align="left" valign="middle" bgcolor="#FFFFFF" class="menutext">&nbsp;&nbsp;<?php echo constant("MESSAGE_TO");?> :</td>
                        <td colspan="2" bgcolor="#FFFFFF"><input name="sentto" type="text" readonly="" class="new_textbox190" id="sentto" value="<?php echo $student["email"];?>"/></td>
                        <td width="190" align="left" valign="middle" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                      <tr>
                        <td align="left" valign="middle" bgcolor="#FFFFFF" class="menutext">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_EMAIL_SUBJECT");?> :</td>
                        <td height="30" colspan="3" align="left" valign="middle" bgcolor="#FFFFFF"><input name="subject" type="text" id="subject" style="border:solid 1px; border-color:#FFCC00; text-align:right;width:400px;"></td>
						</tr>
                      <?php $res = $dbf->strRecordID("email_templete","*",""); ?>
                      <tr>
                        <td align="left" valign="top" bgcolor="#FFFFFF" class="menutext">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_EMAIL_MESSAGE");?> :</td>
                        <td colspan="3" align="left" valign="middle" bgcolor="#FFFFFF"><textarea name="content" id="content" ><?php echo $res["content"];?></textarea>
                          <script type="text/javascript">
							//<![CDATA[
