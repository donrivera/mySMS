...
<table width="100%" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">            
  <tr>
	...
	<td align="center" valign="middle" bgcolor="#DDDDDD" class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_GROUPSTARTDATE");?></td>
	<td align="center" valign="middle" bgcolor="#DDDDDD" class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_GROUPENDDATE");?></td>
	<td align="center" valign="middle" bgcolor="#DDDDDD" class="pedtext"><?php echo constant("TEACHER_MY_GROUPS_STATUS");?></td>
  </tr>
<?php
$color = "#ECECFF";
//Get Number of Rows
$num=$dbf->countRows('student_group',"centre_id='$_REQUEST[centre_id]' And course_id='$_REQUEST[course]'","");
 
//Loop start
foreach($dbf->fetchOrder('student_group',"centre_id='$_REQUEST[centre_id]' And course_id='$_REQUEST[course]'","id","") as $val){
...
?>
  ...
  <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'">
	...
	<td width="138" align="left" valign="middle"  class="mycon"><?php echo $val[group_name];?> <?php echo $val["group_time"];?>-<?php echo $dbf->GetGroupTime($val["id"]);?></td>
	<td width="143" align="center" valign="middle"  class="mycon"><?php echo $val_no["COUNT(id)"];?></td>
	<td width="123" align="center" valign="middle"  class="mycon"><?php echo date('m/d/Y',strtotime($val[start_date]));?></td>
	<td width="130" align="center" valign="middle"  class="mycon"><?php echo date('m/d/Y',strtotime($val[end_date]));?></td>
	<td width="96" align="center" valign="middle"  class="mycon"><?php echo $val[status];?></td>
  </tr>
<?php 
if($color=="#ECECFF")
	  {
