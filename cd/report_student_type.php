          ...
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <tr class="logintext">
				  ...
				  -->
                  <th width="16%" colspan="2" align="center" class="pedtext"><?php echo "Group Name";/*constant("ADMIN_REPORT_STUDENT_NOT_ENROLLED_INTRESTEDIN");*/?></th>
                </tr>
				</thead>
                <?php 
          ...
          <tr>
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                  ...
                  <td align="right" valign="middle" class="mycon" ><?php echo $val_student[first_name]."&nbsp;".$val_student[father_name]."&nbsp;".$val_student[family_name]."&nbsp;(".$val_student[first_name1]."&nbsp;".$val_student[father_name1]."&nbsp;".$val_student[grandfather_name1]."&nbsp;".$val_student[family_name1].")";?></td>
                  <td height="25" align="center" valign="middle" class="mycon"><?php echo $i;?></td>
                  <?php
					  $i = $i + 1;
					  if($color=="#ECECFF"){
