		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <table width="95%" border="1" cellspacing="0" cellpadding="0" bordercolor="#999" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td width="65%" align="left" valign="middle" class="mytext"><?php echo $student[first_name]."&nbsp;".$student[father_name]."&nbsp;".$student[family_name]."&nbsp;(".$student[first_name1]."&nbsp;".$student[father_name1]."&nbsp;".$student[grandfather_name1]."&nbsp;".$student[family_name1].")";?></td>
                  </tr>
                  <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="left" valign="top"><table width="99%" border="1" cellspacing="0" cellpadding="0" bordercolor="#999" style="border-collapse:collapse;">
                  <tr>
                  ...
                  <tr>
                    <td width="87%" height="22" align="right" valign="middle" class="pedtext"><?php echo constant("NO_OF_ENROLLED_COURSES");?> :</td>
                    <td width="13%" align="center" valign="middle" class="mytext"><?php echo $dbf->getDataFromTable("student_enroll","COUNT(id)","student_id='$student_id'");?></td>
                  </tr>
                  <tr>
              ...
              <tr>
                ...
                <td align="left" valign="top"><table width="95%" border="1" cellspacing="0" cellpadding="0" bordercolor="#999" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td width="84%" align="right" valign="middle" class="pedtext">&nbsp; : <?php echo constant("NO_OF_ENROLLED_COURSES");?>&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td align="right" valign="middle" class="pedtext">&nbsp; : <?php echo constant("NO_OF_COURSE_COMPLETED");?>&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td align="right" valign="middle" class="pedtext">&nbsp; : <?php echo constant("NO_OF_SMS_SENT");?>&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td align="right" valign="middle" class="pedtext">&nbsp; : <?php echo constant("NO_OF_CERTIFICATE_ISSUE");?>&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td align="right" valign="middle" class="pedtext">&nbsp; : <?php echo constant("TOTAL_NO_OF_LEAVE");?>&nbsp;</td>
                  </tr>
                </table></td>
                <td colspan="3" align="left" valign="top"><table width="97%" border="1" cellspacing="0" cellpadding="0" bordercolor="#999" style="border-collapse:collapse;">
                  <tr>
