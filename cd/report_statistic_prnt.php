...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#AAAAAA" style="border:solid 1px; border-color:#AAAAAA;">
  <tr>
    ...
    <td width="536" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#6a6868;font-weight:bold;" ><?php echo constant("ADMIN_REPORT_STATISTIC_TXT1");?> :&nbsp;
      <?php
  ...
  <tr>
    <td height="30"></td>
    <td style="font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#6a6868;font-weight:bold;"><?php echo constant("ADMIN_REPORT_STATISTIC_TXT2");?> :&nbsp;
      <?php
	         if($_REQUEST[startdate] !='' && $_REQUEST[enddate] !='')
			   {
  ...
  ?>
      <span style="font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#000000;padding-left:3px;"> <?php echo number_format($val_no_course['COUNT(course_id)'],0); ?></span>
      <?php } ?></td>
  </tr>
  <tr>
    <td height="30"></td>
    <td class="leftmenu"><table width="90%" border="1" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#AAAAAA;" bordercolor="#AAAAAA" >
      ...
      <tr class="pedtext">
        <td height="30" align="left" valign="middle" bgcolor="#CDCDCD" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#6a6868;font-weight:bold;">&nbsp;<?php echo constant("ADMIN_REPORT_STATISTIC_TXT4");?></td>
        <td align="left" valign="middle" bgcolor="#CDCDCD" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#6a6868;font-weight:bold;"><?php echo constant("ADMIN_REPORT_STATISTIC_STARTDAT");?> </td>
        <td align="left" valign="middle" bgcolor="#CDCDCD" style="font-family:Arial, Helvetica, sans-serif;font-size:14px;color:#6a6868;font-weight:bold;"><?php echo constant("CD_REPORT_GROUP_TO_FINIFH_PDF_DATA_ENDDATE");?></td>
      </tr>
      <tr>
        <td colspan="3" align="left" valign="middle" ><table width="100%" border="1" cellspacing="0" cellpadding="0">
          <?php
					   if($_REQUEST[startdate] !='' && $_REQUEST[enddate] !='')
						{
