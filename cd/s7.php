                      ...
                      <form action="s1_process.php?action=comment" name="frm" method="post" id="frm">
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                              <tr>
                                ...
                                <td width="48%" rowspan="5" align="left" valign="top" style="padding-top:60px;">
                          ...
                          <tr>
                            <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            <td width="23%" height="25" align="center" valign="middle" class="leftmenu"><a href="s_group.php"><input type="button" value="<?php echo constant("btn_back");?>" class="btn2" border="0" align="left" /></a></td>
                              ...
                              <tr>
                                <td align="center" valign="top" bgcolor="#EBEBEB">
                                  <form action="s1_process.php?action=comment" name="frm" method="post" id="frm">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                      <tr>
                                        <td width="53%" rowspan="5" align="left" valign="top" style="padding-top:60px;">
                                      ...
                                      <tr>
                                        ...
                                        <td height="28" colspan="2" align="center" valign="bottom" class="mycon"><?php echo constant("STUDENT_ADVISOR_S7_HTEXT");?></td>
