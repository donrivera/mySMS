...
<form id="frm" name="frm" method="post" action="student_from_another_center_process.php?action=update&tran_id=<?=$_REQUEST[tran_id];?>" onSubmit="return check()">
...
<form id="frm" name="frm" method="post" action="student_from_another_center_process.php?action=update&tran_id=<?=$_REQUEST[tran_id];?>" onSubmit="return check()">
  <table width="470" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 2px; border-color:#FF9900;">
    <tr>
      <td height="36" align="left" valign="middle" bgcolor="#FFA022" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="8%" align="center" valign="middle" class="leftmenu" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-weight:bold; font-size:12px;"><img src="../images/close-btn.png" width="25" height="25" onclick="javascript:self.parent.tb_remove();"/></td>
          <td width="68%">&nbsp;</td>
          <td width="24%" align="right" valign="middle"><img src="../logo/logo-ar.png" width="100" height="30" /></td>
        </tr>
        <tr>
          <td height="5" colspan="3" align="right" valign="middle"></td>
        </tr>
