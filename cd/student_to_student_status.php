...
$res_tran = $dbf->strRecordID("transfer_student_to_student", "*", "id='$_REQUEST[tran_id]'");
?>	
...
<form id="frm" name="frm" method="post" action="student_to_student_process.php?action=update&tran_id=<?=$_REQUEST[tran_id];?>" onSubmit="return check()">
...
<form id="frm" name="frm" method="post" action="student_to_student_process.php?action=update&tran_id=<?=$_REQUEST[tran_id];?>" onSubmit="return check()">
  <table width="470" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 2px; border-color:#FF9900;">
    <tr>
      <td height="36" align="left" valign="middle" bgcolor="#FFA022" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="64%" align="left" valign="middle" class="leftmenu" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-weight:bold; font-size:12px;"><img src="../images/close-btn.png" width="25" height="25" onclick="javascript:self.parent.tb_remove();"/></td>
          <td width="6%">&nbsp;</td>
          <td width="30%" align="center" valign="middle"><img src="../logo/logo-ar.png" width="100" height="30" /></td>
        </tr>
        <tr>
          <td height="5" colspan="3" align="right" valign="middle"></td>
        </tr>
    ...
    <tr>
      <td height="103" align="center" valign="top"><table width="440" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td colspan="2" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="65%" align="right" valign="middle" class="leftmenu">
			  <select name="status" class="combo" id="status" style="width:150px; border:solid 1px; border-color:#999999;background-color:#ECF1FF;">
              ...
              <td width="2%">&nbsp;</td>
<td width="33%" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:normal; font-size:12px;">&nbsp; : <?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?>              </td>
              </tr>
            <tr>
            ...
            <tr>
              <td align="right" valign="top" class="leftmenu">
              ...
              <td>&nbsp;</td>
              <td align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:normal; font-size:12px;">&nbsp; : <?php echo constant("RECEPTION_STUDENT_APPOINT_MANAGE_COMMENT");?></td>
            </tr>
            <tr>
              <td height="5" colspan="3" align="right" valign="middle"></td>
              </tr>
        ...
        <tr>
		  ...
		  <table width="97%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="89%" align="right" valign="middle" class="mytext"><?php echo constant("CD_STUDENT_STATUS_STANDARD_SMS");?></td>
              <td width="6%" align="center" valign="middle" class="mytext"><input name="sms" type="radio" id="radio" value="1" checked="checked" onchange="showsms(this.value)" /></td>
            </tr>
            <tr>
              <td align="center" valign="middle"></td>
              <td align="right" valign="middle" class="mytext"><?php echo constant("CD_STUDENT_STATUS_CANCEL_SMS");?></td>
              <td align="center" valign="middle" class="mytext"><input name="sms" type="radio" id="radio2" value="2" onchange="showsms(this.value)" /></td>
            </tr>
            <!--<tr>
            <td align="center" valign="middle"><input name="sms" type="radio" id="radio3" value="3" onChange="showsms(this.value)"></td>
            <td align="left" valign="middle" class="mytext">Change SMS</td>
            ...
            <tr>
              ...
              <?php
				$sms_cont = $dbf->getDataFromTable("sms_templete","contents","id='16'");
				?>
              <td align="right" valign="middle" class="mytext"><table width="97%" border="0" cellspacing="0" cellpadding="0" id="smsid" style="display:none;">
                <tr>
                  <td align="left" valign="middle"><textarea name="contents" id="contents" style="width:400px; height:30px; border:solid 1px; border-color:#999999;background-color:#ECF1FF;" autocomplete="off"><?php echo $sms_cont;?></textarea></td>
                </tr>
              </table></td>
