            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <td>&nbsp;</td>
                ...
                <table width="99%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  <tr class="pedtext">
                    <td width="12%" align="center" bgcolor="#CCCCCC"><?php echo constant("SA_REQUEST_DATE");?></td>
                    <td width="14%" align="center" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_GROUP");?></td>
                    <td width="17%" align="center" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_COURSE");?></td>
                    <td width="17%" align="center" bgcolor="#CCCCCC"><?php echo constant("ADMIN_TEACHER1_MANAGE_MOBILE");?></td>
                    <td width="12%" align="center" bgcolor="#CCCCCC"><?php echo constant("SA_REASON_FOR_CANCEL");?></td>
                    <td width="14%" align="center" bgcolor="#CCCCCC"><?php echo constant("SA_CD_CANCEL_STATUS");?></td>
                    <td width="14%" align="center" bgcolor="#CCCCCC"><?php echo constant("SA_ADMIN_CANCEL_STATUS");?></td>
                  </tr>
                  <?php
              ...
              <tr>
                ...
                <table width="99%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  <tr class="pedtext">
                    ...
                    <td width="16%" align="center" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_GROUP");?></td>
                    <td width="17%" align="center" valign="middle" bgcolor="#CCCCCC">&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_COURSE");?></td>
                    <td width="17%" align="center" bgcolor="#CCCCCC"><?php echo constant("ADMIN_TEACHER1_MANAGE_MOBILE");?></td>
                    <td width="12%" align="center" bgcolor="#CCCCCC"><?php echo constant("SA_REASON_FOR_CANCEL");?></td>
                    <td width="13%" align="center" bgcolor="#CCCCCC"><?php echo constant("SA_CD_CANCEL_STATUS");?></td>
                    <td width="15%" align="center" bgcolor="#CCCCCC"><?php echo constant("SA_ADMIN_CANCEL_STATUS");?></td>
                    <td width="10%" align="center" bgcolor="#CCCCCC"><?php echo constant("SA_REQUEST_DATE");?></td>
                  </tr>
                  <?php
				  	 $num=$dbf->countRows("student_cancel","student_id='$student_id'");
				  	  foreach($dbf->fetchOrder("student_cancel","student_id='$student_id'") as $valcancel) {
