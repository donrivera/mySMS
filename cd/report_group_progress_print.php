  ...
  <tr>
    <td colspan="3" align="left" valign="middle" bgcolor="#FFFFFF"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#000000;">
      ...
      <tr>
        ...
        <td align="left" valign="middle" class="pedtext_normal"><?php if($res_g[start_date]!='0000-00-00') { echo date("d/m/Y",strtotime($res_g[start_date]));}?></td>
        <td>&nbsp;</td>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="41%" height="20" align="left" valign="middle" class="leftmenu"><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_ENDDATE");?>: </td>
            <td width="59%" align="left" valign="middle" class="pedtext_normal" ><?php if($res_g[end_date]!='0000-00-00') {echo date("d/m/Y",strtotime($res_g[end_date]));}?></td>
          </tr>
        </table></td>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        <td height="20" colspan="5" align="left" valign="middle" class="leftmenu"><table width="988" border="0" cellspacing="0" cellpadding="0">
          <tr>
          ...
          <tr>
            ...
            <td width="82" align="left" valign="middle" bgcolor="#F5F5F5" class="pedtext_normal" style="border-left:solid 1px; border-color:#000000;"><?php echo constant("CD_GROUP_PROGRESS_ATTENDACE");?></td>
          </tr>
          <tr>
            <td height="1" colspan="10" align="left" valign="middle" bgcolor="#000000"></td>
          </tr>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td align="right" valign="middle" class="shop2"><?php echo date('m/d/Y');?></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="20" align="left" valign="middle" class="leftmenu">&nbsp;</td>
