...
$teacher_id = $_REQUEST["teacher_id"];#$_SESSION[uid];
?>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="30" bgcolor="#FFA938" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="30%" class="footertext">&nbsp;<?php echo "Class Extend";?></td>
                  <td width="70%" align="right" valign="middle">
					<!--
					<a href="arf_manage.php"> 
                          ...
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                              <tr>
                                ...
                                <form action="cer_process.php?action=edit" name="frm" method="post" id="frm">
									<?php
										$res_cer = $dbf->strRecordID("cer","*","id='$_REQUEST[id]'");
										#$user = $dbf->strRecordID("user","user_type,user_name","id='$_SESSION[id]'");
									?>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-color:#CCCCCC;">
								  ...
								  <tr>
                                    ...
                                    <td class="leftmenu">
                                    <select name="status" id="status" onChange="show_group();" style="border:1px solid #999;font-size:14px;color:#000;background:#ECF1FF;padding:2px; width:192px;" disabled>
                                  ...
                                  <tr>
                                    ...
                                    <td class="leftmenu" align="left" id="lblgroup">
                                      <select name="group_id" id="group_id"  style="border:1px solid #999;font-size:14px;color:#000;background:#ECF1FF;padding:2px; width:350px;" disabled><!--onChange="show_student();"-->
								  ...
								  <tr>
                                    <td width="63">&nbsp;</td>
                                    <td width="115" height="30" align="left" valign="middle" class="leftmenu"><?php echo "Units";?> : <span class="nametext1">*</span></td>
                                    <td width="202" class="leftmenu">
                                      <input type="text" name="units" id="units" onKeyPress="return isNumberKey(event);" value="<?php echo $res_cer['units'];?>" readonly="readonly"/>
                                    </td>
                                    <td width="16">&nbsp;</td>
                                    <td width="74">&nbsp;</td>
                                    <td width="196">&nbsp;</td>
								  ...
								  <tr>
									<td width="63">&nbsp;</td>
                                    <td width="115" height="30" align="left" valign="middle" class="leftmenu"><?php echo "Reason";?> : <span class="nametext1">*</span></td>
                                    <td width="202" class="leftmenu">
                                      <textarea name="remarks" cols="40" rows="10" readonly><?php echo $res_cer['remarks'];?></textarea>
                                    </td>
                                    <td width="16">&nbsp;</td>
                                    <td width="74">&nbsp;</td>
                                    <td width="196">&nbsp;</td>
									...
									<tr>
									<td width="63">&nbsp;</td>
                                    <td width="115" height="30" align="left" valign="middle" class="leftmenu"><?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?> : <span class="nametext1">*</span></td>
                                    <td width="202" class="leftmenu">
								...
								<input type="hidden" name="record_id" value="<?php echo $res_cer["id"];?>">
								<input type="hidden" name="group_id" value="<?php echo $res_cer[group_id];?>">
                                </form></td>
                          </tr>
                        </table></td>
                      </tr>
