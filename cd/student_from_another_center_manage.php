        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" align="left" class="logintext"><?php echo constant("DIFFERENT_CENTER");?></td>
                <td width="22%">&nbsp;</td>
          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="10%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_FROMGROUP");?></th>
                ...
                <th width="6%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("COMMON_ACTION");?></th>
                </tr>
			  </thead>
              <?php
					$i = 1;
                    ...
                    $num=$dbf->countRows('transfer_different_centre',"status='Approved' And centre_to='$_SESSION[centre_id]' And ".$cond,"");					
					foreach($dbf->fetchOrder('transfer_different_centre',"status='Approved' And centre_to='$_SESSION[centre_id]' And ".$cond,"id DESC ","*") as $transfer){
              ...
              <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                ...
                <td align="center" valign="middle" class="mycon" ><?php echo $transfer[final_status];?></td>
                <td align="center" valign="middle" >
                <?php if($transfer["final_status"] == ''){?>
                <a href="student_from_another_center_status.php?tran_id=<?php echo $transfer["id"];?>&page=student_from_another_center_status.php&amp;TB_iframe=true&amp;height=300&amp;width=465&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox "><img src="../images/change_status2.png" width="16" height="16" border="0" title="Set Status" /></a>
                <a href="student_to_student_process.php?action=delete&amp;del_id=<?php echo $transfer[id];?>"  class="linktext" ></a>
                <?php } if($transfer["final_status"] == 'Rejected'){?><img src="../images/change_status2.png" width="16" height="16" border="0" title="Rejected" />
                <?php } if($transfer["final_status"] == 'Approved'){?><img src="../images/tickbox.png" width="16" height="16" border="0" title="Approved" />
                <?php } ?>
                </td>
                <?php
                    ...
                    <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#000000" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                      <thead>
                        <tr class="logintext">
                          ...
                          <th width="8%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:20px;"><?php echo constant("CD_STUDENT_CENTER_FROM");?></th>
