          ...
          <tr>
			...
			<thead>
              ...
              <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onclick="javascript:window.location.href='student_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                ...
                <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><a href="student_edit.php?id=<?php echo $val[id];?>" style="cursor:pointer;"><?php echo $val[first_name]."&nbsp;".$val[father_name]."&nbsp;".$val[family_name]."&nbsp;(".$val[first_name1]."&nbsp;".$val[father_name1]."&nbsp;".$val[grandfather_name1]."&nbsp;".$val[family_name1].")";?></a></td>
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#000000" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                  <thead>
                    <tr class="logintext">
                      ...
                      <th width="15%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("STUDENT_ADVISOR_STUDENT_MANAGE_STUDENTMOBNO");?></th>
                      <th width="41%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("STUDENT_ADVISOR_STUDENT_MANAGE_ENQUIREDABOUT");?></th>
                      <th width="15%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("STUDENT_ADVISOR_STUDENT_MANAGE_ENQUIREFROM");?></th>
                      <th width="15%" align="right" valign="middle" bgcolor="#DDDDDD" class="pedtext" style="padding-right:25px;"><?php echo constant("STUDENT_ADVISOR_STUDENT_MANAGE_STUDENTNAME");?></th>
                  ...
                  <tr bgcolor="<?php echo $color;?>"  onmouseover="this.bgColor='#FDE6D0'" onmouseout="this.bgColor='<?php echo $color;?>'" onclick="javascript:window.location.href='student_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                     <?php
                      $numg=$dbf->countRows('student_group_dtls',"student_id='$val[id]'");
                      ?>
                    <td width="5%" align="center" valign="middle"><a href="student_edit.php?id=<?php echo $val[id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="<?php echo EDIT?>" /></a></td>
