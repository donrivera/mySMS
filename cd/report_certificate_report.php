    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" height="25" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>&nbsp;</td>
              <td width="36" align="center" valign="middle"><a href="report_certificate_report_word.php?cmbgroup=<?php echo $_REQUEST[cmbgroup];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="Export to Word"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_certificate_report_csv.php?cmbgroup=<?php echo $_REQUEST[cmbgroup];?>"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="Export to Excel"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_certificate_report_pdf.php?cmbgroup=<?php echo $_REQUEST[cmbgroup];?>"><img src="../images/pdf.png" width="20" height="20" border="0" title="Export to PDF"></a></td>
              <td width="36" align="center" valign="middle"><a href=" report_certificate_report_print.php?cmbgroup=<?php echo $_REQUEST[cmbgroup];?>" target="_blank"><img src="../images/print.png" alt="" width="16" height="16" border="0" title="Print"></a></td>
            </tr>
        </table></td>
      </tr>
    </table></td>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="25%" height="30" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_CERTIFICATE");?></td>
                  <td width="10%" align="right" class="logintext">Status : &nbsp;</td>
          ...
          <tr>
			...
			<thead>
                <tr class="logintext">
                  ...
                  <th width="20%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_GROUPNAME");?></th>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" height="25" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>&nbsp;</td>
              <td width="36" align="center" valign="middle"><a href="report_certificate_report_word.php?group=<?php echo $_REQUEST[group];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="Export to Word"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_certificate_report_csv.php?group=<?php echo $_REQUEST[group];?>"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="Export to Excel"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_certificate_report_pdf.php?group=<?php echo $_REQUEST[group];?>"><img src="../images/pdf.png" width="20" height="20" border="0" title="Export to PDF"></a></td>
              <td width="36" align="center" valign="middle"><a href=" report_certificate_report_print.php?group=<?php echo $_REQUEST[group];?>" target="_blank"><img src="../images/print.png" alt="" width="16" height="16" border="0" title="Print"></a></td>
            </tr>
        </table></td>
      </tr>
    </table></td>
                    ...
                    <tr>
                      <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                        <tr class="logintext">
                          ...
                          <td width="31%" align="right">
                            <select name="group" id="group" style="border:solid 1px; border-color:#FFCC33; height:20px; width:210px;"  onChange="javascript:document.frm.action='report_certificate_report.php',document.frm.submit();">
                              ...
                              <?php
								foreach($dbf->fetchOrder('student_group',"centre_id='$_SESSION[centre_id]'","") as $val) {	
							  ?>
                              <option value="<?php echo $val[id];?>" <?php if($_REQUEST[group]==$val[id]){?> selected="selected"<?php }?>><?php echo $val['group_name'] ?>, <?php echo date('d/m/Y',strtotime($val['start_date']));?> - <?php echo date('d/m/Y',strtotime($val['end_date'])) ?>, <?php echo $val["group_time"];?>-<?php echo $dbf->GetGroupTime($val["id"]);?>
</option>
                              <?php
							   }
							   ?>
                          ...
                          <td width="8%" align="left">&nbsp;</td>
                          <td width="43%" height="30" class="headingtext" align="right"><img src="../images/arrow_small_right4.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?> <img src="../images/arrow_small_right2.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_CERTIFICATE");?></td>
                          </tr>
                        </table></td>
                      </tr>
                    <tr>
                      <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                        <thead>
                          <tr class="logintext">
                            ...
                            <th width="20%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_GROUPNAME");?></th>
