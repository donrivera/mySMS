              ...
              <tr>
                <td align="center" valign="top" bgcolor="#FFFFFF"><table width="300" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#66CC66;">
                    <tr>
                      ...
                      <td width="253" align="left" valign="middle" bgcolor="#EAFDEB" class="lable2"><?php echo constant("STUDENT_ADVISOR_S4_TXT1");?></td>
                    </tr>
                </table></td>
              </tr>
              <?php } ?>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" align="left" valign="middle" class="logintext" style="background:url(../images/left_mid_bg.png) repeat-x;"><?php echo constant("STUDENT_ADVISOR_S4_EMAILADDRESS");?>&nbsp;</td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="s1_process.php?action=email" name="frm" method="post" id="frm">
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          <tr>
                            ...
                            <td width="1%">&nbsp;</td>
                            <td width="28%">&nbsp;</td>
                            <td width="49%" rowspan="8" align="left" valign="top" style="padding-top:3px;">
                              <br>
                          ...
                          <tr>
                            ...
                            <td height="28" colspan="3" align="left" valign="middle" class="leftmenu"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="9%" align="center" valign="middle" class="shop2">40%</td>
                              </tr>
                            </table></td>
                            </tr>
                          <tr>
                          ...
                          <tr>
                            <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            <td height="25" align="center" valign="middle" class="leftmenu"><a href="s3.php"><input type="button" value="<?php echo constant("btn_back");?>" class="btn2" border="0" align="left" /></a></td>
                            <td>&nbsp;</td>
                            <td align="left" valign="middle">&nbsp;</td>
                        ...
                        <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                                <td width="100%" align="right" valign="middle" class="logintext" style="background:url(../images/left_mid_bg.png) repeat-x;"><?php echo constant("STUDENT_ADVISOR_S4_EMAILADDRESS");?>&nbsp;</td>
                                <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                                </tr>
                              </table></td>
                            </tr>
                            ...
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                              <tr>
                                ...
                                <form action="s1_process.php?action=email" name="frm" method="post" id="frm">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                      <tr>
                                        <td width="49%" rowspan="8" align="right" valign="top" style="padding-top:3px;">
                                          <br>
                                          <table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px #B6B6B6; background:url(../images/bg.png) repeat-x; ">
                                            <tr>
                                              <td align="left" valign="middle">&nbsp;</td>
                                              </tr>
                                            <tr>
                                      ...
                                      <tr>
                                        <td width="25%" height="28" align="right" valign="middle" class="leftmenu"><input name="email" type="text" class="validate[required,custom[email]] new_textbox190_ar" id="email" value="<?php echo $_SESSION[email] ;?>" onBlur="checkTab('email');"/></td>
                                        
                                         <td>&nbsp;</td>
                                        <td width="23%" align="left" valign="middle"><span class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("STUDENT_ADVISOR_S4_EMAILADDRESS");?></span></td>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left" valign="middle">&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td height="25" align="center" valign="middle" class="leftmenu"><a href="s3.php"><input type="button" value="<?php echo constant("btn_back");?>" class="btn1" border="0" align="left" /></a></td>
                                        <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                        </tr>
                                      <tr>
                                        <td height="10" colspan="5" align="left" valign="middle"></td>
