      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#000000;">
          ...
          <tr>
            ...
            <td align="left" valign="middle" class="pedtext_normal">
            <?php if($_REQUEST["cmbgroup"] != ""){
            		if($res_g[start_date]!='0000-00-00') { echo date("d/m/Y",strtotime($res_g[start_date]));}
			}
			?>
            </td>
            <td>&nbsp;</td>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <?php if($_REQUEST["cmbgroup"] != ""){
						if($res_g[end_date]!='0000-00-00') {echo date("d/m/Y",strtotime($res_g[end_date]));}
				}
				?></td>
                </tr>
              </table></td>
    ...
    <table width="1000" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="250" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
          ...
          <tr>
            ...
            <select name="group_id" class="" id="group_id" style="width:150px; border:solid 1px; border-color:#999999;" onChange="setsubmit();">
			  ...
			  foreach($dbf->fetchOrder('student_group',"centre_id='$_SESSION[centre_id]'".$cond,"","") as $res_group) {
			  ?>
              <option value="<?php echo $res_group['id'];?>" <?php if($_REQUEST[group_id]==$res_group["id"]) { ?> selected="selected" <?php } ?>><?php echo $res_group['group_name'] ?>, <?php echo date('d/m/Y',strtotime($res_group['start_date']));?> - <?php echo date('d/m/Y',strtotime($res_group['end_date'])) ?>, <?php echo $res_group["group_time"];?>-<?php echo $dbf->GetGroupTime($res_group["id"]);?>
</option>
              <?php } ?>
            </select></td>
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#000000;">
		  ...
		  ?>
          <tr>
            <td height="20" align="right" valign="middle" class="shop2">
			<?php if($_REQUEST["cmbgroup"] != ""){?>
			<?php echo $res_g[group_name];?> <?php echo $res_g["group_time"];?>-<?php echo $dbf->GetGroupTime($res_g["id"]);?>&nbsp;
            <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="59%" align="right" valign="middle" class="shop2" >
                <?php if($_REQUEST["cmbgroup"] != ""){
						if($res_g[end_date]!='0000-00-00') {echo date("d/m/Y",strtotime($res_g[end_date]));}
				}
				?>&nbsp;</td>
          ...
          <tr>
            ...
            <table width="988" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="30" colspan="10" align="right" valign="middle">&nbsp;&nbsp;<u class="leftmenu"><?php echo constant("CD_GROUP_PROGRESS_SCORE");?></u></td>
                </tr>
              <tr>
                <td height="1" colspan="10" align="left" valign="middle" bgcolor="#000000"></td>
                </tr>
