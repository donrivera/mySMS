		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="35%" height="30" align="left" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_SCHEDULE_TEACHERSSCHEDULE");?></td>
          ...
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table1" style="border-collapse:collapse;">
                ...
                <tr class="logintext">
                  ...
                  <th width="20%" height="25" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_CURRENTGROUP");?></span></th>
                  <th width="18%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_GROUPSTARTDATE");?></span></th>
                  <th width="19%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_GROUPENDDATE");?></span></th>
                  <th width="17%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_NUMBEROFSTUD");?></span></th>
                  <th width="15%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_CLASSROOM");?></span></th>
                  </tr>
				</thead>
                <?php
					if($_REQUEST[teacher]!=''){
                        ...
                        <tr class="logintext">
                          ...
                          <td width="51%" align="right">
							...
							<?php
                              ...
                              <td width="12%" align="left" class="headingtext"> : &nbsp;<?php echo constant("ADMIN_REPORT_TEACHER_SCHEDULE_SELECTTEACHER");?></td>
                          <td width="1%" align="left">&nbsp; </td>
                          <td width="1%" align="left">&nbsp;</td>
                           <td width="35%" height="30" align="right" class="headingtext"><img src="../images/arrow_small_right4.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?><img src="../images/arrow_small_right2.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_SCHEDULE_TEACHERSSCHEDULE");?></td>
                          </tr>
                        </table></td>
                      </tr>
                    <tr>
