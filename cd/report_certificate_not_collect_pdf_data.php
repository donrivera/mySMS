...
<thead>
  ...
  <?php
    ...
    if($_REQUEST[start_date]!='' && $_REQUEST[end_date]!=''){
        $cond="certificate_collect='0' And (enroll_date BETWEEN '$_REQUEST[start_date]' And '$_REQUEST[end_date]') And centre_id='$_REQUEST[centre_id]'";
    }else{
        $cond="certificate_collect='0' And centre_id='$_REQUEST[centre_id]'";
    }
