              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                  <tr>
                    ...
                    <form action="s1_process.php?action=edit_payment&ids=<?=$_REQUEST[ids];?>&amp;schid=<?=$_REQUEST[schid];?>&course_id=<?=$_REQUEST[course_id];?>" name="frm" method="post" id="frm" onSubmit="return validate();">
                      <?php
                      ...
                      <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                        ...
                        <tr>
                          ...
                          <td colspan="4" align="left" valign="middle"><table width="97%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
                            ...
                            <tr>
                              <td width="23%" height="28" align="right" valign="middle"><span class="leftmenu">&nbsp;<?php echo constant("STUDENT_MYACCOUNT_PAYMENTDATE");?> :</span></td>
                              ...
                              <td width="39%" rowspan="3" align="center" valign="middle">&nbsp;</td>
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="4" align="left" valign="middle"><table width="97%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
                                      ...
                                      <tr>
                                        ...
                                        <td width="40%" rowspan="3" align="center" valign="middle">&nbsp;</td>
                                        </tr>
                                      <tr>
                                        <td height="28" align="right" valign="middle"><span class="leftmenu">&nbsp;<?php echo constant("CD_SEARCH_INVOICE_FEES");?> :</span></td>
                                        <td align="left" valign="middle">
