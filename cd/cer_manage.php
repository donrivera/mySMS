        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="headingtext"><h1><?php echo constant("TEACHER_CER_MANAGE");?></h1></td>
                <td width="22%">&nbsp;</td>
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left"></td>
                <td width="8%" align="left"><a href="cer_add.php">
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bordercolor="#000000" class="tablesorter" id="sort_table">
                  <thead>
                    <tr class="logintext">
                      ...
                      <th width="11%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("TEACHER_CER_DATE");?></th>
                      <th width="23%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("TEACHER_CER_GROUP");?></th>
                      <!--<th width="18%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("TEACHER_CER_DTL");?></th>-->
                      <th width="15%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("TEACHER_CER_UNIT");?></th>
                      <th width="15%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("TEACHER_CER_APPROVED");?></th>
					  <th width="15%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("TEACHER_CER_STATUS");?></th>
					  <th width="10%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("COMMON_ACTION");?></th>
                    </tr>
                  </thead>
                  <?php
				  $i = 1;
                  ...
                  <tr bgcolor="<?php echo $color;?>" onmouseover="this.bgColor='#FDE6D0'" onmouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                    ...
                    <td align="left" valign="middle" class="contenttext" style="padding-left:5px;"><?php echo $val[date_added];?></td>
                    <td align="left" valign="middle" class="contenttext" style="padding-left:5px;"><?php echo $dbf->FullGroupInfo($val[group_id]);?></td>
                    <!--<td align="left" valign="middle" class="contenttext" style="padding-left:5px;"><?php echo $dbf->getDataFromTable("teacher","name","id='$val[teacher_id]'");?></td>-->
                    ...
                    <a href="cer_edit.php?id=<?php echo $val["id"];?>&amp;teacher_id=<?php echo $val["teacher_id"];?>"><img src="../images/edit_icon.png" width="16" height="16" border="0" title="Click here to change the Status" /></a>
                    <?php } ?>
					</td>
                    <?php
					  $i = $i + 1;
