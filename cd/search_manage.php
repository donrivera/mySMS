                        ...
                        <tr>
                          ...
                          <?php
                            if($val_student["photo"]!=''){
                                $photo = "../sa/photo/".$val_student["photo"];
                            }else{
                        ...
                        <tr>
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#EBEBEB">
                            <tr>
                              ...
                              <td width="19%" height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("STUDENT_ADVISOR_SEARCH_MANAGE_LEVELCOMPL");?> :</td>
                              <td width="1%">&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td colspan="2" rowspan="4" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="9%" align="left" valign="middle" class="mycon"><?php echo $res_currency[symbol];?></td>
                                ...
                                <?php
								$opening_amt = $dbf->getDataFromTable('student_fees',"paid_amt","course_id='$course_id' And student_id='$student_id' And (type='advance') And invoice_sl LIKE '$enroll_dtl%'");
                            ...
                            <tr>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="19%" align="right" valign="middle" class="leftmenu"><?php echo constant("NOTE_FOR_INVOICE");?> : &nbsp;</td>
                                  <td width="81%" align="left" valign="middle" style="padding-left:4px;"><input name="note" class="new_textbox690" type="text" id="note" value="<?php echo $res_enroll["invoice_note"];?>" /></td>
                                </tr>
                              </table></td>
                            </tr>
							 <tr>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
									<td width="19%" align="right" valign="middle" class="leftmenu">
								  
									</td>
									<td width="81%" align="left" valign="middle" style="padding-left:4px;">
									<?php
                            ...
                            <tr>
                              ...
                              <td height="18" colspan="4" align="left" valign="top" class="leftmenu"><table width="98%" border="2" bordercolor="#AAAAAA" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                                <tr>
                                  ...
                                  <td align="center" valign="middle" bgcolor="#CDCDCD" class="pedtext">
                                ...
                                <?php                                    
                                    ...
                                    foreach($dbf->fetchOrder('student_fees',"course_id='$course_id' And student_id='$student_id' AND type !='advance' And (invoice_sl LIKE '$enroll_dtl%')","") as $vali) {
                            ...
                            <tr>
                              ...
                              <td height="28" colspan="4" align="left" valign="middle" class="leftmenu"><table width="365" border="2" bordercolor="#FF6600" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                                <tr>
                                  ...
                                  <td width="40%" align="left" valign="middle" bgcolor="#FF9900" class="pay_heading"><?php echo constant("STUDENT_ADVISOR_SEARCH_MANAGE_PAYDT");?></td>
                                  <td width="42%" align="center" valign="middle" bgcolor="#FF9900" class="pay_heading"><?php echo constant("STUDENT_ADVISOR_SEARCH_MANAGE_PRICE");?></td>
                                  ...
                                  <td height="25" colspan="4" align="center" valign="middle"><div id="div1"> </div>
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="41%" align="left" valign="middle"><input name="pdate1" type="text" class="datepick new_textbox100" id="pdate1" readonly="readonly" size="45" minlength="4"/></td>
                                          <td width="32%" align="left" valign="middle"><input name="amt1" type="text" class="new_textbox100" id="amt1" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                          <td width="22%" align="left">&nbsp;<?php echo $res_currency[symbol];?></td>
                                        </tr>
                                      </table>
                                    </div>
                                    <div id="div2"> </div>
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="41%" align="left" valign="middle"><input name="pdate2" type="text" class="datepick new_textbox100" id="pdate2" readonly="readonly" size="45" minlength="4"/></td>
                                          <td width="32%" align="left" valign="middle"><input name="amt2" type="text" class="new_textbox100" id="amt2" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                          <td width="22%" align="left">&nbsp;<?php echo $res_currency[symbol];?></td>
                                        </tr>
                                      </table>
                                    </div>
                                    ...
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="41%" align="left" valign="middle"><input name="pdate3" type="text" class="datepick new_textbox100" id="pdate3" readonly="readonly" size="45" minlength="4"/></td>
                                          <td width="32%" align="left" valign="middle"><input name="amt3" type="text" class="new_textbox100" id="amt3" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                          <td width="22%" align="left">&nbsp;<?php echo $res_currency[symbol];?></td>
                                        </tr>
                                      </table>
                                    </div>
                                    ...
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="41%" align="left" valign="middle"><input name="pdate4" type="text" class="datepick new_textbox100" id="pdate4" size="45" readonly="readonly" minlength="4"/></td>
                                          <td width="32%" align="left" valign="middle"><input name="amt4" type="text" class="new_textbox100" id="amt4" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                          <td width="22%" align="left">&nbsp;<?php echo $res_currency[symbol];?></td>
                                        </tr>
                                      </table>
                                    </div>
                                    ...
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="41%" align="left" valign="middle"><input name="pdate5" type="text" class="datepick new_textbox100" id="pdate5" size="45" readonly="readonly" minlength="4"/></td>
                                          <td width="32%" align="left" valign="middle"><input name="amt5" type="text" class="new_textbox100" id="amt5" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                          <td width="22%" align="left">&nbsp;<?php echo $res_currency[symbol];?></td>
                                        </tr>
                                      </table>
                                    </div>
                                    ...
                                    <div id="div<?php echo $i;?>" style="display:none;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="41%" align="left" valign="middle"><input name="pdate<?php echo $i;?>" type="text" class="datepick new_textbox100" readonly="readonly" id="pdate<?php echo $i;?>" size="45" minlength="4"/></td>
                                          <td width="32%" align="left" valign="middle"><input name="amt<?php echo $i;?>" type="text" class="new_textbox100" id="amt<?php echo $i;?>" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                          <td width="22%" align="left">&nbsp;<?php echo $res_currency[symbol];?></td>
                                        </tr>
                                      </table>
                                    </div>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#EBEBEB">
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="15%" align="center" valign="middle"><?php echo $dbf->VVIP_Icon($val_student["id"]);?></td>
                                        <td width="70%" align="right" valign="middle"><img src="<?php echo $photo;?>" width="100" height="100" oncontextmenu="return false;" />
                                        </td>
                                    ...
                                    <td align="center" >
                                      ...
                                      <?php }} ?></td>
                                          ...
                                          <tr>
                                            ...
                                            <tr>
                                              <td width="6%" height="25" align="center" valign="middle" bgcolor="#FF9900" class="amt_head">&nbsp;</td>
                                              <td width="44%" align="left" valign="middle" bgcolor="#FF9900" class="pay_heading">
											  <?php echo constant("STUDENT_ADVISOR_SEARCH_MANAGE_PAYDT");?></td>
                                              <td width="38%" align="center" valign="middle" bgcolor="#FF9900" class="pay_heading">
                                                ...
                                                <div style="clear:both;">
                                                  <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <td width="30%" align="left" valign="middle"><input name="amt1" type="text" class="new_textbox100_ar" id="amt1" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                                ...
                                                <div style="clear:both;">
                                                  <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <td width="30%" align="left" valign="middle"><input name="amt2" type="text" class="new_textbox100_ar" id="amt2" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                                      <td width="20%" align="left" valign="middle">&nbsp;<?php echo $res_currency[symbol];?></td>
                                                      </tr>
                                                    </table>
                                                  </div>
                                                ...
                                                <div style="clear:both;">
                                                  <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <td width="30%" align="left" valign="middle"><input name="amt5" type="text" class="new_textbox100" id="amt5" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                                      <td width="20%" align="left" valign="middle">&nbsp;<?php echo $res_currency[symbol];?></td>
                                                      </tr>
                                                    </table>
                                                  </div>
                                                ...
                                                <div id="div<?php echo $i;?>" style="display:none;">
                                                  <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                                    <tr>
                                                      ...
                                                      <td width="30%" align="left" valign="middle"><input name="amt<?php echo $i;?>" type="text" class="new_textbox100" id="amt<?php echo $i;?>" maxlength="6" onKeyPress="return isNumberKey(event);"/></td>
                                                      <td width="20%" align="left" valign="middle">&nbsp;<?php echo $res_currency[symbol];?></td>
                                                      </tr>
                                                    </table>
                                                  </div>
