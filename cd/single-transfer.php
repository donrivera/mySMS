              ...
              <tr>
                ...
                <thead>
                  <tr>
                    ...
                    <th width="14%" align="left" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_DATE");?></th>
                    ...
                    <th width="10%" align="center" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_NO");?></th>
                    <th width="16%" align="left" valign="middle" bgcolor="#ccc" class="pedtext">Student Name</th>
                    <th width="19%" align="left" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
              ...
              <tr>
                ...
                <thead>
                  <tr>
                    ...
                    <th width="10%" align="left" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_FROMGROUP");?></th>
                    <th width="9%" align="left" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_TO");?></th>
                    <th width="10%" align="left" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_TOGROUP");?></th>
                    <th width="8%" align="left" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_NO");?></th>
                    <th width="15%" align="left" valign="middle" bgcolor="#ccc" class="pedtext">Student Name(s)</th>
                    <th width="10%" align="left" valign="middle" bgcolor="#ccc" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
