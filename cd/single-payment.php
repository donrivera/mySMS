                  ...
                  <tr>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td colspan="2" rowspan="4" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="30%" align="left" valign="middle"><input name="othertext" type="text" class="new_textbox190" id="othertext" value="<?php echo $res_enroll["othertext"];?>" /></td>
                      ...
                      <?php
						...
						$num_structure = $dbf->countRows('student_fees',"course_id='$course_id' And student_id='$student_id' And invoice_sl LIKE '$enroll_dtl%'");						
						if($num_structure > 0){
						?>
                      <tr>
                        <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <table width="98%" border="2" bordercolor="#AAAAAA" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                          ...
                          <?php							
							$j = 1;
							$fifo = $dbf->strRecordID("student_fees","*","course_id='$course_id' And student_id='$student_id' AND status='0' And invoice_sl LIKE '$enroll_dtl%' LIMIT 0,1");
							$fifo_id = $fifo["id"];
