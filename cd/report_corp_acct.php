    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" height="25" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>&nbsp;</td>
              <td width="36" align="center" valign="middle"><a href="report_corp_acct_word.php?corp_code=<?php echo $_REQUEST[code];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_WORD ?>"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_corp_acct_csv.php?corp_code=<?php echo $_REQUEST[code];?>"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_XLS ?>"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_corp_acct_pdf.php?corp_code=<?php echo $_REQUEST[code];?>"><img src="../images/pdf.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_PDF ?>"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_corp_acct_print.php?corp_code=<?php echo $_REQUEST[code];?>" target="_blank"><img src="../images/print.png" width="16" height="16" border="0" title="<?php echo STUDENT_ADVISOR_SEARCH_MANAGE_PRINT ?>"></a></td>
            </tr>
          </table></td>
      </tr>
    </table></td>
          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  ...
                  <td width="7%"><span class="logintext"><?php echo "Name";?></span> :</td>
                  <td width="22%" align="left">
                  <select name="code" id="code"  style="border:solid 1px; border-color:#FFCC33; height:20px; width:200px;" onChange="javascript:document.frm.action='report_corp_acct.php',document.frm.submit();">
                    <option value=""> Select Status </option>
                    <?php
						foreach($dbf->fetchOrder('corporate',"centre_id='$_SESSION[centre_id]'","name") as $val1) {	
					  ?>
                    <option value="<?php echo $val1['code'];?>" <?php if($_REQUEST[code]==$val1['code']) { ?> selected="selected" <?php } ?>><?php echo $val1[name];?></option>
                    <?php
					   }
					   ?>
                  </select></td>
          ...
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <tr class="logintext">
                  ...
                  <th width="17%" align="left" valign="middle" class="pedtext"><?php echo "Account";?></th>
                  <th width="10%" align="left" valign="middle" class="pedtext"><?php echo "Course";?></th>
                </tr>
				</thead>
                <?php 
					$i = 1;
					...
					$query=$dbf->genericQuery(" SELECT s.id,cs.account,crs.name
												...
												WHERE s.centre_id='$_SESSION[centre_id]' AND c.code='$_REQUEST[code]'
											");
					$num=count($query);
