    ...
    <table width="670" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		*/
		$res_currency = $dbf->strRecordID("currency_setup","*","use_currency='1'");	
		$course=$dbf->getDataFromTable("course","name","id='$course_id'");
		$course_fee=$dbf->getDataFromTable("course_fee","fees","course_id='$course_id'");
		$group_id=$dbf->getDataFromTable("student_moving","group_id","student_id='$student_id' And course_id='$course_id'");
		$group=$dbf->strRecordID("student_group","*","id='$group_id'");
		
		?>
		<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#6666FF" style="border-collapse:collapse;">
		<tr>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Contract Lesson: <?=$group['units']?></td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Program: <?=$course?></td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Tuition: <?=$course_fee?><?=$res_currency[symbol];?></td>
		</tr>
		<tr>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Lesson Rate:</td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Language: English</td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Registration:</td>
		</tr>
		<tr>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Travel Units:</td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Lesson Type:</td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Material:</td>
		</tr>
		<tr>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Travel Rate:</td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Group:</td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Travel Amount:</td>
		</tr>
		<tr>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext">Company Percentage:</td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext"></td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext"></td>
		</tr>
		<tr>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext" colspan="2">
				<?php
					
					echo "<BR/>Group Details: ".$group['group_name']."<BR/>";
					echo "<BR/>Lesson Schedule: ".$group['class_day']."<BR/>";
					echo "<BR/>Time: ".$group['group_start_time']."-".$group['group_end_time'];
				?>
				
			</td>
			<td width="15%" height="25" align="left" valign="middle" class="smalltext" colspan="2">
				Total: <?=$course_fee?><?=$res_currency[symbol];?>
			</td>
		</tr>
		</table>
		</td>
