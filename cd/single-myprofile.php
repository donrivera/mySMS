                      ...
                      <tr>
                        ...
                        <form action="s_process.php?action=edit_from_student_profile&student_id=<?=$student_id;?>" name="frm" method="post" id="frm" enctype="multipart/form-data" onSubmit="return checkid();">
                          ...
                          <tr>
                            ...
                            <td width="345" align="left" valign="middle"><span class="leftmenu">
                              <?php
							$v = $res_edit_student["gender"];
							if($v == ''){ $v = 'male'; }
							?>
                          ...
                          <tr>
                            <td width="262" height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("STUDENT_ADVISOR_S_PARENT_PARENTGUARDIANS");?> :<span class="nametext1">*</span></td>
                            <td align="left" valign="middle">&nbsp;</td>
                          ...
                          <tr>
                              ...
                              <tr>
                                <td width="4%" align="left" valign="middle" class="hometest_name">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                      <tr>
                        ...
                        <form action="s_process.php?action=edit_from_student_profile&student_id=<?=$student_id;?>" name="frm" method="post" id="frm" enctype="multipart/form-data" onSubmit="return checkid();">
                          ...
                          <tr>
                            <td width="331" height="28" align="right" valign="middle" class="leftmenu"><input name="gname" type="text" class="validate[required] new_textbox190_ar" id="gname" value="<?php echo $res_edit_student["guardian_name"];?>"/></td>
                            <td align="left" valign="middle">&nbsp;</td>
                            <td align="left" valign="middle" class="leftmenu">
