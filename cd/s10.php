					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          ...
                          <tr>
                            ...
                            <td height="25" colspan="3" align="left" valign="middle" class="leftmenu"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="33%" align="right" valign="middle"><?php echo constant("PROGRESS_BAR");?>&nbsp;</td>
                                <td width="58%" align="left" valign="middle" style="padding-left:2px;">
                          ...
                          <tr>
                            ...
                            <?php }?>
							<?php if($_SESSION['corp_acct'] != ''){?>
							<tr>
                            <td>&nbsp;</td>
                            <td height="25" align="right" valign="middle" class="leftmenu"><?php echo "Corporate Code";?> : </td>
                            <td>&nbsp;</td>
                            <td align="left" valign="middle" class="mytext"><?php echo $_SESSION['corp_acct'];?></td>
                            <td align="right" valign="middle" class="mytext">&nbsp;</td>
                            </tr>
                            <?php } ?>
							<?php if($_SESSION['corp_student_acct'] != ''){?>
							<tr>
                            <td>&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td width="1%">&nbsp;</td>
                            <td width="54%" align="left" valign="middle" class="lable1">&nbsp;</td>
                            <td width="12%" align="left" valign="top" style="padding-top:3px;">&nbsp;</td>
                          </tr>
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          ...
                          <tr>
                            ...
                            <td height="25" colspan="3" align="left" valign="middle" class="leftmenu"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="9%" align="center" valign="middle" class="shop2">100%</td>
                                <td width="54%" align="left" valign="middle" style="padding-left:2px;">
                                  <div class="meter-wrap" style="background-color:#fff; border:solid 1px; border-color:#847B7B;">
                                    <div class="meter-value" style="background-color:#847B7B; width:100%;">
                                      <div style="border:solid 1px; border-color:#847B7B; "></div>
                                      </div>
                                    </div></td>
                                    <td width="37%" align="left" valign="middle">&nbsp;&nbsp;<?php echo constant("PROGRESS_BAR");?></td>
                                </tr>
                            </table></td>
                            </tr>
                          <tr>
                          ...
                          <tr>
                            <td width="14%">&nbsp;</td>
                            <td width="41%" align="left" valign="middle" class="lable1">&nbsp;</td>
                            <td width="18%" align="left" valign="top" style="padding-top:3px;">&nbsp;</td>
                            <td width="27%" align="left" valign="top" style="padding-top:3px;">&nbsp;</td>
                          </tr>
