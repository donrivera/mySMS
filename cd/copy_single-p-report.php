              ...
              <tr>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#CCC;">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle" class="pedtext_normal"><?php echo $dbf->printStudentName($student_id);?></td>
                    <td>&nbsp;</td>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#CCC;">
				  ...
				  ?>
                  <tr>
                    <td height="20" align="right" valign="middle" class="pedtext_normal"><?php echo $dbf->printStudentName($student_id);?></td>
