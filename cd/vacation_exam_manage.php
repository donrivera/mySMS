        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="logintext"><?php echo constant("ADMIN_VACATION_EXAM_MANAGE_MANAGEEXAM");?></td>
                <td width="22%">&nbsp;</td>
          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="23%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_CENTRENAME");?> </th>
              ...
              <?php
				...
				$num=$dbf->countRows('exam_vacation',"centre_id='$_SESSION[centre_id]' And ".$cond);
				foreach($dbf->fetchOrder('exam_vacation',"centre_id='$_SESSION[centre_id]' And ".$cond,"id DESC","*") as $val) {
              ...
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                ...
                <td height="25" align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $res[name];?></td>
				  <td height="25" align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo date('d-M-Y',strtotime($val[frm]));?></td>
				    <td height="25" align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo date('d-M-Y',strtotime($val[tto]));?></td>
                    <td align="left" valign="middle" class="mycon"><?php echo $val[type];?></td>
                    <?php
						  $i = $i + 1;
						  if($color=="#ECECFF"){
							  $color = "#E7FEEA";
                ...
                <tr>
                  <td align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="8%" align="left">&nbsp;</td>
                      <td width="8%" align="left">&nbsp;</td>
                       <td width="54%" height="30" align="right" class="logintext"><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_MANAGE_CENTRE_VACATION");?></td>
                      </tr>
                    </table></td>
                  </tr>
                <tr>
                  <td align="left" valign="top" bgcolor="#e6e6e6">
					...
					?>
                      <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                        <td height="25" align="right" valign="middle" class="mycon" style="padding-left:5px;"><?php echo date('d-M-Y',strtotime($val[frm]));?></td>
                        <td height="25" align="right" valign="middle" class="mycon" style="padding-left:5px;"><?php echo date('d-M-Y',strtotime($val[tto]));?></td>
                        <td align="right" valign="middle" class="mycon"><?php echo $val[type];?></td>
