					...
					<tr>
					  ...
					  <td width="492" align="left" valign="middle" class="home_head_text"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="61%" align="left" valign="middle"> <?php echo constant("CD_ALERT_LATEST_INFORMATION");?> </td>
							<td width="34%">&nbsp;</td>
						  </tr>
					  </table></td>
					</tr>
        ...
        <td width="78%" align="right" valign="top">
          <table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr bgcolor="#000000">
                  <td height="30" bgcolor="#FFA938" class="logintext" align="right" style="background:url(../images/footer_repeat.png) repeat-x;"><?php echo constant("ALERT");?></td>
                  </tr>
                <tr>
                  <td height="450" align="left" valign="top" bgcolor="#FFFFFF">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
