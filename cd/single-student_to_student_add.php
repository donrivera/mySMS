            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 1px; border-color:#CCC;">
              ...
              <tr>
                ...
                <table width="70%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" bordercolor="#CCCCCC">
                  <tr>
                    <td width="41%" align="left" valign="middle" class="pedtext"><?php echo constant('ADMIN_VIEW_COMMENTS_MANAGE_STUDENT');?> :</td>
                    <td width="59%" align="left" valign="middle" class="mycon"><?php echo $dbf->printStudentName($student_id);?></td>
                  </tr>
                </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle" bgcolor="#FFFFFF" >&nbsp;<?php echo $dbf->printStudentName($student_id);?></td>
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 1px; border-color:#CCC;">
              ...
              <tr>
                <td align="right" valign="middle"><table width="70%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" bordercolor="#CCCCCC">
                  <tr>
                    <td width="41%" align="right" valign="middle" class="mycon"><?php echo $dbf->printStudentName($student_id);?></td>
                    <td width="59%" align="left" valign="middle" class="pedtext">: <?php echo constant('ADMIN_VIEW_COMMENTS_MANAGE_STUDENT');?></td>
                  </tr>
                </table>&nbsp;</td>
                <td align="left" valign="top">&nbsp;</td>
                <td align="left" valign="top" class="mymenutext"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="top"><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="88%" height="40" align="right" valign="middle" bgcolor="#E9E9E9" id="lbl_sec_group" style="border-right:solid 1px; border-top:solid 1px; border-bottom:solid 1px; border-color:#999;">
                      <select name="to_id" id="to_id" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF; height:25px; width:140px;">
                        <option value="">--<?php echo constant("SELECT");?>--</option>
                        </select>&nbsp;&nbsp;</td>
                        <td width="12%" align="center" valign="middle" bgcolor="#E9E9E9" class="mymenutext" style="border-left:solid 1px; border-top:solid 1px; border-bottom:solid 1px; border-color:#999;">: <?php echo constant("STUDENT_ADVISOR_TRANSLATE_TO");?></td>
                    </tr>
                  <tr>
                    <td colspan="2" align="left" valign="top" id="lbl_group2_dtls">&nbsp;</td>
                    </tr>
              ...
              <tr>
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td align="right" valign="middle" bgcolor="#FFFFFF" >&nbsp;<?php echo $dbf->printStudentName($student_id);?></td>
                    <td align="center" valign="middle" bgcolor="#FFFFFF" >
                    <input type="checkbox" name="student_id<?php echo $i;?>" id="student_id<?php echo $i;?>" />
                    </td>
                  </tr>
