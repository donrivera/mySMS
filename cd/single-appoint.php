                ...
                <td colspan="4" align="left" valign="top"><table width="99%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999" class="tablesorter" id="sort_table2" style="border-collapse:collapse;">
                  <thead>
                    <tr class="logintext" bgcolor="#CCCCCC">
                      ...
                      <th align="right" valign="middle" class="pedtext"><?php echo constant("RECEPTION_STUDENT_APPOINT_MANAGE_COMMENT");?></th>
                      <th align="right" valign="middle" class="pedtext"><?php echo constant("RECEPTION_STUDENT_APPOINT_MANAGE_STUDENTNAME");?></th>
                      <th align="right" valign="middle" class="pedtext"><?php echo constant("RECEPTION_STUDENT_APPOINT_MANAGE_DATE");?></th>
                      <th height="25" align="center" valign="middle">&nbsp;</th>
                    </tr>
                  </thead>
                  <?php				
