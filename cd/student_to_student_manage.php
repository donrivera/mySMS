    ...
    <td align="left" valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" align="left" valign="middle" style="background:url(../images/footer_repeat.png) repeat-x;">
          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="11%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_FROMGROUP");?></th>
                <th width="11%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_TOGROUP");?></th>
                <th width="15%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_STUDENT");?></th>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
              <tr>
				...
				?>
              <tr>
                <td height="30"  colspan="9" align="center" valign="middle" bgcolor="#F8F9FB" class="nametext1"><?php echo constant("COMMON_NORECFOUND");?></td>
              </tr>
				<?php
				}
				?>
  ...
  <tr>
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
                ...
                <table width="100%" border="0" cellspacing="0">
                    ...
                    <thead>
                      <tr class="logintext">
                        ...
                        <th width="10%" align="right" valign="middle" bgcolor="#DDDDDD" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?></th>
                        <th width="15%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("CD_STUDENT_CENTER_FROMGROUP");?></th>
                        <th width="10%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("CD_STUDENT_CENTER_TOGROUP");?></th>
                        <th width="14%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("STUDENT_ADVISOR_STUDENT_MANAGE_STUDENTNAME");?></th>
                        <th width="30%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
                        <th width="8%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_DATE");?></th>
        ...
        <td width="17%" align="right" valign="top"><?php include 'left_menu_right.php';?></td>
      </tr>
    </table>	
	</td>
  </tr>
