        ...
        <td width="79%" align="left" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr>
                  <td width="54%" height="30" align="left" class="logintext"><?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_CONVERTER");?></td>
          ...
          <tr>
			...
			<table width="900" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
              ...
              <tr>
                <td width="20">&nbsp;</td>
                <td colspan="3" align="left" valign="middle" ><table width="860" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                  ...
                  <td align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                    <tr>
                     <td width="8%" align="left"><a href="home.php"> 
                      ...
                      <td width="8%" align="left">&nbsp;</td>
                      <td width="8%" align="left">&nbsp;</td>                      
                      <td width="54%" height="30" align="right" class="logintext"><?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_CONVERTER");?></td>
                    </tr>
                   </table></td>
                  </tr>
                <tr>
                      ...
                      <tr>
                        ...
                        <td colspan="3" align="left" valign="middle" ><table width="860" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="425" align="left" valign="top"><iframe height="230" width="420" src="calc_hijri.php" style="border:none;"> </iframe></td>
                            <td width="10">&nbsp;</td>
                            <td width="425" align="left" valign="top"><iframe height="230" width="420" src="calc_eng.php" style="border:none;"> </iframe></td>                            </tr>
                          </table></td>
                        <td width="20">&nbsp;</td>
                        </tr>
