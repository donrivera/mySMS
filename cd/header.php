  ...
  <tr>
    <td align="left" valign="top" background="images/title.png" ><div id="glowmenu" class="glowingtabs">
	  ...
	  if(	$page_name == "report_centre_director_main.php" || 
			$page_name=="report_group_progress.php" || 
			$page_name == "report_teacher_progress.php" || 
			...
			$page_name == "view_student_comments_history_from_manage.php" || 
			...
			$page_name=="view_student_comments_history.php" || 
			$page_name=="manage_sms_history.php" || 
