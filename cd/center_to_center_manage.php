          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="11%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_TO");?></th>
                ...
                <th width="17%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
              ...
              <?php					
                    ...
                    $num=$dbf->countRows('transfer_centre_to_centre',"(centre_id='$_SESSION[centre_id]' OR centre_to='$_SESSION[centre_id]') And ".$cond,"");
					foreach($dbf->fetchOrder('transfer_centre_to_centre',"(centre_id='$_SESSION[centre_id]' OR centre_to='$_SESSION[centre_id]') And ".$cond,"id DESC ","*") as $transfer){
              ...
              <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                ...
                <?php if($transfer["status"] == 'Pending')
					{
						if($transfer[centre_to]==$_SESSION[centre_id])
						{
				?>
                ...
                <?php 
					...
					} if($transfer["status"] == 'Rejected'){?><img src="../images/change_status2.png" width="16" height="16" border="0" title="Rejected" />
                    ...
                    <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#000000" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                      <thead>
                        <tr class="logintext">
                          ...
                          <th width="8%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_FROM");?></th>
                          ...
                          <th width="17%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("STUDENT_ADVISOR_STUDENT_MANAGE_STUDENTNAME");?></th>
                          <th width="19%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
                          <th width="8%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?></th>
                          <th width="10%" align="right" valign="middle" bgcolor="#DDDDDD" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_DATE");?></th>
