...
<form id="frm" name="frm" method="post" action="vacation_exam_process.php" >
  <table width="470" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 2px; border-color:#FF9900;">
    <tr>
      <td height="36" align="left" valign="middle" bgcolor="#FFA022" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="70%" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-weight:bold; font-size:12px;"><?php echo constant("CD_VACATION_EXAM_STATUS_EXAMVAC");?></td>
    ...
    <tr>
      <td height="36" align="left" valign="middle" bgcolor="#FFA022" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="9%"><input type="hidden" name="id" id="id" value="<?php echo $_REQUEST[id];?>" /></td>
          <td width="84%" align="right" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-weight:bold; font-size:12px;"><?php echo constant("CD_VACATION_EXAM_STATUS_EXAMVAC");?></td>
        </tr>
        <tr>
          <td height="5" colspan="3" align="right" valign="middle"></td>
        </tr>
    ...
    <tr>
      <td height="103" align="center" valign="top"><table width="380" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td colspan="2" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="58%" height="30" align="right" valign="middle" >
              <select name="status" id="status" style="width:150px; border:solid 1px; border-color:#FF9900;">
              <option value="1">Approved</option>
              <option value="2">Rejected</option>
              </select></td>
              <td width="2%">&nbsp;</td>
              <td width="40%" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:bold; font-size:12px;"><span style="color:#FF0000; font-weight:bold;">*&nbsp;</span> : <?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?></td>
              </tr>
            <tr>
              <td height="5" colspan="3" align="right" valign="middle"></td>
              </tr>
