                      ...
                      <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" >
                        <tr>
                          ...
                          <table width="97%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
                            ...
                            <tr>
                              <td width="24%" height="28" align="right" valign="middle"><input name="dated" type="text" class="datepick new_textbox100" readonly="" value="<?php echo $val["paid_date"];?>" id="dated" /></td>
                            ...
                            <tr>
                              <td height="28" align="right" valign="middle"><input name="amt" type="text" class="new_textbox100" id="amts" value="<?php echo $val["fee_amt"];?>" maxlength="10" onKeyPress="return isNumberKey(event);"/></td>
