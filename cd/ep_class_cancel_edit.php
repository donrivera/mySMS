...
$dbf = new User();
include_once '../includes/language.php';
$resc = $dbf->strRecordID("class_cancel","*","id='$_REQUEST[id]'");
?>
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("EDIT_CANCELLATON");?></span></td>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                        <tr>
                          <td align="center" valign="top" bgcolor="#EBEBEB">
                            ...
                            <form action="ep_class_cancel_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm">
                              <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                  ...
                                  <td align="left" valign="middle">
									...
									foreach($dbf->fetchOrder('student_group',"status<>'Completed' And centre_id='$_SESSION[centre_id]'","") as $res) {
									  ?>
                                      <option value="<?php echo $res['id'];?>" <?php if($resc["group_id"]==$res["id"]) {?> selected="selected" <?php } ?>><?php echo $res['group_name'] ?>, <?php echo date('d/m/Y',strtotime($res['start_date']));?> - <?php echo date('d/m/Y',strtotime($res['end_date'])) ?>, <?php echo $res["group_time"];?>-<?php echo $dbf->GetGroupTime($res["id"]);?></option>
                                      <?php }?>
                                      </select></td>
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle" id="showsch">
                                  <?php
								  $resgroup = $dbf->strRecordID("student_group","*","id='$resc[group_id]'");
								  ?>
                                  <table width="60%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF3300;">
                                      <tr>
                                        <td width="87%" height="25" align="center" valign="middle" bgcolor="#FFDDD7" class="red_smalltext"><?php echo constant("CD_EP_CLASS_CANCEL_AJAX_GROUPSTARTON");?>  <?php echo date('d-M-Y',strtotime($resgroup["start_date"]));?><?php echo constant("CD_EP_CLASS_CANCEL_AJAX_TO");?>   <?php echo date('d-M-Y',strtotime($resgroup["end_date"]));?></td>
                                      </tr>
                                    </table>
                                  </td>
                                  </tr>
                                <tr>
                                  ...
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle">
                                  <input name="startdate" type="text" class="validate[required] datepickFuture new_textbox140" readonly="" id="startdate" value="<?php echo $resc["cancel_date"];?>" /></td>
                                  <td>&nbsp;</td>
                                ...
                                <tr>
                                  <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                  <td height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("STUDENT_ADVISOR_S7_COMMENTS");?> : <span class="nametext1">*</span></td>
                                  <td align="left" valign="middle">&nbsp;</td>
                                  <td colspan="3" align="left" valign="middle">
                                    <textarea name="comments" cols="45" id="comments" class="validate[required]" style="width:450px; height:70px; border:solid 1px; border-color:#999999;background-color:#ECF1FF;"><?php echo $resc["comments"];?></textarea></td>
                                </tr>
                                <tr>
                  ...
                  <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                          <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("EDIT_CANCELLATON");?></span></td>
                          <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                          </tr>
                        </table></td>
                      </tr>
                            ...
                            <form action="ep_class_cancel_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm">
                              <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                  ...
                                  <td align="right" valign="middle" id="showsch">
                                  <?php
								  $resgroup = $dbf->strRecordID("student_group","*","id='$resc[group_id]'");
								  ?>
                                  <table width="60%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF3300;">
                                ...
                                <tr>
                                   <td align="left" valign="top" id="lblerror"></td>
                                  <td>&nbsp;</td>
								  <td align="right" valign="middle">
                                  <input name="startdate" type="text" class="validate[required] datepickFuture new_textbox140_ar" readonly="" id="startdate" value="<?php echo $resc["cancel_date"];?>" /></td>
								  <td>&nbsp;</td>
                                ...
                                <tr>
                                  <td colspan="3" align="right" valign="middle">
                                    <textarea name="comments" cols="45" id="comments" class="validate[required]" style="width:450px; height:70px; border:solid 1px; border-color:#999999;background-color:#ECF1FF;"><?php echo $resc["comments"];?></textarea></td>
									<td align="left" valign="middle">&nbsp;</td>
									<td height="28" align="left" valign="middle" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("STUDENT_ADVISOR_S7_COMMENTS");?></td>
								  <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                </tr>
                                <tr>
                                  <td height="10" colspan="6" align="left" valign="middle"></td>
