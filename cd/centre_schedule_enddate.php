		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>&nbsp;</td>
                <td width="36" align="center" valign="top"><a href="centre_schedule_enddate_word.php?enddate=<?php echo $_REQUEST["enddate"];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="Export to Word"></a></td>
                <td width="36" align="center" valign="top"><a href="centre_schedule_enddate_csv.php?enddate=<?php echo $_REQUEST["enddate"];?>"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="Export to Excel"></a></td>
                <td width="30" align="center" valign="top"><a href="centre_schedule_enddate_pdf.php?enddate=<?php echo $_REQUEST["enddate"];?>"><img src="../images/pdf.png" width="20" height="20" border="0" title="Export to PDF"></a></td>
