                          ...
                          <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                              <tr>
                                ...
                                <form action="cancel_process.php?cancel_id=<?php echo $_REQUEST["cancel_id"];?>&action=update" name="frm" method="post" id="frm">        
                                      ...
                                      <tr>
                                        ...
                                        <table width="250" border="1" cellspacing="0" cellpadding="0" bordercolor="#9999FF" style="border-collapse:collapse;">
                                          ...
                                          <tr>
                                            ...
                                            <td width="46%" align="left" valign="middle" bgcolor="#999999" class="shop2">&nbsp;<?php echo $course_fee;?></td>
                                          </tr>
                                          <tr>
                                            <td align="right" valign="middle" class="mycon">Discount (-) : &nbsp;</td>
                                            <td align="left" valign="middle" class="shop2">&nbsp;<?php echo $discount;?></td>
                                          </tr>
                                          <tr>
                                            <td align="right" valign="middle" class="mycon">Enrollment Amount : &nbsp;</td>
                                            <td align="left" valign="middle" bgcolor="#FFFF99" class="shop2">&nbsp;<?php echo $en_amt;?></td>
                                          </tr>
                                          <tr>
                                            <td align="right" valign="middle" class="mycon">Other Amount : &nbsp;</td>
                                            <td align="left" valign="middle" class="shop2">&nbsp;<?php echo $other_amt;?></td>
                                          </tr>
                                          <tr>
                                            <td align="right" valign="middle" class="mycon">Course Fees : &nbsp;</td>
                                            <td align="left" valign="middle" bgcolor="#9D9DFF" class="shop2">&nbsp;<?php echo $course_fee_final;?></td>
                                          </tr>
                                          <tr>
                                            <td align="right" valign="middle" class="mycon">Paid Amount : &nbsp;</td>
                                            <td align="left" valign="middle" class="shop2" >&nbsp;<?php echo $paid_amt;?></td>
                                          </tr>
                                          <tr>
                                            <td align="right" valign="middle" class="mycon">Balance Amount : &nbsp;</td>
                                            <td align="left" valign="middle" bgcolor="#006699" class="logintext" >&nbsp;<?php echo $bal_amt;?></td>
                                          </tr>
                                        </table></td>
                                        </tr>
                                      <tr>
                                    ...
                                    <form action="cancel_process.php?cancel_id=<?php echo $_REQUEST["cancel_id"];?>&action=update" name="frm" method="post" id="frm">        
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-color:#CCCCCC;">
                                        ...
                                        <tr>
                                          ...
                                          <td width="283" align="right" valign="middle" class="red_smalltext">&nbsp;<?php echo $student["first_name"];?><?php echo $Arabic->en2ar($dbf->StudentName($student["id"]));?></td>
                                        ...
                                        ?>
                                            <table width="250" border="1" cellspacing="0" cellpadding="0" bordercolor="#9999FF" style="border-collapse:collapse;">
                                              <tr>
                                                ...
                                                <td width="54%" height="20" align="left" valign="middle" class="mycon"> &nbsp; :<?php echo $Arabic->en2ar('Course');?></td>
                                                </tr>
                                              <tr align="right" class="mycon">
                                                <td colspan="2" align="center" valign="middle"><u class="mymenutext"><?php echo $Arabic->en2ar('Payment Details');?></u> &nbsp;</td>
                                                </tr>
                                              <tr>
                                               
                                                <td width="46%" align="right" valign="middle" bgcolor="#999999" class="shop2">&nbsp;<?php echo $course_fee;?></td>
                                                 <td width="54%" align="left" valign="middle" class="mycon">&nbsp; :<?php echo $Arabic->en2ar('Course Fees');?></td>
                                                </tr>
                                              <tr>
                                                
                                                <td align="right" valign="middle" class="shop2">&nbsp;<?php echo $discount;?></td>
                                                <td align="left" valign="middle" class="mycon"> &nbsp; : <?php echo $Arabic->en2ar('Discount (-)');?></td>
                                                </tr>
                                              <tr>
                                               
                                                <td align="right" valign="middle" bgcolor="#FFFF99" class="shop2">&nbsp;<?php echo $en_amt;?></td>
                                                 <td align="left" valign="middle" class="mycon">&nbsp;  : <?php echo $Arabic->en2ar('Enrollment Amount');?></td>
                                                </tr>
                                              <tr>
                                                
                                                <td align="right" valign="middle" class="shop2">&nbsp;<?php echo $other_amt;?></td>
                                                <td align="left" valign="middle" class="mycon">&nbsp; :<?php echo $Arabic->en2ar('Other Amount');?></td>
                                                </tr>
                                              <tr>
                                                
                                                <td align="right" valign="middle" bgcolor="#9D9DFF" class="shop2">&nbsp;<?php echo $course_fee_final;?></td>
                                                <td align="left" valign="middle" class="mycon">&nbsp; :<?php echo $Arabic->en2ar('Course Fees');?></td>
                                                </tr>
                                              <tr>
                                               
                                                <td align="right" valign="middle" class="shop2" >&nbsp;<?php echo $paid_amt;?></td>
                                                 <td align="left" valign="middle" class="mycon">&nbsp; :<?php echo $Arabic->en2ar('Amount');?> </td>
                                                </tr>
                                              <tr>
                                                
                                                <td align="right" valign="middle" bgcolor="#006699" class="logintext" >&nbsp;<?php echo $bal_amt;?></td>
                                                <td align="left" valign="middle" class="mycon">&nbsp; : <?php echo $Arabic->en2ar('Balance Amount');?></td>
                                                </tr>
                                              </table></td>
                                          </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          ...
                                          <td height="30" align="left" valign="middle" class="pedtext">
                                             : <?php echo constant("TEACHER_ARF_MANAGE_DATE");?></td>
                                          </tr>
                                        <tr>
                                          <td>&nbsp;</td>
                                        ...
                                        <tr>
                                          <td>&nbsp;</td>
                                          <td height="30" align="left" valign="middle" class="leftmenu"><input type="submit" name="submit2" id="submit2" value="<?php echo constant("btn_save_btn");?>" class="btn2"/></td>
                                          <td align="left" valign="middle">&nbsp;</td>
                                          <td align="left" valign="middle">&nbsp;</td>
                                          </tr>
                                        </table>
