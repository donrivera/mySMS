...
$res = $dbf->strRecordID("student","first_name","id='$_SESSION[student_id]'");
?>	
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          ...
                          <tr>
                            <td height="10" colspan="5" align="center" valign="middle" class="leftmenu"><table width="715" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td height="28" align="left" valign="middle">
                                <input name="t1" type="text" class="new_textbox140_ar" id="t1" value="<?php echo $_SESSION[family_name1];?>" onBlur="checkTab('t1');"/></td>
                                <td align="left" valign="middle">
                                <input name="t2" type="text" class="new_textbox140_ar" id="t2" value="<?php echo $_SESSION[grandfather_name1];?>" onBlur="checkTab('t2');"/></td>
                                <td align="left" valign="middle">
                                <input name="t3" type="text" class="new_textbox140_ar" id="t3" value="<?php echo $_SESSION[father_name1];?>" onBlur="checkTab('t3');"/></td>
                                <td align="left" valign="middle">
                                <input name="t4" type="text" class="new_textbox140_ar" id="t4" value="<?php echo $_SESSION[name1];?>" onBlur="checkTab('t4');"/></td>
                                </tr>
                              <tr class="shop2">
