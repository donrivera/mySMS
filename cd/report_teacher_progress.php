    ...
    <table width="1000" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="250" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
          ...
          <tr>
            ...
            <select name="teacher_id" id="teacher_id" style="width:150px; border:solid 1px; border-color:#999999;" onChange="setsubmit();">
              ...
              <?php
			  foreach($dbf->fetchOrder('student s,student_group_dtls d',"s.id=d.student_id And d.parent_id='$_REQUEST[cmbgroup]'","first_name","s.*","") as $res_teacher) {
				  ?>
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#000000;">
          ...
          <tr>
            <td height="40" colspan="2" align="left" valign="top" class="leftmenu">&nbsp;&nbsp;<?php echo $pro_narration;?></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#000000;">
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="41%" height="20" align="right" valign="middle" class="pedtext_normal"><?php echo $res_g[group_name];?> <?php echo $dbf->printClassTimeFormat($res_g['group_start_time'],$res_g['group_end_time']);?></td>
