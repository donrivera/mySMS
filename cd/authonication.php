    ...
    <td align="left" valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#000000;">
          <tr>
            <td height="30" bgcolor="#FFA938" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;"><?php echo constant("STUDENT_ADVISOR_SEARCH_AUTHENTI");?></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <form action="user_process.php?action=insert" name="frm" method="post" id="frm">
                  <table width="90%" border="0" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#cccccc;">
                    <tr>
                      <td width="5%" bgcolor="#EDECF2"><input type="hidden" name="student_id" id="student_id" value="<?php echo $_REQUEST[student_id];?>" /></td>
                      <td width="20%" bgcolor="#EDECF2">&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="middle" bgcolor="#EDECF2">
                      <input name="uid" type="text" class="validate[required] new_textbox190" id="uid" value="" onkeyup="show_user();" autocomplete="off"/></td>
                    ...
                    <tr>
                      ...
                      <td bgcolor="#EDECF2">&nbsp;</td>
                      <td align="left" valign="middle" bgcolor="#EDECF2">
                      <input name="password" type="password" class="validate[required] new_textbox190" id="password" value="" /></td>
                      <td bgcolor="#EDECF2">&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="left" valign="middle" bgcolor="#EDECF2" class="leftmenu">&nbsp;</td>
                      ...
                      <td bgcolor="#EDECF2">&nbsp;</td>
                      <td height="40" align="left" valign="middle" bgcolor="#EDECF2">
          ...
          <table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="79%" align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#000000;">
                  <tr>
                    <td height="30" bgcolor="#FFA938" class="logintext" align="right" style="background:url(../images/footer_repeat.png) repeat-x;"><?php echo constant("STUDENT_ADVISOR_SEARCH_AUTHENTI");?></td>
                    </tr>
                  <tr>
                    <td height="40" align="left" valign="middle">&nbsp;</td>
                    </tr>
                    ...
                    <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td align="center"><table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF9900;">
                          <tr>
                            <td width="14%" height="30" align="center" valign="middle" bgcolor="#FFECFF"><a href="search.php">
                              <input type="button" value="<?php echo constant("btn_btn_no");?>" class="btn_yes" border="0" align="left" />
                              </a></td>
                              <td width="13%" align="right" valign="middle" bgcolor="#FFECFF"><input type="button" value="<?php echo constant("btn_btn_yes");?>" class="btn_no" border="0" align="left" onclick="show();"/></td>
                              <td width="73%" align="right" valign="middle" bgcolor="#FFECFF" class="nametext1">&nbsp;&nbsp;<?php echo constant("CD_AUTHONICATION_GENERATEUIDANDPASSWORD");?></td>
                            </tr>
                          </table></td>
                        </tr>
                      <tr>
                      ...
                      <tr>
                        <td align="center" valign="middle"><div id="diva" style="display:none;">
                          <form action="user_process.php?action=insert" name="frm" method="post" id="frm">
                            <table width="90%" border="0" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#cccccc;">
                              <tr>
                                <td width="10%" bgcolor="#EDECF2"><input type="hidden" name="student_id" id="student_id" value="<?php echo $_REQUEST[student_id];?>" /></td>
                                <td width="31%" bgcolor="#EDECF2">&nbsp;</td>
                                <td width="1%" bgcolor="#EDECF2">&nbsp;</td>
                                <td width="38%" bgcolor="#EDECF2">&nbsp;</td>
                                <td width="20%" bgcolor="#EDECF2">&nbsp;</td>
                                </tr>
                              <tr>
                                <td align="left" valign="middle" bgcolor="#EDECF2" class="leftmenu">&nbsp;</td>
                                <td height="28" align="left" valign="middle" bgcolor="#EDECF2" class="nametext" id="lbluser"></td>
                                <td bgcolor="#EDECF2">&nbsp;</td>
                                <td align="right" valign="middle" bgcolor="#EDECF2">
                                  <input name="uid" type="text" class="validate[required] new_textbox190_ar" id="uid" value="" onkeyup="show_user();" autocomplete="off"/></td>
                                <td align="left" valign="middle" bgcolor="#EDECF2" class="leftmenu">&nbsp;<span class="nametext1">*</span> : <?php echo constant("ADMIN_USER_MANAGE_USERID");?></td>
                                </tr>
                              <tr>
                                <td align="left" valign="middle" bgcolor="#EDECF2" class="leftmenu">&nbsp;</td>
                                <td height="28" align="left" valign="middle" bgcolor="#EDECF2" class="nametext">&nbsp;</td>
                                <td bgcolor="#EDECF2">&nbsp;</td>
                                <td align="right" valign="middle" bgcolor="#EDECF2">
                                  <input name="password" type="password" class="validate[required] new_textbox190_ar" id="password" value="" /></td>
                                <td bgcolor="#EDECF2" class="leftmenu">&nbsp;<span class="nametext1">*</span> : <?php echo constant("ADMIN_USER_MANAGE_PASSWORD");?></td>
                                </tr>
                              <tr>
                                <td align="left" valign="middle" bgcolor="#EDECF2" class="leftmenu">&nbsp;</td>
                                <td height="25" align="left" valign="middle" bgcolor="#EDECF2" class="leftmenu">&nbsp;</td>
