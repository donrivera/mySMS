...
<table width="470" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 2px; border-color:#FF9900;">
    ...
    <tr>
      ...
      <table width="460" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="344" height="30" align="right" class="red_smalltext" id="lbl_error"><input name="number" type="text" class="validate[required]" style="border:solid 1px; background-color:#ECF1FF; width:200px; border-color:#999999; text-align:right;" id="number" onkeyup="showno();"/></td>
