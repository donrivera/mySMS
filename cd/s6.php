                      ...
                      <tr>
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          <tr>
                            ...
                            <td width="1%">&nbsp;</td>
                            <td width="24%">&nbsp;</td>
                            <td width="49%" rowspan="9" align="left" valign="top" style="padding-top:3px;">
                            <br>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          <tr>
                              <td width="48%" rowspan="9" align="center" valign="top" style="padding-top:3px;">
                              <br>
                          ...
                          <tr>
                            <td width="26%" rowspan="3" align="right" valign="top" class="mytext">
                              <?php
							$i = 1;
							$courseid=explode(',',$_SESSION[courseid]);
							//print_r($courseid);
