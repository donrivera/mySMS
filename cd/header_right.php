...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="topbg" align="center">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="150" align="left" valign="middle"><div id="suggest" style="width:300px;">
            <input name="testinput" type="text" class="searchtext" id="testinput" onblur="fill(this.value);" onkeyup="suggest(this.value);" autocomplete="off" value="<?php echo $_REQUEST[testinput];?>" style="text-align:right;" />
  ...
  <tr>
    <td align="right" valign="top" background="images/title.png" ><div id="glowmenu" class="glowingtabs">
	  ...
	  ?>
        <li><a <?php echo $mystyle;?> href="email.php" title="email"><span <?php echo $mystyle;?> ><?php echo constant("ADMIN_MENU_EMAIL");?></span></a></li><?php
	  $mystyle = '';
	  ...
	  <?php
	  $mystyle = '';
	  if($page_name == "s_age.php" || $page_name=="s_classic.php" || $page_name=="s_manage.php" || $page_name=="s_edit.php" || $page_name=="arf_manage.php" || $page_name=="arf_print.php" ||$page_name=="arf_view.php" || $page_name=="s1.php" ||$page_name=="s2.php" || $page_name=="s3.php" || $page_name=="s4.php" || $page_name=="s5.php" || $page_name=="s_group.php" || $page_name=="s6.php" || $page_name=="s7.php" || $page_name=="s8.php" || $page_name=="s10.php" || $page_name == "cancel_manage.php"  || $page_name == "hold_manage.php"  || $page_name == "single-student.php")
	  {
		  $mystyle = 'style="background-color:#003399; background-image:none;"';
	  }
	  ?>
