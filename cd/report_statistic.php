    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" height="25" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>&nbsp;</td>
              <td width="36" align="center" valign="middle"><a href="report_statistic_word.php?startdate=<?php echo $_REQUEST[startdate];?>&enddate=<?php echo $_REQUEST[enddate];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="Export to Word"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_statistic_csv.php?startdate=<?php echo $_REQUEST[startdate];?>&enddate=<?php echo $_REQUEST[enddate];?>"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="Export to Excel"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_statistic_pdf.php?startdate=<?php echo $_REQUEST[startdate];?>&enddate=<?php echo $_REQUEST[enddate];?>"><img src="../images/pdf.png" width="20" height="20" border="0" title="Export to PDF"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_statistic_prnt.php?startdate=<?php echo $_REQUEST[startdate];?>&enddate=<?php echo $_REQUEST[enddate];?>" target="_blank"><img src="../images/print.png" alt="" width="16" height="16" border="0" title="Print"></a></td>
            </tr>
          </table></td>
      </tr>
    </table></td>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="54%" height="30" align="left" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_STATISTIC_STATISTICREPORT");?></td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
				...
				if($_REQUEST[startdate] !='' && $_REQUEST[enddate] !=''){
					  ...
					  $cond1="s.centre_id='$_SESSION[centre_id]' And s.status='Completed' And gs.group_id=s.group_id And ((s.start_date >='$_REQUEST[startdate]' AND s.start_date <='$_REQUEST[enddate]') OR (s.end_date >='$_REQUEST[startdate]' AND s.end_date <='$_REQUEST[enddate]'))";
				}else{
			   ...
			   //Get no. of students
                ...
                <tr>
                  ...
                  <table width="600" border="0" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#FFCC00;" >
                         ...
                         <tr>
                          ...
                          <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#FF6600" style="border-collapse:collapse;">                          <?php
					   	if($_REQUEST[startdate] !='' && $_REQUEST[enddate] !=''){
							...
							$cond="centre_id='$_SESSION[centre_id]' And status='Completed' And ((start_date >='$_REQUEST[startdate]' AND start_date <='$_REQUEST[enddate]') OR (end_date >='$_REQUEST[startdate]' AND end_date <='$_REQUEST[enddate]'))";
						}else{
							$cond="";
						}
					...
					$val_student_no = $dbf->strRecordID("student_group g,student_group_dtls d","COUNT(d.student_id)","g.centre_id='$_SESSION[centre_id]' And g.id=d.parent_id And g.status='Completed' And g.course_id='$val[course_id]' And (start_date <= '$_REQUEST[enddate]' And end_date >= '$_REQUEST[startdate]')");					
					?>
                    <tr>
                      <td height="30"></td>
                ...
                <tr>
                  <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                    <tr class="logintext">
                      ...
                      <td width="54%" height="30" align="right" class="headingtext"><img src="../images/arrow_small_right4.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?> <img src="../images/arrow_small_right2.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_STATISTIC_STATISTICREPORT");?></td>
