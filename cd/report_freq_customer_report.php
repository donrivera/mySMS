          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr class="logintext">
                ...
                <td width="10%" class="logintext">&nbsp;</td>
                ...
                <tr>
                  <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                    <tr class="logintext">
                      ...
                      <td width="8%" align="left">&nbsp;</td>
                      <td width="8%" align="left">&nbsp;</td>
                      <td width="43%" height="30" align="right" class="headingtext">
                    ...
                    <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                      <thead>
                        <tr class="logintext">
                          ...
                          <th width="16%" align="right" valign="middle" bgcolor="#99CC99" class="menutext" style="padding-right:25px;"><span class="pedtext"><?php echo constant("ADMIN_REPORT_FREQ_CUSTOMER_REPORT_EMAILADDRESS");?></span></th>
                          <th width="20%" align="right" valign="middle" bgcolor="#99CC99" class="menutext" style="padding-right:25px;"><span class="pedtext"><?php echo constant("ADMIN_REPORT_FREQ_CUSTOMER_REPORT_PHONENO");?></span></th>
                          <th width="26%" align="right" valign="middle" bgcolor="#99CC99" class="menutext" style="padding-right:25px;"><span class="pedtext"><?php echo constant("ADMIN_REPORT_FREQ_CUSTOMER_REPORT_COURSESATTENDED");?></span></th>
                          <th width="23%" align="right" valign="middle" bgcolor="#99CC99" class="menutext" style="padding-right:25px;"><span class="pedtext"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_STUDENTNAME");?></span></th>
                          <th width="2%" height="25" align="center" valign="middle" bgcolor="#99CC99">&nbsp;</th>
                          </tr>
                        </thead>
                      <?php
