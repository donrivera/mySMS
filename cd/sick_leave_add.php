  ...
  <table width="470" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 2px; border-color:#FF9900;">
    <tr>
      <td height="36" align="left" valign="middle" bgcolor="#FFA022" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="24%" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-weight:bold; font-size:12px;"><span class="leftmenu"><img src="../logo/logo.png" alt="logo" width="100" height="30" /></span></td>
          <td width="58%" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-weight:bold; font-size:12px;"><?php echo constant("CD_SICK_LEAVE_ADD_LEAVESTATUS");?></td>
          <td width="11%"><input type="hidden" name="id" id="id" value="<?php echo $_REQUEST[id];?>" /></td>
          <td width="7%" align="center" valign="middle"><img src="../images/close-btn.png" width="25" height="25" onclick="javascript:self.parent.tb_remove();" style="cursor:pointer" title="Close"/></td>
        </tr>
        <tr>
...
<form id="frm" name="frm" method="post" action="sick_leave_process.php" >
  <table width="470" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 2px; border-color:#FF9900;">
    <tr>
      <td height="36" align="left" valign="middle" bgcolor="#FFA022" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="10%" align="center" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-weight:bold; font-size:12px;"><img src="../images/close-btn.png" width="25" height="25" onclick="javascript:self.parent.tb_remove();" style="cursor:pointer" title="Close"/></td>
          <td width="65%" align="right" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-weight:bold; font-size:12px;"><?php echo constant("CD_SICK_LEAVE_ADD_LEAVESTATUS");?><input type="hidden" name="id" id="id" value="<?php echo $_REQUEST[id];?>" /></td>
          <td width="25%" align="right" valign="middle">
            <img src="../logo/logo-ar.png" width="100" height="30" /></td>
          </tr>
        <tr>
          <td height="5" colspan="3" align="right" valign="middle"></td>
        </tr>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td width="66%" align="right" valign="middle">
                 ...
                 <td width="31%" height="30" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:bold; font-size:12px;"> <span style="color:#FF0000; font-weight:bold;">*&nbsp;</span>:<?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?></td>
              </tr>
             <tr align="right">
			 ...
			 <tr id="tr1" style="display:''">
			 	<td  width="66%" align="right" valign="middle">
              	...
              	<td width="3%">&nbsp;</td>
                <td width="31%" height="30" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:bold; font-size:12px;"> <span style="color:#FF0000; font-weight:bold;">*&nbsp;</span> :<?php echo constant("CD_SICK_LEAVE_ADD_OPTION");?></td>
