...
.pedtext1 {font-family:"Courier New", Courier, monospace;font-size:12px;color:#000000;padding-left:7px;font-weight:bold;}
</style>
<?php
...
<table width="99%" border="1" cellspacing="0" cellpadding="0" bordercolor="#EBE5CD" style="border-collapse:collapse;">
  <tr>
    ...
    <td width="88%" bordercolor="#FF9933" bgcolor="#FFF8E6"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr class="pedtext1">
        <td width="98" align="center" valign="middle" style="border-right:solid 1px; border-color:#EBE5CD;"><span class="style25"><?php echo $sum_day.'<br>'.$sat?></span></td>
        <td width="110" align="center" valign="middle" style="border-right:solid 1px; border-color:#EBE5CD;"><span class="style25"><?php echo $mon_day.'<br>'.$sun?></span></td>
        <td width="110" align="center" valign="middle" style="border-right:solid 1px; border-color:#EBE5CD;"><span class="style25"><?php echo $tue_day.'<br>'.$mon?></span></td>
        <td width="101" align="center" valign="middle" style="border-right:solid 1px; border-color:#EBE5CD;"><span class="style25"><?php echo $wed_day.'<br>'.$tue?></span></td>
        <td width="108" align="center" valign="middle" style="border-right:solid 1px; border-color:#EBE5CD;"><span class="style25"><?php echo $thu_day.'<br>'.$wed?></span></td>
        <td width="103" align="center" valign="middle" style="border-right:solid 1px; border-color:#EBE5CD;"><span class="style25"><?php echo $fri_day.'<br>'.$thu?></span></td>
        <td align="center" valign="middle"><span class="style25"><?php echo $sat_day.'<br>'.$fri?></span></td>
      </tr>
    </table></td>
  </tr>
  <tr>
          ...
          <div class="scroll-div">
              ...
              ?>
                <tr>
                    ...
                    <?php
					$num = $dbf->timeSlotAvailable($teacher_id, $sun1, $centre_time,$sun_day);                                           
