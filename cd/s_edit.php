                          ...
                          <tr>
                            ...
                            <table width="715" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                <td align="left" valign="middle">&nbsp;</td>
                                <td height="28" align="left" valign="middle">
                                  <input name="t1" type="text" class="new_textbox140_ar" id="t1" value="<?php echo $res_edit_student["family_name1"];?>" onBlur="checkTab('t1');"/></td>
                                <td align="left" valign="middle">
                                  <input name="t2" type="text" class="new_textbox140_ar" id="t2" value="<?php echo $res_edit_student["grandfather_name1"];?>" onBlur="checkTab('t2');"/></td>
                                <td align="left" valign="middle">
                                  <input name="t3" type="text" class="new_textbox140_ar" id="t3" value="<?php echo $res_edit_student["father_name1"];?>" onBlur="checkTab('t3');"/></td>
                                <td align="left" valign="middle">
                                  <input name="t4" type="text" class="new_textbox140_ar" id="t4" value="<?php echo $res_edit_student["first_name1"];?>" onBlur="checkTab('t4');"/></td>
                                </tr>
                              <tr class="shop2">
                                <td align="left" valign="top">&nbsp;</td>
                        ...
                        <form action="s_process.php?action=edit&student_id=<?=$student_id;?>" name="frm" method="post" id="frm" enctype="multipart/form-data" onsubmit="return checkid();">
                          ...
                          <tr>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><input name="email" type="text" class="new_textbox190" id="email" size="45" minlength="4" value="<?php echo $res_edit_student["email"];?>"/></td>
                          ...
                          <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                              <tr>
                                ...
                                <form action="s_process.php?action=edit_from_student_profile&student_id=<?=$student_id;?>" name="frm" method="post" id="frm" enctype="multipart/form-data" onsubmit="return checkid();">
                                  <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                    <tr>
                                      <td width="6%">&nbsp;</td>
                                      <td width="55%">
                                        <input name="mytxt_src" type="hidden" id="mytxt_src" value="<?php echo $res_edit_student["first_name1"];?>"/>
                                        <input name="mytxt_src1" type="hidden" id="mytxt_src1" value="<?php echo $res_edit_student["father_name"];?>"/>
                                        <input name="mytxt_src2" type="hidden" id="mytxt_src2" value="<?php echo $res_edit_student["grandfather_name"];?>"/>
                                        <input name="mytxt_src3" type="hidden" id="mytxt_src3" value="<?php echo $res_edit_student["family_name"];?>"/>
                                        <input name="ar_mytxt_src" type="hidden" id="ar_mytxt_src" value="<?php echo $res_edit_student["family_name"];?>"/>
                                        </td>
                                      <td width="1%">&nbsp;</td>
                                      <td width="35%">&nbsp;</td>
                                      <td width="3%">&nbsp;</td>
                                  ...
                                  <tr>
                                    <td width="329" height="28" align="right" valign="middle" class="leftmenu"><input name="gname" type="text" class="validate[required] new_textbox190_ar" id="gname" value="<?php echo $res_edit_student["guardian_name"];?>"/></td>
                                    <td align="left" valign="middle">&nbsp;</td>
                                    <td align="left" valign="middle" class="leftmenu">
                                  ...
                                  <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td width="7%" align="right" valign="middle" class="hometest_name"><input name="id_type" type="radio" id="id_typen" value="National ID" <?php if($res_edit_student["id_type"] == "National ID") { ?> checked="checked" <?php } ?>>
                                        </td>
                                        <td width="43%" align="right" valign="middle" class="shop2">
                                        <?php echo constant("PASSPORT");?>
                                        </td>
                                        <td width="10%" align="left" valign="middle" class="hometest_name"><input type="radio" name="id_type" id="id_typep" value="Passport" <?php if($res_edit_student["id_type"] != "National ID") { ?> checked="checked" <?php } ?>></td>
                                      </tr>
                                    </table></td>
                                      <td>&nbsp;</td>
                                    ...
                                    <tr>
                                      ...
                                      <td align="left" valign="middle" class="leftmenu">: <?php echo constant("STUDENT_ADVISOR_HOME_S_CLASSIC_L9");?>
                                      </td>
                                      <td>&nbsp;</td>
                                      </tr>
                                    <tr>
