...
<table width="420" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
  <tr>
    <td height="30" colspan="4" bgcolor="#CCCCCC" class="headingtext">&nbsp;<?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_GREGORIANTOHIJRI");?></td>
  </tr>
  <tr>
    <td width="28">&nbsp;</td>
...
<?php } else{?>
<table width="420" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc; margin-top:-15px;">
  <tr>
    <td height="30" colspan="4" align="right" bgcolor="#CCCCCC" class="headingtext">&nbsp;<?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_GREGORIANTOHIJRI");?></td>
  </tr>
  <tr>
    <td width="28">&nbsp;</td>
    <td width="78" align="left" valign="middle" class="bigerrortext">&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right" valign="middle"><input type="submit" name="submit" id="submit" value="<?php echo constant("btn_hijri");?>" class="btn2" onclick="showdate();"/></td>
    <td align="right" valign="middle"><input name="dated" type="text" class="datepick textfield_amt" id="dated" /></td>
