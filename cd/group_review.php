                      ...
                      <tr>
                        ...
                        <form action="group_course_process.php?action=finish" name="frm" method="post" id="frm">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              <td height="25">&nbsp;</td>
                              <td colspan="3" align="left" valign="middle" class="lable1"><span class="shop1"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_GROUPSTARTDATE");?> : </span><span class="shop2"><?php echo $_SESSION[gr_course_strdt];?></span></td>
                              <td align="left" valign="top" style="padding-top:3px;">&nbsp;</td>
                            </tr>
                            <tr>
                              <td height="25"></td>
                        ...
                        <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                                <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("REVIEW_GROUP");?></span></td>
                                <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                                </tr>
                              </table></td>
                            </tr>
                                ...
                                <td align="center" valign="top" bgcolor="#EBEBEB">
                                  ...
                                  <form action="group_course_process.php?action=finish" name="frm" method="post" id="frm">
									...
									?>
                                      ...
                                      <tr>
                                        <td height="25">&nbsp;</td>
                                        <td colspan="3" align="right" valign="middle" class="lable1"><span class="shop2"><?php echo $_SESSION[gr_course_strdt];?></span><span class="shop1"> : <?php echo constant("ADMIN_REPORT_TEACHER_BOARD_GROUPSTARTDATE");?></span></td>
                                        <td align="left" valign="top" style="padding-top:3px;">&nbsp;</td>
                                        </tr>
                                      <tr>
                                        <td height="25"></td>
