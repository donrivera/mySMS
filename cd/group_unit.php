                              ...
                              <tr>
                                ...
                                ?>
                                      ...
                                      <tr>
										...
										$max = $size["MAX(units)"];
										?>
                                        <td height="28" align="right" valign="middle" class="leftmenu"><select name="totalunit" id="totalunit" class="validate[required]" style="width:150px; text-align:center; border:solid 1px; border-color:#999999;" onBlur="checkTab('totalunit');">
