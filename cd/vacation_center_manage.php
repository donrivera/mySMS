        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" class="logintext"><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_MANAGE_CENTRE_VACATION");?></td>
                <td width="22%">&nbsp;</td>
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#000000" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                    <thead>
                      <tr class="logintext">
                        ...
                        <th width="16%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_CENTRENAME");?> </th>
                        <th width="17%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_VACATIONSTART");?> </th>
                         <th width="18%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_VACATIONEND");?></th>
                         <th width="34%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_VACATIONTYPE");?> </th>
                      </tr>
                      </thead>
                      <?php
                            ...
                            if($_REQUEST[start_date] != '' && $_REQUEST[end_date] != ''){
                                $cond = "(frm BETWEEN '$_REQUEST[start_date]' And '$_REQUEST[end_date]') And centre_id='$_SESSION[centre_id]'";
                            }else{
                                $cond = "(frm BETWEEN '$start_date' And '$end_date') And centre_id='$_SESSION[centre_id]'";
                            }
                            $num=$dbf->countRows('centre_vacation', $cond);
                            foreach($dbf->fetchOrder('centre_vacation', $cond ,"id DESC") as $val) {
                            ...
                            ?>
                      <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='vacation_center_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
      ...
      <tr>
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" align="right" valign="middle" class="logintext"><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_MANAGE_CENTRE_VACATION");?>&nbsp;</td>
                </tr>
              </table></td>
            </tr>
          <tr>
              ...
              <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#000000" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                <thead>
                  <tr class="logintext">                    
                    ...
                    <th width="23%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_CENTRENAME");?></th>
                    <th width="3%" height="25" align="center" valign="middle" bgcolor="#99CC99" >&nbsp;</th>
                    </tr>
                  </thead>
                <?php
				...
				$cond = '';
					if($_REQUEST[start_date] != '' && $_REQUEST[end_date] != ''){
						$cond = "(frm BETWEEN '$_REQUEST[start_date]' And '$_REQUEST[end_date]')";
					}else{
						$cond = "(frm BETWEEN '$start_date' And '$end_date')";
					}
				
				$num=$dbf->countRows('centre_vacation',"centre_id='$_SESSION[centre_id]' And ".$cond);
				foreach($dbf->fetchOrder('centre_vacation',"centre_id='$_SESSION[centre_id]' And ".$cond,"id DESC","*") as $val) {
                ...
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">                
                  ...
                  <td height="25" align="right" valign="middle" class="mycon" style="padding-right:5px;"><?php echo date('d-M-Y',strtotime($val[frm]));?></td>
                  <td height="25" align="right" valign="middle" class="mycon" style="padding-right:5px;"><?php echo date('d-M-Y',strtotime($val[tto]));?></td>
                  <td align="right" valign="middle" class="mycon" style="padding-right:5px;"><?php echo $val[type];?></td>
                  <td height="25" align="right" valign="middle" class="mycon" style="padding-right:5px;"><?php echo $res[name];?></td>
