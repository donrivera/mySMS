              ...
              <tr>
                ...
                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 3px; border-color:#FFCC00;">
                  ...
                  <tr>
                    ...
                    <script type="text/javascript" src="arabic_files/free-translator_tran.js"></script>
              ...
              <tr>
                <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="8%" align="left">&nbsp;</td>
                    <td width="8%" align="left">&nbsp;</td>
                    <td width="54%" height="30" align="right" class="logintext"><?php echo constant("STUDENT_ADVISOR_TRANSLATE_LANGUAGE_CONVERTER");?>&nbsp;</td>                   
                    </tr>                    
                  </table></td>
                </tr>
              <tr>
                          ...
                          <form action="https://www.translation-services-usa.com/customers/short.php" enctype="multipart/form-data" method="post" name="translator_template">
                            ...
                            <div>
                              ...
                              <table width="200" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="50">&nbsp;</td>
                                    <td width="78" align="left" valign="middle"><select id="src" name="src" style="width:100px;">
                                  <option value="en">English</option>
                                  <option value="ar">Arabic</option>
                                  </select></td>
                                    <td width="64" align="left" valign="middle"><label for="src" class="red_smalltext"><?php echo constant("STUDENT_ADVISOR_TRANSLATE_FROM");?></label></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                    <td align="left" valign="middle"><select id="dst" name="dst" style="width:100px;">
                                  <option value="ar">Arabic</option>
                                  <option value="en">English</option>
                                  </select></td>
                                    <td align="left" valign="middle"><label for="dst" class="red_smalltext"><?php echo constant("STUDENT_ADVISOR_TRANSLATE_TO");?>:</label></td>
                                  </tr>
                                </table>                              
