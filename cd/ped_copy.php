                  ...
                  <tr>
                    ...
                    ?>
                      <div style="width:800px;">
                          ...
                          <table width="100%" border="1" align="center" cellpadding="3" bordercolor="#000000" cellspacing="0" style="border-collapse:collapse;">
                            ...
                            <tr>
                              ...
                              <?php
								...
								#if($attend_date["dated"] == '0000-00-00'){ $attend_dt = '';}else{ $attend_dt = $attend_date["attend_date"]; }
                        ...
                        ?>
                            <tr>
                              <td width="10%" height="4.7%" align="left" bgcolor="#E9EFEF" class="pedtext" style="max-width:300px;position:absolute;width:388px;left: 150px;float: right; display:block;">
