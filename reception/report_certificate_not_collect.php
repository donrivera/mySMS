        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="30%" height="30" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_CERTIFICATE_NOT_COLLECT_CERTIFI");?></td>
          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="8%" height="25" align="center" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("STUDENT_ADVISOR_SEARCH_MANAGE_SL");?></th>
				<th width="26%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_TEACHER1_MANAGE_NAME");?></th>
                <th width="20%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_TEACHER1_MANAGE_MOBILE");?></th>
                <th width="29%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_TEACHER1_MANAGE_EMAIL");?></th>
                <th width="11%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("CD_AUTO_SEARCH_AGE");?></th>
                </tr>
			  </thead>
              <?php
			    $k=1;
              ...
              <tr style="display:none;" id="<?php echo $val[id];?>">
                ...
                <table width="99%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                  <tr class="pedtext">
                    ...
                    <td width="12%" height="25" align="center" valign="middle" style="background-color:#DDDDDD;"><?php echo constant("TEACHER_MY_GROUPS_STATUS");?></td>
                  </tr>
                  <?php
					$color1="#ECECFF";
					$j=1;				  
                ...
                <tr>
                  ...
                  <table width="100%" border="0" cellspacing="0">
                        <tr class="logintext">
                          ...
                          <td width="25%" height="30" align="right" class="headingtext"><img src="../images/arrow_small_right4.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_CERTIFICATE_NOT_COLLECT_CERTIFI");?> <img src="../images/arrow_small_right2.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS");?></td>
                          </tr>
                        </table>                        
                  </td>
                  </tr>
                  ...
                  <td align="left" valign="top" bgcolor="#FFFFFF">
					...
					foreach($dbf->fetchOrder('student',"centre_id='$_SESSION[centre_id]'","","") as $val){
				     ...
				     ?>
                      ...
                      <tr style="display:none;" id="<?php echo $val[id];?>">
                        <td colspan="4" align="right"  bgcolor="#F8F9FB" valign="middle" style="padding-left:5px;">
                          <?php if($num_dtls>0) { ?>
