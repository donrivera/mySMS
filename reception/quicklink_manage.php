        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr>
                  <td width="54%" height="30" align="left" valign="middle" class="centercolumntext"><?php echo constant("RECEPTION_QUICKLINK_MANAGE_ADDTO_QUICKLINK");?></td>
                                  ...
                                  <tr>
                                    ...
                                    <td height="28" colspan="2" align="left" valign="middle" class="leftmenu">
                                      ...
                                      <table width="99%" border="0" cellspacing="0" bordercolor="#cccccc" cellpadding="0" style="border-collapse:collapse;">
                                        ...
                                        <?php
										$k = 0;
										foreach($dbf->fetchOrder('quick_menu',"module_name='Receptionist'","id") as $qpage) {
									$num=$dbf->countRows('quick_links',"link_name='$qpage[link_name]' And module_name='Receptionist' And user_id='$_SESSION[id]'");
										?>
          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr>
                  ...
                  <td width="8%" align="left">&nbsp; </td>
                  <td width="8%" align="left">&nbsp;</td>
                  <td width="54%" height="30" align="right" valign="middle" class="centercolumntext"><?php echo constant("RECEPTION_QUICKLINK_MANAGE_ADDTO_QUICKLINK");?></td>
                </tr>
            </table></td>
          </tr>
          <tr>
                                    ...
                                    <td height="28" colspan="2" align="left" valign="middle" class="leftmenu">
                                      ...
                                      <table width="99%" border="0" cellspacing="0" bordercolor="#cccccc" cellpadding="0" style="border-collapse:collapse;">
                                        ...
                                        <tr>
                                          ...
                                          <td width="52%" align="right" valign="middle" bgcolor="#DDDDDD" class="mymenutext"><?php echo constant("ADMIN_QUICKLINK_MANAGE_PAGENAME");?></td>
                                          <td width="1%" align="center" valign="middle" bgcolor="#DDDDDD">&nbsp;</td>
