...
<?php }else{ ?>
<textarea name="textarea" id="textarea" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF; text-align:right;" rows="5" cols="29" onfocus="if(this.value=='SMS Message-160 char')this.value='';" onclick="if(this.value=='SMS Message-160 char')this.value='';" onKeyDown="CountLeft();" onKeyUp="CountLeft();" ><?php echo $res[contents];?></textarea>
<?php } ?>
