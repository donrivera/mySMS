                ...
                <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="8%" align="left"><a href="auto_search.php"> 
                      <input type="button" value="<?php echo constant("btn_cancel_btn2");?>" class="mybtn1" border="0" align="left" /></a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                        ...
                        <form action="s_process.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm" enctype="multipart/form-data">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td height="28" align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_TEACHER1_MANAGE_NATIONALITY");?></td>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              <td>&nbsp;</td>
                              <td align="right" valign="middle"><?php echo $res[email]; ?></td>
                              <td>&nbsp;</td>
							...
							<?php echo $course;?>
                              ...
                              <td>&nbsp;</td>
                              <td height="28" align="left" valign="top" class="leftmenu"><label class="description" for="element_11"> : <?php echo constant("STUDENT_ADVISOR_S10_INTEREST");?></label></td>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              ...
                              <td>&nbsp;</td>
                               <td height="28" align="left" valign="top" class="leftmenu"><label class="description" for="element_7"> : <?php echo constant("STUDENT_ADVISOR_S10_COMMENTS");?></label></td>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td align="left" valign="middle">&nbsp;</td><td height="28" align="left" valign="middle" class="leftmenu"> : <?php echo constant("STUDENT_ADVISOR_HOME_S_CLASSIC_STDPHOTO");?></td>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            </tr>
                            <tr>                             
                              <td align="left" valign="middle">&nbsp;</td>							 
