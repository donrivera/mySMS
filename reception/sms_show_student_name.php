...
foreach($dbf->fetchOrder("student","(first_name LIKE '$name%' OR student_first_name LIKE '$name%' OR first_name1 LIKE '$name%') And centre_id='$_SESSION[centre_id]' And email <> ''") as $val){
?>
  <tr>
...
?>
  <tr>
    <td width="103" align="right" valign="top" style="padding-right:2px; font-size:121px; font-family:Arial, Helvetica, sans-serif; color:#000;"><a href="sms_student_f.php?student_id=<?php echo $val["id"];?>" style="text-decoration:none;"><?php echo $val["email"];?></a></td>
