...
include_once '../includes/language.php';
			...
			ob_clean();
			$VALUE=$_POST['val']; 							
				$totalcount=$dbf->countRows("alerts","rep='1' AND status='0' And imp='1' And id not in (select alert_id from alerts_read where user_id='$_SESSION[id]')");//mysql_result(mysql_query($total),0);
				$perpage=1;
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			...
			<tr>
			  ...
			  <td align="center" valign="top">
			   <?php				
				foreach($dbf->fetchOrder('alerts',"rep='1' AND status='0' And imp='1'","dt DESC LIMIT $limitstart,$limitend") as $valalert) {
				?>
