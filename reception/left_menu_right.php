...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="30" align="right" valign="middle" bgcolor="#FFA938" class="centercolumntext" style="background:url(../images/footer_repeat.png) repeat-x;"><?php echo constant("ADMIN_MENU_QUICK_LINKS");?>&nbsp;&nbsp;</td>
  </tr>
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">    
    <?php
	foreach($dbf->fetchOrder('quick_links',"module_name='Receptionist' And user_id='$_SESSION[id]'","prec") as $val_quick)
	{
	...
	?>
      <tr>
        <td width="5" style="border-left:solid 2px; border-color:#CCC;">&nbsp;</td>
        <td width="1291" align="right" valign="middle" class="<?php echo $class;?>"><a style="text-decoration:none;" href="<?php echo $val_quick[links];?>"><?php echo $linkname;?></a></td>
        <td width="34" height="30" align="center" valign="middle"><a href="<?php echo $val_quick[links];?>"><img src="<?php echo $img;?>" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr>
