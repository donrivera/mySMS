  ...
  <tr>
	...
	?>
      <tr>
        ...
        <td width="357" align="right" valign="middle" class="<?php echo $class;?>"><a style="text-decoration:none;" href="<?php echo $val_quick[links];?>"><?php echo $linkname; ?></a>&nbsp;</td>
        <td width="33" height="30" align="center" valign="middle" ><a href="<?php echo $val_quick[links];?>"><img src="<?php echo $img;?>" width="16" height="16" border="0" /></a>
        </td>
      </tr>
      <tr>
