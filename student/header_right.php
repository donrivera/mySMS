...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="topbg" align="center">
  <tr>
    <td height="46" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="30" align="center" valign="middle"> : <?php echo constant("CD_GROUP_PROGRESS_LANGUAGE");?></td>
        <td width="10" align="left" valign="middle">&nbsp;</td>
        <td width="5" align="left" valign="middle">&nbsp;</td>
        <td align="center" valign="middle"><table width="150" border="0" cellspacing="0" cellpadding="0" style="display:'';">
          <tr>
  ...
  <tr>
    <td align="right" valign="top" ><div id="glowmenu" class="glowingtabs">
	  ...
	  ?>
        <li><a <?php echo $mystyle;?> href="calc_converter.php" title="Date Convertor"><span <?php echo $mystyle;?>><?php echo constant("STUDENT_MENU_DATE_CONVERTER");?></span></a></li>
	  ...
	  ?>
        <li><a <?php echo $mystyle;?> href="certificate_report.php" title="Certificates Grade"><span <?php echo $mystyle;?>><?php echo constant("STUDENT_MENU_CERTIFICATE_GRADES");?></span></a></li>
