...
$i = 1;
foreach($dbf->fetchOrder('alerts',"(student='1' AND status='0') OR audience='1'","id DESC LIMIT 0,10") as $val) {
?>
	  ...
	  <td width="432" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    <td colspan="2" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="11%" align="left" valign="middle" class="hometest_time"><?php echo constant("STUDENT_ALERT_MARKAS");?> : </td>
                <td width="6%" align="center" valign="middle" class="hometest_time"><img src="../images/important.png" width="16" height="16"></td>
                <td width="83%" align="left" valign="middle" class="hometest_time"><?php echo constant("STUDENT_ALERT_IMPORTANT");?></td>
              </tr>
            </table></td>
	    </tr>
		<?php } ?>
