            ...
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    <td width="54%" height="30" class="logintext"><?php echo constant("STUDENT_TRANSLATE_LANGUAGE_CONVERTER");?></td>
                    <td width="22%">&nbsp;</td>
                ...
                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 3px; border-color:#FFCC00;">
                  ...
                  <tr>
                    <td colspan="3" align="center" valign="middle">
                        ...
                        <p><strong><?php echo constant("STUDENT_TRANSLATE_TXTT1");?>:</strong></p>
                        <p class="red_smalltext"><?php echo constant("STUDENT_TRANSLATE_TXTT2");?></p>
                        ...
                        <textarea id="txt_src" cols="50" name="txt_src" rows="5" onkeyup="detectLanguage(); return false;" style="border:solid 2px; border-color:#CCCCCC;"></textarea>
                                    ...
                                    <div>
                                        <div>
                                            <label for="src" class="red_smalltext"><?php echo constant("STUDENT_TRANSLATE_FROM");?>:</label>
                                        ...
                                        <div>
                                            <label for="dst" class="red_smalltext"><?php echo constant("STUDENT_TRANSLATE_TO");?>:</label>
                       ...
                       <a id="translate-free" href="#" title="Get this text translated by machine for free." onclick="googleGetTranslation();return false;" class="free-translator-button"><?php echo constant("ADMIN_TRANSLATE_TRANSL");?></a>
