				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
					<tr>
					  ...
					  <td width="492" align="left" valign="middle" class="home_head_text"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr>
							...
							<td width="61%" align="left" valign="middle" class="home_head_text"> <?php echo constant("STUDENT_ALERT_LATEST_INFORMATION");?> </td>
							<td width="34%">&nbsp;</td>
						  </tr>
					  </table></td>
					</tr>
					...
					<tr>
					  ...
					  <td align="center" valign="top"><div id="dataDisplay">
						  <?php
								$i = 1;
								foreach($dbf->fetchOrder('alerts',"student='1' AND status='0'","id DESC") as $val) {
							?>
					    <table width="450" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td width="432" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="26%" align="left" valign="middle" class="hometest_name"><?php echo constant("STUDENT_ALERT_POSTEDBYADMIN");?> </td>
                                ...
                                <?php if($val["imp"]=="1") { ?>
									<tr>
									  <td colspan="2" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
										  <tr>
											<td width="14%" align="left" valign="middle" class="hometest_time"><?php echo constant("STUDENT_ALERT_MARKAS");?> : </td>
											<td width="9%" align="center" valign="middle" class="hometest_time"><img src="../images/important.png" width="16" height="16" /></td>
											<td width="77%" align="left" valign="middle" class="hometest_time"><?php echo constant("STUDENT_ALERT_IMPORTANT");?></td>
										  </tr>
									  </table></td>
									</tr>
                                <?php } ?>
                                <tr>
                                  <td colspan="2" align="left" valign="top" class="hometest_time"><?php echo constant("STUDENT_ALERT_MSGTYPE");?> : <?php echo $valm["name"];?></td>
                                </tr>
                                <tr>
					  ...
					  <?php
							$i = 1;
							foreach($dbf->fetchOrder('news',"student='1' AND status='0'","id DESC") as $val) {
					   ?>
					    <table width="450" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="64" align="center" valign="middle"><img src="../images/admin.png" width="55" height="55" /></td>
                            ...
                            <td width="432" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                               ...
                               <?php
                                ...
                                <tr>
                                  <td colspan="2" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="15%" align="left" valign="middle" class="hometest_time"><?php echo constant("STUDENT_ALERT_MARKAS");?> : </td>
                                        <td width="6%" align="center" valign="middle" class="hometest_time"><img src="../images/important.png" width="16" height="16" /></td>
                                        <td width="79%" align="left" valign="middle" class="hometest_time"><?php echo constant("STUDENT_ALERT_IMPORTANT");?></td>
                                      </tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr bgcolor="#000000">
            <td height="30" align="right" valign="middle" bgcolor="#FFA938" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;"><?php echo constant("ALERT");?>&nbsp;&nbsp;</td>
            </tr>
          <tr>
            <td height="450" align="left" valign="top" bgcolor="#FFFFFF">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                <tr>
                  ...
                  <td width="476" height="50">&nbsp;</td>
                  <td width="47" align="left" valign="top">&nbsp;</td>
                  <td width="492" align="left" valign="middle" class="home_head_text">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="5%" align="left" valign="middle">&nbsp;</td>
                      <td width="72%" align="right" valign="middle" class="hometest_name"><?php echo constant("STUDENT_ALERT_LATEST_INFORMATION");?>&nbsp;</td>
                      <td width="23%" align="left"><img src="../images/Info.png" width="16" height="16" /></td>
                      </tr>
                    </table></td>
                  </tr>
