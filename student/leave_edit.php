...
if($_REQUEST['action']=='edit'){
	...
	$string="reason='$_POST[reason]',frm='$_POST[startdate]',tto='$_POST[enddate]',last_updated='$cr_date',updated_by='$_SESSION[id]'";
...
function validate(){
	...
	if(document.frm.reason.value == ''){
		document.getElementById('lblname').innerHTML = "<html><table width='190' border='0' cellspacing='0' cellpadding='0' style='border:solid 1px; border-color:#990000;'><tr><td width='14%' rowspan='2' align='center' valign='middle' bgcolor='#FFCCFF'><img src='../images/block.png' width='16' height='16' /></td><td width='6%' bgcolor='#FFCCFF'>&nbsp;</td><td width='80%' rowspan='2' bgcolor='#FFCCFF' class='nametext1'>Enter Reason. </td></tr><tr><td bgcolor='#FFCCFF'>&nbsp;</td></tr></table></html>";
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="450" align="left" valign="top" style="border:solid 1px; border-color:#CCC; background-color:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <?php } ?>
              <?php
				$res = $dbf->strRecordID("student_vacation","*","id='$_REQUEST[id]'");
			  ?>
              <tr>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("STUDENT_LEAVE_MANAGE_EDITLEAVE");?></span></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
                        ...
                        <form action="leave_edit.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm">
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><input name="startdate" type="text" class="validate[required] datepick new_textbox190" id="startdate" size="45" minlength="4" value="<?php echo $res[frm];?>" readonly="readonly"/></td>
                              <td>&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle"><input name="enddate" type="text" class="validate[required] datepick new_textbox190" value="<?php echo $res[tto];?>" readonly="" id="enddate" size="45" minlength="4"/></td>
                              <td>&nbsp;</td>
                              </tr>
                              <tr>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              ...
                              <textarea name="reason" class="validate[required]" style="height:200px; width:190px; border:solid 1px; background-color:#ECF1FF;border-color:#999999;" id="reason"><?php echo $res[reason];?></textarea></td>
                              <td>&nbsp;</td>
              ...
              <tr>
                <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="8%" align="left">&nbsp;</td>
                    <td width="8%" align="left">&nbsp;</td>
                    <td width="8%" align="left" class="logintext"><?php echo constant("STUDENT_MENU_LEAVE");?></td>
                    </tr>
                  </table></td>
                </tr>
              <tr>
                            ...
                            <td align="center" valign="top" bgcolor="#EBEBEB">
                              ...
                              <form action="leave_edit.php?action=edit&id=<?php echo $_REQUEST[id];?>" name="frm" method="post" id="frm">
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                  ...
                                  <tr>
                                    <td colspan="2" rowspan="2" align="right" valign="middle" class="nametext1" id="lblerror">&nbsp;</td>
                                    <td height="30">&nbsp;</td>
                                    <td align="right" valign="middle"><input name="startdate" type="text" class="validate[required] datepick new_textbox190" readonly="" id="startdate" size="45" minlength="4" value="<?php echo $res[frm];?>"/></td>
                                    <td>&nbsp;</td>
                                    <td align="left" valign="middle" class="leftmenu">&nbsp; : <span class="nametext1">*</span> <?php echo constant("STUDENT_LEAVE_MANAGE_LEAVEFROM");?></td>
                                    </tr>
                                  <tr>
                                    <td height="30">&nbsp;</td>
                                    <td align="right" valign="middle"><input name="enddate" type="text" class="validate[required] datepick new_textbox190" readonly="" id="enddate" size="45" minlength="4" value="<?php echo $res[tto];?>"/></td>
                                    <td>&nbsp;</td>
                                    <td align="left" valign="middle" class="leftmenu">&nbsp; : <span class="nametext1">*</span> <?php echo constant("STUDENT_LEAVE_MANAGE_LEAVETO");?></td>
                                    </tr>
                                  <tr>
                                    <td colspan="2" rowspan="2" align="right" valign="middle" class="nametext1" id="lblname">&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td align="right" valign="middle"><textarea name="reason" class="validate[required]" style="height:200px; width:190px; border:solid 1px; background-color:#ECF1FF;border-color:#999999;" id="reason" ><?php echo $res[reason];?></textarea></td>
                                    <td>&nbsp;</td>
