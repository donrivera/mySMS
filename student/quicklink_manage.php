...
//Get from the table (i.e Logout time)
...
if($_REQUEST["action"] == "update"){
	...
	$dbf->deleteFromTable("quick_links","module_name='Student' And user_id='$_SESSION[id]'");
	
	# Count number of pages
	$total = $_REQUEST["total"];
	
	# Loops for number of pages
	for($i = 0; $i <= $total; $i++){
		...
		if($ida != ''){
			...
			//Insert query here
			$string="link_name='$link_name',prec='$i',links='$links',module_name='Student',user_id='$_SESSION[id]',centre_id='$_SESSION[centre_id]'";
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr>
                  <td width="54%" height="30" class="logintext"><?php echo constant("STUDENT_QUICKLINK_MANAGE_ADDTO_QUICKLINK");?></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("TEACHER_QUICKLINK_MANAGE_ADDTO_QUICKLINK");?></span></td>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;">
                      <tr>
                        <td align="center" valign="top" bgcolor="#EBEBEB">
                        	<form action="quicklink_manage.php?action=update" name="frm" method="post" id="frm">
                                  ...
                                  <tr>
                                    ...
                                    <td height="28" colspan="2" align="left" valign="middle" class="leftmenu">
                                      ...
                                      <table width="99%" border="0" cellspacing="0" bordercolor="#cccccc" cellpadding="0" style="border-collapse:collapse;">
                                        ...
                                        <?php
										$k = 0;
										foreach($dbf->fetchOrder('quick_menu',"module_name='Student'","id") as $qpage) {
									$num=$dbf->countRows('quick_links',"link_name='$qpage[link_name]' And module_name='Student' And user_id='$_SESSION[id]'");
										?>
          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr>
                  ...
                  <td width="8%" align="left">&nbsp; </td>
                  <td width="8%" align="left">&nbsp;</td>
                  <td width="54%" height="30" align="right" class="logintext"><?php echo constant("STUDENT_QUICKLINK_MANAGE_ADDTO_QUICKLINK");?></td>
                </tr>
            </table></td>
          </tr>
          <tr>
            ...
            <table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("TEACHER_QUICKLINK_MANAGE_ADDTO_QUICKLINK");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                                    ...
                                    <td height="28" colspan="2" align="left" valign="middle" class="leftmenu">
                                      ...
                                      <table width="99%" border="0" cellspacing="0" bordercolor="#cccccc" cellpadding="0" style="border-collapse:collapse;">
                                        ...
                                        <tr>
                                          ...
                                          <td width="5%" align="center" valign="middle" bgcolor="#DDDDDD">&nbsp;</td>
                                          <td width="42%" align="right" valign="middle" bgcolor="#DDDDDD" class="mymenutext"><?php echo constant("ADMIN_QUICKLINK_MANAGE_PAGENAME");?></td>
                                          <td width="5%" height="25" align="center" valign="middle" bgcolor="#DDDDDD">
                                          <input type="checkbox" name="checkbox" id="checkbox" onChange="check1(this.checked)"></td>
                                          </tr>
                                        </table>
