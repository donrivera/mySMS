        ...
        <td width="79%" align="left" valign="top" ><table width="99%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" align="left" class="logintext"><?php echo constant("STUDENT_CALC_CONVERTER_DATA_CONVERTER");?></td>
                </tr>
            </table></td>
          </tr>
          <tr>
            <td height="400" align="center" valign="middle" bgcolor="#FFFFFF">
			<br>
			<table width="900" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
      ...
      <tr>
        ...
        <td width="79%" align="left" valign="top" ><table width="99%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="54%" height="30" align="right" class="logintext"><?php echo constant("STUDENT_CALC_CONVERTER_DATA_CONVERTER");?>&nbsp;</td>
                </tr>
            </table></td>
          </tr>
          <tr>
			...
			<table width="900" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
              ...
              <tr>
                ...
                <td colspan="3" align="left" valign="middle" class="bigerrortext"><table width="860" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="425" align="left" valign="top"><iframe height="240" width="420" src="calc_hijri.php" style="border:none;"> </iframe></td>
                    <td width="10">&nbsp;</td>
                    <td width="425" align="left" valign="top"><iframe height="240" width="420" src="calc_eng.php" style="border:none;"> </iframe></td>
