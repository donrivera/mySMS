          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
				...
				<th width="28%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_TEACHER1_MANAGE_NAME");?></th>
                <th width="19%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_TEACHER1_MANAGE_MOBILE");?></th>
                <th width="30%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("ADMIN_TEACHER1_MANAGE_EMAIL");?></th>
                <th width="4%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("CD_AUTO_SEARCH_AGE");?></th>
                <th width="13%"colspan="2" align="center" valign="middle" bgcolor="#99CC99" class="pedtext" >
				<?php echo constant("STUDENT_ADVISOR_HOME_S_CLASSIC_STDPHOTO");?></th>
              </tr>
			  </thead>
              <?php
			    $k=1;
              ...
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                <td width="3%" height="25" align="center" valign="middle" class="contenttext"><a href="javascript:void(0);" onClick="show_details('<?php echo $val[id];?>');">
				...
				<td width="28%" align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[first_name];?> <?php echo $Arabic->en2ar($dbf->StudentName($val["id"]));?> <?php echo " [".$num_dtls."]";?></td>
                <td width="19%" align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[student_mobile];?></td>
                <td width="30%" align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[email];?></td>
                <td width="4%" align="center" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[age];?></td>
                <?php
				if($val["photo"]!=''){
				...
				?>
                <td width="13%" align="center" valign="middle" style="background-color:<?php echo $color;?>" >
                <img src="<?php echo $photo;?>" width="70" height="80" oncontextmenu="return false;"/></td>
                <?php
					  $i = $i + 1;
					  if($color=="#ECECFF"){
						  $color = "#FBFAFA";
              ...
              <tr style="display:none;" id="<?php echo $val[id];?>">
                ...
                <td height="25" colspan="5" align="left"  bgcolor="#F8F9FB" valign="middle" style="padding-left:5px;">
                <?php if($num_dtls>0) { ?>
                <table width="800" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                  <tr class="pedtext">
                    ...
                    <td width="12%" height="25" align="left" valign="middle" style="background-color:#DDDDDD;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_SEARCH_GROUPNM");?></td>
                    <td width="13%" height="25" align="left" valign="middle" style="background-color:#DDDDDD;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_COURSE");?></td>
                    <td width="12%" height="25" align="left" valign="middle" style="background-color:#DDDDDD;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_TEACHER");?></td>
                    <td width="21%" align="left" valign="middle" style="background-color:#DDDDDD;">&nbsp;<?php echo constant("CD_SEARCH_PRINT_INVOICE_INVOICENO");?></td>
                    <td align="center" valign="middle" style="background-color:#DDDDDD;">&nbsp;<?php echo constant("CD_SEARCH_PRINT_INVOICE_BALANCE");?>&nbsp;</td>
                    <td width="12%" height="25" align="left" valign="middle" style="background-color:#DDDDDD;"><?php echo constant("TEACHER_MY_GROUPS_STATUS");?></td>
                  </tr>
                  <?php
					$color1="#ECECFF";
					$j=1;				  
                  ...
                  <tr bgcolor="<?php echo $color1;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color1;?>'">
                    ...
                    <td align="left" valign="middle"><?php echo $val_group[status];?></td>
                  </tr>
                  <?php
					if($color1=="#ECECFF")
					  {
              ...
              <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr class="logintext">
                          ...
                          <td width="27%" align="left" valign="middle">
                            <table width="256" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <td width="8%" align="left"><span class="logintext"> :&nbsp;<?php echo constant("ADMIN_REPORT_GROUP_TO_FINISH_TO");?></span> </td>
                          ...
                          <td width="30%" align="left" valign="middle" class="logintext">:&nbsp;<?php echo constant("ADMIN_REPORT_GROUP_TO_FINISH_PERIODFROM");?></td>
                          <td width="25%" height="30" align="right" class="headingtext">                          
						  <?php echo constant("ADMIN_MENU_REPORTS_COLLECT");?>
                          <img src="../images/arrow_small_right2.png" width="16" height="16"></td>
                          </tr>
                        </table>                        
                  </td>
                  </tr>
                <tr>
                  <td align="left" valign="top" bgcolor="#FFFFFF">
                    ...
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tablesorter" id="sort_table1" style="border-collapse:collapse;">
                      <thead>
                        <tr class="logintext">
                          <th width="21%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("STUDENT_ADVISOR_HOME_S_CLASSIC_STDPHOTO");?></th>                          
				...
				?>
                      <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
				        ...
				        ?>
                        <td width="21%" align="center" valign="middle" style="background-color:<?php echo $color;?>" >
                          <img src="<?php echo $photo;?>" width="70" height="80" oncontextmenu="return false;"/></td>
                        
                        
                        <td width="18%" align="right" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[student_mobile];?></td>
				     ...
				     ?>
                      ...
                      <tr style="display:none;" id="<?php echo $val[id];?>">
                        <td height="25" colspan="5" align="right"  bgcolor="#F8F9FB" valign="middle" style="padding-left:5px;">
                          <?php if($num_dtls>0) { ?>
                          <table width="800" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                            <tr class="pedtext">
                              
                              <td width="13%" height="25" align="right" valign="middle" style="background-color:#DDDDDD;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_COURSE");?></td>
                              <td width="12%" height="25" align="right" valign="middle" style="background-color:#DDDDDD;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_TEACHER");?></td>
                              <td width="21%" align="right" valign="middle" style="background-color:#DDDDDD;">&nbsp;<?php echo constant("CD_SEARCH_PRINT_INVOICE_INVOICENO");?></td>
                              <td align="center" valign="middle" style="background-color:#DDDDDD;">&nbsp;<?php echo constant("CD_SEARCH_PRINT_INVOICE_BALANCE");?>&nbsp;</td>
                              <td width="12%" height="25" align="right" valign="middle" style="background-color:#DDDDDD;"><?php echo constant("TEACHER_MY_GROUPS_STATUS");?></td>
                             <td width="12%" height="25" align="right" valign="middle" style="background-color:#DDDDDD;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_SEARCH_GROUPNM");?></td>
                            ...
                            <tr bgcolor="<?php echo $color1;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color1;?>'">
                              ...
                              <td height="25" align="right" valign="middle"><?php echo $val_group[group_name];?> <?php echo $val_group["group_time"];?>-<?php echo $dbf->GetGroupTime($val_group["id"]);?></td>
                              <td align="center" valign="middle"><?php echo $j;?></td>
                              </tr>
                            <?php
							if($color1=="#ECECFF"){
