			...
			<table width="100%" border="1" cellpadding="0" bordercolor="#000000" cellspacing="0" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
              ...
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='s_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                ...
                <?php
				  ...
				  ?>
                <td width="3%" align="center" valign="middle" ><a href="search_adding_group.php?student_id=<?php echo $val[id];?>&page=search_adding_group.php&amp;TB_iframe=true&amp;height=240&amp;width=465&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox">
                  <?php //if($numg > 0) {?>
              ...
              <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td align="left" valign="top" bgcolor="#FFFFFF">
					...
					$i = 1;
					$color = "#ECECFF";
					$num=$dbf->countRows('student',"family_name LIKE '$_REQUEST[testinput]%' OR family_name1 LIKE '$_REQUEST[testinput]%' OR first_name LIKE '%$_REQUEST[testinput]%' OR student_first_name LIKE '%$_REQUEST[testinput]%'");
					foreach($dbf->fetchOrder('student',"family_name LIKE '$_REQUEST[testinput]%' OR family_name1 LIKE '$_REQUEST[testinput]%' OR first_name LIKE '%$_REQUEST[testinput]%' OR student_first_name LIKE '%$_REQUEST[testinput]%'","id DESC ") as $val){					 
