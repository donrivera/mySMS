...
function secondPass()
{
	...
	if(f)
		for(key in google_language_code)
			...
			document.getElementById("t1").value = temp[0];
			document.getElementById("t2").value = temp[1];
			document.getElementById("t3").value = temp[2];
			document.getElementById("t4").value = temp[3];
