...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td height="26" align="center" valign="middle" class="<?php echo $class;?>"><a href="single-certificate.php?student_id=<?php echo $student_id;?>&course_id=<?=$course_id?>"><?php echo constant("ADMIN_MENU_CERTIFICATE");?></a></td>
          </tr>
          <tr>
            <td height="2"></td>
            <td height="2" align="left" valign="middle"></td>
