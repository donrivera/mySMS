		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="left" valign="top"><table width="98%" border="1" cellspacing="0" cellpadding="0" bordercolor="#999" style="border-collapse:collapse;">
                  <tr>
                  ...
                  <tr>
                    <td width="86%" height="22" align="right" valign="middle" class="pedtext"><?php echo constant("NO_OF_ENROLLED_COURSES");?> :</td>
                    <td width="14%" align="center" valign="middle" class="mytext"><?php echo $dbf->getDataFromTable("student_enroll","COUNT(id)","student_id='$student_id'");?></td>
                  </tr>
                  <tr>
