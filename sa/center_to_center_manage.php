          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0">
              <tr>
                ...
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left"><a href="center_to_center_add.php">
          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="9%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_FROM");?></th>
                ...
                <th width="14%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext">Student Name(s)</th>
                <th width="16%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
              ...
              <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                ...
                <a href="center_to_center_process.php?action=delete&amp;del_id=<?php echo $transfer[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="Delete" /></a>
                <?php } ?>
                </td>
                <?php
                    ...
                    <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#000000" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                      <thead>
                        <tr class="logintext">
                          ...
                          <th width="9%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?></th>
                          <th width="13%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("CD_STUDENT_CENTER_FROM");?></th>
                          <th width="11%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("CD_STUDENT_CENTER_FROMGROUP");?></th>
                          <th width="10%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("CD_STUDENT_CENTER_TO");?></th>
                          ...
                          <th width="15%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
                          <th width="9%" align="right" valign="middle" bgcolor="#DDDDDD" class="pedtext" style="padding-right:25px;"><?php echo constant("CD_STUDENT_TRANSFER_DATE");?></th>
                ...
                <tr>
                  <td>                    
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                      <tr>
                        <td width="76%" align="center">&nbsp;</td>
                        <td width="24%" align="left" valign="top" ><div id="pager" class="pager" style="text-align:left; padding-top:10px;">
