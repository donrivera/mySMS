      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="57%" align="right" valign="middle"><div id="suggest" style="width:450px;"> <span class="leftmenu"><?php echo constant("RE_MENU_SEARCH");?></span>:
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="topbg" align="right">
  <tr>
    <td align="left" height="40" valign="top" background="images/title.png" ><div id="glowmenu" class="glowingtabs">
      <ul>        
         <?php
	  $mystyle = '';
