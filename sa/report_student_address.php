    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left" height="25" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>&nbsp;</td>
              <td width="36" align="center" valign="middle"><a href="report_student_address_word.php?area_code=<?php echo $_REQUEST[area_code];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_WORD ?>"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_student_address_csv.php?area_code=<?php echo $_REQUEST[area_code];?>"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_XLS ?>"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_student_address_pdf.php?area_code=<?php echo $_REQUEST[area_code];?>"><img src="../images/pdf.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_PDF ?>"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_student_address_print.php?area_code=<?php echo $_REQUEST[area_code];?>" target="_blank"><img src="../images/print.png" width="16" height="16" border="0" title="<?php echo STUDENT_ADVISOR_SEARCH_MANAGE_PRINT ?>"></a></td>
            </tr>
          </table></td>
      </tr>
    </table></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="50%" height="30" align="left" class="logintext">
                  ...
                  <select name="area_code" id="area_code"  style="border:solid 1px; border-color:#FFCC33; height:20px; width:110px;" onChange="javascript:document.frm.action='report_student_address.php',document.frm.submit();">
          ...
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <tr class="logintext">
                  ...
                  <th width="10%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_NOT_ENROLLED_MOBILENUMBER");?></th>
                  <th width="10%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_REPORT_STUDENT_GROUP_GRADE_EMAIL");?></th>
                  <th width="10%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_PRINT_AREA");?></th>
                  <th width="40%" align="left" valign="middle" class="pedtext"><?php echo constant("ADMIN_PRINT_ADDRESS");?></th>
                  <th width="16%" colspan="2" align="center" class="pedtext"><?php echo constant("CD_CENTRE_SCHEDULE_RANGEDATE_GROUP");?></th>
                </tr>
				</thead>
                <?php
					#echo $_REQUEST['area_code'];
					if($_REQUEST[area_code]!=''){
						
						$cond="s.area_code='$_REQUEST[area_code]'";
					}else{
						
						$cond="s.area_code=a.code AND s.area_code='$_REQUEST[area_code]'";
					}
                ...
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                  ...
                  <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><a href="single-home.php?student_id=<?php echo $val_student[id];?>" style="cursor:pointer;"><?php echo $dbf->printStudentName($val_student[id]);?></a></td>
                  ...
                  <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $dbf->getDataFromTable("area","name","code='$val_student[area_code]'");?></td>
                  <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val_student[address];?></td>
          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  ...
                  <td width="7%" align="left"><select name="teacher" id="teacher"  style="border:solid 1px; border-color:#FFCC33; height:20px; width:110px;" onChange="javascript:document.frm.action='report_student_not_enrolled.php',document.frm.submit();">
                  ...
                  <td width="26%" align="left">&nbsp; : <span class="logintext"><?php echo constant("ADMIN_REPORT_STUDENT_NOT_ENROLLED_STATUS");?></span></td>
                  <td width="12%" align="right" class="logintext"><?php echo constant("ADMIN_MENU_REPORTS_NOT_ENROLLED");?><img src="../images/arrow_small_right2.png" width="16" height="16"></td>
                </tr>
            </table></td>
          </tr>
          <tr>
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
				  <td align="right" valign="middle" class="mycon" ><?php echo $course;?></td>                  
                  <td align="right" valign="middle" class="mycon"><?php echo $lead;?></td>
                  <td align="right" valign="middle" class="mycon" ><?php echo $com["comments"];?></td>
                  <td align="right" valign="middle" class="mycon" ><?php echo $dt;?></td>
                  ...
                  <td align="right" valign="middle" class="mycon" ><?php echo $dbf->printStudentName($val_student[id]);?></td>
                  <td height="25" align="center" valign="middle" class="mycon"><?php echo $i;?></td>
                  <?php
					  $i = $i + 1;
					  if($color=="#ECECFF"){
