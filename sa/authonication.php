    ...
    <td align="left" valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#000000;">
          <tr>
            <td height="30" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;"><?php echo constant("STUDENT_ADVISOR_SEARCH_AUTHENTI");?></td>
          </tr>
          <tr>
            ...
            <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="40" align="center" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF9900;">
                  <tr>
                    <td height="30" align="center" valign="middle" bgcolor="#FFFFCC"><span class="loginheading">
					<?php echo constant("STUDENT_ADVISOR_SEARCH_TEXTNOLOGIN");?></span></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td align="center"><table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF9900;">
                  <tr>
                    ...
                    <td width="14%" height="30" align="center" valign="middle" bgcolor="#FFECFF"><a href="search.php"><input type="button" value="<?php echo constant("btn_btn_no");?>" class="btn_no" border="0" align="left" /></a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
        ...
        <td width="78%" align="right" valign="top">
          <table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#000000;">
                <tr>
                  <td height="30" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;" align="right"><?php echo constant("STUDENT_ADVISOR_SEARCH_AUTHENTI");?></td>
                  </tr>
                <tr>
                  <td height="40" align="left" valign="middle">&nbsp;</td>
                  </tr>
                <tr>
                  <td><table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td align="center"><table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF9900;">
                        <tr>
                           <td width="14%" height="30" align="center" valign="middle" bgcolor="#FFECFF"><a href="search.php"><input type="button" value="<?php echo constant("btn_btn_no");?>" class="btn_yes" border="0" align="left" /></a></td>
