		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="25%" height="30" class="logintext">
                  <img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS_SUMMARY");?></td>
                  ...
                  <select name="cmbgroup" id="cmbgroup" style="border:solid 1px; border-color:#FFCC33; height:20px; width:150px;"  onChange="setsubmit();">
                    ...
                    <?php
					  ...
					  ?>
                    <option value="<?php echo $val[id];?>" <?php if($_REQUEST[cmbgroup]==$val[id]){?> selected="selected"<?php }?>><?php echo $val['group_name'] ?>, <?php echo date('d/m/Y',strtotime($val['start_date']));?> - <?php echo date('d/m/Y',strtotime($val['end_date'])) ?>, <?php echo $val["group_start_time"];?>-<?php echo $val["group_end_time"];?></option>
                    <?php
					   }
					   ?>
                  </select>
          ...
          <tr>
			...
			<thead>
                <tr class="logintext">
                  ...
                  <th width="26%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_STUDENTNAME");?></th>
                  ...
                  <th width="27%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_GROUPNAME");?></th>
                  <th width="11%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_PERCENT");?></th>
                  <th width="20%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_GROUPSAED");?></th>
                  </tr>
				  </thead>
                <?php					
                ...
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                  ...
                  <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[first_name]."&nbsp;".$val[father_name]."&nbsp;".$val[family_name]."&nbsp;(".$val[first_name1]."&nbsp;".$val[father_name1]."&nbsp;".$val[grandfather_name1]."&nbsp;".$val[family_name1].")";?></td>
                  <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[student_id];?></td>
                  <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $res_group[group_name];?> <?php echo $res_group["group_start_time"];?>-<?php echo $res_group["group_end_time"];?></td>
                  <td align="center" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $percentage;?>%</td>
                  <td align="center" valign="middle" class="mycon" style="padding-left:5px;">
                    ...
                    <tr>
                      <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                        <tr class="logintext">
                              ...
                              <td width="28%" align="right" valign="middle" id="statusresult">
                              <select name="cmbgroup" id="cmbgroup" style="border:solid 1px; border-color:#FFCC33; height:20px; width:150px;"  onChange="setsubmit();">
                                <option value="">--<?php echo constant("SELECT_GROUP");?>--</option>
                                <?php
                                    foreach($dbf->fetchOrder('student_group',"centre_id='$_SESSION[centre_id]'","") as $val) {	
                          ...
                          <td width="8%" align="left" class="logintext">&nbsp;&nbsp;:&nbsp;<?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_GROUPNAME");?></td>
                          <td width="6%" align="left">&nbsp; </td>
                          <td width="42%" height="30" class="headingtext" align="right">
                          <img src="../images/arrow_small_right2.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS_SUMMARY");?></td>
                          </tr>
                        </table></td>
                      </tr>
                    <tr>
                      <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                        <thead>
                          <tr class="logintext">
                            ...
                            <th width="27%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_GROUPNAME");?></th>
                            <th width="10%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_PERCENT");?></th>
                            <th width="18%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_GROUPSAED");?></th>
                            <th width="29%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_REPORT_CERTIFICATE_REPORT_STUDENTNAME");?></th>
                            <th width="3%" height="25" align="center" valign="middle" bgcolor="#99CC99">&nbsp;</th>
                            </tr>
                          </thead>
                        <?php
                        ...
                        <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">                          <td align="right" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[student_id];?></td>
                          <td align="right" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $res_group[group_name];?> <?php echo $res_group["group_start_time"];?>-<?php echo $res_group["group_end_time"];?></td>
                          <td align="center" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $percentage;?>%</td>
