...
$alert_count = $dbf->countRows("alerts", "stu_ad='1' AND status='0' And imp='1' And id not in (select alert_id from alerts_read where user_id='$_SESSION[id]')");
}
?>
...
<?php
//echo base64_decode(base64_decode("WVdodFpXUjI="));
//Get from the table
    ...
    <td align="left" valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr bgcolor="#000000">
            <td height="30" bgcolor="#FFA938" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;">&nbsp; <?php echo constant("STUDENT_ADVISOR_HOME_DASHBOARD");?></td>
          </tr>
          <tr>
            <td height="450" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#CCCCCC;">
                  <tr>
                    <td height="30" align="center" valign="middle"><?php //echo $Arabic->ar2en("كيشور");?></td>
                    <td align="center" valign="middle">&nbsp;</td>
                    <td align="center" valign="middle"><?php //echo $_SESSION[lang];?></td>
                    <td align="center" valign="middle">&nbsp;</td>
                  </tr>
                  <tr>
                  ...
                  <tr class="leftmenu">
                    <td height="30" align="center" valign="top"><a href="password.php" title="<?php echo constant("ADMIN_TEACHER1_MANAGE_PASSWORD");?>"><span><?php echo constant("ADMIN_TEACHER1_MANAGE_PASSWORD");?></span></a></td>
              ...
              <tr>
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td width="61%" align="left" valign="middle" bgcolor="#FEF0FF" class="red_smalltext">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_HOME_LATESTALERTS");?></td>
              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FFCCFF;">
                  <tr>
                    ...
                    <td width="54%" align="left" valign="middle" bgcolor="#FAFCE0" class="red_smalltext">&nbsp;&nbsp;<!--<a href="student_appoint_manage.php">--><?php echo constant("STUDENT_ADVISOR_HOME_TEXT1");?><!--</a>--></td>
                    <td width="34%" bgcolor="#FAFCE0">
                    </td>
                  </tr>
                </table></td>
                <td align="left" valign="top">&nbsp;</td>
        ...
        <td width="78%" align="right" valign="top">
          <table width="98%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr bgcolor="#000000">
                  <td height="30" align="right" bgcolor="#FFA938" class="logintext" style="background:url(../images/footer_repeat.png) repeat-x;"><?php echo constant("STUDENT_ADVISOR_HOME_DASHBOARD");?>&nbsp;&nbsp;</td>
                  </tr>
                <tr>
                  <td height="450" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                      ...
                      <td width="45%" rowspan="2" align="left" valign="top" style="padding-top:15px;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#CCCCCC;">
                          <tr>
                            ...
                            <td align="center" valign="middle">&nbsp;</td>
                            <td align="center" valign="middle"><?php //echo 'asd'.$_SESSION[lang];?></td>
                            <td align="center" valign="middle">&nbsp;</td>
                            </tr>
                          <tr>
                            <td width="25%" height="72" align="center" valign="middle"><a href="home.php"><img src="../home_icon/home.jpg" width="80" height="63" border="0" /></a></td>
                            ...
                            <td align="right">
                              <table width="450" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FFCC00;">
                                <tr>
                                  ...
                                  <td width="79%" align="right" valign="middle" bgcolor="#FEF0FF" class="red_smalltext">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_HOME_LATESTALERTS");?></td>
                                  <td width="9%" align="center" valign="middle" bgcolor="#FEF0FF"><img src="../images/errror.png" width="25" height="25" /></td>
                                  </tr>
                                </table>
                              <div id="dataDisplay">
				...
				?>
                                <table width="450" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="432" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="54%" align="right" valign="middle" class="hometest_time"><?php echo date("l, d M Y",strtotime($val["dt"]));?>&nbsp;,<?php echo $val["tm"];?></td>
                                        <td width="46%" align="right" valign="middle" class="hometest_name"><?php echo constant("STUDENT_ADVISOR_HOME_POSTEDBYADMIN");?>  </td>
                                        </tr>
                                      <tr>
                                        <td height="5"></td>
                                        <td height="5"></td>
                                      ...
                                      <tr>
                                        <td colspan="2" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td width="83%" align="right" valign="middle" class="hometest_time"><?php echo constant("STUDENT_ADVISOR_HOME_URGENT");?></td> 
                                            <td width="6%" align="center" valign="middle" class="hometest_time"><img src="../images/important.png" width="16" height="16"></td>
                                            <td width="11%" align="left" valign="middle" class="hometest_time"> : <?php echo constant("STUDENT_ADVISOR_HOME_MARKAS");?></td>
                                  ...
                                  <tr>
                                    <td width="432" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="55%" align="right" valign="middle" class="hometest_time"><?php echo date("l, d M Y",strtotime($val_r["date_time"]));?>&nbsp;,<?php echo date("h:i A",strtotime($val_r["date_time"]));?></td>
                                        <td width="45%" align="right" valign="middle" class="hometest_name"><?php echo constant("STUDENT_ADVISOR_HOME_POSTEDBY");?> <?php echo $res_user[user_name];?>  </td>
                                        </tr>
                                      <tr>
                                        <td height="5"></td>
                                        <td height="5"></td>
                                  ...
                                  <tr>
                                    <td height="25" colspan="3" align="right" valign="middle"><img src="../images/replyar.png" width="46" height="22" onclick="show_a(<?php echo $i;?>)" style="cursor:pointer;" /></td>
                                    </tr>
                                  <tr>
                                    <td height="10" colspan="3">
                                          ...
                                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              ...
                                              <td width="86%" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                  <td colspan="3" align="left" valign="middle">&nbsp;
                                                    <textarea name="msg<?php echo $i;?>" id="msg<?php echo $i;?>" cols="45" rows="3" style="border:solid 1px; text-align:right; border-color:#5A79A8;"></textarea>
                                                    </td>
                                                  </tr>
                                                <tr>
                                                  <td height="5" colspan="3" align="left" valign="middle" class="hometest_name"></td>
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FFCCFF;">
                          <tr>
                            ...
                            <td width="80%" align="right" valign="middle" bgcolor="#FAFCE0" class="red_smalltext">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_HOME_TEXT1");?></td>
                            <td width="8%" align="center" valign="middle" bgcolor="#FAFCE0"><img src="../images/appointment_con.jpg" width="25" height="25" /></td>
                            </tr>
                          </table></td>
                      <td align="left" valign="top">&nbsp;</td>
                      <td align="right" valign="top">
                        <table width="450" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF9900;">
                          <tr>
                            <td width="7%" align="center" valign="middle" bgcolor="#FFEFEA">&nbsp;</td>
                            <td width="85%" align="right" valign="middle" bgcolor="#FFEFEA" class="red_smalltext"><?php echo constant("STUDENT_ADVISOR_HOME_TEXT2");?></td>
                            <td width="8%" align="center" valign="middle" bgcolor="#FFEFEA"><img src="../images/diagram11.png" width="25" height="25" /></td>
                            </tr>
                          </table></td>
                      </tr>
                    <tr>
					...
					?>
                          <tr>
                            <td width="432" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td colspan="2" align="right" valign="top" class="mycon"><?php echo $val_s["comments"];?></td>
                                </tr>
                              </table></td>
                            <td width="4">&nbsp;</td>
                            <td width="64" align="center" valign="middle"><img src="<?php echo $photo;?>" width="30" height="30" oncontextmenu="return false;" /></td>
					...
					?>
                        ...
                        <table width="400" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#CCCCCC;">
                          <tr>
                            <td width="363" height="25" align="right" valign="middle" bgcolor="#FAF7E2"><?php echo constant("STUDENT_ADVISOR_HOME_TEXT3");?></td>
                            <td width="35" align="center" valign="middle" bgcolor="#FAF7E2" class="mycon">&nbsp;<img src="../images/warning.png" width="16" height="16" /></td>
                            </tr>
                          <tr>
                            <td height="1" colspan="2" bgcolor="#d8dfea"></td>
                            </tr>
