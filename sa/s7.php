...
<style>
.mytext{border:solid 1px; border-color:#999999;background-color:#ECF1FF;}
</style>
<script>	
                ...
                <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="100%" align="left" valign="middle" class="logintext" style="background:url(../images/left_mid_bg.png) repeat-x;"><?php echo constant("STUDENT_ADVISOR_S7_HTEXT");?>&nbsp;</td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      ...
                      <form action="s1_process.php?action=comment" name="frm" method="post" id="frm">
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                              <tr>
                                <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                <td height="28" colspan="2" align="left" valign="middle" class="mycon"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td width="9%" align="center" valign="middle" class="shop2">80%</td>
                                  </tr>
                                </table></td>
                                <td width="51%" rowspan="5" align="left" valign="top" style="padding-top:60px;">
								...
								$ress = $dbf->strRecordID("student_group","*","id='$_SESSION[group]'");
                                    ...
                                    <tr>
                                      ...
                                      <span class="shop1">
									  <?php echo constant("STUDENT_ADVISOR_S6_STATUS");?> :</span> <span class="shop2"><?php echo $ress[group_name];?></span></td>
                                    </tr>
                                    <?php } ?>
                                    <tr>
                            ...
                            <td height="28" colspan="2" align="left" valign="bottom" class="mycon"><?php echo constant("STUDENT_ADVISOR_S7_HTEXT");?></td>
                            </tr>
                          <tr>
                          ...
                          <tr>
                            <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            <td width="18%" height="25" align="center" valign="middle" class="leftmenu"><a href="s_group.php"><input type="button" value="<?php echo constant("btn_back");?>" class="btn2" border="0" align="left" /></a></td>
                        ...
                        <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                                <td width="100%" align="right" valign="middle" class="logintext" style="background:url(../images/left_mid_bg.png) repeat-x;"><?php echo constant("STUDENT_ADVISOR_S7_HTEXT");?>&nbsp;</td>
                                <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                                </tr>
                              </table></td>
                            </tr>
                                  ...
                                  <form action="s1_process.php?action=comment" name="frm" method="post" id="frm">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                      <tr>
                                        <td width="51%" rowspan="5" align="left" valign="top" style="padding-top:60px;">
                                          ...
                                          <table width="95%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px #B6B6B6; background:url(../images/bg.png) repeat-x; ">
                                            ...
                                            <td height="28" colspan="2" align="left" valign="middle" class="mycon"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td width="9%" align="center" valign="middle" class="shop2">80%</td>
                                            <td width="73%" align="left" valign="middle" style="padding-left:2px;">
                                            <div class="meter-wrap" style="background-color:#fff; border:solid 1px; border-color:#847B7B;">
                                      ...
                                      <tr>
                                        ...
                                        <td height="28" colspan="2" align="right" valign="bottom" class="mycon"><?php echo constant("STUDENT_ADVISOR_S7_HTEXT");?></td>
                                        <td width="2%" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                        </tr>
                                      <tr>
                                        
                                        <td colspan="2" rowspan="3" align="center" valign="top" class="leftmenu">
                                          <textarea name="student_comment" id="student_comment" rows="20" cols="50" style="text-align:right;" class="mytext" onBlur="checkTab('student_comment');"><?php echo $_SESSION[student_comment];?></textarea></td>
                                          <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td width="24%" height="25" align="center" valign="middle" class="leftmenu"><a href="s_group.php"><input type="button" value="<?php echo constant("btn_back");?>" class="btn1" border="0" align="left" /></a></td>
                                        <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                      </tr>
                                      <tr>
                                        <td height="10" colspan="4" align="left" valign="middle"></td>
