                      ...
                      <tr>
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          <tr>
                            ...
                            <td width="1%">&nbsp;</td>
                            <td width="30%">&nbsp;</td>
                            <td width="47%" rowspan="8" align="left" valign="top" style="padding-top:3px;">
                              ...
                              <tr>
                                <td align="center" valign="top" bgcolor="#EBEBEB">
                                  ...
                                  <form action="s1_process.php?action=group" name="frm" method="post" id="frm">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                      <tr>
                                        <td width="56%" rowspan="8" align="center" valign="top" style="padding-top:3px;">
								...
								?>
                                      ...
                                      <tr>
                                        <td width="11%" height="28" align="right" valign="middle" class="leftmenu"></td>
                                        <td>&nbsp;</td>
                                        <td width="26%" align="right" valign="middle" class="leftmenu">: <?php echo constant("STUDENT_ADVISOR_S_GROUP_ADDINGSTDTOGRUP");?></td>                                        <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                                      </tr>
                                      <?php							
										if($_SESSION["courseid"] == ''){
											$interest_course = 0;
                                      ...
                                      <tr>
                                        ...
                                        <select name="group" class="combo" id="group" style="width:300px; text-align:right; border:solid 1px; border-color:#999999;background-color:#ECF1FF;" onBlur="checkTab('group');">
                                          <option value=""><?php echo $select_first_value;?></option>
                                          <?php
							foreach($dbf->fetchOrder('student_group',"centre_id='$_SESSION[centre_id]' And status<>'Completed' And course_id in (".$interest_course.")","") as $res_g) {
							  ?>
