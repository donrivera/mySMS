...
$teacher_id = $dbf->getDataFromTable("student_group","teacher_id","id='$group_id'");
$rest = $dbf->strRecordID("teacher","*","id='$teacher_id'");
$pro = $dbf->strRecordID("teacher_progress","*","group_id='$group_id'");
...
function setsubmit(){
	...
	document.location.href='report_teacher_progress_form.php?cmbgroup='+group_id+'&mystatus='+mystatus;
}
...
<table <?php if($_SESSION["lang"] == "AR"){?> style="margin-top:-15px;" <?php } ?> width="100%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="countdown_init(<?=$count;?>);">
  ...
  <tr>
    ...
    <form action="report_teacher_progress_form_save.php?action=insert" name="frm" method="post" id="frm">
            ...
            <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="32%" align="center">
					<?php if($group_id!='') {?>
						<!--<a href="report_teacher_progress_form_print.php?group_id=<?php echo $group_id;?>" target="_blank">
						<img src="../images/print.png" width="16" height="16" /></a>-->
					<?php } ?>
				</td>
                </tr>
                <tr>
                    ...
                    <tr>
                      ...
                      <td width="75%" align="left" valign="middle" bgcolor="#FFCB7D" class="heading" id="statusresult">
                        <select name="cmbgroup" id="cmbgroup" style="width:150px; border:solid 1px; border-color:#999999;" onChange="setsubmit();">
						  ...
						  foreach($dbf->fetchOrder('student_group',"status='$status' AND centre_id='$_SESSION[centre_id]'","group_name","") as $res_group) {
							  ?>
                          <option value="<?php echo $res_group['id'];?>" <?php if($group_id==$res_group["id"]) { ?> selected="selected" <?php } ?>><?php echo $res_group['group_name'] ?>, <?php echo date('d/m/Y',strtotime($res_group['start_date']));?> - <?php echo date('d/m/Y',strtotime($res_group['end_date'])) ?>, <?php echo $dbf->printClassTImeFormat($res_group['group_start_time'],$res_group['group_end_time']);?></option>
                          <?php
						  }
						  ?>
                        </select>
                ...
                <?php
				  ...
				  if($group_id!='' && $_REQUEST[course_id]!='')
				  {
					 $res_teacher_group = $dbf->strRecordID("student_group","*","course_id='$_REQUEST[course_id]' AND group_id='$group_id'");
				  }
				  ?>
                <tr>
            ...
            ?>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				?>
					...
					foreach($dbf->fetchOrder('student s,student_group g,student_group_dtls c',"g.id=c.parent_id And s.id=c.student_id And g.id='$group_id'","s.first_name","s.*,c.course_id,g.units") as $r) {
					?>
                      <?php
                    $res_country = $dbf->strRecordID("countries","*","id='$r[country_id]'");					
					$course_mark = $dbf->strRecordID("teacher_progress_course","*","student_id='$r[id]' AND group_id='$group_id'");					
					?>
                      <tr>                  
                        ...
                        <td align="center" valign="middle" bgcolor="#FFFFFF">
                          ...
                          <select name="course_partication<?php echo "_".$student_count;?>" id="course_partication<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;">
                            <option value=""></option>
							<?php for($c_ptcpate=1;$c_ptcpate<=5;$c_ptcpate++): ?>
							<option value="<?php echo $c_ptcpate?>"<?php echo (($course_mark['course_partication']==$c_ptcpate)?'selected':'');?>><?php echo $c_ptcpate;?></option>
							<?php endfor;?>
						  </select>
							-->
							<input type="text" name="course_partication<?php echo "_".$student_count;?>" id="course_partication<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['course_partication']; ?>" readonly="readonly"/>
                        </td>
                        <td align="center" valign="middle" bgcolor="#FFFFFF">
							<!--
                          <select name="course_homework<?php echo "_".$student_count;?>" id="course_homework<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;" >
                            <option value=""></option>
							<?php for($c_hwork=1;$c_hwork<=5;$c_hwork++): ?>
							<option value="<?php echo $c_hwork?>"<?php echo (($course_mark['course_homework']==$c_hwork)?'selected':'');?>><?php echo $c_hwork;?></option>
							<?php endfor;?>
                          </select>
						  -->
						  <input type="text" name="course_homework<?php echo "_".$student_count;?>" id="course_homework<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['course_homework'];?>" readonly="readonly"/>
                        </td>
                        <td align="center" valign="middle" bgcolor="#FFFFFF">
							<!--
                          <select name="course_fluency<?php echo "_".$student_count;?>" id="course_fluency<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;">
                            <option value=""></option>
                            <?php for($c_fluency=1;$c_fluency<=5;$c_fluency++): ?>
							<option value="<?php echo $c_fluency?>"<?php echo (($course_mark['course_fluency']==$c_fluency)?'selected':'');?>><?php echo $c_fluency;?></option>
							<?php endfor;?>
                          </select>
						  -->
						  <input type="text" name="course_fluency<?php echo "_".$student_count;?>" id="course_fluency<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['course_fluency'];?>" readonly="readonly"/>
                        </td>
                        <td align="center" valign="middle" bgcolor="#FFFFFF">
							<!--
                          <select name="course_pro<?php echo "_".$student_count;?>" id="course_pro<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;">
                            <option value=""></option>
							<?php for($c_pro=1;$c_pro<=5;$c_pro++): ?>
							<option value="<?php echo $c_pro?>"<?php echo (($course_mark['course_pro']==$c_pro)?'selected':'');?>><?php echo $c_pro;?></option>
							<?php endfor;?>
                          </select>
						  -->
						  <input type="text" name="course_pro<?php echo "_".$student_count;?>" id="course_pro<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['course_pro']; ?>" readonly="readonly"/>
                         </td>
                        <td align="center" valign="middle" bgcolor="#FFFFFF">
							<!--
                          <select name="course_grammer<?php echo "_".$student_count;?>" id="course_grammer<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;">
                            <option value=""></option>
                            <?php for($c_grammer=1;$c_grammer<=5;$c_grammer++): ?>
							<option value="<?php echo $c_grammer?>"<?php echo (($course_mark['course_grammer']==$c_grammer)?'selected':'');?>><?php echo $c_grammer;?></option>
							<?php endfor;?>
                          </select>
						  -->
						  <input type="text" name="course_grammer<?php echo "_".$student_count;?>" id="course_grammer<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['course_grammer'];?>" readonly="readonly"/>
                        </td>
                        <td align="center" valign="middle" bgcolor="#FFFFFF">
							<!--
                          <select name="course_voca<?php echo "_".$student_count;?>" id="course_voca<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;">
                            <option value=""></option>
                            <?php for($c_voca=1;$c_voca<=5;$c_voca++): ?>
							<option value="<?php echo $c_voca?>"<?php echo (($course_mark['course_voca']==$c_voca)?'selected':'');?>><?php echo $c_voca;?></option>
							<?php endfor;?>
                          </select>
						  -->
						  <input type="text" name="course_voca<?php echo "_".$student_count;?>" id="course_voca<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['course_voca'];?>" readonly="readonly"/>
                        </td>
                        <td align="center" valign="middle" bgcolor="#FFFFFF">
							<!--
                          <select name="course_listen<?php echo "_".$student_count;?>" id="course_listen<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;">
                            <option value=""></option>
                            <?php for($c_listen=1;$c_listen<=5;$c_listen++): ?>
							<option value="<?php echo $c_listen?>"<?php echo (($course_mark['course_listen']==$c_listen)?'selected':'');?>><?php echo $c_listen;?></option>
							<?php endfor;?>
                          </select>
						  -->
						  <input type="text" name="course_listen<?php echo "_".$student_count;?>" id="course_listen<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['course_listen'];?>" readonly="readonly"/>
                        </td>
                        <?php
					...
					?>
                        <td align="center" valign="middle" bgcolor="#FFFFFF">
							...
							<input type="hidden" name="course_attendance<?php echo "_".$student_count;?>" id="course_attendance<?php echo "_".$student_count;?>" style="border:none; width:50px; text-align:center; font-weight:bold;" maxlength="3" onKeyPress="return isNumberKey(event);" value="<?php echo $attendance_count_shift; ?>" readonly="">
                        </td>
                        <?php					
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <table width="1100" border="1" cellspacing="0" cellpadding="0" style="border:solid 1px; border-collapse:collapse;">
                    ...
                    <?php
                    $student_count = 1;
					foreach($dbf->fetchOrder('student s,student_group g,student_group_dtls c',"g.id=c.parent_id And s.id=c.student_id And g.id='$group_id'","s.first_name","s.*,c.course_id") as $r) {
					
                    $res_country = $dbf->strRecordID("countries","*","id='$r[country_id]'");	
					
					$course_mark = $dbf->strRecordID("teacher_progress_certificate","*","student_id='$r[id]' AND group_id='$group_id'");
                    ...
                    <tr>
                      ...
                      <td align="center" valign="middle" bgcolor="#FFFFFF">
						...
						<select name="fluency<?php echo "_".$student_count;?>" id="fluency<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;">
							<option value=""></option>
							<?php for($cm_fluency=1;$cm_fluency<=5;$cm_fluency++): ?>
							<option value="<?php echo $cm_fluency?>"<?php echo (($course_mark['fluency']==$cm_fluency)?'selected':'');?>><?php echo $cm_fluency;?></option>
							<?php endfor;?>
                        </select>
						-->
						<input type="text" name="fluency<?php echo "_".$student_count;?>" id="fluency<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['fluency'];?>" readonly="readonly"/>
                      </td>
                      ...
                      <td align="center" valign="middle" bgcolor="#FFFFFF">
						...
						<select name="pronunciation<?php echo "_".$student_count;?>" id="pronunciation<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;">
							<option value=""></option>
							<?php for($cm_pronunciation=1;$cm_pronunciation<=5;$cm_pronunciation++): ?>
							<option value="<?php echo $cm_pronunciation?>"<?php echo (($course_mark['pronunciation']==$cm_pronunciation)?'selected':'');?>><?php echo $cm_pronunciation;?></option>
							<?php endfor;?>
                        </select>
                        -->
						<input type="text" name="pronunciation<?php echo "_".$student_count;?>" id="pronunciation<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['pronunciation'];?>" readonly="readonly"/>
                      </td>
                      ...
                      <td align="center" valign="middle" bgcolor="#FFFFFF">
						...
						<select name="grammer<?php echo "_".$student_count;?>" id="grammer<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;">
							<option value=""></option>
							<?php for($cm_grammer=1;$cm_grammer<=5;$cm_grammer++): ?>
							<option value="<?php echo $cm_grammer?>"<?php echo (($course_mark['grammer']==$cm_grammer)?'selected':'');?>><?php echo $cm_grammer;?></option>
							<?php endfor;?>
                        </select>
                        -->
						<input type="text" name="grammer<?php echo "_".$student_count;?>" id="grammer<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['grammer'];?>" readonly="readonly"/>
                      </td>
                      ...
                      <td align="center" valign="middle" bgcolor="#FFFFFF">
						...
						<select name="vocabulary<?php echo "_".$student_count;?>" id="vocabulary<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;">
							<option value=""></option>
							<?php for($cm_vocabulary=1;$cm_vocabulary<=5;$cm_vocabulary++): ?>
							<option value="<?php echo $cm_vocabulary?>"<?php echo (($course_mark['vocabulary']==$cm_vocabulary)?'selected':'');?>><?php echo $cm_vocabulary;?></option>
							<?php endfor;?>
                        </select>
                        -->
						<input type="text" name="vocabulary<?php echo "_".$student_count;?>" id="vocabulary<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['vocabulary'];?>" readonly="readonly"/>
                      </td>
                      ...
                      <td align="center" valign="middle" bgcolor="#FFFFFF">
						...
						<select name="listening<?php echo "_".$student_count;?>" id="listening<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;">
							<option value=""></option>
							<?php for($cm_listening=1;$cm_listening<=5;$cm_listening++): ?>
							<option value="<?php echo $cm_listening?>"<?php echo (($course_mark['listening']==$cm_listening)?'selected':'');?>><?php echo $cm_listening;?></option>
							<?php endfor;?>
                        </select>
                        -->
						<input type="text" name="listening<?php echo "_".$student_count;?>" id="listening<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;" value="<?php echo $course_mark['listening']?>" readonly="readonly"/> 
                      </td>
                      ...
                      <select name="end_of_level<?php echo "_".$student_count;?>" id="end_of_level<?php echo "_".$student_count;?>" style="border:none; width:60px; text-align:center; font-weight:bold;">
							<option value=""></option>
							<?php for($cm_end_of_level=1;$cm_end_of_level<=40;$cm_end_of_level++): ?>
							<option value="<?php echo $cm_end_of_level?>"<?php echo (($course_mark['end_of_level']==$cm_end_of_level)?'selected':'');?>><?php echo $cm_end_of_level;?></option>
							<?php endfor;?>
                        </select></td>
						<?php
