...
if($_REQUEST['action']=='insert'){
	...
	$string="first_name='$student_name',first_name1='$_SESSION[name]',father_name='$_SESSION[father_name]',grandfather_name='$_SESSION[grandfather_name]',student_first_name='$_SESSION[name1]',family_name1='$_SESSION[family_name1]',family_name='$_SESSION[family_name]',guardian_name='$_SESSION[gname]',age='$_SESSION[age]',guardian_contact='$_SESSION[pcontact]',guardian_comment='$_SESSION[information]',gender='$gender',country_id='$_SESSION[country]',id_type='$_SESSION[id_type]',student_id='$_SESSION[student_id]',student_mobile='$_SESSION[mobile_no]',alt_contact='$_SESSION[alt_no]',email='$_SESSION[email]',centre_id='$centre_id',created_datetime='$dt1',created_by='$_SESSION[id]',sms_status='1'";
...
if($_REQUEST['action']=='search'){
	...
	$dbf->deleteFromTable("student_material","course_id='$_REQUEST[course_id]' And student_id='$student_id'");
...
if($_REQUEST['action']=='edit_payment'){
	...
	header("Location:search_manage.php?student_id=$student_id&course_id=$_REQUEST[course_id]");
}
