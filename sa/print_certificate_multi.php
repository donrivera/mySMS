		...
		<tr>
			<td colspan="2" align="center" valign="top">
				<table width="920" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
										...
										<table width="870" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="447" align="left" valign="top">
													...
													<p align="left" class="cer1" dir="rtl">&nbsp;</p>
												</td>
												<td width="380" align="right" valign="top" >
													<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
														...
														<tr>
															<th height="28" align="right" valign="middle" class="cer2" scope="col"><span class="cer_my_head_bold" dir="rtl">الموافق من: <?php if($res_g[start_date]!='0000-00-00') { echo $dbf->enNo2ar($sdt,'-');} ?>إلى: <?php if($res_g[start_date]!='0000-00-00') { echo $dbf->enNo2ar($edt,'-');} ?></span></th>
														</tr>
														<tr>
					...
					<?php
						if($sl > 0){$height = $height + 150;}
					?>
					<tr>
						<td height="<?php //echo $height;?>" align="left" valign="top">&nbsp;</td>
					</tr>
				</table>
			</td>
		</tr>
