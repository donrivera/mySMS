...
{
	//adjust and create an update to the student_group start/end dates..echo strtotime("+1 week"), "\n";
	...
	{$studentSendSMS=1;
		...
		if($no_unit_finined > 0)
		{
			...
			//Insert / Update the Advance amount as Opening amount in ENROLLED Table
			$string="student_id='$student_id',centre_id='$centre_id',group_id='$group',course_id='$course_id',fee_id='$course_fee_id',status_id='5',created_by='$_SESSION[id]',enroll_date='$current_date',page_full_path='$_SERVER[REQUEST_URI]'";				
			$dbf->insertSet("student_enroll",$string);
			...
			if($is_enrollment == 1)
			{$string_status = "enrolled_status='New Enrollment'";}
			else{$string_status = "enrolled_status='Re-Enrollment'";$student_reenroll=1;}
			$dbf->updateTable("student_enroll", $string_status, "student_id='$student_id' And course_id='$course_id'");
			# End
			...
			$headers .= 'MIME-Version: 1.0' . "\n";
			$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
			$body1='<table width="550" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px grey">
						<tr>
							<td align="center" bgcolor="#CCCCCC" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 16px; color: #000000; font-weight: bold;">&nbsp;</td>
							<td height="35" align="center" bgcolor="#CCCCCC" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 16px; color: #000000; font-weight: bold;">Group size  has been changed Notification !!!</td>
						</tr>
						
						<tr style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td>&nbsp;</td>
							<td height="30">Dear  <span style="font:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: normal;">'.$res_teacher[name].',</span></td>
						</tr>
					 
						<tr style="font:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td>&nbsp;</td>
							<td height="30" align="left" valign="middle" style="padding-left:50px;">Now, the ePed card needs to adjust the total remaining units for this course from a </td>
						</tr>
					  
						<tr style="font:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td>&nbsp;</td>
							<td height="30" align="left" valign="middle"><span> remaining of '.$pending_units.' units for the previously '.$g_name.' group to a  remaining of '.$dec_right_value_is.' units for the newly formed</span></td>
						</tr>
						<tr style="font:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td>&nbsp;</td>
							<td height="30" align="left" valign="middle"> '.$g3_name.' group.</td>
						</tr>
						<tr style="font:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td>&nbsp;</td>
						...
						<tr style="font:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td>&nbsp;</td>
							<td height="30" align="left" valign="middle" style="padding-left:50px;">Add '.$unit.' units to this group due to adding a student to a '.$student.' '.$g_name.' group that has</td>
						</tr>
						<tr style="font:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td>&nbsp;</td>
							<td height="30" align="left" valign="middle">Completed '.$no_unit_finined.' units at the time of adding this student.</td>
						</tr>
						<tr  style="font:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td>&nbsp;</td>
							<td height="30" align="left" valign="middle">&nbsp;</td>
						...
						<tr  style="font:Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td>&nbsp;</td>
							<td height="30" align="right" valign="middle"><table width="200" border="0" cellspacing="0" cellpadding="0">
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px; color: #000000; font-weight: bold;">
							<td colspan="3" align="center" valign="middle">Thanks</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
