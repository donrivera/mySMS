              ...
              <tr>
                ...
                <td align="center" valign="top" bgcolor="#FFFFFF"><table width="300" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#66CC66;">
                    ...
                    <tr>
                      ...
                      <td width="253" align="left" valign="middle" bgcolor="#FFF2FD" class="nametext"><?php echo "Corporate Account Exists";?></td>
                            ...
                            <td height="10" colspan="5" align="right" valign="middle" class="leftmenu"><table width="715" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <tr>
                                ...
                                <td height="28" align="left" valign="middle">
                                  ...
                                  <input name="t1" type="text" class="new_textbox140_ar" id="t1" value="<?php echo $_SESSION[classic_name1];?>" tabindex=10/></td>

                                <td align="left" valign="middle">

                                  <input name="t2" type="text" class="new_textbox140_ar" id="t2" value="<?php echo $_SESSION[classic_fathername1];?>" tabindex=9/></td>

                                <td align="left" valign="middle">

                                  <input name="t3" type="text" class="new_textbox140_ar" id="t3" value="<?php echo $_SESSION[classic_gfathername1];?>" tabindex=8/></td>

                                <td align="left" valign="middle">

                                  <input name="t4" type="text" class="new_textbox140_ar" id="t4" value="<?php echo $_SESSION[classic_familyname1];?>"  tabindex=7/></td>
                          ...
                          <tr>
							...
							foreach($group_query as $res_g) {
							  ...
							  ?>
                                ...
                                <option value="<?php echo $res_g['id']?>"><?php echo $res_g['group_name'] ?>, <?php echo date('d/m/Y',strtotime($res_g['start_date']));?> - <?php echo date('d/m/Y',strtotime($res_g['end_date'])) ?>,  <?php echo $dbf->printClassTimeFormat($res_g["group_time"],$res_g["group_time_end"]);?></option>
