                      ...
                      <tr>
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          <tr>
                            ...
                            <td width="1%">&nbsp;</td>
                            <td width="26%">&nbsp;</td>
                            <td width="48%" rowspan="8" align="left" valign="top" style="padding-top:3px;">
                              <br>
                              ...
                              <tr>
                                ...
                                <form action="s1_process.php?action=email" name="frm" method="post" id="frm">
                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                      ...
                                      <tr>
                                        <td height="28" align="right" valign="middle" class="leftmenu"><input name="email" type="text" class="validate[required,custom[email]] new_textbox190_ar" id="email" value="<?php echo $_SESSION[email] ;?>" onBlur="checkTab('email');"/></td>
                                        
                                         <td>&nbsp;</td>
                                        <td width="25%" align="left" valign="middle"><span class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("STUDENT_ADVISOR_S4_EMAILADDRESS");?></span></td>
