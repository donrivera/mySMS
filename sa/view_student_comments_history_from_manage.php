          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0">
              <tr>
                ...
                <td width="26%" align="right"><a href="search.php"><input type="button" value="<?php echo constant("btn_back_btn");?>" class="btn2" border="0" align="left" /></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td bgcolor="#b4b4b4"  style="background:url(../images/footer_repeat.png) repeat-x;">
              ...
              <table width="100%" border="0" cellspacing="0">
                <tr>
                  <td width="26%" align="left"><a href="search.php"><input type="button" value="<?php echo constant("btn_back_btn");?>" class="btn2" border="0" align="left" /></a></td>
                  <td width="12%" align="left" valign="middle" class="logintext">&nbsp;</td>
