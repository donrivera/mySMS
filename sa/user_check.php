...
<table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF9900;">
    <tr>
    <td width="73%" height="20" align="right" valign="middle" bgcolor="#FFECFF" class="nametext1" style="padding-right:5px;">&nbsp;&nbsp;<?php echo constant("STUDENT_ADVISOR_PASSWORD_EXITMSG");?></td>
    </tr>
</table>
