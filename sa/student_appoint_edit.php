                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          ...
                          <tr>
                            ...
                            <select name="student" id="student" class="chzn-select validate[required,minListOptions[]]">
                                    ...
                                    ?>
                                    <option value="<?php echo $ress2['id']?>" <?php if($ress2["id"]==$res["student_id"]) { echo "Selected"; }?>><?php echo $ress2['first_name'];?> <?php echo $Arabic->en2ar($dbf->StudentName($ress2["id"]));?></option>
                                    <?php }?>
                                </select>
