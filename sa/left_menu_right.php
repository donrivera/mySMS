...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">    
    <?php
	foreach($dbf->fetchOrder('quick_links',"module_name='Student Advisor' And user_id='$_SESSION[id]'","prec") as $val_quick)
	{
	...
	?>
      <tr>
        <td  style="border-left:solid 2px; border-color:#CCC;" align="right" valign="middle"><span class="<?php echo $class;?>"><a style="text-decoration:none;" href="<?php echo $val_quick[links];?>"><?php echo $linkname;?></a>&nbsp;</span></td>
        <td width="26" align="center" valign="middle"><a href="<?php echo $val_quick[links];?>"><img src="<?php echo $img;?>" width="16" height="16" border="0" /></a></td>
        <td width="10" height="30" align="left" valign="middle" class="<?php echo $class;?>">&nbsp;</td>
      </tr>
      <tr>
