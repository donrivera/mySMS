			...
			<table width="100%" border="1" cellpadding="0" bordercolor="#000000" cellspacing="0" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
              <thead>
                <tr class="logintext">
                  ...
                  <th width="24%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("STUDENT_ADVISOR_HOME_S_MANAGE_STUDENTNAME");?></th>
                  <th width="12%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("STUDENT_ADVISOR_HOME_S_MANAGE_STUDENTID");?></th>
                  ...
                  <th width="21%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("STUDENT_ADVISOR_HOME_S_MANAGE_EMAILADDRESS");?></th>
              ...
              <?php			  	
				...
				foreach($dbf->fetchOrder('student',$condition,"id DESC ") as $val){					 
					...
					if($moving["name"] == ''){
						...
						$status_name = $moving["name"];
					}
			  ?>
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;" onClick="javascript:window.location.href='report_student_group_grade_dtls.php?student_id=<?php echo $val[id];?>'">
                ...
                <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $status_name;?></td>
                <td width="6%" align="center" valign="middle" ><?php echo $dbf->VVIP_Icon($val["id"]);?></td>
                <td width="5%" align="center" valign="middle" >
                <a href="report_student_group_grade_dtls.php?student_id=<?php echo $val[id]; ?>">
                <img src="../images/epd.png" width="15" height="15" border="0" title="View Group Grade"></a></td>
                <?php
					  $i = $i + 1;
					  if($color=="#ECECFF"){
						  $color = "#FBFAFA";
			  ...
			  ?>
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;" onClick="javascript:window.location.href='report_student_group_grade_dtls.php?student_id=<?php echo $val[id];?>'">
                  <td width="3%" align="center" valign="middle" >
                    <a href="report_student_group_grade_dtls.php?student_id=<?php echo $val[id]; ?>"><img src="../images/epd.png" width="15" height="15" border="0" title="View Group Grade"></a></td>
                    <td width="4%" align="center" valign="middle" ><?php echo $dbf->VVIP_Icon($val["id"]);?></td>
                  <td align="right" valign="middle" class="mycon" style="padding-right:5px;"><?php echo $status_name;?></td>
