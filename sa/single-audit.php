              ...
              <tr>
                ...
                <table width="90%" border="1" cellspacing="0" bordercolor="#999999" cellpadding="0" style="border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle" class="shop2"><?php if($group["group_name"] != ''){ ?><?php echo $group["group_name"];?> <?php echo $group["group_start_time"];?>-<?php echo $group["group_end_time"];?><?php } ?></td>
				  ...
				  ?>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                      <tr>
                        ...
                        <td height="15" align="left" valign="middle" class="hometest_time"><?php echo $dbf->getDataFromTable("student_status","name","id='$dtls[id]'");?></td>
                      </tr>
                    </table>
                    </td>
					<?php } ?>
