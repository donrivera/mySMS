                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bordercolor="#000000" class="tablesorter" id="sort_table">
                  <thead>
                    <tr class="logintext">
                      ...
                      <th width="13%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("RECEPTION_ARF_MANAGE_REPORTDATE");?></th>
                      <th width="36%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("RECEPTION_ARF_MANAGE_STUDENTNAME");?></th>
                      <th width="12%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("RECEPTION_ARF_MANAGE_ACTIONOWENER");?></th>
                      <th width="13%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("RECEPTION_ARF_MANAGE_REPORTBY");?></th>
                      <th width="13%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("RECEPTION_ARF_MANAGE_REPORTTO");?></th>
                  ...
                  <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='arf_view.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                    ...
                    <td width="4%" align="center" valign="middle"><a href="arf_view.php?id=<?php echo $val[id];?>">
                ...
                <tr>
                  <td bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="8%" align="left">&nbsp;</td>
                      <td width="8%" align="left">&nbsp; </td>                      
                      <td width="54%" height="30" align="right" class="logintext"><?php echo constant("SA_MENU_ARF_REPORTS");?></td>
                      </tr>
                    </table></td>
                  </tr>
                <tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td width="88" height="36" align="left" valign="middle" bgcolor="#FFFFFF" class="leftmenu">: <?php echo constant("STUDENT_ADVISOR_SEARCH_FIRSTNAME");?></td>
                      ...
                      <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bordercolor="#000000" class="tablesorter" id="sort_table">
                        <thead>
                          <tr class="logintext">
                            ...
                            <th width="13%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("RECEPTION_ARF_MANAGE_REPORTTO");?></th>
                            <th width="33%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("RECEPTION_ARF_MANAGE_STUDENTNAME");?></th>
                            <th width="13%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("RECEPTION_ARF_MANAGE_ACTIONOWENER");?></th>
                            <th width="14%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("RECEPTION_ARF_MANAGE_REPORTBY");?></th>
                            <th width="14%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("RECEPTION_ARF_MANAGE_REPORTDATE");?></th>
						...
						$condition = $condition."  And c.centre_id='$centre_id' And s.id=c.student_id AND c.sa_status='1'";
					...
					?>
                        ...
                        <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='arf_view.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">                          
                          ...
                          <a href="arf_view.php?id=<?php echo $val[id];?>">
                          <img src="images/search.png" width="20" height="20" border="0" title="<?php echo ICON_VIEW ?>" /></a></td>                          
                          <td width="5%" align="center" valign="middle"><a href="arf_print.php?id=<?php echo $val[id];?>" target="_blank">
                            <img src="../images/print.png" width="16" height="16" title="<?php echo STUDENT_ADVISOR_SEARCH_MANAGE_PRINT ?>"/></a></td>
