          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0">
              <tr>
                ...
                <td width="8%" align="left">&nbsp;</td>
                <td width="8%" align="left"><a href="student_to_student_add.php">
          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="10%" align="left" valign="middle" bgcolor="#DDDDDD" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_DATE");?></th>
                <th width="13%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_FROMGROUP");?></th>
                <th width="12%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("CD_STUDENT_CENTER_TOGROUP");?></th>
                <th width="16%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext">Student Name</th>
                <th width="31%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
              ...
              <?php					
                    ...
                    $num=$dbf->countRows('transfer_student_to_student',"centre_id='$_SESSION[centre_id]' And ".$cond,"");					
					foreach($dbf->fetchOrder('transfer_student_to_student',"centre_id='$_SESSION[centre_id]' And ".$cond,"id DESC ","*") as $transfer){
										
					//Name of the students
					$student = $dbf->getDataFromTable("student","first_name","id='$transfer[student_id]'");
              ...
              <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                ...
                <a href="student_to_student_process.php?action=delete&amp;del_id=<?php echo $transfer[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="Delete" /></a>
                <?php } ?>
                </td>
                <?php
...
<table <?php if($_SESSION["lang"] == "AR"){?> style="margin-top:-15px;" <?php } ?> width="100%" border="0" align="center" cellpadding="0" cellspacing="0" onclick="countdown_init(<?=$count;?>);">
  <tr>
    <td height="39" align="right" valign="middle" style="padding-left:5px;"><?php include '../top_right.php';?></td>
  </tr>
  <tr>
                  ...
                  <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;">
                    <table width="100%" border="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="8%" align="left">&nbsp;</td>
                        <td width="8%" align="left">&nbsp;</td>
                        <td width="54%" height="30" align="right" class="logintext"><?php echo constant("SA_STUDENT_TO_STUDENT");?></td>
                      </tr>
                    </table></td>
                  </tr>
                <tr>
                  ...
                  <form name="frm" id="frm" >
                    ...
                    <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#000000" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                      <thead>
                        <tr class="logintext">
                          <th width="5%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("COMMON_ACTION");?></th>
                           <th width="12%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_WEEK_MANAGE_STATUS");?></th>
                          <th width="12%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("CD_STUDENT_TRANSFER_FROM");?></th>
                          <th width="12%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("CD_STUDENT_TRANSFER_TO");?></th>
                          <th width="15%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("STUDENT_ADVISOR_STUDENT_MANAGE_STUDENTNAME");?></th>
                          <th width="28%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_COMMENTS");?></th>
                          <th width="11%" align="right" valign="middle" bgcolor="#DDDDDD" class="pedtext"><?php echo constant("CD_STUDENT_TRANSFER_DATE");?></th>
                          <th width="5%" height="25" align="center" valign="middle" bgcolor="#99CC99">&nbsp;</th>
                          </tr>
                        </thead>
                      <?php					
