...
if($_REQUEST['action']=='insert')
{
	...
	//Check duplicate
	$num=$dbf->countRows('teacher_progress',"teacher_id='$uid' and group_id='$group_id'");
	if($num==0)
	{#echo "1";
		...
		$string="	teacher_id='$uid',
					...
					grade_submit='$_POST[grade_submit]',
					report_print='$_POST[report_print]',
					report_print_by='$_POST[report_print_by]',
					certificate_print='$_POST[certificate_print]',
					certificate_print_by='$_POST[certificate_print_by]', 
		...
		for($m=1; $m<=$student_count; $m++)
		{
			...
			else
			{
				...
				$dbf->updateTable("teacher_progress_certificate",$string,"teacher_id='$uid' AND group_id='$group_id' AND course_id='$res_group[course_id]' AND student_id='$student_id'");
			}
			//SMS start
		...
		for($j=1; $j<=$student_count; $j++)
		{
			...
			//Check duplicate
			$num=$dbf->countRows('teacher_progress_course',"teacher_id='$uid' AND group_id='$group_id' AND course_id='$res_group[course_id]' AND student_id='$student_id'");
			if($num==0)
			{
				//Insert in Progress course table	
				$string="teacher_id='$uid',group_id='$group_id',course_id='$res_group[course_id]',student_id='$student_id',course_partication='$course_partication',course_partication_perc='$course_partication_perc',course_homework='$course_homework', course_homework_perc='$course_homework_perc', course_fluency='$course_fluency', course_fluency_perc='$course_fluency_perc', course_pro='$course_pro',course_pro_perc='$course_pro_perc', course_grammer='$course_grammer', course_grammer_perc='$course_grammer_perc', course_voca='$course_voca', course_voca_perc='$course_voca_perc',course_listen='$course_listen',course_listen_perc='$course_listen_perc',course_attendance='$course_attendance',course_attendance_perc='$course_attendance_perc',parent_id='$ids'";
			...
			else
			{
				...
				$dbf->updateTable("teacher_progress_course",$string,"teacher_id='$uid' AND group_id='$group_id' AND course_id='$res_group[course_id]' AND student_id='$student_id'");
		...
		//Header location
		header("Location:report_teacher_progress_form.php?msg=added&cmbgroup=$group_id");
	}	
	else
	{#echo "2";
		...
		//Excute the query
		$dbf->updateTable("teacher_progress",$string,"teacher_id='$uid' and group_id='$group_id' and course_id='$res_group[course_id]'");	
		...
		{	
			...
			#echo "<BR/>".$student_id."-".$res_group['course_id']."-".$group_id;
		}
