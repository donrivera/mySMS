          ...
          <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="center" valign="middle" height="30"><a href="single-student_to_student_add.php?student_id=<?php echo $student_id;?>">
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="center" valign="middle" height="30"><a href="single-center_to_center_add.php?student_id=<?php echo $student_id;?>">
                <input type="button" value="<?php echo constant("btn_add_btn");?>" class="btn1" border="0" align="left" />
                </a></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="center" valign="middle" height="30"><a href="center_to_center_add.php?student_id=<?php echo $student_id;?>">
                <input type="button" value="<?php echo constant("btn_add_btn");?>" class="btn1" border="0" align="left" />
                </a></td>
              </tr>
              <tr>
            ...
            <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#999;">
              ...
              <?php					
                  ...
                  <tr bgcolor="<?php echo $color;?>"  onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                    ...
                    <td align="center" valign="middle" class="mycon"><?php echo $noofstudent;?></td>
                    <td align="right" valign="middle" class="mycon" style="padding-left:2px;"><?php echo $to_id;?></td>
                    <td align="right" valign="middle" class="mycon" style="padding-left:2px;"><?php echo $from_id;?></td>
