        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0">
              <tr>
                <td width="56%" height="30" class="logintext"><?php echo constant("CANCELLATION_REQUEST");?></td>
                <td width="14%">&nbsp;</td>
                <td width="13%" align="left">&nbsp;</td>
                <td width="17%" align="right"><a href="cancel_add.php">
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bordercolor="#000000" class="tablesorter" id="sort_table">
                  <thead>
                    <tr class="logintext">
                      ...
                      <th width="23%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("RECEPTION_ARF_MANAGE_STUDENTNAME");?></th>
                      <th width="11%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("ADMIN_TEACHER1_MANAGE_MOBILE");?></th>
                      <th width="20%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("SA_REASON_FOR_CANCEL");?></th>
                      <th width="14%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("SA_CD_CANCEL_STATUS");?></th>
                      <th width="14%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("SA_ADMIN_CANCEL_STATUS");?></th>
                  ...
                  <?php					
					...
					//4.
						...
						$condition = "s.family_name LIKE '$_REQUEST[fname]%' OR s.family_name1 LIKE '$_REQUEST[fname]%' OR s.first_name LIKE '$_REQUEST[fname]%' AND s.student_id LIKE  '$_REQUEST[stid]%' AND s.student_mobile LIKE '$_REQUEST[mobile]%' AND s.email LIKE '$_REQUEST[email]%'";
					}else if($_REQUEST[fname]=='' && $_REQUEST[stid]=='' && $_REQUEST[mobile]=='' && $_REQUEST[email]==''){
						$condition = "s.id>'0'";
					}
                  ...
                  <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                    ...
                    <td align="left" valign="middle" class="mycon" >&nbsp;<a href="single-home.php?student_id=<?php echo $res_student[id];?>" style="cursor:pointer;">
					...
					?>
                    <td align="center" valign="middle" class="mycon" >&nbsp;<?php echo $comment;?></td>
                    <?php
                    ...
                    <a href="cancel_process.php?action=delete&cancel_id=<?php echo $valcancel["id"];?>"><img src="../images/delete.png" width="16" height="16" border="0" title="Click here to change the Status" /></a>
                    <?php } ?>
                    </td>
                    <?php
					  	  $i = $i + 1;
              ...
              <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td bgcolor="#b4b4b4" style="background:url(../images/footer_repeat.png) repeat-x;">
                    <table width="100%" border="0" cellspacing="0">
                      <tr>
                        <td width="22%" align="left" valign="middle"><a href="cancel_add.php">
                        <input type="button" value="<?php echo constant("btn_add_btn");?>" class="btn1" border="0" align="left" />
                        </a></td>
                        <td width="8%" align="left">&nbsp;</td>
                        <td width="8%" align="left">&nbsp;</td>
                        <td width="8%" align="left">&nbsp;</td>
                        <td width="54%" height="30" class="logintext" align="right"><?php echo constant("CANCELLATION_REQUEST");?></td>
                        </tr>
                      </table></td>
                  </tr>
                <tr>
                    ...
                    <tr>
                      <td align="left" valign="top" bgcolor="#FFFFFF">
                        ...
                        <tr>
                          ...
                          <td width="108" height="36" align="right" valign="middle" bgcolor="#FFFFFF"><input name="stid" type="text" class="new_textbox100_ar" id="stid" value="<?php echo $_REQUEST[stid];?>" onKeyPress="return PhoneNo(event);"></td>
                        ...
                        <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bordercolor="#000000" class="tablesorter" id="sort_table">
                          <thead>
                            <tr class="logintext">
                              ...
                              <th width="12%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("SA_REASON_FOR_CANCEL");?></th>
                              <th width="17%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("SA_CD_CANCEL_STATUS");?></th>
                              <th width="14%" align="center" valign="middle" bgcolor="#99CC99" class="pedtext"><?php echo constant("SA_ADMIN_CANCEL_STATUS");?></th>
                              <th width="12%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("SA_REQUEST_DATE");?></th>
                              <th width="23%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("RECEPTION_ARF_MANAGE_STUDENTNAME");?></th>
                              <th width="4%" height="25" align="center" valign="middle" bgcolor="#99CC99">&nbsp;</th>
                              </tr>
                            </thead>
                          <?php					
						...
						?>                    
                          <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                            <td align="center" valign="middle" class="mycon" >
                              <?php if($valcancel["cd_status"] == 'Pending'){?>
                              <a href="cancel_status.php?cancel_id=<?php echo $valcancel["id"];?>"><img src="../images/edit_icon.png" width="16" height="16" border="0" title="<?php echo $Arabic->en2ar('Click here to change the Status');?>" /></a>
                              <?php } ?>
                              </td>                            
                          ...
                          <td align="right" valign="middle" class="mycon" >&nbsp;<a href="single-home.php?student_id=<?php echo $res_student[id];?>" style="cursor:pointer;">
							<?php echo $res_student[first_name]."&nbsp;".$res_student[father_name]."&nbsp;".$res_student[family_name]."&nbsp;(".$res_student[first_name1]."&nbsp;".$res_student[father_name1]."&nbsp;".$res_student[grandfather_name1]."&nbsp;".$res_student[family_name1].")";?>
						  </a></td>
                          <td align="center" valign="middle" class="mycon"><?php echo $i;?></td>
                            <?php
