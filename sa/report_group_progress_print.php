...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
		...
		<table width="250" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
			...
			<tr>
				...
				<td width="72%" align="left" valign="middle" bgcolor="#FFCB7D" class="leftmenu">
					<?php echo $dbf->getDataFromTable("student_group","group_name","id='$_REQUEST[group_id]'");?>
				</td>
			</tr>
			<tr>
				<td height="5" colspan="2" align="left" bgcolor="#FFCB7D" class="pedtext"></td>
    ...
    <td width="46" align="center" valign="middle" bgcolor="#FFFFFF">
		<!--
		<a href="report_teacher_progress_condition.php?group_id=<?php echo $_REQUEST[group_id];?>&teacher_id=<?php echo $teacher_id;?>">
  ...
  <tr>
    <td colspan="3" align="left" valign="middle" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<td align="left" valign="middle" class="pedtext"><?php echo $res_g[group_name];?> <?php echo $dbf->printClassTimeFormat($res_g["group_start_time"],$res_g["group_end_time"]);?></td>
			<td>&nbsp;</td>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<?php
							if($_SESSION[lang]=='EN'){$lang1 = "English";}
							else if($_SESSION[lang]=='AR'){$lang1 = "Arabic";}
							else{$lang1 = "English";}
						?>
				...
				<table width="988" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td width="82" align="left" valign="middle" bgcolor="#F5F5F5" class="pedtext_normal" style="border-left:solid 1px; border-color:#000000;">
							<?php echo constant("CD_GROUP_PROGRESS_ATTENDACE");?>
						</td>
					</tr>
					<tr>
						<td height="1" colspan="10" align="left" valign="middle" bgcolor="#000000"></td>
