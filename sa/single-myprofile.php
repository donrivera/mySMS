                      ...
                      <tr>
                        ...
                        <form action="s_process.php?action=edit_from_student_profile&student_id=<?=$student_id;?>" name="frm" method="post" id="frm" enctype="multipart/form-data"  onSubmit="return checkid();">
                          ...
                          <tr>
                            ...
                            <td width="205" height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("STUDENT_ADVISOR_HOME_S_CLASSIC_GENDER");?>:</td>
                            <td width="10">&nbsp;</td>
                            <td width="291" align="left" valign="middle" class="leftmenu"><?php
                          ...
                          <tr>
                            ...
                            <td width="346" align="left" valign="middle"><span class="leftmenu">
                              <?php
							$v = $res_edit_student["gender"];
							if($v == ''){ $v = 'male'; }
							?>
                          ...
                          <tr>
                            <td width="261" height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("STUDENT_ADVISOR_S_PARENT_PARENTGUARDIANS");?> :<span class="nametext1">*</span></td>
                            <td align="left" valign="middle">&nbsp;</td>
