		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr class="logintext">
                <td width="21%" height="30" class="logintext">
                <img src="../images/rightarrow.png" width="16" height="16">
				<?php echo constant("ADMIN_MENU_REPORTS_TEACHER_LEAVE");?></td>
                <td width="8%" align="right" valign="middle" class="logintext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHER");?> :&nbsp; </td>
                ...
                <td width="5%" align="right"><span class="logintext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_FROM");?></span> :&nbsp; </td>
                ...
                <td width="6%" align="right"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TO");?> :&nbsp; </td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                        <tr class="logintext">
                          <td width="3%" align="left">&nbsp;</td>
                          <td width="25%" align="left"><table width="240" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="187" align="right" valign="middle"><input name="end_date" readonly="" type="text" class="datepick validate[required] new_textbox80_ar" id="end_date" value="<?php echo $_REQUEST[end_date];?>" size="45" minlength="4"/></td>
                              </tr>
                            </table></td>
                          <td width="11%" align="left"> :&nbsp;<?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TO");?> </td>
                           <td width="9%" align="left">
                           ...
                           <td width="8%" align="left">:&nbsp;<span class="logintext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_FROM");?></span>  </td>
					   ...
					   ?>
                          ...
                          <td width="9%" align="left" valign="middle" class="logintext"> :&nbsp;<?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHER");?> </td>
                           <td width="19%" height="30" align="right" class="headingtext"><?php echo constant("ADMIN_MENU_REPORTS_TEACHER_LEAVE");?><img src="../images/arrow_small_right2.png" width="16" height="16"></td>
                          </tr>
                        </table></td>
                      </tr>
                    <tr>
                      <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB"class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                        <thead>
                          <tr class="logintext">
                            <th width="20%" align="right" valign="middle" bgcolor="#99CC99" class="menutext" style="padding-right:25px;"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_STARTDATE");?></span></th>
                            <th width="26%" align="right" valign="middle" bgcolor="#99CC99" class="menutext" style="padding-right:25px;"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_ENDDATE");?></span></th>
                            <th width="27%" align="right" valign="middle" bgcolor="#99CC99" class="menutext" style="padding-right:25px;"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_GROUPAFFECTED");?></span></th>
                            <th width="20%" align="right" valign="middle" bgcolor="#99CC99" class="menutext" style="padding-right:25px;"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHERNAME");?></span></th>
                            <th width="7%" height="25" align="center" valign="middle" bgcolor="#99CC99">&nbsp;</th>
                            </tr>
                          </thead>
                        <?php
