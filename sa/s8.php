                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          <tr>
                            <td width="47%" rowspan="7" align="center" valign="top" style="padding-top:3px;">
                              <br>
                          ...
                          <tr>
                            <td align="left" valign="top" class="mytext">&nbsp;</td>
                            <td>&nbsp;</td>
                          ...
                          <tr>
							...
							?>
                              <input type="hidden" name="tcount" id="tcount" value="<?php echo $t-1;?>"></td>
                            <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            </tr>
                          <tr>
                            <td align="left" valign="middle">&nbsp;</td>
