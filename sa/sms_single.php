    ...
    <tr>
      ...
      <?php if($_REQUEST['msg'] == 'block'){?>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td height="30" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#f00; font-weight:normal; font-size:12px;">SMS API has been disabled by Administrator</td>
        </tr>
        <?php } ?>
        <?php if($_REQUEST['msg'] != 'block'){?>
        <?php if($_REQUEST['msg'] != ''){?>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td height="30" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#f00; font-weight:normal; font-size:12px;"><?php echo $_REQUEST['msg'];?></td>
        </tr>
        <?php }} ?>
        <tr>
          <td>&nbsp;</td>
          <td width="53">&nbsp;</td>
          <td width="306" height="30" align="left" valign="middle" class="red_smalltext" id="lbl_error">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td colspan="2" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="right" valign="top" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:normal; font-size:12px;"><?php echo ADMIN_SMS_HISTORY_MESSAGE?> :&nbsp;</td>
              <td>&nbsp;</td>
