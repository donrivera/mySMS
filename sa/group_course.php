                            ...
                            <td height="28" colspan="3" align="left" valign="middle" class="leftmenu">
                              <select name="course" class="validate[required]" id="course" style="width:300px; border:solid 1px; border-color:#999999;">
								...
								foreach($dbf->fetchOrder('course',"","") as $ress) {
								  ?>
                                <option value="<?php echo $ress['id']?>" <?php if($ress["id"]==$_SESSION[gr_course_id]) {?> selected="selected" <?php } ?>>
                                  <?php echo $ress['name'];?></option>
                                <?php }?>
                              </select></td>
                            <td>&nbsp;</td>
                          </tr>
                        ...
                        <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                                <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("SELECT_COURSE");?></span></td>
                                <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                                </tr>
                              </table></td>
                            </tr>
                                  ...
                                  <form action="group_course_process.php?action=insert" name="frm" method="post" id="frm">
                                    <table width="100%" height="90" border="0" cellpadding="0" cellspacing="0" >
                                      ...
                                      <tr>
                                        ...
                                        <td>&nbsp;</td>
                                        <td align="right" valign="middle" class="leftmenu">&nbsp;<?php echo constant("STUDENT_ADVISOR_GROUP_TXT1");?></td>
                                        <td>&nbsp;</td>
                                      </tr>
                                      <tr>
                                        <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
