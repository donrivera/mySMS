          ...
          <tr>
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#AAAAAA" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <?php
					...
					$cond = '';
					if($centre_id == '' && $_REQUEST[payment_type] == ''){
						$cond = "(paid_date BETWEEN '$_REQUEST[start_date]' And '$_REQUEST[end_date]')";
					}else if($centre_id != '' && $_REQUEST[payment_type] == ''){
						$cond = "centre_id='$centre_id' And (paid_date BETWEEN '$_REQUEST[start_date]' And '$_REQUEST[end_date]')";
					}else if($centre_id != '' && $_REQUEST[payment_type] != ''){
						$cond = "centre_id='$centre_id' And payment_type='$_REQUEST[payment_type]' And (paid_date BETWEEN '$_REQUEST[start_date]' And '$_REQUEST[end_date]')";
					}else if($centre_id == '' && $_REQUEST[payment_type] != ''){
