...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="left" valign="middle" class="heading"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="36%" align="left" valign="middle" class="heading">&nbsp;</td>
        <td width="32%">&nbsp;</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" style="padding-left:13px;"><table width="350" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
      <tr>
        <td height="5" colspan="2" align="left" bgcolor="#FFE2D5" class="pedtext"></td>
      </tr>
      <tr>
        <td height="25" align="left" bgcolor="#FFE2D5" class="pedtext"><?php echo constant("STUDENT_ADVISOR_PED_TNAME");?> :</td>
        <td align="left" valign="middle" bgcolor="#FFE2D5" class="pedtext"><?php echo $res_teacher["name"];?></td>
      </tr>
      <tr>
        <td width="32%" height="25" align="left" bgcolor="#FFE2D5" class="pedtext"><?php echo constant("STUDENT_ADVISOR_PED_GROUP");?>:</td>
        <?php
				  //Get course name
				  $course = $dbf->strRecordID("student_group","*","id='$cmbgroup'");
				  $course_name = $dbf->strRecordID("course","*","id='$course[course_id]'");
				  ?>
        <td width="68%" align="left" valign="middle" bgcolor="#FFE2D5" class="pedtext"><?php echo $course["group_name"];?> <?php echo $course["group_time"];?>-<?php echo $dbf->GetGroupTime($course["id"]);?></td>
      </tr>
      <tr>
        <td height="25" align="left" bgcolor="#FFE2D5" class="pedtext"><?php echo constant("STUDENT_ADVISOR_PED_COURSE");?>:</td>
        
        <td align="left" valign="middle" bgcolor="#FFE2D5" class="pedtext"><?php echo $course_name[name];?></td>
      </tr>
      <tr>
        <td height="5" colspan="2" align="left" bgcolor="#FFE2D5" class="pedtext"></td>
      </tr>
  ...
  <tr>
    <td colspan="2" align="right" valign="top"><span class="heading"><?php echo constant("STUDENT_ADVISOR_PED_PEDAGOCARD");?></span></td>
    <td align="center" valign="middle" class="heading">&nbsp;</td>
  </tr>
  <?php
			  ...
			  //
			  $unit = $res_size["effect_units"];
			?>
  <tr>
    <td colspan="3" align="left" valign="top" id="lblpedcard"><table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse;" bgcolor="#FFFFFF">
      <?php
                  //===================================================
				  ...
				  $prev_sa = '';
				  $no_student = 0;
				  $no_student = $dbf->countRows('student_group_dtls',"parent_id='$cmbgroup'");
                  foreach($dbf->fetchOrder('student_group',"id='$cmbgroup'","","") as $res_group)
                  {
      ...
      <tr>
        <td height="25" align="left" valign="middle" class="pedtext"> <?php echo constant("STUDENT_ADVISOR_PED_STARTING");?> : <?php echo $res_cource_name[name];?></td>
        <td align="left" valign="middle" class="pedtext"><?php echo constant("STUDENT_ADVISOR_PED_BLGOAL");?>:</td>
      </tr>
      <tr>
        <td height="25" align="left" valign="middle" class="pedtext"><?php echo constant("STUDENT_ADVISOR_PED_MATERIALS");?> : <?php echo $res_cource_name[code];?></td>
        <?php
                    $level = $res_ped["level"];
					?>
        <td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr class="pedtext">
            <td width="54%" height="25" align="left" valign="middle" style="border-right:solid 1px;"><strong class="pedtext" ><?php echo constant("STUDENT_ADVISOR_PED_PROGREPORT");?> : </strong></td>
      ...
      <tr>
        <td height="25" colspan="2" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="21%" height="75" align="left" valign="middle" style="border-right:solid 1px;"><strong class="pedtext" ><?php echo constant("CD_EP_CLASS_CANCEL_COMMENTS");?> : </strong></td>
            <td width="79%" align="left" valign="middle">&nbsp;&nbsp;<?php echo $res_ped["comments"];?></td>
          </tr>
          <?php
                      $center_name = '';
                      ...
                      ?>
          <tr>
            <td height="30" align="left" valign="middle" class="pedtext" style="border-right:solid 1px; border-top:solid 1px;"><?php echo constant("STUDENT_ADVISOR_PED_LOCADIRECTION");?>: </td>
            <td align="left" valign="middle" class="pedtext" style="border-top:solid 1px;"><?php echo $center_name;?>&nbsp;&nbsp;<?php echo $res_ped["location"];?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
          ...
          <tr>
            <td height="25" colspan="4" align="left" valign="middle" style="border-right:solid 1px; border-color:#000000;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="9%" align="center" valign="middle" class="pedtext_normal"><?php echo constant("ADMIN_NEWS_MANAGE_DATE");?>:</td>
      ...
      <tr>
        <td colspan="2" align="left" valign="middle"><table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
          <tr>
            <td width="20%" height="25" align="left" valign="middle" class="pedtext"><?php echo constant("STUDENT_ADVISOR_PED_TXT14");?></td>
            <td width="5%" align="center" valign="middle" class="pedtext"><?php echo constant("TEACHER_ARF_MANAGE_LIS");?></td>
            <td width="5%" align="center" valign="middle" class="pedtext"><?php echo constant("ADMIN_GROUP_SIZE_MANAGE_UNITS");?></td>
            <td width="10%" align="center" valign="middle" class="pedtext"><?php echo constant("ADMIN_NEWS_MANAGE_DATE");?></td>
            <td width="5%" align="center" valign="middle" class="pedtext"><?php echo constant("STUDENT_ADVISOR_PED_CSV_DATA_ATTD");?></td>
            <td width="15%" align="center" valign="middle" class="pedtext"><?php echo constant("STUDENT_MYSCHEDULE_INSTRUCTOR");?></td>
            <td width="25%" align="center" valign="middle" class="pedtext"><?php echo constant("STUDENT_MYSCHEDULE_MATERIALCOVER");?></td>
            <td width="15%" align="center" valign="middle" class="pedtext"><?php echo constant("STUDENT_MYSCHEDULE_HOMEWORK");?></td>
          </tr>
          <tr bgcolor="#E9EFEF">
            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
                <td height="23" align="left" valign="middle" class="pedtext_normal"><?php echo constant("TEACHER_REPORT_TEACHER_DATE");?>:</td>
              </tr>
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
              ...
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
                <td height="23" align="left" valign="middle" class="pedtext_normal"><?php echo constant("STUDENT_ADVISOR_PED_CSV_DATA_ARFSUBMIT");?></td>
              </tr>
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
                <td height="23" align="left" valign="middle" class="pedtext_normal">&nbsp;</td>
              ...
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
                <td height="23" align="left" valign="middle" class="pedtext_normal"><?php echo constant("STUDENT_MYSCHEDULE_INSTRUCTOR");?></td>
              </tr>
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
              ...
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
                <td height="23" align="left" valign="middle" class="pedtext_normal"><?php echo constant("RECEPTION_STUDENT_APPOINT_MANAGE_DATE");?>:</td>
              </tr>
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
              ...
              <tr>
                <td height="23" colspan="2" align="left" valign="middle" class="pedtext_normal"><?php echo constant("STUDENT_ADVISOR_PED_TEXT");?></td>
              </tr>
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
                <td height="23" align="left" valign="middle" class="pedtext_normal">&nbsp;</td>
              ...
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
                <td height="23" align="left" valign="middle" class="pedtext_normal"><?php echo constant("ADMIN_STUDENT_MANAGE_NEWSTUDENT");?></td>
              </tr>
              <tr>
                <td align="center" valign="middle">&nbsp;</td>
            ...
            <td colspan="6" align="left" valign="top" bgcolor="#F7F3F8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <?php
						...
						$res_unit = $dbf->strRecordID("ped_units","*","group_id='$cmbgroup' And teacher_id='$teacher_id' AND units='$i'");
						
						//Get the Number of Present in a particular Units
						$present = $dbf->strRecordID("ped_attendance","COUNT(id)","unit='$res_unit[units]' And teacher_id='$teacher_id' And group_id='$cmbgroup' And (shift1='X' OR shift2='X' OR shift3='X' OR shift4='X' OR shift5='X' OR shift6='X' OR shift7='X' OR shift8='X' OR shift9='X')");
						
						?>
              <tr class="pedtext_normal">
                <td width="56" height="30" align="center" valign="middle" bgcolor="#F7F3F8" class="pedtext_normal" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;"><?php echo $i;?></td>
                <td width="128" align="center" valign="middle" bgcolor="#F7F3F8" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;"><?php echo $res_unit["dated"];?></td>
                <td width="56" align="center" valign="middle" bgcolor="#F7F3F8" class="pedtext_normal" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;"><?php echo $present["COUNT(id)"];?></td>
                <td width="191" bgcolor="#F7F3F8" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px; ">&nbsp;</td>
                <td width="320" align="left" valign="middle" bgcolor="#F7F3F8" style="border-right:solid 1px; border-color:#000000;border-bottom:solid 1px;"><?php echo $res_unit["material_overed"];?></td>
                <td  align="left" valign="middle" bgcolor="#F7F3F8" style="border-bottom:solid 1px; border-color:#000000;">&nbsp; <?php echo $res_unit["homework"];?></td>
              </tr>
              <?php } ?>
      ...
      <tr>
        <td height="25" colspan="2" align="left" valign="middle" class="nametext" style="padding-left:16px;"><table width="850" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FFCC00;">
          <tr class="pedtext">
            <td width="49" bgcolor="#FFFF00" class="redtext">&nbsp;<?php echo constant("ADMIN_GROUP_SIZE_MANAGE_NOTE");?> :</td>
      ...
      <tr>
        <td height="25" colspan="2" align="center" valign="middle"><?php
					$count_course = 1;
                     //Get Group Name
					 
                      foreach($dbf->fetchOrder('student_group',"id='$cmbgroup'","","") as $val_course)
                      {
          ...
          <div style="width:1250px;">
            <div style="width:100%; overflow:scroll;overflow-y:hidden; margin-bottom:15px;" >
              <table width="100%" border="1" align="center" cellpadding="3" bordercolor="#000000" cellspacing="0" style="border-collapse:collapse;">
                ...
                <tr>
                  <td width="10%" align="left" bgcolor="#4D7373"><div class="logouttext" style="width:130px;">
                    <span class="logouttext" style="width:130px;"><strong><?php echo "Student Name";?></strong></span>
                ...
                <?php
                        ...
                        foreach($dbf->fetchOrder('student_group_dtls d,student s',"s.id=d.student_id AND d.parent_id='$cmbgroup'","s.first_name","s.*") as $r) {
                        ?>
                <tr>
                  ...
                  <?php
							...
							{
							?>
                  <td colspan="3" align="center" bgcolor="#E9EFEF"><?php
                    ...
                    <div style="padding:3px;">
                      <?php						
						...
						?>
                      <span class="pedtext_normal"><?php echo $status_shift1;?> </div>
                    <?php
                        $shift_no++;
						}
						?></td>
      ...
      <tr>
        <td height="35" colspan="2" align="center" valign="middle" class="nametext"></td>
      </tr>
    </table></td>
  </tr>
  <tr>
