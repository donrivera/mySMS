...
if($_REQUEST['action'] == 'insert'){
	...
	if($is_enable > 0){
		...
		if($mobile_no != ''){
			...
			//$msg = $stu["0"]." is applying for cancellaion of class";
			//$msg = "%0% is applying for cancellaion of class";
			$sms = $_REQUEST['sms'];
			if($sms == "1" || $sms == "3"){
				if($sms == "1"){
                                ...
                                <form action="single-cancel-add.php?student_id=<?php echo $student_id;?>&action=insert" name="frm" method="post" id="frm">        
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-color:#CCCCCC;">
                                      ...
                                      <tr>
                                        ...
                                        <?php echo $Arabic->en2ar($dbf->StudentName($student_id));?> <?php echo $dbf->getDataFromTable("student", "first_name", "id='$student_id'");?>
                                        </td>
