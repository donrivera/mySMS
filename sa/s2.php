...
function check(){
	if(document.getElementById('country').value == '189'){
		if(document.getElementById('id_type').checked == true){
                      ...
                      <tr>
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          <tr>
                            ...
                            <td width="1%">&nbsp;</td>
                            <td width="28%">&nbsp;</td>
                            <td width="50%" rowspan="9" align="left" valign="top" style="padding-top:3px;">
                            <br>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="middle"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <input name="id_type" type="radio" id="id_type" value="National ID" <?php if($v == "National ID") { ?> checked="checked" <?php } ?>></td>
                                <td width="50%" align="left" valign="middle" class="hometest_name">
								<?php echo constant("NATIONAL_ID_IQAMA");?></td>
                                <td width="9%" align="left" valign="middle" class="hometest_name">
                                <input type="radio" name="id_type" id="id_type" value="Passport" <?php if($v != "National ID") { ?> checked="checked" <?php } ?>></td>
                          ...
                          <tr>
                            <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            <td height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("STUDENT_ADVISOR_S2_STDIDNO");?>   : <span class="nametext1">*</span></td>
                            <td>&nbsp;</td>
                            <td align="left" valign="middle">
                                ...
                                <tr>
                                  <td align="center" valign="top" bgcolor="#EBEBEB">
                                    ...
                                    <form action="s1_process.php?action=country" name="frm" method="post" id="frm" onSubmit="return check();">
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                        <tr>
                                          <td width="50%" rowspan="9" align="center" valign="top" style="padding-top:3px;">
                                            <br>
                                            <table width="95%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px #B6B6B6; background:url(../images/bg.png) repeat-x; ">
                                              <tr>
                                                <td align="left" valign="middle">&nbsp;</td>
                                        ...
                                        <tr>
                                          ...
                                          <td align="right" valign="middle"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                             <td width="42%" align="right" valign="middle" class="mytext">
                                                <?php echo constant("NATIONAL_ID_IQAMA");?></td>
                                              <td width="11%" align="left" valign="middle" class="hometest_name">
                                                <input name="id_type" type="radio" id="id_type" value="National ID" <?php if($v == "National ID") { ?> checked="checked" <?php } ?>></td>
          									 <td width="38%" align="right" valign="middle" class="mytext"><?php echo constant("PASSPORT");?></td>                                  
                                              <td width="9%" align="left" valign="middle" class="hometest_name">
                                                <input type="radio" name="id_type" id="id_type" value="Passport" <?php if($v != "National ID") { ?> checked="checked" <?php } ?>></td>
                                        ...
                                        <tr>
                                          ...
                                          <td>&nbsp;</td>
                                          <td height="28" align="left" valign="middle" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("STUDENT_ADVISOR_S2_STDIDNO");?></td>
