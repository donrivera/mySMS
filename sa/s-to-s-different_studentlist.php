...
if($_SESSION['lang']=='EN'){
  ...
  <tr>
    ...
    <input type="checkbox" name="student_id<?php echo $i;?>" id="student_id<?php echo $i;?>" value="<?php echo $student["id"];?>" onchange="show_save();" />
    </td>
  ...
  <input type="hidden" name="count" id="count" value="<?php echo $i-1;?>">
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
	  ...
	  <?php
      $i = 1;
      //foreach($dbf->fetchOrder('student',"centre_id='$_REQUEST[centre_from]' And student_mobile<>''","first_name") as $student) {
