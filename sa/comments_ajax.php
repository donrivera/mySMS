...
<table width="450" border="0" cellspacing="0" cellpadding="0">
	<tr>
	  ...
	  <td width="432" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td width="26%" align="left" valign="middle" class="hometest_name"><?php echo constant("STUDENT_HOME_POSTEDBYADMIN");?>  </td>
		  ...
		  <tr>
		    <td colspan="2" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="11%" align="left" valign="middle" class="hometest_time"><?php echo constant("STUDENT_HOME_MARKAS");?> : </td>
                <td width="6%" align="center" valign="middle" class="hometest_time"><img src="../images/important.png" width="16" height="16"></td>
                <td width="83%" align="left" valign="middle" class="hometest_time"><?php echo constant("STUDENT_HOME_IMPORTANT");?></td>
              </tr>
            </table></td>
	    </tr>
		<?php } ?>
		  <tr>
		    <td colspan="2" align="left" valign="top" class="hometest_time"><?php echo constant("STUDENT_HOME_MSGTYPE");?>: <?php echo $valm["name"];?></td>
	    </tr>
		  <tr>
	...
	<tr>
	  <td width="432" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
            ...
            <td width="26%" align="right" valign="middle" class="hometest_name"><?php echo constant("STUDENT_HOME_POSTEDBYADMIN");?>  </td>
	    </tr>
		  <tr>
			<td height="5"></td>
			<td height="5"></td>
		  ...
		  <tr>
		    <td colspan="2" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="83%" align="right" valign="middle" class="hometest_time"><?php echo constant("STUDENT_HOME_IMPORTANT");?></td>
                <td width="6%" align="center" valign="middle" class="hometest_time"><img src="../images/important.png" width="16" height="16"></td>
                <td width="11%" align="right" valign="middle" class="hometest_time"> : <?php echo constant("STUDENT_HOME_MARKAS");?></td>
		...
		<?php } ?>
		  <tr>
		    <td colspan="2" align="right" valign="top" class="hometest_time"> <?php echo $valm["name"];?> : <?php echo constant("STUDENT_HOME_MSGTYPE");?></td>
	    </tr>
		  <tr>
