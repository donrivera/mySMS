...
if($_SESSION['lang']=='EN'){
  ...
  <tr>
    ...
    <td width="28%" align="left" valign="middle" bgcolor="#E0E3FE" class="pedtext"><?php echo constant("ADMIN_VIEW_COMMENTS_MANAGE_STUDENT");?></td>
    <td width="27%" align="left" valign="middle" bgcolor="#E0E3FE" class="pedtext"><?php echo constant("ADMIN_SMS_GATEWAY_MANAGE_MOBILENO");?></td>
    <td width="22%" height="25" align="left" valign="middle" bgcolor="#E0E3FE" class="pedtext"><?php echo constant("ADMIN_S_MANAGE_STUDENTID");?></td>
  ...
  <tr>
    ...
    <input type="radio" name="tostudent_id" id="tostudent_id<?php echo $kk;?>" value="<?php echo $mygroup["student_id"];?>"  onchange="show_save();"/></td>
...
<input type="hidden" name="tocount" id="tocount" value="<?php echo $kk-1;?>" />
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
          ...
          <tr>
            ...
            <td align="right" valign="middle" bgcolor="#FFFFFF" >&nbsp;<?php echo $student["first_name"];?><?php echo $Arabic->en2ar($dbf->StudentName($student["id"]));?></td>
            <td align="center" valign="middle" bgcolor="#FFFFFF" >
            <input type="radio" name="tostudent_id" id="tostudent_id<?php echo $i-1;?>" value="<?php echo $student["id"];?>" onchange="show_save();" />
            </td>
          </tr>
          <?php $kk++; } ?>
        </table>
