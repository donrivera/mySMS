...
<table width="700" border="0" align="center" cellpadding="0" cellspacing="1" style="border:solid 2px; border-color:#000000;">
  ...
  <tr>
    ...
    <td width="74">&nbsp;</td>
     ...
     <td width="16">&nbsp;</td>
    <td width="202" class="leftmenu"><?php echo $res_std[first_name]."&nbsp;".$res_std[father_name]."&nbsp;".$res_std[family_name]."&nbsp;(".$res_std[first_name1]."&nbsp;".$res_std[father_name1]."&nbsp;".$res_std[grandfather_name1]."&nbsp;".$res_std[family_name1].")";?></td>
    <td width="115" height="30" bgcolor="#CCCCCC" class="leftmenu" style="border-left:solid 1px; border-color:#636;border-top:solid 1px; border-color:#636;border-bottom:solid 1px; border-color:#636;border-right:solid 1px; border-color:#636;"> :<?php echo constant("RECEPTION_ARF_MANAGE_STUDENTNAME");?></td>
    <td width="63">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td align="left" valign="middle"><?php echo $res_arf[nr];?></td>
     <td align="left" valign="middle" bgcolor="#CCCCCC" class="leftmenu">:<?php echo constant("RECEPTION_ARF_MANAGE_NR");?> </td>
     <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
    <td align="left" valign="middle"  class="leftmenu"><?php echo $res_arf[dated];?></td>
     <td height="30" align="left" valign="middle" bgcolor="#CCCCCC" class="leftmenu">:<?php echo constant("RECEPTION_ARF_MANAGE_DATE");?> </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td align="left" valign="middle"  class="leftmenu"><?php echo $res_arf[action_owner];?></td>
     <td height="30" align="left" valign="middle" bgcolor="#CCCCCC" class="leftmenu">:<?php echo constant("RECEPTION_ARF_MANAGE_ACTIONOWNER");?> </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td align="left" valign="middle" class="leftmenu1"><?php echo $res_arf[report_to];?></td>
     <td align="left" valign="middle" bgcolor="#CCCCCC" class="leftmenu">:<?php echo constant("RECEPTION_ARF_MANAGE_REPORTED TO");?></td>
    <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
  ...
  <tr>    
    ...
    <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
    <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[customer];?></td>
  ...
  <tr>  
    ...
    <td align="right" bgcolor="#CCCCCC" class="leftmenu">: <?php echo constant("RECEPTION_ARF_MANAGE_LCD");?>  </td>
     <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
    <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[teacher];?></td>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
    <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[reception1];?></td>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
    <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[cs1];?></td>
  ...
  <tr>
    ...
    <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
     <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[other1];?></td>
  ...
  <tr>
    ...
    <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[instruction];?></td>
  ...
  <tr>
    ...
    <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[material];?></td>
  ...
  <td align="left" valign="middle">&nbsp;</td>
    ...
    <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
        ...
        <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[programme];?></td>
  ...
  <tr>
    ...
    <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[premisses];?></td>
  ...
  <tr>
    ...
    <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[administration];?></td>
  ...
  <tr>
    ...
    <td height="25" align="left" valign="middle" class="leftmenu"><?php echo $res_arf[other3];?></td>
     <td align="right" valign="middle" bgcolor="#CCCCCC" class="leftmenu"> : <?php echo constant("RECEPTION_ARF_MANAGE_OTHER");?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
