                          ...
                          <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="middle">
                                  <select name="unit" id="unit" class="validate[required]" style="width:150px; border:solid 1px; border-color:#999999;">
									...
									?>
                                    <option value="<?php echo $res_unit['name']?>" <?php if($res_unit['name'] == "2"){?> selected="" <?php } ?>><?php echo $res_unit['name'];?>&nbsp;units/day</option>
                                    <?php } ?>
                                    </select></td>
                              ...
                              <tr>
                                ...
                                <input type="text" name="date_value" class="validate[required] datepick new_textbox80" value="<?php echo date('Y-m-d');?>" id="date_value" onChange="date_change();" />&nbsp;<img src="../images/change_status.png" width="16" height="16" title="Refresh Time slot" onClick="showtime();" style="cursor:pointer;"></td>
                                </tr>
                              <tr>
                              ...
                              <tr>
								...
								?>
                                <td align="left" valign="middle">
                                <input type="text" name="gr_course_endt" class="validate[required] new_textbox80"  id="gr_course_endt" value="<?php echo $new_dt1;?>" readonly="" />&nbsp;<input type="text" name="dt" class="validate[required] new_textbox80" id="dt" readonly="" value="">&nbsp;<input type="text" name="tm" class="new_textbox70" id="tm" readonly="" value=""></td>
                                </tr>
                              </table>
                            </td>
                            <td>&nbsp;</td>
