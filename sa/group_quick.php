                          ...
                          <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
								...
								?>
                                <td align="left" valign="middle">
                                <input type="text" name="gr_course_endt" class="validate[required] new_textbox80"  id="gr_course_endt" value="<?php echo $dt1;?>" readonly="" />&nbsp;<input type="text" name="dt" class="validate[required] new_textbox80" id="dt" readonly="" value="">&nbsp;<input type="text" name="tm" class="new_textbox70" id="tm" readonly="" value=""></td>
                                </tr>
                              </table>
                            </td>
                            <td>&nbsp;</td>
