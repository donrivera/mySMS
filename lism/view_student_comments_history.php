					  ...
					  $user = $dbf->strRecordID("user","*","id='$resc[user_id]'");
                        ...
                        <!-- Green -->
                          <table width="99%" border="0" cellspacing="0" cellpadding="0" >
                            ...
                            <tr>
                              ...
                              <td align="left" valign="middle" bgcolor="#C8EF54" class="shop1"><?php echo constant("TEACHER_REPORT_TEACHER_DATE");?>  : <?php echo date("D, d M Y",strtotime($resc["date_time"]));?>&nbsp;,&nbsp;<?php echo date("h:m",strtotime($resc["date_time"]));?></td>
                        ...
                        <!-- Gray -->
                          <table width="98%" border="0" align="right" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              <td background="../images/left_mid_grey.png">&nbsp;</td>
                              <td align="left" valign="middle" class="shop1"><?php echo constant("TEACHER_REPORT_TEACHER_DATE");?>  : <?php echo date("D, d M Y",strtotime($resc["date_time"]));?>&nbsp;,&nbsp;<?php echo date("h:m",strtotime($resc["date_time"]));?></td>
                              <td background="../images/right_midgrey.png">&nbsp;</td>
                            </tr>
                            <tr>
