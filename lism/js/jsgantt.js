/*
Copyright (c) 2011, BLET-E Technologies,India. All rights reserved.
...
*/ this.Draw = function()
   {
      ...
      if(vTaskList.length > 0)
      {
         ...
         vLeftTable += '</TR>';
            ...
            vLeftTable += '</TD></TR>' +
              '<TR><TD border=1 colspan=5 align=left style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 11px; BORDER-LEFT: #efefef 1px solid; height=18px">&nbsp;&nbsp;Powered by&nbsp;&nbsp; Kabul Patel&nbsp;,&nbsp;BLET&nbsp;&nbsp;&nbsp;&nbsp;Format:';
