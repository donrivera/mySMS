                                  ...
                                  <tr>
                                    ...
                                    <td height="28" colspan="2" align="left" valign="middle" class="leftmenu">
                                      ...
                                      <table width="99%" border="0" cellspacing="0" bordercolor="#cccccc" cellpadding="0" style="border-collapse:collapse;">
                                        ...
                                        <?php
										$k = 0;
										foreach($dbf->fetchOrder('quick_menu',"module_name='LIS Manager'","id") as $qpage) {
									$num=$dbf->countRows('quick_links',"link_name='$qpage[link_name]' And module_name='LIS Manager' And user_id='$_SESSION[id]'");
										?>
