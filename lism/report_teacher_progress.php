        ...
        <table width="250" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
          ...
          <tr>
            ...
            <select name="cmbgroup" id="cmbgroup" style="width:150px; border:solid 1px; border-color:#999999;" onChange="setsubmit();">
                ...
                <?php
				if($_REQUEST["mystatus"] != ""){ $cond = " centre_id='$_SESSION[centre_id]' And status='$_REQUEST[mystatus]'";}else{ $cond = "centre_id > '0'"; }
			  	foreach($dbf->fetchOrder('student_group',$cond,"group_name","") as $res_group) {
				  ?>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#000000;">
            ...
            <tr>
              ...
              <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="41%" height="20" align="right" valign="middle" class="pedtext_normal"><?php echo $res_g[group_name];?> <?php echo $dbf->printClassTime($res_g["group_start_time"],$res_g["group_end_time"]);?></td>
