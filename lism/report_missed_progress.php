	...
	.tablesorterPager({container: $("#pager"), size: 10});
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td>&nbsp;</td>
              <td width="36" align="center" valign="top"><a href="report_missed_progress_report_word.php?centre_id=<?php echo $_REQUEST["centre_id"];?>&teacher_id=<?php echo $_REQUEST["teacher_id"];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="Export to Word"></a></td>
              <td width="36" align="center" valign="top"><a href="report_missed_progress_report_csv.php?centre_id=<?php echo $_REQUEST["centre_id"];?>&teacher_id=<?php echo $_REQUEST["teacher_id"];?>"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="Export to Excel"></a></td>
              <td width="36" align="center" valign="top"><a href="report_missed_progress_report_pdf.php?centre_id=<?php echo $_REQUEST["centre_id"];?>&teacher_id=<?php echo $_REQUEST["teacher_id"];?>"><img src="../images/pdf.png" width="20" height="20" border="0" title="Export to PDF"></a></td>
              <td width="36" align="center" valign="middle"><a href="report_missed_progress_report_print.php?centre_id=<?php echo $_REQUEST["centre_id"];?>&teacher_id=<?php echo $_REQUEST["teacher_id"];?>" target="_blank"><img src="../images/print.png" alt="" width="16" height="16" border="0" title="Print"></a></td>
            </tr>
        </table></td>
      </tr>
    </table>
          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
				  ...
				  <?php echo constant("ADMIN_MENU_REPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"> <?php echo constant("LISM_MISSED_PROGRESS");?> </td>
                ...
                <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                  <thead>
                    ...
                    <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                      ...
                      <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val_leave[preport_update_date];?></td>
                      <?php
                          $i = $i + 1;
                          if($color=="#ECECFF"){
                              $color = "#FBFAFA";
