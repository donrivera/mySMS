...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="topbg" align="center">
  ...
  <tr>
    <td align="left" valign="top" background="images/title.png" ><div id="glowmenu" class="glowingtabs">
      ...
      <?php
	  $mystyle = '';
	  if($page_name == "report_sick_leave.php" || $page_name=="report_outstanding.php" || $page_name=="report_missed_eped.php" || $page_name=="report_missed_progress.php" || $page_name=="report_missed_certificate.php" || $page_name=="report_management.php")
	  {
		  $mystyle = 'style="background-color:#003399; background-image:none;"';
	  }
	  ?> 
        <li><a <?php echo $mystyle;?> href="#" title="mnu_reports" rel="mnu_reports"><span <?php echo $mystyle;?>><?php echo constant("ADMIN_MENU_REPORTS");?></span></a></li>       <?php
	  $mystyle = '';
   ...
   <div id="prefer" class="dropmenudiv_d">
    ...
    <div id="mnu_reports" class="dropmenudiv_d">
        <a href="report_sick_leave.php"><?php echo constant("LIS_SICK_LEAVE");?></a> 
		<a href="report_outstanding.php"><?php echo constant("LIS_OUT_APP");?></a>        
    ...
    <?php
    foreach($dbf->fetchOrder('help',"lism='1'","id") as $val) {
    ?>
