                              ...
                              <table width="350" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  ?>
                                   ...
                                   <td width="10">&nbsp;</td>
                                  <td width="101" align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_USER_MANAGE_USERSTATUS");?></td>
                                </tr>
                              </table>
                              </div>
                              ...
                              <table width="350" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  ?>
                                   ...
                                   <td width="10">&nbsp;</td>
                                  <td width="101" align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_USER_MANAGE_CENTRENAME");?></td>
                                </tr>
                              </table>
                              </div>
                              </td>
