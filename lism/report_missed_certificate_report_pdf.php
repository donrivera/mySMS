...
ini_set('memory_limit', '-1');
	...
	$html = '<table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#999999" style="border-collapse:collapse;">
				<tr>
				  ...
				  <th width="9%" align="left" valign="middle" bgcolor="#CCCCCC"><span id="result_box" lang="ar" xml:lang="ar">'.LISM_DUE_DATE.'</span></th>
				  ...
				  <th width="12%" align="left" valign="middle" bgcolor="#CCCCCC"><span id="result_box" lang="ar" xml:lang="ar">'.LISM_UPDATE_DATE.'</span></th>
				</tr>';
					$i = 1;
				...
				$html.='<tr>
				  ...
				  <td align="left" valign="middle" class="mycon" style="padding-left:5px;">'.$val_leave[certificate_update_date].'</td>';
					  $i = $i + 1;
				  }
				$html.='</tr>                   
			</table>';
