          ...
          <tr>
			...
			<thead>
                ...
                <?php
					$i = 1;
					$color = "#ECECFF";
					$num=$dbf->countRows('alerts',"centre_id='$_REQUEST[centre_id]'");
					foreach($dbf->fetchOrder('alerts',"centre_id='$_REQUEST[centre_id]'","id DESC") as $val)
					{
                ...
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='alert1_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                  ...
                  <td width="3%" align="center" valign="middle"><a href="alert1_process.php?action=delete&amp;id=<?php echo $val[id];?>"  class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="Delete" /></a></td>
                  <?php
					  $i = $i + 1;
					   if($color=="#ECECFF")
					  {
