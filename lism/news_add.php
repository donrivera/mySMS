...
function validate()
{
	...
	{
		document.getElementById('lblname').innerHTML = "<html><table width='200' border='0' cellspacing='0' cellpadding='0' style='border:solid 1px; border-color:#990000;'><tr><td width='14%' rowspan='2' align='center' valign='middle' bgcolor='#FFCCFF'><img src='../images/block.png' width='16' height='16' /></td><td width='6%' bgcolor='#FFCCFF'>&nbsp;</td><td width='80%' rowspan='2' bgcolor='#FFCCFF' class='nametext1'>Enter Important Information</td></tr><tr><td bgcolor='#FFCCFF'>&nbsp;</td></tr></table></html>";
                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("ADMIN_VIEW_GROUP_SIZE_CENTRE");?> :</td>
                          <td>&nbsp;</td>
                          <td align="left" valign="middle"><select name="centre_id" id="centre_id" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF; height:25px; width:192px;">
                            <?php
            ...
            <table width="637" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15" align="left" valign="top"><img src="../images/left_top_bg.png" width="15" height="31" alt="left_top" /></td>
                        <td width="100%" align="right" style="background:url(../images/left_mid_bg.png) repeat-x;"><span class="logintext"><?php echo constant("ADMIN_NEWS_MANAGE_NEWNEWS");?></span></td>
                        <td width="15" align="right" valign="top"><img src="../images/top_right_bg.png" width="15" height="31" /></td>
                      </tr>
                    </table></td>
                  </tr>
                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td align="right" valign="middle"><select name="centre_id" id="centre_id" style="border:solid 1px; border-color:#999999;background-color:#ECF1FF; height:25px; width:192px;">
                            <?php
						foreach($dbf->fetchOrder('centre',"","name") as $valc) {	
					  ?>
                            <option value="<?php echo $valc[id];?>"><?php echo $valc[name];?></option>
					   ...
					   ?>
                          ...
                          <td>&nbsp;</td>
                           <td height="28" align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_VIEW_GROUP_SIZE_CENTRE");?></td>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                        </tr>
                        <tr>
                          ...
                          <td height="28" align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_NEWS_MANAGE_ALERTTYPE");?></td>
                           <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                        </tr>
                        <tr>
                          ...
                          <td height="28" align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_NEWS_MANAGE_IMPORTANT");?></td>
                           <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                        </tr>
                        <tr>
                          ...
                          <td height="28" align="left" valign="top" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_NEWS_MANAGE_IMPORTANTINFO");?> </td>
                           <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="middle">&nbsp;</td>
                          <td>&nbsp;</td>
                          <td align="right" valign="middle" style="padding-top:3px;"><textarea name="info" id="info" style="border:solid 1px; background-color:#ECF1FF;border-color:#999999; width:187px; height:150px;"></textarea></td>
                          <td>&nbsp;</td>
                          
                          <td height="28" align="left" valign="top" class="leftmenu"> : <?php echo constant("ADMIN_NEWS_MANAGE_INFORMATION");?></td>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                        </tr>
                        <tr>
                         ...
                         <td align="left" valign="middle" id="lblerror">&nbsp;</td>
                          <td>&nbsp;</td>
                          <td align="right" valign="middle"><input name="date" readonly="" type="text" class="datepick validate[required] new_textbox1" id="date" value="" size="45" minlength="4"/></td>
                          <td>&nbsp;</td>
                          
                           <td height="28" align="left" valign="middle" class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("ADMIN_NEWS_MANAGE_DATE");?></td>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                         </tr>
                        <tr>
                          ...
                          <td height="28" align="left" valign="middle" class="leftmenu"> : <?php echo constant("ADMIN_NEWS_MANAGE_AUDIENCE");?></td>
                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                        </tr>
                        <tr>
                          <td height="10" colspan="6" align="left" valign="middle"></td>
