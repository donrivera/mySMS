			...
			<table width="900" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
              ...
              <tr>
                ...
                <td colspan="3" align="left" valign="middle" class="bigerrortext"><table width="860" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="425" align="left" valign="top"><iframe height="230" width="430" src="calc_eng.php" style="border:none;"> </iframe></td>
                    <td width="10">&nbsp;</td>
                    <td width="425" align="left" valign="top"><iframe height="230" width="430" src="calc_hijri.php" style="border:none;"> </iframe></td>
                  </tr>
                </table></td>
                <td width="20">&nbsp;</td>
              </tr>
